...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_gsc_alert_id_azs_gsc_alert",
				data: "lbl_azs_gsc_alert_id_azs_gsc_alert",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_gsc_alert_m_date_created",
				data: "lbl_azs_gsc_alert_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_gsc_alert_m_date_modified",
				data: "lbl_azs_gsc_alert_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_gsc_alert_m_description",
				data: "lbl_azs_gsc_alert_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Tiempo Proximo Vencer",
				id: "lbl_azs_gsc_alert_t_next_time",
				data: "lbl_azs_gsc_alert_t_next_time",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_gsc_alert_t_time_expired",
				data: "lbl_azs_gsc_alert_t_time_expired",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Cliente",
				id: "lbl_azs_gsc_alert_u_gsc_client",
				data: "lbl_azs_gsc_alert_u_gsc_client",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Fase",
				id: "lbl_azs_gsc_alert_u_gsc_phase",
				data: "lbl_azs_gsc_alert_u_gsc_phase",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_gsc_alert_id_azp_gsc_alert").innerHTML = objData.data.lbl_azp_gsc_alert_id_azp_gsc_alert;
					...
					document.querySelector("#lbl_azp_gsc_alert_m_date_created").innerHTML = objData.data.lbl_azp_gsc_alert_m_date_created;
					document.querySelector("#lbl_azp_gsc_alert_m_date_modified").innerHTML = objData.data.lbl_azp_gsc_alert_m_date_modified;
					document.querySelector("#lbl_azp_gsc_alert_m_description").innerHTML = objData.data.lbl_azp_gsc_alert_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_gsc_alert_t_next_time").innerHTML = objData.data.lbl_azp_gsc_alert_t_next_time;
					document.querySelector("#lbl_azp_gsc_alert_t_time_expired").innerHTML = objData.data.lbl_azp_gsc_alert_t_time_expired;
					document.querySelector("#lbl_azp_gsc_client_t_name").innerHTML = objData.data.lbl_azp_gsc_client_t_name;
					document.querySelector("#lbl_azp_gsc_phase_t_name").innerHTML = objData.data.lbl_azp_gsc_phase_t_name;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_gsc_alert_id_azp_gsc_alert;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_gsc_alert_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_gsc_alert_m_status;
					document.querySelector("#field_up_next_time_d").value = objData.data.lbl_azp_gsc_alert_t_next_time_d;
					document.querySelector("#field_up_next_time_h").value = objData.data.lbl_azp_gsc_alert_t_next_time_h;
					document.querySelector("#field_up_next_time_m").value = objData.data.lbl_azp_gsc_alert_t_next_time_m;
					document.querySelector("#field_up_next_time_s").value = objData.data.lbl_azp_gsc_alert_t_next_time_s;
					document.querySelector("#field_up_time_expired_d").value = objData.data.lbl_azp_gsc_alert_t_time_expired_d;
					document.querySelector("#field_up_time_expired_h").value = objData.data.lbl_azp_gsc_alert_t_time_expired_h;
					document.querySelector("#field_up_time_expired_m").value = objData.data.lbl_azp_gsc_alert_t_time_expired_m;
					document.querySelector("#field_up_time_expired_s").value = objData.data.lbl_azp_gsc_alert_t_time_expired_s;
					document.querySelector("#field_up_gsc_client").value = objData.data.lbl_azp_gsc_alert_v_id_azp_gsc_client;
					document.querySelector("#field_up_gsc_phase").value = objData.data.lbl_azp_gsc_alert_v_id_azp_gsc_phase;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
