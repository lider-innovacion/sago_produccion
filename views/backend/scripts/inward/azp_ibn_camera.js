...
function action_checkbox_info() {
	...
	if ($('#field_ck_checkbox_info').is(':checked')) {
		...
		//Array.prototype.forEach.call(list, function (item) {
			...
			var querys = document.querySelector('#dt_info');
			var elements = querys.querySelectorAll('tr td.lbl_azp_ibn_camera_t_identification input');
			[].forEach.call(elements, function(items) {
			...
			var querys = document.querySelector('#dt_info');
			var elements = querys.querySelectorAll('tr td.lbl_azp_ibn_camera_t_full_name input');
			[].forEach.call(elements, function(items) {
				items.className = 'form-control input-xs';
				items.disabled = true;
			});
...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_camera_id_azs_ibn_camera",
				data: "lbl_azs_ibn_camera_id_azs_ibn_camera",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_camera_m_date_created",
				data: "lbl_azs_ibn_camera_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_camera_m_date_modified",
				data: "lbl_azs_ibn_camera_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_camera_m_description",
				data: "lbl_azs_ibn_camera_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Consecutivo",
				id: "lbl_azs_ibn_camera_t_consecutive",
				data: "lbl_azs_ibn_camera_t_consecutive",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Cedula",
				id: "lbl_azs_ibn_camera_t_identification",
				data: "lbl_azs_ibn_camera_t_identification",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Nombre",
				id: "lbl_azs_ibn_camera_t_full_name",
				data: "lbl_azs_ibn_camera_t_full_name",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Estado",
				id: "lbl_azs_ibn_camera_u_ibn_state",
				data: "lbl_azs_ibn_camera_u_ibn_state",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Matricula",
				id: "lbl_azs_ibn_camera_t_nro_registration",
				data: "lbl_azs_ibn_camera_t_nro_registration",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Ciudad",
				id: "lbl_azs_ibn_camera_t_city",
				data: "lbl_azs_ibn_camera_t_city",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Departamento",
				id: "lbl_azs_ibn_camera_t_department",
				data: "lbl_azs_ibn_camera_t_department",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Municipio",
				id: "lbl_azs_ibn_camera_t_municipality",
				data: "lbl_azs_ibn_camera_t_municipality",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Direccion",
				id: "lbl_azs_ibn_camera_t_address",
				data: "lbl_azs_ibn_camera_t_address",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_ibn_camera_t_renewal_date",
				data: "lbl_azs_ibn_camera_t_renewal_date",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_ibn_camera_u_ibn_type_certified",
				data: "lbl_azs_ibn_camera_u_ibn_type_certified",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Tipo Sociedad",
				id: "lbl_azs_ibn_camera_t_type_company",
				data: "lbl_azs_ibn_camera_t_type_company",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_ibn_camera_t_type_organization",
				data: "lbl_azs_ibn_camera_t_type_organization",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_ibn_camera_t_legal_representative",
				data: "lbl_azs_ibn_camera_t_legal_representative",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Cedula RP Legal",
				id: "lbl_azs_ibn_camera_t_legal_rp_certificate",
				data: "lbl_azs_ibn_camera_t_legal_rp_certificate",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "RUP",
				id: "lbl_azs_ibn_camera_t_rup",
				data: "lbl_azs_ibn_camera_t_rup",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Año",
				id: "lbl_azs_ibn_camera_t_year",
				data: "lbl_azs_ibn_camera_t_year",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_ibn_camera_t_establishment",
				data: "lbl_azs_ibn_camera_t_establishment",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Nit",
				id: "lbl_azs_ibn_camera_t_nit",
				data: "lbl_azs_ibn_camera_t_nit",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Razon Social",
				id: "lbl_azs_ibn_camera_t_business_name",
				data: "lbl_azs_ibn_camera_t_business_name",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Act Economica",
				id: "lbl_azs_ibn_camera_t_act_economic",
				data: "lbl_azs_ibn_camera_t_act_economic",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Telefono",
				id: "lbl_azs_ibn_camera_t_phone",
				data: "lbl_azs_ibn_camera_t_phone",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Activo Total",
				id: "lbl_azs_ibn_camera_t_total_active",
				data: "lbl_azs_ibn_camera_t_total_active",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Gravamen",
				id: "lbl_azs_ibn_camera_t_assessment",
				data: "lbl_azs_ibn_camera_t_assessment",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Viable",
				id: "lbl_azs_ibn_camera_t_viable",
				data: "lbl_azs_ibn_camera_t_viable",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Bien Viable",
				id: "lbl_azs_ibn_camera_t_well_viable",
				data: "lbl_azs_ibn_camera_t_well_viable",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Tipo Concepto",
				id: "lbl_azs_ibn_camera_u_ibn_type_concept",
				data: "lbl_azs_ibn_camera_u_ibn_type_concept",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_ibn_camera_t_causal_feasibility",
				data: "lbl_azs_ibn_camera_t_causal_feasibility",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Observacion",
				id: "lbl_azs_ibn_camera_t_observation",
				data: "lbl_azs_ibn_camera_t_observation",
				type: "text",
				className: "text-dark",
				visible: true,
			},
					...
					$.ajax({
						...
						success : function(json) {
							...
							if (obj.success == 1) {
								...
								if (v_ibn_state == '7' || v_ibn_state == '8') {
									document.getElementById('field_cr_rup').value = 'NO';
									document.getElementById('field_cr_viable').value = 'NO';
									document.getElementById('field_cr_ibn_type_certified').value = '1';
									document.getElementById('field_cr_ibn_type_concept').value = '1';
								...
								if (obj.register > 0) {
									...
									request.onreadystatechange = function(){
										if (request.readyState == 4 && request.status == 200) {
											...
											if (objData.status) {
												var v_concept = objData.data.lbl_azp_ibn_camera_t_concept;
												if (v_concept == '') {
													// Configuracion de la ventana modal
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					...
					//vtable.column(0).visible(false);
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_camera_id_azp_ibn_camera").innerHTML = objData.data.lbl_azp_ibn_camera_id_azp_ibn_camera;
					...
					document.querySelector("#lbl_azp_ibn_camera_m_date_created").innerHTML = objData.data.lbl_azp_ibn_camera_m_date_created;
					document.querySelector("#lbl_azp_ibn_camera_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_camera_m_date_modified;
					document.querySelector("#lbl_azp_ibn_camera_m_description").innerHTML = objData.data.lbl_azp_ibn_camera_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_ibn_camera_t_act_economic").innerHTML = objData.data.lbl_azp_ibn_camera_t_act_economic;
					document.querySelector("#lbl_azp_ibn_camera_t_address").innerHTML = objData.data.lbl_azp_ibn_camera_t_address;
					document.querySelector("#lbl_azp_ibn_camera_t_assessment").innerHTML = objData.data.lbl_azp_ibn_camera_t_assessment;
					document.querySelector("#lbl_azp_ibn_camera_t_business_name").innerHTML = objData.data.lbl_azp_ibn_camera_t_business_name;
					document.querySelector("#lbl_azp_ibn_camera_t_causal_feasibility").innerHTML = objData.data.lbl_azp_ibn_camera_t_causal_feasibility;
					document.querySelector("#lbl_azp_ibn_camera_t_city").innerHTML = objData.data.lbl_azp_ibn_camera_t_city;
					document.querySelector("#lbl_azp_ibn_camera_t_comment_legal").innerHTML = objData.data.lbl_azp_ibn_camera_t_comment_legal;
					document.querySelector("#lbl_azp_ibn_camera_t_concept").innerHTML = objData.data.lbl_azp_ibn_camera_t_concept;
					document.querySelector("#lbl_azp_ibn_camera_t_consecutive").innerHTML = objData.data.lbl_azp_ibn_camera_t_consecutive;
					document.querySelector("#lbl_azp_ibn_camera_t_department").innerHTML = objData.data.lbl_azp_ibn_camera_t_department;
					document.querySelector("#lbl_azp_ibn_camera_t_establishment").innerHTML = objData.data.lbl_azp_ibn_camera_t_establishment;
					document.querySelector("#lbl_azp_ibn_camera_t_full_name").innerHTML = objData.data.lbl_azp_ibn_camera_t_full_name;
					document.querySelector("#lbl_azp_ibn_camera_t_identification").innerHTML = objData.data.lbl_azp_ibn_camera_t_identification;
					document.querySelector("#lbl_azp_ibn_camera_t_legal_representative").innerHTML = objData.data.lbl_azp_ibn_camera_t_legal_representative;
					document.querySelector("#lbl_azp_ibn_camera_t_legal_rp_certificate").innerHTML = objData.data.lbl_azp_ibn_camera_t_legal_rp_certificate;
					document.querySelector("#lbl_azp_ibn_camera_t_municipality").innerHTML = objData.data.lbl_azp_ibn_camera_t_municipality;
					document.querySelector("#lbl_azp_ibn_camera_t_nit").innerHTML = objData.data.lbl_azp_ibn_camera_t_nit;
					document.querySelector("#lbl_azp_ibn_camera_t_nro_registration").innerHTML = objData.data.lbl_azp_ibn_camera_t_nro_registration;
					document.querySelector("#lbl_azp_ibn_camera_t_observation").innerHTML = objData.data.lbl_azp_ibn_camera_t_observation;
					document.querySelector("#lbl_azp_ibn_camera_t_phone").innerHTML = objData.data.lbl_azp_ibn_camera_t_phone;
					document.querySelector("#lbl_azp_ibn_camera_t_renewal_date").innerHTML = objData.data.lbl_azp_ibn_camera_t_renewal_date;
					document.querySelector("#lbl_azp_ibn_camera_t_rup").innerHTML = objData.data.lbl_azp_ibn_camera_t_rup;
					document.querySelector("#lbl_azp_ibn_camera_t_total_active").innerHTML = objData.data.lbl_azp_ibn_camera_t_total_active;
					document.querySelector("#lbl_azp_ibn_camera_t_type_company").innerHTML = objData.data.lbl_azp_ibn_camera_t_type_company;
					document.querySelector("#lbl_azp_ibn_camera_t_type_organization").innerHTML = objData.data.lbl_azp_ibn_camera_t_type_organization;
					document.querySelector("#lbl_azp_ibn_camera_t_viable").innerHTML = objData.data.lbl_azp_ibn_camera_t_viable;
					document.querySelector("#lbl_azp_ibn_camera_t_well_viable").innerHTML = objData.data.lbl_azp_ibn_camera_t_well_viable;
					document.querySelector("#lbl_azp_ibn_camera_t_year").innerHTML = objData.data.lbl_azp_ibn_camera_t_year;
					document.querySelector("#lbl_azp_ibn_state_t_name").innerHTML = objData.data.lbl_azp_ibn_state_t_name;
					document.querySelector("#lbl_azp_ibn_type_certified_t_name").innerHTML = objData.data.lbl_azp_ibn_type_certified_t_name;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_camera/fl_remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_camera/restore",
...
function event_save() {
	...
	if (idtbl > 0) {
		...
		var v_nro_registration = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_nro_registration").find('input').val();
		var v_city = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_city").find('input').val();
		var v_department = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_department").find('input').val();
		var v_municipality = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_municipality").find('input').val();
		var v_address = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_address").find('input').val();
		var v_renewal_date = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_renewal_date").find('input').val();
		var v_ibn_type_certified = $("#dt_info tr.selected td.lbl_azp_ibn_type_certified_t_name").find('select').val();
		var v_type_company = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_type_company").find('input').val();
		var v_type_organization = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_type_organization").find('input').val();
		var v_legal_representative = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_legal_representative").find('input').val();
		var v_legal_rp_certificate = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_legal_rp_certificate").find('input').val();
		var v_rup = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_rup").find('select').val();
		var v_year = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_year").find('input').val();
		var v_establishment = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_establishment").find('input').val();
		var v_nit = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_nit").find('input').val();
		var v_business_name = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_business_name").find('input').val();
		var v_act_economic = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_act_economic").find('input').val();
		var v_phone = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_phone").find('input').val();
		var v_total_active = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_total_active").find('input').val();
		var v_assessment = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_assessment").find('input').val();
		var v_viable = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_viable").find('select').val();
		var v_well_viable = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_well_viable").find('input').val();
		var v_ibn_type_concept = $("#dt_info tr.selected td.lbl_azp_ibn_type_concept_t_name").find('select').val();
		var v_causal_feasibility = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_causal_feasibility").find('input').val();
		// Mensaje de audio para mostrar en la pagina web
		initApp.playSound('views/templates/smart/dist/media/sound', 'bigbox');
		var dialog = bootbox.dialog({
			title: '¿Estas seguro de continuar con el proceso?',
					...
					callback: function() {
						$.ajax({
							...
							data : {
								...
								field_sv_renewal_date: v_renewal_date,
								field_sv_ibn_type_certified: v_ibn_type_certified,
								field_sv_type_company: v_type_company,
								field_sv_type_organization: v_type_organization,
								field_sv_legal_representative: v_legal_representative,
								field_sv_legal_rp_certificate: v_legal_rp_certificate,
								field_sv_rup: v_rup,
								field_sv_year: v_year,
								field_sv_establishment: v_establishment,
								field_sv_nit: v_nit,
								field_sv_business_name: v_business_name,
								field_sv_act_economic: v_act_economic,
								field_sv_phone: v_phone,
								field_sv_total_active: v_total_active,
	...
	if (mvalue == 'create') {
		...
		if (idtbl > 0) {
			...
			if (tp != '') {
				...
				request.onreadystatechange = function(){
					if (request.readyState == 4 && request.status == 200) {
						...
						if (objData.status) {
							var name = objData.data.lbl_azp_ibn_type_concept_t_name;
							var text = objData.data.lbl_azp_ibn_type_concept_t_text;
							$("#dt_info tr.selected td.lbl_azp_ibn_camera_t_causal_feasibility").find('input').val(text);
							// Obtener valores de un campo en especifico
				...
				$("#dt_info tr.selected td.lbl_azp_ibn_camera_t_causal_feasibility").find('input').val('');
			}
		}
	}
};
					...
					$.ajax({
						...
						success : function(json) {
							...
							if (obj.success == 1) {
								...
								if (v_ibn_state == '' || v_ibn_state == '7' || v_ibn_state == '8') {
									var querys = document.querySelector('#form_update');
									var elements = querys.querySelectorAll('select, input, textarea');
									[].forEach.call(elements, function(items) {
										items.disabled = true;
...
function event_viable(mvalue) {
	if (mvalue == 'create') {
		...
		var cr_city = document.getElementById('field_cr_city').value;
		var cr_nro_registration = document.getElementById('field_cr_nro_registration').value;
		if (cr_viable == 'SI') {
			if (cr_city != '' && cr_nro_registration != '') {
				var new_value = 'RM ' + cr_nro_registration + ' DE ' + cr_city;
				...
				bootbox.alert({
					...
					message: "<span><strong>Lo sentimos:</strong> No haz digitado ningun texto en el campo de ciudad.</span>",
					centerVertical: true,
					className: "modal-alert",
					closeButton: false,
				});
		...
		var up_city = document.getElementById('field_up_city').value;
		var up_nro_registration = document.getElementById('field_up_nro_registration').value;
		if (up_viable == 'SI') {
			if (up_city != '' && up_nro_registration != '') {
				var new_value = 'RM ' + up_nro_registration + ' DE ' + up_city;
		...
		$('#dt_info tr.selected td.lbl_azp_ibn_camera_t_well_viable').attr('readonly','');
		var v_viable = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_viable").find('select').val();
		var v_city = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_city").find('input').val();
		var v_nro_registration = $("#dt_info tr.selected td.lbl_azp_ibn_camera_t_nro_registration").find('input').val();
		if (v_viable == 'SI') {
			if (v_city != '' && v_nro_registration != '') {
				var text = 'RM ' + v_nro_registration + ' DE ' + v_city;
				$("#dt_info tr.selected td.lbl_azp_ibn_camera_t_well_viable").find('input').val(text);
			} else if (v_city == '') {
				// Mensaje de audio para mostrar en la pagina web
				initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
				bootbox.alert({
					size: "small",
					title: "<i class='fal fa-times-circle text-warning mr-2'></i> <span class='text-warning fw-500'>Advertencia!</span>",
					message: "<span><strong>Lo sentimos:</strong> No haz digitado ningun valor en el campo de ciudad.</span>",
					centerVertical: true,
					className: "modal-alert",
					closeButton: false,
				});
			...
			$("#dt_info tr.selected td.lbl_azp_ibn_camera_t_well_viable").find('input').val('');
		}
		$('#dt_info tr.selected td.lbl_azp_ibn_camera_t_well_viable').removeAttr('readonly','');
	}
};
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					...
					//vtable.column(0).visible(false);
					$('#modal-id-update').modal('show');
					document.querySelector('#field_fl_id').value = objData.data.lbl_azp_ibn_camera_id_azp_ibn_camera;
					document.querySelector('#field_fl_control').value = objData.data.lbl_azp_ibn_camera_v_id_azp_ibn_control_panel;
					document.querySelector('#field_fl_detection').value = objData.data.lbl_azp_ibn_camera_t_identification;

					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_camera_id_azp_ibn_camera;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_camera_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_camera_m_status;
					document.querySelector("#field_up_act_economic").value = objData.data.lbl_azp_ibn_camera_t_act_economic;
					document.querySelector("#field_up_address").value = objData.data.lbl_azp_ibn_camera_t_address;
					document.querySelector("#field_up_assessment").value = objData.data.lbl_azp_ibn_camera_t_assessment;
					document.querySelector("#field_up_business_name").value = objData.data.lbl_azp_ibn_camera_t_business_name;
					document.querySelector("#field_up_causal_feasibility").value = objData.data.lbl_azp_ibn_camera_t_causal_feasibility;
					document.querySelector("#field_up_city").value = objData.data.lbl_azp_ibn_camera_t_city;
					document.querySelector("#field_up_comment_legal").value = objData.data.lbl_azp_ibn_camera_t_comment_legal;
					//document.querySelector("#field_up_concept").value = objData.data.lbl_azp_ibn_camera_t_concept;
					document.querySelector("#field_up_consecutive").value = objData.data.lbl_azp_ibn_camera_t_consecutive;
					document.querySelector("#field_up_department").value = objData.data.lbl_azp_ibn_camera_t_department;
					document.querySelector("#field_up_establishment").value = objData.data.lbl_azp_ibn_camera_t_establishment;
					document.querySelector("#field_up_full_name").value = objData.data.lbl_azp_ibn_camera_t_full_name;
					document.querySelector("#field_up_identification").value = objData.data.lbl_azp_ibn_camera_t_identification;
					document.querySelector("#field_up_legal_representative").value = objData.data.lbl_azp_ibn_camera_t_legal_representative;
					document.querySelector("#field_up_legal_rp_certificate").value = objData.data.lbl_azp_ibn_camera_t_legal_rp_certificate;
					document.querySelector("#field_up_limitation").value = objData.data.lbl_azp_ibn_camera_t_limitation;
					document.querySelector("#field_up_municipality").value = objData.data.lbl_azp_ibn_camera_t_municipality;
					document.querySelector("#field_up_nit").value = objData.data.lbl_azp_ibn_camera_t_nit;
					document.querySelector("#field_up_nro_registration").value = objData.data.lbl_azp_ibn_camera_t_nro_registration;
					//document.querySelector("#field_up_observation").value = objData.data.lbl_azp_ibn_camera_t_observation;
					document.querySelector("#field_up_phone").value = objData.data.lbl_azp_ibn_camera_t_phone;
					document.querySelector("#field_up_renewal_date").value = objData.data.lbl_azp_ibn_camera_t_renewal_date;
					document.querySelector("#field_up_rup").value = objData.data.lbl_azp_ibn_camera_t_rup;
					document.querySelector("#field_up_total_active").value = objData.data.lbl_azp_ibn_camera_t_total_active;
					document.querySelector("#field_up_type_company").value = objData.data.lbl_azp_ibn_camera_t_type_company;
					document.querySelector("#field_up_type_organization").value = objData.data.lbl_azp_ibn_camera_t_type_organization;
					document.querySelector("#field_up_viable").value = objData.data.lbl_azp_ibn_camera_t_viable;
					document.querySelector("#field_up_well_viable").value = objData.data.lbl_azp_ibn_camera_t_well_viable;
					document.querySelector("#field_up_year").value = objData.data.lbl_azp_ibn_camera_t_year;
					document.querySelector("#field_up_ibn_state").value = objData.data.lbl_azp_ibn_camera_v_id_azp_ibn_state;
					document.querySelector("#field_up_ibn_type_certified").value = objData.data.lbl_azp_ibn_camera_v_id_azp_ibn_type_certified;
					document.querySelector("#field_up_ibn_type_concept").value = objData.data.lbl_azp_ibn_camera_v_id_azp_ibn_type_concept;

					document.querySelector("#field_up_ibn_observation").value = objData.data.lbl_azp_ibn_camera_v_id_azp_ibn_observation;
					document.querySelector("#field_up_st_returnable").value = objData.data.lbl_azp_ibn_camera_t_st_returnable;
					document.querySelector("#field_up_st_receipt").value = objData.data.lbl_azp_ibn_camera_t_st_receipt;
					document.querySelector("#field_up_st_date").value = objData.data.lbl_azp_ibn_camera_t_st_date;
					document.querySelector("#field_up_st_value").value = objData.data.lbl_azp_ibn_camera_t_st_value;

					event_state('update');

					if (objData.data.lbl_azp_ibn_camera_t_st_returnable == 'SI') {
...
/*function event_list() {
	let trs = document.querySelectorAll('#dt_info tbody tr');
	trs.forEach(tr => {
		...
		rows[0].onchange = () => {
			console.log('hola');
			//console.log(rows);
			rows[4].firstElementChild.toggleAttribute('disabled');
			rows[5].firstElementChild.toggleAttribute('disabled');
		}
	});
};*/
...
function event_check() {
	$("#dt_info input.dt_table_info").change(function () {
		if ($(this).prop("checked")) {
			...
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_nro_registration input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_city input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_department input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_municipality input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_address input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_renewal_date input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_type_certified_t_name select').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_type_company input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_type_organization input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_legal_representative input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_legal_rp_certificate input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_rup select').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_year input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_establishment input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_nit input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_business_name input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_act_economic input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_phone input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_total_active input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_assessment input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_viable select').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_well_viable input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_type_concept_t_name select').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_causal_feasibility input').prop('disabled', false);

			$(this).closest('tr').find('td.lbl_azp_ibn_state_t_name select').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_nro_registration input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_city input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_department input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_municipality input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_address input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_renewal_date input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_type_certified_t_name select').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_type_company input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_type_organization input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_legal_representative input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_legal_rp_certificate input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_rup select').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_year input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_establishment input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_nit input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_business_name input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_act_economic input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_phone input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_total_active input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_assessment input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_viable select').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_well_viable input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_type_concept_t_name select').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_causal_feasibility input').addClass('border-success');
		} else {
			$(this).closest('tr').find('td.lbl_azp_ibn_state_t_name select').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_nro_registration input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_city input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_department input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_municipality input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_address input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_renewal_date input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_type_certified_t_name select').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_type_company input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_type_organization input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_legal_representative input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_legal_rp_certificate input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_rup select').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_year input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_establishment input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_nit input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_business_name input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_act_economic input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_phone input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_total_active input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_assessment input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_viable select').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_well_viable input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_type_concept_t_name select').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_causal_feasibility input').prop('disabled', true);

			$(this).closest('tr').find('td.lbl_azp_ibn_state_t_name select').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_nro_registration input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_city input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_department input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_municipality input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_address input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_renewal_date input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_type_certified_t_name select').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_type_company input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_type_organization input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_legal_representative input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_legal_rp_certificate input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_rup select').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_year input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_establishment input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_nit input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_business_name input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_act_economic input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_phone input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_total_active input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_assessment input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_viable select').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_well_viable input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_type_concept_t_name select').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_camera_t_causal_feasibility input').removeClass('border-success');
		}
	});
};
			...
			buttons: {
				...
				ok: {
					...
					callback: function() {
						$.ajax({
							type : "POST",
							url : "api/azp_ibn_camera/multiple",
...
function event_state(mvalue) {
	if (mvalue == 'create') {
		var v_ibn_state = document.getElementById('field_cr_ibn_state').value;
		if (v_ibn_state == '' || v_ibn_state == '1' || v_ibn_state == '7' || v_ibn_state == '8') {
			document.getElementById('field_cr_rup').value = 'NO';
			document.getElementById('field_cr_viable').value = 'NO';
			document.getElementById('field_cr_ibn_type_certified').value = '1';
			document.getElementById('field_cr_ibn_type_concept').value = '1';
...
function field_act_economic() {
	var se_field = document.getElementById('field_se_act_economic').value;
	let sf_field = document.getElementById('field_sf_act_economic');
	sf_field.value += "'" + se_field + "',";
};
...
function field_establishment() {
	var se_field = document.getElementById('field_se_establishment').value;
	let sf_field = document.getElementById('field_sf_establishment');
	sf_field.value += "'" + se_field + "',";
};
...
function field_legal_representative() {
	var se_field = document.getElementById('field_se_legal_representative').value;
	let sf_field = document.getElementById('field_sf_legal_representative');
	sf_field.value += "'" + se_field + "',";
};

function field_legal_rp_certificate() {
	var se_field = document.getElementById('field_se_legal_rp_certificate').value;
	let sf_field = document.getElementById('field_sf_legal_rp_certificate');
	sf_field.value += "'" + se_field + "',";
};
...
function field_renewal_date() {
	var se_field = document.getElementById('field_se_renewal_date').value;
	let sf_field = document.getElementById('field_sf_renewal_date');
	sf_field.value += "'" + se_field + "',";
};

function field_rup() {
	var se_field = document.getElementById('field_se_rup').value;
	let sf_field = document.getElementById('field_sf_rup');
	sf_field.value += "'" + se_field + "',";
};

function field_total_active() {
	var se_field = document.getElementById('field_se_total_active').value;
	let sf_field = document.getElementById('field_sf_total_active');
	sf_field.value += "'" + se_field + "',";
};

function field_type_company() {
	var se_field = document.getElementById('field_se_type_company').value;
	let sf_field = document.getElementById('field_sf_type_company');
	sf_field.value += "'" + se_field + "',";
};

function field_type_organization() {
	var se_field = document.getElementById('field_se_type_organization').value;
	let sf_field = document.getElementById('field_sf_type_organization');
	sf_field.value += "'" + se_field + "',";
};
...
function field_year() {
	var se_field = document.getElementById('field_se_year').value;
	let sf_field = document.getElementById('field_sf_year');
	sf_field.value += "'" + se_field + "',";
};
...
function field_ibn_type_certified() {
	var se_field = document.getElementById('field_se_ibn_type_certified').value;
	let sf_field = document.getElementById('field_sf_ibn_type_certified');
	sf_field.value += "'" + se_field + "',";
};
...
function modal_download_archive() {
	// Definir los iconos para los correspondientes mensajes
	var error_icon = '<span class="far fa-times-circle" aria-hidden="true"></span>' + ' ';
	var success_icon = '<span class="far fa-check-circle" aria-hidden="true"></span>' + ' ';
	var process_icon = '<span class="far fa-spinner fa-spin" aria-hidden="true"></span>' + ' ';
	...
	$.ajax({ type: 'POST', url: ajaxurl, }).done(function(data) {
		if (data == 0) {
			...
			var ajaxurl = var_url + "dashboard/dwarchive/" + iddata + "/";
			$.ajax({ type: 'POST', url: ajaxurl, }).done(function(argument) {});
			var request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
...
function modal_download_dit() {
	...
	$.ajax({ type: 'POST', url: ajaxurl, }).done(function(data) {
		if (data == 0) {
			...
			var ajaxurl = var_url + "dashboard/dwdit/" + iddata + "/";
			$.ajax({ type: 'POST', url: ajaxurl, }).done(function(argument) {});
			var request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
