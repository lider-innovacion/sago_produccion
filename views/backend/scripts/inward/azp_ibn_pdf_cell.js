...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_pdf_cell_id_azs_ibn_pdf_cell",
				data: "lbl_azs_ibn_pdf_cell_id_azs_ibn_pdf_cell",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_pdf_cell_m_date_created",
				data: "lbl_azs_ibn_pdf_cell_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_pdf_cell_m_date_modified",
				data: "lbl_azs_ibn_pdf_cell_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_pdf_cell_m_description",
				data: "lbl_azs_ibn_pdf_cell_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Ancho Celda",
				id: "lbl_azs_ibn_pdf_cell_t_width",
				data: "lbl_azs_ibn_pdf_cell_t_width",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Altura Celda",
				id: "lbl_azs_ibn_pdf_cell_t_height",
				data: "lbl_azs_ibn_pdf_cell_t_height",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Texto",
				id: "lbl_azs_ibn_pdf_cell_t_text",
				data: "lbl_azs_ibn_pdf_cell_t_text",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Borde",
				id: "lbl_azs_ibn_pdf_cell_t_border",
				data: "lbl_azs_ibn_pdf_cell_t_border",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Salto Linea",
				id: "lbl_azs_ibn_pdf_cell_t_line",
				data: "lbl_azs_ibn_pdf_cell_t_line",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Alineacion",
				id: "lbl_azs_ibn_pdf_cell_t_align",
				data: "lbl_azs_ibn_pdf_cell_t_align",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Fondo",
				id: "lbl_azs_ibn_pdf_cell_t_fill",
				data: "lbl_azs_ibn_pdf_cell_t_fill",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Enlace",
				id: "lbl_azs_ibn_pdf_cell_t_link",
				data: "lbl_azs_ibn_pdf_cell_t_link",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "DIT",
				id: "lbl_azs_ibn_pdf_cell_u_ibn_interface_dit",
				data: "lbl_azs_ibn_pdf_cell_u_ibn_interface_dit",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_pdf_cell/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_pdf_cell/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_pdf_cell_id_azp_ibn_pdf_cell").innerHTML = objData.data.lbl_azp_ibn_pdf_cell_id_azp_ibn_pdf_cell;
					...
					document.querySelector("#lbl_azp_ibn_pdf_cell_m_date_created").innerHTML = objData.data.lbl_azp_ibn_pdf_cell_m_date_created;
					document.querySelector("#lbl_azp_ibn_pdf_cell_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_pdf_cell_m_date_modified;
					document.querySelector("#lbl_azp_ibn_pdf_cell_m_description").innerHTML = objData.data.lbl_azp_ibn_pdf_cell_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_ibn_pdf_cell_t_align").innerHTML = objData.data.lbl_azp_ibn_pdf_cell_t_align;
					document.querySelector("#lbl_azp_ibn_pdf_cell_t_border").innerHTML = objData.data.lbl_azp_ibn_pdf_cell_t_border;
					document.querySelector("#lbl_azp_ibn_pdf_cell_t_fill").innerHTML = objData.data.lbl_azp_ibn_pdf_cell_t_fill;
					document.querySelector("#lbl_azp_ibn_pdf_cell_t_height").innerHTML = objData.data.lbl_azp_ibn_pdf_cell_t_height;
					document.querySelector("#lbl_azp_ibn_pdf_cell_t_line").innerHTML = objData.data.lbl_azp_ibn_pdf_cell_t_line;
					document.querySelector("#lbl_azp_ibn_pdf_cell_t_link").innerHTML = objData.data.lbl_azp_ibn_pdf_cell_t_link;
					document.querySelector("#lbl_azp_ibn_pdf_cell_t_text").innerHTML = objData.data.lbl_azp_ibn_pdf_cell_t_text;
					document.querySelector("#lbl_azp_ibn_pdf_cell_t_width").innerHTML = objData.data.lbl_azp_ibn_pdf_cell_t_width;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_pdf_cell/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_pdf_cell/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_pdf_cell/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_pdf_cell_id_azp_ibn_pdf_cell;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_pdf_cell_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_pdf_cell_m_status;
					document.querySelector("#field_up_align").value = objData.data.lbl_azp_ibn_pdf_cell_t_align;
					document.querySelector("#field_up_border").value = objData.data.lbl_azp_ibn_pdf_cell_t_border;
					document.querySelector("#field_up_fill").value = objData.data.lbl_azp_ibn_pdf_cell_t_fill;
					document.querySelector("#field_up_height").value = objData.data.lbl_azp_ibn_pdf_cell_t_height;
					document.querySelector("#field_up_line").value = objData.data.lbl_azp_ibn_pdf_cell_t_line;
					document.querySelector("#field_up_link").value = objData.data.lbl_azp_ibn_pdf_cell_t_link;
					document.querySelector("#field_up_text").value = objData.data.lbl_azp_ibn_pdf_cell_t_text;
					document.querySelector("#field_up_width").value = objData.data.lbl_azp_ibn_pdf_cell_t_width;
					document.querySelector("#field_up_ibn_interface_dit").value = objData.data.lbl_azp_ibn_pdf_cell_v_id_azp_ibn_interface_dit;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
