...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_button_property_id_azs_button_property",
				data: "lbl_azs_button_property_id_azs_button_property",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_button_property_m_date_created",
				data: "lbl_azs_button_property_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_button_property_m_date_modified",
				data: "lbl_azs_button_property_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_button_property_m_description",
				data: "lbl_azs_button_property_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Nombre",
				id: "lbl_azs_button_property_t_name",
				data: "lbl_azs_button_property_t_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Dimension",
				id: "lbl_azs_button_property_u_button_dimension",
				data: "lbl_azs_button_property_u_button_dimension",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Icono",
				id: "lbl_azs_button_property_u_icon_code",
				data: "lbl_azs_button_property_u_icon_code",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_button_property/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_button_property/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_button_property_id_azp_button_property").innerHTML = objData.data.lbl_azp_button_property_id_azp_button_property;
					...
					document.querySelector("#lbl_azp_button_property_m_date_created").innerHTML = objData.data.lbl_azp_button_property_m_date_created;
					document.querySelector("#lbl_azp_button_property_m_date_modified").innerHTML = objData.data.lbl_azp_button_property_m_date_modified;
					document.querySelector("#lbl_azp_button_property_m_description").innerHTML = objData.data.lbl_azp_button_property_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_button_property_t_name").innerHTML = objData.data.lbl_azp_button_property_t_name;
					document.querySelector("#lbl_azp_button_dimension_t_name").innerHTML = objData.data.lbl_azp_button_dimension_t_name;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_button_property/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_button_property/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_button_property/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_button_property_id_azp_button_property;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_button_property_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_button_property_m_status;
					document.querySelector("#field_up_name").value = objData.data.lbl_azp_button_property_t_name;
					document.querySelector("#field_up_button_dimension").value = objData.data.lbl_azp_button_property_v_id_azp_button_dimension;
					document.querySelector("#field_up_icon_code").value = objData.data.lbl_azp_button_property_v_id_azp_icon_code;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
