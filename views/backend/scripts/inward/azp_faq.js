...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_faq_id_azs_faq",
				data: "lbl_azs_faq_id_azs_faq",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_faq_m_date_created",
				data: "lbl_azs_faq_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_faq_m_date_modified",
				data: "lbl_azs_faq_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_faq_m_description",
				data: "lbl_azs_faq_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Pregunta",
				id: "lbl_azs_faq_t_question",
				data: "lbl_azs_faq_t_question",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Respuesta",
				id: "lbl_azs_faq_t_answer",
				data: "lbl_azs_faq_t_answer",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_faq_id_azp_faq").innerHTML = objData.data.lbl_azp_faq_id_azp_faq;
					...
					document.querySelector("#lbl_azp_faq_m_date_created").innerHTML = objData.data.lbl_azp_faq_m_date_created;
					document.querySelector("#lbl_azp_faq_m_date_modified").innerHTML = objData.data.lbl_azp_faq_m_date_modified;
					document.querySelector("#lbl_azp_faq_m_description").innerHTML = objData.data.lbl_azp_faq_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_faq_t_answer").innerHTML = objData.data.lbl_azp_faq_t_answer;
					document.querySelector("#lbl_azp_faq_t_question").innerHTML = objData.data.lbl_azp_faq_t_question;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_faq_id_azp_faq;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_faq_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_faq_m_status;
					document.querySelector("#field_up_answer").value = objData.data.lbl_azp_faq_t_answer;
					document.querySelector("#field_up_question").value = objData.data.lbl_azp_faq_t_question;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
