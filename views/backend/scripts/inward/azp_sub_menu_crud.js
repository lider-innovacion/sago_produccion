...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_sub_menu_crud_id_azs_sub_menu_crud",
				data: "lbl_azs_sub_menu_crud_id_azs_sub_menu_crud",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_sub_menu_crud_m_date_created",
				data: "lbl_azs_sub_menu_crud_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_sub_menu_crud_m_date_modified",
				data: "lbl_azs_sub_menu_crud_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_sub_menu_crud_m_description",
				data: "lbl_azs_sub_menu_crud_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Menu Crud",
				id: "lbl_azs_sub_menu_crud_u_menu_crud",
				data: "lbl_azs_sub_menu_crud_u_menu_crud",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Sub Menu",
				id: "lbl_azs_sub_menu_crud_u_sub_under",
				data: "lbl_azs_sub_menu_crud_u_sub_under",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_sub_menu_crud/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_sub_menu_crud/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_sub_menu_crud_id_azp_sub_menu_crud").innerHTML = objData.data.lbl_azp_sub_menu_crud_id_azp_sub_menu_crud;
					...
					document.querySelector("#lbl_azp_sub_menu_crud_m_date_created").innerHTML = objData.data.lbl_azp_sub_menu_crud_m_date_created;
					document.querySelector("#lbl_azp_sub_menu_crud_m_date_modified").innerHTML = objData.data.lbl_azp_sub_menu_crud_m_date_modified;
					document.querySelector("#lbl_azp_sub_menu_crud_m_description").innerHTML = objData.data.lbl_azp_sub_menu_crud_m_description;
					...
					document.querySelector("#lbl_azp_sub_under_t_name").innerHTML = objData.data.lbl_azp_sub_under_t_name;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_sub_menu_crud/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_sub_menu_crud/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_sub_menu_crud/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_sub_menu_crud_id_azp_sub_menu_crud;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_sub_menu_crud_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_sub_menu_crud_m_status;
					document.querySelector("#field_up_menu_crud").value = objData.data.lbl_azp_sub_menu_crud_v_id_azp_menu_crud;
					document.querySelector("#field_up_sub_under").value = objData.data.lbl_azp_sub_menu_crud_v_id_azp_sub_under;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
