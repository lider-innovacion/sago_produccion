...
if (document.getElementById('form_btn_massive')) {
	document.getElementById('form_btn_massive').onclick = function(e) {
		e.preventDefault();
		event_massive();
	};
}

if (document.getElementById('form_massive')) {
	document.getElementById('form_massive').onkeypress = function(e) {
		if (!e) e = window.event;
		var keyCode = e.keyCode || e.which;
		if (keyCode == '13') {
			event_massive();
...
function action_checkbox_info() {
	...
	if ($('#field_ck_checkbox_info').is(':checked')) {
		...
		//Array.prototype.forEach.call(list, function (item) {
			...
			var querys = document.querySelector('#dt_info');
			var elements = querys.querySelectorAll('tr td.lbl_azp_ibn_property_t_identification input');
			[].forEach.call(elements, function(items) {
			...
			var querys = document.querySelector('#dt_info');
			var elements = querys.querySelectorAll('tr td.lbl_azp_ibn_property_t_full_name input');
			[].forEach.call(elements, function(items) {
				items.className = 'form-control input-xs';
				items.disabled = true;
			});
			...
			var querys = document.querySelector('#dt_info');
			var elements = querys.querySelectorAll('tr td.lbl_azp_ibn_property_t_nro_registration input');
			[].forEach.call(elements, function(items) {
				items.className = 'form-control input-xs';
				items.disabled = true;
			});
			...
			var querys = document.querySelector('#dt_info');
			var elements = querys.querySelectorAll('tr td.lbl_azp_ibn_property_t_department input');
			[].forEach.call(elements, function(items) {
				items.className = 'form-control input-xs';
				items.disabled = true;
			});
			...
			var querys = document.querySelector('#dt_info');
			var elements = querys.querySelectorAll('tr td.lbl_azp_ibn_property_t_municipality input');
			[].forEach.call(elements, function(items) {
				items.className = 'form-control input-xs';
				items.disabled = true;
			});
			...
			var querys = document.querySelector('#dt_info');
			var elements = querys.querySelectorAll('tr td.lbl_azp_ibn_property_t_address input');
			[].forEach.call(elements, function(items) {
				items.className = 'form-control input-xs';
				items.disabled = true;
			});
...
function event_change_data() {
	...
	var idtbl = $("tr.selected td:first").find('input').val();
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_property_id_azs_ibn_property",
				data: "lbl_azs_ibn_property_id_azs_ibn_property",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_property_m_date_created",
				data: "lbl_azs_ibn_property_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_property_m_date_modified",
				data: "lbl_azs_ibn_property_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_property_m_description",
				data: "lbl_azs_ibn_property_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Consecutivo",
				id: "lbl_azs_ibn_property_t_consecutive",
				data: "lbl_azs_ibn_property_t_consecutive",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Cedula",
				id: "lbl_azs_ibn_property_t_identification",
				data: "lbl_azs_ibn_property_t_identification",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Nombre",
				id: "lbl_azs_ibn_property_t_full_name",
				data: "lbl_azs_ibn_property_t_full_name",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Nro Matricula",
				id: "lbl_azs_ibn_property_t_nro_registration",
				data: "lbl_azs_ibn_property_t_nro_registration",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Departamento",
				id: "lbl_azs_ibn_property_t_department",
				data: "lbl_azs_ibn_property_t_department",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Municipio",
				id: "lbl_azs_ibn_property_t_municipality",
				data: "lbl_azs_ibn_property_t_municipality",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Direccion",
				id: "lbl_azs_ibn_property_t_address",
				data: "lbl_azs_ibn_property_t_address",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Estado",
				id: "lbl_azs_ibn_property_u_ibn_state",
				data: "lbl_azs_ibn_property_u_ibn_state",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Tipo Inmueble",
				id: "lbl_azs_ibn_property_u_ibn_type_property",
				data: "lbl_azs_ibn_property_u_ibn_type_property",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Area",
				id: "lbl_azs_ibn_property_t_area",
				data: "lbl_azs_ibn_property_t_area",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_ibn_property_t_purchase_annotation",
				data: "lbl_azs_ibn_property_t_purchase_annotation",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Vr Comercial",
				id: "lbl_azs_ibn_property_t_market_value",
				data: "lbl_azs_ibn_property_t_market_value",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Titularidad",
				id: "lbl_azs_ibn_property_t_ownership",
				data: "lbl_azs_ibn_property_t_ownership",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Gravamen",
				id: "lbl_azs_ibn_property_t_assessment",
				data: "lbl_azs_ibn_property_t_assessment",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Tipo Concepto",
				id: "lbl_azs_ibn_property_u_ibn_type_concept",
				data: "lbl_azs_ibn_property_u_ibn_type_concept",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Causal Viabilidad",
				id: "lbl_azs_ibn_property_t_causal_feasibility",
				data: "lbl_azs_ibn_property_t_causal_feasibility",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Viable",
				id: "lbl_azs_ibn_property_t_viable",
				data: "lbl_azs_ibn_property_t_viable",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Bien Viable",
				id: "lbl_azs_ibn_property_t_well_viable",
				data: "lbl_azs_ibn_property_t_well_viable",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Observacion",
				id: "lbl_azs_ibn_property_t_observation",
				data: "lbl_azs_ibn_property_t_observation",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Lista 1",
				id: "lbl_azs_ibn_property_t_sel_one",
				data: "lbl_azs_ibn_property_t_sel_one",
				type: "text",
				className: "text-dark lbl_azs_ibn_property_t_sel_one",
				visible: true,
			},
			{
				title: "Lista 2",
				id: "lbl_azs_ibn_property_t_sel_two",
				data: "lbl_azs_ibn_property_t_sel_two",
				type: "text",
				className: "text-dark lbl_azs_ibn_property_t_sel_two",
				visible: true,
			},
			{
				title: "Campo 2",
			...
			{
				title: "Lista 3",
				id: "lbl_azs_ibn_property_t_sel_three",
				data: "lbl_azs_ibn_property_t_sel_three",
				type: "text",
				className: "text-dark lbl_azs_ibn_property_t_sel_three",
				visible: true,
			},
			{
				title: "Lista 4",
				id: "lbl_azs_ibn_property_t_sel_four",
				data: "lbl_azs_ibn_property_t_sel_four",
				type: "text",
				className: "text-dark lbl_azs_ibn_property_t_sel_four",
				visible: true,
			},
			{
				title: "Campo 3",
				id: "lbl_azs_ibn_property_t_text_three",
				data: "lbl_azs_ibn_property_t_text_three",
				type: "text",
				className: "text-dark lbl_azs_ibn_property_t_text_three",
				visible: true,
			},
			{
				title: "Campo 4",
				id: "lbl_azs_ibn_property_t_text_four",
				data: "lbl_azs_ibn_property_t_text_four",
				type: "text",
				className: "text-dark lbl_azs_ibn_property_t_text_four",
				visible: true,
			},
			{
				title: "Campo 5",
				id: "lbl_azs_ibn_property_t_text_five",
				data: "lbl_azs_ibn_property_t_text_five",
				type: "text",
				className: "text-dark lbl_azs_ibn_property_t_text_five",
				visible: true,
			},
			{
				title: "Campo 6",
				id: "lbl_azs_ibn_property_t_text_six",
				data: "lbl_azs_ibn_property_t_text_six",
				type: "text",
				className: "text-dark lbl_azs_ibn_property_t_text_six",
				visible: true,
			},
			{
				title: "Campo 7",
				id: "lbl_azs_ibn_property_t_text_seven",
				data: "lbl_azs_ibn_property_t_text_seven",
				type: "text",
				className: "text-dark lbl_azs_ibn_property_t_text_seven",
				visible: true,
			},
			{
				title: "Campo 8",
				id: "lbl_azs_ibn_property_t_text_eight",
				data: "lbl_azs_ibn_property_t_text_eight",
				type: "text",
				className: "text-dark lbl_azs_ibn_property_t_text_eight",
				visible: true,
			},
			{
				title: "Lista 5",
				id: "lbl_azs_ibn_property_t_sel_five",
				data: "lbl_azs_ibn_property_t_sel_five",
				type: "text",
				className: "text-dark lbl_azs_ibn_property_t_sel_five",
				visible: true,
			},
		];
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_property/create",
								...
								if (obj.register > 0) {
									...
									request.onreadystatechange = function(){
										if (request.readyState == 4 && request.status == 200) {
											...
											if (objData.status) {
												var v_concept = objData.data.lbl_azp_ibn_property_t_concept;
												if (v_concept == '') {
													// Configuracion de la ventana modal
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_property/delete",
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					...
					//vtable.column(0).visible(false);
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_property_id_azp_ibn_property").innerHTML = objData.data.lbl_azp_ibn_property_id_azp_ibn_property;
					...
					document.querySelector("#lbl_azp_ibn_property_m_date_created").innerHTML = objData.data.lbl_azp_ibn_property_m_date_created;
					document.querySelector("#lbl_azp_ibn_property_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_property_m_date_modified;
					document.querySelector("#lbl_azp_ibn_property_m_description").innerHTML = objData.data.lbl_azp_ibn_property_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_ibn_property_t_address").innerHTML = objData.data.lbl_azp_ibn_property_t_address;
					document.querySelector("#lbl_azp_ibn_property_t_area").innerHTML = objData.data.lbl_azp_ibn_property_t_area;
					document.querySelector("#lbl_azp_ibn_property_t_assessment").innerHTML = objData.data.lbl_azp_ibn_property_t_assessment;
					document.querySelector("#lbl_azp_ibn_property_t_causal_feasibility").innerHTML = objData.data.lbl_azp_ibn_property_t_causal_feasibility;
					document.querySelector("#lbl_azp_ibn_property_t_comment_legal").innerHTML = objData.data.lbl_azp_ibn_property_t_comment_legal;
					document.querySelector("#lbl_azp_ibn_property_t_concept").innerHTML = objData.data.lbl_azp_ibn_property_t_concept;
					document.querySelector("#lbl_azp_ibn_property_t_consecutive").innerHTML = objData.data.lbl_azp_ibn_property_t_consecutive;
					document.querySelector("#lbl_azp_ibn_property_t_department").innerHTML = objData.data.lbl_azp_ibn_property_t_department;
					document.querySelector("#lbl_azp_ibn_property_t_full_name").innerHTML = objData.data.lbl_azp_ibn_property_t_full_name;
					document.querySelector("#lbl_azp_ibn_property_t_identification").innerHTML = objData.data.lbl_azp_ibn_property_t_identification;
					document.querySelector("#lbl_azp_ibn_property_t_market_value").innerHTML = objData.data.lbl_azp_ibn_property_t_market_value;
					document.querySelector("#lbl_azp_ibn_property_t_municipality").innerHTML = objData.data.lbl_azp_ibn_property_t_municipality;
					document.querySelector("#lbl_azp_ibn_property_t_nro_registration").innerHTML = objData.data.lbl_azp_ibn_property_t_nro_registration;
					document.querySelector("#lbl_azp_ibn_property_t_observation").innerHTML = objData.data.lbl_azp_ibn_property_t_observation;
					document.querySelector("#lbl_azp_ibn_property_t_ownership").innerHTML = objData.data.lbl_azp_ibn_property_t_ownership;
					document.querySelector("#lbl_azp_ibn_property_t_purchase_annotation").innerHTML = objData.data.lbl_azp_ibn_property_t_purchase_annotation;
					document.querySelector("#lbl_azp_ibn_property_t_viable").innerHTML = objData.data.lbl_azp_ibn_property_t_viable;
					document.querySelector("#lbl_azp_ibn_property_t_well_viable").innerHTML = objData.data.lbl_azp_ibn_property_t_well_viable;
					document.querySelector("#lbl_azp_ibn_property_t_text_one").innerHTML = objData.data.lbl_azp_ibn_property_t_text_one;
					document.querySelector("#lbl_azp_ibn_property_t_text_two").innerHTML = objData.data.lbl_azp_ibn_property_t_text_two;
					document.querySelector("#lbl_azp_ibn_property_t_text_three").innerHTML = objData.data.lbl_azp_ibn_property_t_text_three;
					document.querySelector("#lbl_azp_ibn_property_t_text_four").innerHTML = objData.data.lbl_azp_ibn_property_t_text_four;
					document.querySelector("#lbl_azp_ibn_property_t_text_five").innerHTML = objData.data.lbl_azp_ibn_property_t_text_five;
					document.querySelector("#lbl_azp_ibn_property_t_text_six").innerHTML = objData.data.lbl_azp_ibn_property_t_text_six;
					document.querySelector("#lbl_azp_ibn_property_t_text_seven").innerHTML = objData.data.lbl_azp_ibn_property_t_text_seven;
					document.querySelector("#lbl_azp_ibn_property_t_text_eight").innerHTML = objData.data.lbl_azp_ibn_property_t_text_eight;
					document.querySelector("#lbl_azp_ibn_property_t_sel_one").innerHTML = objData.data.lbl_azp_ibn_property_t_sel_one;
					document.querySelector("#lbl_azp_ibn_property_t_sel_two").innerHTML = objData.data.lbl_azp_ibn_property_t_sel_two;
					document.querySelector("#lbl_azp_ibn_property_t_sel_three").innerHTML = objData.data.lbl_azp_ibn_property_t_sel_three;
					document.querySelector("#lbl_azp_ibn_property_t_sel_four").innerHTML = objData.data.lbl_azp_ibn_property_t_sel_four;
					document.querySelector("#lbl_azp_ibn_property_t_sel_five").innerHTML = objData.data.lbl_azp_ibn_property_t_sel_five;
					...
					document.querySelector("#lbl_azp_ibn_type_property_t_name").innerHTML = objData.data.lbl_azp_ibn_type_property_t_name;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
				...
				callback: function() {
					...
					if (load === 0) {
						...
						if (!extensions.exec(path)) {
							...
							$.ajax({
								type : "POST",
								url : "api/azp_ibn_property/import",
								datatype: "HTML",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_property/finish",
...
function event_massive() {
	// Definir los iconos para los correspondientes mensajes
	var error_icon = '<span class="far fa-times-circle" aria-hidden="true"></span>' + ' ';
	var success_icon = '<span class="far fa-check-circle" aria-hidden="true"></span>' + ' ';
	var process_icon = '<span class="far fa-spinner fa-spin" aria-hidden="true"></span>' + ' ';
	// Configuracion de la ventana modal
	//$('#modal-id-massive').modal('hide');
	...
	if (value_checked == '') {
		...
		// Añadir y remover las clases incorporadas de las hojas de estilo
		$('#form_ajax_massive').removeClass('alert-danger');
		$('#form_ajax_massive').removeClass('alert-success');
		$('#form_ajax_massive').removeClass('alert-warning');
		// Añadir y remover las clases incorporadas de las hojas de estilo
		$('#form_ajax_massive').addClass('alert-warning');
		$("#form_ajax_massive").html(process_icon  + 'Advertencia: Procesando información, por favor espere...');
		$('#form_ajax_massive').removeClass('hide');
		$('#form_ajax_massive').addClass('alert');
		// Mensaje de audio para mostrar en la pagina web
		initApp.playSound('views/templates/smart/dist/media/sound', 'bigbox');
		var dialog = bootbox.dialog({
			title: '¿Estas seguro de continuar con el proceso?',
			...
			buttons: {
				cancel: {
					...
					callback: function() {
						// Añadir y remover las clases incorporadas de las hojas de estilo
						setTimeout(function() {
							$('#form_ajax_massive').removeClass('alert');
							$('#form_ajax_massive').addClass('hide');
							$('#form_ajax_massive').html('');
						}, 0);
						// Mensaje de audio para mostrar en la pagina web
						initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
						bootbox.alert({
				...
				ok: {
					...
					callback: function() {
						$.ajax({
							type : "POST",
							url : "api/azp_ibn_property/massive",
							data : $('#form_massive').serialize() + '&field_ms_id=' + value_checked,
							success : function(json) {
								var obj = jQuery.parseJSON(json);
								if (obj.success == 1) {
									// Recargar la tabla con nueva informacion
									if ($("#dt_info").length) { $('#dt_info').DataTable().ajax.reload(); }
									// Mensaje a mostrar una vez terminada la accion
									$('#form_ajax_massive').html(success_icon + obj.message);
									$("#form_ajax_massive").removeClass('alert-warning');
									$("#form_ajax_massive").addClass('alert-success');
									// Dejar campos vacios sobre los elementos id del formulario
									document.querySelector("#form_massive").reset();
									// Configuracion de la ventana modal
									$('#modal-id-massive').modal('hide');
									// Añadir y remover las clases incorporadas de las hojas de estilo
									setTimeout(function() {
									...
									$('#modal-id-massive').modal('show');
									// Mensaje a mostrar una vez terminada la accion
									$('#form_ajax_massive').html(error_icon + obj.message);
									$("#form_ajax_massive").removeClass('alert-warning');
									$("#form_ajax_massive").addClass('alert-danger');
								}
							},
							error : function() {
								$('#form_ajax_massive').addClass('alert-danger');
								$("#form_ajax_massive").html(process_icon  + 'Error: Problema detectado en el sistema, por favor comuniquese con el administrador');
								$('#form_ajax_massive').removeClass('hide');
							},
						});
					},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_property/fl_remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_property/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_property/restore",
...
function event_save() {
	...
	if (idtbl > 0) {
		...
		//var in_00 = $("#dt_info tr.selected").find('td').eq(0).find('input').val();
		// Obtencion de los datos a traves de inputs
		var v_nro_registration = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_nro_registration").find('input').val();
		var v_department = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_department").find('input').val();
		var v_municipality = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_municipality").find('input').val();
		var v_address = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_address").find('input').val();
		var v_ibn_state = $("#dt_info tr.selected td.lbl_azp_ibn_state_t_name").find('select').val();
		var v_ibn_type_property = $("#dt_info tr.selected td.lbl_azp_ibn_type_property_t_name").find('select').val();
		var v_area = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_area").find('input').val();
		var v_purchase_annotation = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_purchase_annotation").find('input').val();
		var v_market_value = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_market_value").find('input').val();
		var v_ownership = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_ownership").find('input').val();
		var v_assessment = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_assessment").find('input').val();
		var v_ibn_type_concept = $("#dt_info tr.selected td.lbl_azp_ibn_type_concept_t_name").find('select').val();
		var v_causal_feasibility = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_causal_feasibility").find('input').val();
		var v_viable = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_viable").find('select').val();
		var v_well_viable = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_well_viable").find('input').val();
		var v_text_one = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_text_one").find('input').val();
		var v_text_two = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_text_two").find('input').val();
		var v_text_three = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_text_three").find('input').val();
		var v_text_four = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_text_four").find('input').val();
		var v_text_five = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_text_five").find('input').val();
		var v_text_six = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_text_six").find('input').val();
		var v_text_seven = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_text_seven").find('input').val();
		var v_text_eight = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_text_eight").find('input').val();
		var v_sel_one = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_sel_one").find('select').val();
		var v_sel_two = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_sel_two").find('select').val();
		var v_sel_three = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_sel_three").find('select').val();
		var v_sel_four = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_sel_four").find('select').val();
		var v_sel_five = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_sel_five").find('select').val();
		// Mensaje de audio para mostrar en la pagina web
		initApp.playSound('views/templates/smart/dist/media/sound', 'bigbox');
		var dialog = bootbox.dialog({
			title: '¿Estas seguro de continuar con el proceso?',
			...
			buttons: {
				...
				ok: {
					...
					callback: function() {
						$.ajax({
							type : "POST",
							url : "api/azp_ibn_property/save",
							data : {
								field_sv_id: idtbl,
								field_sv_nro_registration: v_nro_registration,
								...
								field_sv_ibn_type_property: v_ibn_type_property,
								field_sv_area: v_area,
								field_sv_purchase_annotation: v_purchase_annotation,
								field_sv_market_value: v_market_value,
								field_sv_ownership: v_ownership,
								field_sv_assessment: v_assessment,
								field_sv_ibn_type_concept: v_ibn_type_concept,
								field_sv_causal_feasibility: v_causal_feasibility,
								field_sv_viable: v_viable,
								field_sv_well_viable: v_well_viable,
								field_sv_text_one: v_text_one,
								field_sv_text_two: v_text_two,
								field_sv_text_three: v_text_three,
								field_sv_text_four: v_text_four,
								field_sv_text_five: v_text_five,
								field_sv_text_six: v_text_six,
								field_sv_text_seven: v_text_seven,
								field_sv_text_eight: v_text_eight,
								field_sv_sel_one: v_sel_one,
								field_sv_sel_two: v_sel_two,
								field_sv_sel_three: v_sel_three,
								field_sv_sel_four: v_sel_four,
								field_sv_sel_five: v_sel_five,
							},
							success : function(json) {
								var obj = jQuery.parseJSON(json);
								if (obj.success == 1) {
...
function event_type_concept(mvalue) {
	if (mvalue == 'create') {
			...
			request.onreadystatechange = function(){
				if (request.readyState == 4 && request.status == 200) {
					...
					if (objData.status) {
						...
						if (name == 'CREAR') {
							//$('#field_cr_causal_feasibility').removeAttr('readonly','');
							document.getElementById('field_cr_causal_feasibility').value = 'REGISTRA' + ' ' + obvt + text;
						} else {
							//$('#field_cr_causal_feasibility').attr('readonly','');
							document.getElementById('field_cr_causal_feasibility').value = text;
						}
					} else {
						// Mensaje de audio para mostrar en la pagina web
						initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
			...
			request.onreadystatechange = function(){
				if (request.readyState == 4 && request.status == 200) {
					...
					if (objData.status) {
						...
						if (name == 'CREAR') {
							//$('#field_up_causal_feasibility').removeAttr('readonly','');
							document.getElementById('field_up_causal_feasibility').value = 'REGISTRA' + ' ' + obvt + text;
						} else {
							//$('#field_up_causal_feasibility').attr('readonly','');
							document.getElementById('field_up_causal_feasibility').value = text;
						}
					} else {
						// Mensaje de audio para mostrar en la pagina web
						initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
	...
	} else if (mvalue == 'massive') {
		var id = document.getElementById('field_ms_ibn_type_concept').value;
		if (id > 0) {
			var request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
			var ajaxurl = var_url + 'api' + var_controller + "typeconceptid/" + id + "/";
			request.open("GET", ajaxurl, true);
			...
			request.onreadystatechange = function(){
				if (request.readyState == 4 && request.status == 200) {
					...
					if (objData.status) {
						...
						var text = objData.data.lbl_azp_ibn_type_concept_t_text;
						// Obtener valores de un campo en especifico
						var obvt = document.getElementById('field_ms_limitation').value;
						if (name == 'CREAR') {
							//$('#field_ms_causal_feasibility').removeAttr('readonly','');
							document.getElementById('field_ms_causal_feasibility').value = 'REGISTRA' + ' ' + obvt + text;
						} else {
							//$('#field_ms_causal_feasibility').attr('readonly','');
							document.getElementById('field_ms_causal_feasibility').value = text;
						}
					} else {
						// Mensaje de audio para mostrar en la pagina web
						initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
		...
		if (idtbl > 0) {
			...
			if (tp != '') {
				...
				request.onreadystatechange = function(){
					if (request.readyState == 4 && request.status == 200) {
						...
						if (objData.status) {
							var name = objData.data.lbl_azp_ibn_type_concept_t_name;
							var text = objData.data.lbl_azp_ibn_type_concept_t_text;
							$("#dt_info tr.selected td.lbl_azp_ibn_property_t_causal_feasibility").find('input').val(text);
							// Obtener valores de un campo en especifico
							var obvt = document.getElementById('field_tb_observation').value;
							if (name == 'CREAR') {
								//$('#field_tb_causal_feasibility').removeAttr('readonly','');
								document.getElementById('field_tb_causal_feasibility').value = 'REGISTRA' + ' ' + obvt + text;
							} else {
								//$('#field_tb_causal_feasibility').attr('readonly','');
								document.getElementById('field_tb_causal_feasibility').value = text;
							}
						} else {
							// Mensaje de audio para mostrar en la pagina web
							initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
				...
				$("#dt_info tr.selected td.lbl_azp_ibn_property_t_causal_feasibility").find('input').val('');
			}
		}
	}
};
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					...
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_property/update",
						...
						success : function(json) {
							...
							if (obj.success == 1) {
								...
								if (v_ibn_state == '' || v_ibn_state == '2' || v_ibn_state == '10' || v_ibn_state == '11') {
									var querys = document.querySelector('#form_update');
									var elements = querys.querySelectorAll('select, input, textarea');
									[].forEach.call(elements, function(items) {
										items.disabled = true;
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					...
					//vtable.column(0).visible(false);
					$('#modal-id-update').modal('show');
					document.querySelector("#field_fl_id").value = objData.data.lbl_azp_ibn_property_id_azp_ibn_property;
					document.querySelector('#field_fl_control').value = objData.data.lbl_azp_ibn_property_v_id_azp_ibn_control_panel;
					document.querySelector('#field_fl_detection').value = objData.data.lbl_azp_ibn_property_t_identification;

					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_property_id_azp_ibn_property;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_property_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_property_m_status;
					document.querySelector("#field_up_address").value = objData.data.lbl_azp_ibn_property_t_address;
					document.querySelector("#field_up_area").value = objData.data.lbl_azp_ibn_property_t_area;
					document.querySelector("#field_up_assessment").value = objData.data.lbl_azp_ibn_property_t_assessment;
					document.querySelector("#field_up_causal_feasibility").value = objData.data.lbl_azp_ibn_property_t_causal_feasibility;
					document.querySelector("#field_up_comment_legal").value = objData.data.lbl_azp_ibn_property_t_comment_legal;
					//document.querySelector("#field_up_concept").value = objData.data.lbl_azp_ibn_property_t_concept;
					document.querySelector("#field_up_consecutive").value = objData.data.lbl_azp_ibn_property_t_consecutive;
					document.querySelector("#field_up_department").value = objData.data.lbl_azp_ibn_property_t_department;
					document.querySelector("#field_up_full_name").value = objData.data.lbl_azp_ibn_property_t_full_name;
					document.querySelector("#field_up_identification").value = objData.data.lbl_azp_ibn_property_t_identification;
					document.querySelector("#field_up_limitation").value = objData.data.lbl_azp_ibn_property_t_limitation;
					document.querySelector("#field_up_market_value").value = objData.data.lbl_azp_ibn_property_t_market_value;
					document.querySelector("#field_up_municipality").value = objData.data.lbl_azp_ibn_property_t_municipality;
					document.querySelector("#field_up_nro_registration").value = objData.data.lbl_azp_ibn_property_t_nro_registration;
					//document.querySelector("#field_up_observation").value = objData.data.lbl_azp_ibn_property_t_observation;
					document.querySelector("#field_up_ownership").value = objData.data.lbl_azp_ibn_property_t_ownership;
					document.querySelector("#field_up_purchase_annotation").value = objData.data.lbl_azp_ibn_property_t_purchase_annotation;
					document.querySelector("#field_up_viable").value = objData.data.lbl_azp_ibn_property_t_viable;
					document.querySelector("#field_up_well_viable").value = objData.data.lbl_azp_ibn_property_t_well_viable;
					document.querySelector("#field_up_st_returnable").value = objData.data.lbl_azp_ibn_property_t_st_returnable;
					document.querySelector("#field_up_st_receipt").value = objData.data.lbl_azp_ibn_property_t_st_receipt;
					document.querySelector("#field_up_st_date").value = objData.data.lbl_azp_ibn_property_t_st_date;
					document.querySelector("#field_up_st_value").value = objData.data.lbl_azp_ibn_property_t_st_value;
					document.querySelector("#field_up_text_one").value = objData.data.lbl_azp_ibn_property_t_text_one;
					document.querySelector("#field_up_text_two").value = objData.data.lbl_azp_ibn_property_t_text_two;
					document.querySelector("#field_up_text_three").value = objData.data.lbl_azp_ibn_property_t_text_three;
					document.querySelector("#field_up_text_four").value = objData.data.lbl_azp_ibn_property_t_text_four;
					document.querySelector("#field_up_text_five").value = objData.data.lbl_azp_ibn_property_t_text_five;
					document.querySelector("#field_up_text_six").value = objData.data.lbl_azp_ibn_property_t_text_six;
					document.querySelector("#field_up_text_seven").value = objData.data.lbl_azp_ibn_property_t_text_seven;
					document.querySelector("#field_up_text_eight").value = objData.data.lbl_azp_ibn_property_t_text_eight;
					document.querySelector("#field_up_sel_one").value = objData.data.lbl_azp_ibn_property_t_sel_one;
					document.querySelector("#field_up_sel_two").value = objData.data.lbl_azp_ibn_property_t_sel_two;
					document.querySelector("#field_up_sel_three").value = objData.data.lbl_azp_ibn_property_t_sel_three;
					document.querySelector("#field_up_sel_four").value = objData.data.lbl_azp_ibn_property_t_sel_four;
					document.querySelector("#field_up_sel_five").value = objData.data.lbl_azp_ibn_property_t_sel_five;
					document.querySelector("#field_up_ibn_observation").value = objData.data.lbl_azp_ibn_property_v_id_azp_ibn_observation;
					document.querySelector("#field_up_ibn_state").value = objData.data.lbl_azp_ibn_property_v_id_azp_ibn_state;
					document.querySelector("#field_up_ibn_type_concept").value = objData.data.lbl_azp_ibn_property_v_id_azp_ibn_type_concept;
					document.querySelector("#field_up_ibn_type_property").value = objData.data.lbl_azp_ibn_property_v_id_azp_ibn_type_property;

					event_state('update');
					event_val_market('update');
					event_pay_market('update');

					if (objData.data.lbl_azp_ibn_property_t_st_returnable == 'SI') {
						$('#field_up_st_receipt').removeAttr('readonly','');
						$('#field_up_st_date').removeAttr('readonly','');
						$('#field_up_st_value').removeAttr('readonly','');
						$('#check_up_st_returnable').prop('checked', true);
					} else {
						$('#field_up_st_receipt').attr('readonly','');
						$('#field_up_st_date').attr('readonly','');
						$('#field_up_st_value').attr('readonly','');
						$('#check_up_st_returnable').prop('checked', false);
					}

					//event_returnable('update');
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
...
function event_viable(mvalue) {
	if (mvalue == 'create') {
		var cr_viable = document.getElementById('field_cr_viable').value;
		var cr_nro_registration = document.getElementById('field_cr_nro_registration').value;
		var cr_ibn_type_property = document.getElementById('field_cr_ibn_type_property').value;
		if (cr_viable == 'SI') {
			if (cr_nro_registration != '' && cr_ibn_type_property > 0) {
				var request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
				var ajaxurl = var_url + 'api' + 'azp' + 'ibn' + 'typeproperty' + '/' + "detail/" + cr_ibn_type_property + "/";
				request.open("GET", ajaxurl, true);
				request.send();
				request.onreadystatechange = function(){
					if (request.readyState == 4 && request.status == 200) {
						var objData = JSON.parse(request.responseText);
						if (objData.status) {
							var ibn_type_property_name = objData.data.lbl_azp_ibn_type_property_t_name;
							document.getElementById('field_cr_well_viable').value = ibn_type_property_name + ' FMI No ' + cr_nro_registration;
						} else {
							// Mensaje de audio para mostrar en la pagina web
							initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
							bootbox.alert({
			...
			} else if (cr_nro_registration == '') {
				// Mensaje de audio para mostrar en la pagina web
				initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
				bootbox.alert({
					size: "small",
					title: "<i class='fal fa-times-circle text-warning mr-2'></i> <span class='text-warning fw-500'>Advertencia!</span>",
					message: "<span><strong>Lo sentimos:</strong> No haz digitado ningun valor en el campo de nro matricula.</span>",
					centerVertical: true,
					className: "modal-alert",
					closeButton: false,
				});
			} else if (cr_ibn_type_property == 0) {
				// Mensaje de audio para mostrar en la pagina web
				initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
				bootbox.alert({
					size: "small",
		...
		var up_viable = document.getElementById('field_up_viable').value;
		var up_nro_registration = document.getElementById('field_up_nro_registration').value;
		var up_ibn_type_property = document.getElementById('field_up_ibn_type_property').value;
		if (up_viable == 'SI') {
			if (up_nro_registration != '' && up_ibn_type_property > 0) {
				var request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
				var ajaxurl = var_url + 'api' + 'azp' + 'ibn' + 'typeproperty' + '/' + "detail/" + up_ibn_type_property + "/";
				request.open("GET", ajaxurl, true);
				request.send();
				request.onreadystatechange = function(){
					if (request.readyState == 4 && request.status == 200) {
						...
						if (objData.status) {
							var ibn_type_property_name = objData.data.lbl_azp_ibn_type_property_t_name;
							document.getElementById('field_up_well_viable').value = ibn_type_property_name + ' FMI No ' + up_nro_registration;
						} else {
							// Mensaje de audio para mostrar en la pagina web
							initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
							bootbox.alert({
			...
			} else if (up_ibn_type_property == 0) {
				// Mensaje de audio para mostrar en la pagina web
				initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
				bootbox.alert({
					size: "small",
		...
		$('#dt_info tr.selected td.lbl_azp_ibn_property_t_well_viable').attr('readonly','');
		var v_viable = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_viable").find('select').val();
		var v_nro_registration = $("#dt_info tr.selected td.lbl_azp_ibn_property_t_nro_registration").find('input').val();
		var v_ibn_type_property = $("#dt_info tr.selected td.lbl_azp_ibn_type_property_t_name").find('select').val();
		if (v_viable == 'SI') {
			if (v_ibn_type_property != '' && v_nro_registration != '') {
				var text = v_ibn_type_property + ' FMI No ' + v_nro_registration;
				$("#dt_info tr.selected td.lbl_azp_ibn_property_t_well_viable").find('input').val(text);
			} else if (v_ibn_type_property == '') {
				// Mensaje de audio para mostrar en la pagina web
				initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
				bootbox.alert({
					size: "small",
			...
			$("#dt_info tr.selected td.lbl_azp_ibn_property_t_well_viable").find('input').val('');
		}
		$('#dt_info tr.selected td.lbl_azp_ibn_property_t_well_viable').removeAttr('readonly','');
	}
};

function event_limitation(mvalue) {
	$('#modal-id-limitation').modal('show');
	var columnSet = [
		{
			title: "Id",
			id: "lbl_azp_ibn_limitation_id_azp_ibn_limitation",
			data: "lbl_azp_ibn_limitation_id_azp_ibn_limitation",
			type: "text",
			className: "text-dark lbl_azp_ibn_limitation_id_azp_ibn_limitation",
			visible: false,
		},
		{
			title: "Creado Por",
			...
			data: "lbl_azp_user_t_login_created",
			type: "text",
			className: "text-dark lbl_azp_user_t_login_created",
			visible: false,
		},
		{
			title: "Modificado Por",
			...
			data: "lbl_azp_user_t_login_modified",
			type: "text",
			className: "text-dark lbl_azp_user_t_login_modified",
			visible: false,
		},
		{
			title: "Fecha Creacion",
			id: "lbl_azp_ibn_limitation_m_date_created",
			data: "lbl_azp_ibn_limitation_m_date_created",
			type: "text",
			className: "text-dark lbl_azp_ibn_limitation_m_date_created",
			visible: false,
		},
		{
			title: "Fecha Modificacion",
			id: "lbl_azp_ibn_limitation_m_date_modified",
			data: "lbl_azp_ibn_limitation_m_date_modified",
			type: "text",
			className: "text-dark lbl_azp_ibn_limitation_m_date_modified",
			visible: false,
		},
		{
			title: "Descripcion",
			id: "lbl_azp_ibn_limitation_m_description",
			data: "lbl_azp_ibn_limitation_m_description",
			type: "text",
			className: "text-dark lbl_azp_ibn_limitation_m_description",
			visible: false,
		},
		{
			title: "Estado",
			...
			data: "lbl_azp_sys_state_t_name",
			type: "text",
			className: "text-dark lbl_azp_sys_state_t_name",
			visible: false,
		},
		{
			title: "Nombre",
			id: "lbl_azp_ibn_limitation_t_name",
			data: "lbl_azp_ibn_limitation_t_name",
			type: "text",
			className: "text-dark lbl_azp_ibn_limitation_t_name",
			visible: true,
		},
		{
			title: "Inscrita Por",
			id: "lbl_azp_ibn_limitation_t_registered",
			data: "lbl_azp_ibn_limitation_t_registered",
			type: "text",
			className: "text-dark lbl_azp_ibn_limitation_t_registered",
			visible: true,
		},
		{
			title: "Anotacion",
			id: "lbl_azp_ibn_limitation_t_annotation",
			data: "lbl_azp_ibn_limitation_t_annotation",
			type: "text",
			className: "text-dark lbl_azp_ibn_limitation_t_annotation",
			visible: true,
		},
		{
			title: "Frase 1",
			id: "lbl_azp_ibn_limitation_t_sentence_1",
			data: "lbl_azp_ibn_limitation_t_sentence_1",
			type: "text",
			className: "text-dark lbl_azp_ibn_limitation_t_sentence_1",
			visible: false,
		},
		{
			title: "Frase 2",
			id: "lbl_azp_ibn_limitation_t_sentence_2",
			data: "lbl_azp_ibn_limitation_t_sentence_2",
			type: "text",
			className: "text-dark lbl_azp_ibn_limitation_t_sentence_2",
			visible: false,
		},
		{
			title: "",
	...
	// Inicializar tabla de datos
	var myTable = $('#dt_limitation').dataTable({
		// Reinicialiar los datos de la tabla
		destroy: true,
		// Estructura de las columnas para el DOOM
		dom: "<'row mb-3'<'col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-flex align-items-center'B>>"
			...
			+ "<'row mb-3'<'col-xs-12 col-sm-12 col-md-5 col-lg-4 col-xl-4'i><'col-xs-12 col-sm-12 col-md-7 col-lg-8 col-xl-8'p>>",
		// Leer datos de prácticamente cualquier fuente de datos JSON
		ajax: var_url + 'api' + var_controller + "ibnlimitation/",
		// Cargar columnas del encabezado
		columns: columnSet,
		// Opciones para crear, editar, borrar y sincronizar
		altEditor: true,
		...
		columnDefs: [
			{
				targets: 1,
				'render': function (data, type, full, meta) {
					return '<input type="checkbox" id="field_tb_limitation" class="dt_tb_limitation" value="' + $('<div/>').text(data).html() + '">';
				},
			},
			{
				targets: 6,
			...
			},
			{
				...
				'render': function (data, type, full, meta) {
					return '<input type="text"' +
						'name="field_tb_registered"' +
						'id="field_tb_registered"' +
			...
			},
			{
				...
				'render': function (data, type, full, meta) {
					return '<input type="number"' +
						'name="field_tb_annotation"' +
						'id="field_tb_annotation"' +
						'class="form-control input-xs"' +
						'value="' + $('<div/>').text(data).html() + '">';
				},
			},
			{
				...
				'render': function (data, type, full, meta) {
					if (data != '') {
						return '<button type="button" onclick="event_assessment(' + "'" + mvalue + "'" + ');"'
							+ 'class="btn btn-xs waves-effect waves-light btn-outline-dark">'
							+ '<em class="far fa-plus"></em></button>';
					} else { return ''; }
				},
			},
		],
...
function event_assessment(mvalue) {
	// Mostrar la columna especificada de la tabla
	var vtable = $('#dt_limitation').DataTable();
	vtable.column(0).visible(true);
	vtable.column(10).visible(true);
	vtable.column(11).visible(true);
	// Obtener el primer valor seleccionado de la tabla
	var idtbl = $("#dt_limitation tr.selected td:first").html();
	// Validar si el id es mayor a cero
	if (idtbl > 0) {
		// Defincion de variables con valores fijos
		var c_annotation = ''; var c_registered = '';

		// Obtener los valores segun el registro seleccionado
		var v_annotation = $("#dt_limitation tr.selected td.lbl_azp_ibn_limitation_t_annotation").find('input').val();
		var v_limitation = $("#dt_limitation tr.selected td.lbl_azp_ibn_limitation_t_name").html();
		var v_registered = $("#dt_limitation tr.selected td.lbl_azp_ibn_limitation_t_registered").find('input').val();

		// Validacion de valores en campos para asignacion a variables
		if (v_annotation == '') { c_annotation = ''; } else { c_annotation = '(ANOTACION' + ' ' + v_annotation + ')'; }
		if (v_registered == '') { c_registered = ''; } else { c_registered = 'INSCRITA(O) POR' + ' ' + v_registered; }

		// Control de validaciones segun valor
		if (mvalue == 'create') {
			let f_assement = document.getElementById('field_cr_assessment');
			f_assement.value += v_limitation + ' ' + v_registered + ', ';

			let f_observation = document.getElementById('field_cr_limitation');
			f_observation.value += v_limitation + ' ' + c_registered + ' ' + c_annotation + ', ';
		} else if (mvalue == 'update') {
			let f_assement = document.getElementById('field_up_assessment');
			f_assement.value += v_limitation + ' ' + v_registered + ', ';

			let f_observation = document.getElementById('field_up_limitation');
			f_observation.value += v_limitation + ' ' + c_registered + ' ' + c_annotation + ', ';
		} else if (mvalue == 'massive') {
			let f_assement = document.getElementById('field_ms_assessment');
			f_assement.value += v_limitation + ' ' + v_registered + ', ';

			let f_observation = document.getElementById('field_ms_limitation');
			f_observation.value += v_limitation + ' ' + c_registered + ' ' + c_annotation + ', ';
		...
		var vtable = $('#dt_limitation').DataTable();
		vtable.column(0).visible(false);
		vtable.column(10).visible(false);
		vtable.column(11).visible(false);
	} else {
		// Ocultar la columna especificada de la tabla
		var vtable = $('#dt_limitation').DataTable();
		vtable.column(0).visible(false);
...
function event_data_table() {
	/*let trs = document.querySelectorAll('#dt_info tr td');

	trs.forEach(tr => {
		let rows = tr.querySelectorAll('input');
		console.log(rows);
		//tr.find('input').removeAttr('disabled', '');
		//rows.toggleAttribute('disabled');
		//rows[0].onchange = () => {
		//	rows[1].firstElementChild.toggleAttribute('disabled')
		//	rows[2].firstElementChild.toggleAttribute('disabled')
		//}
	});*/
};
...
function event_check() {
	$("#dt_info input.dt_table_info").change(function () {
		if ($(this).prop("checked")) {
			//$(this).closest('tr').find('td.lbl_azp_ibn_property_t_nro_registration input').prop('disabled', false);
			//$(this).closest('tr').find('td.lbl_azp_ibn_property_t_department input').prop('disabled', false);
			//$(this).closest('tr').find('td.lbl_azp_ibn_property_t_municipality input').prop('disabled', false);
			//$(this).closest('tr').find('td.lbl_azp_ibn_property_t_address input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_state_t_name select').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_type_property_t_name select').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_area input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_purchase_annotation input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_market_value input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_ownership input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_assessment input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_type_concept_t_name select').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_causal_feasibility input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_viable select').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_well_viable input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_one input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_two input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_three input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_four input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_five input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_six input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_seven input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_eight input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_one select').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_two select').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_three select').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_four select').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_five select').prop('disabled', false);

			//$(this).closest('tr').find('td.lbl_azp_ibn_property_t_nro_registration input').addClass('border-success');
			//$(this).closest('tr').find('td.lbl_azp_ibn_property_t_department input').addClass('border-success');
			//$(this).closest('tr').find('td.lbl_azp_ibn_property_t_municipality input').addClass('border-success');
			//$(this).closest('tr').find('td.lbl_azp_ibn_property_t_address input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_state_t_name select').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_type_property_t_name select').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_area input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_purchase_annotation input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_market_value input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_ownership input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_assessment input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_type_concept_t_name select').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_causal_feasibility input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_viable select').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_well_viable input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_one input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_two input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_three input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_four input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_five input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_six input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_seven input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_eight input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_one select').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_two select').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_three select').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_four select').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_five select').addClass('border-success');
		} else {
			//$(this).closest('tr').find('td.lbl_azp_ibn_property_t_nro_registration input').prop('disabled', true);
			//$(this).closest('tr').find('td.lbl_azp_ibn_property_t_department input').prop('disabled', true);
			//$(this).closest('tr').find('td.lbl_azp_ibn_property_t_municipality input').prop('disabled', true);
			//$(this).closest('tr').find('td.lbl_azp_ibn_property_t_address input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_state_t_name select').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_type_property_t_name select').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_area input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_purchase_annotation input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_market_value input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_ownership input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_assessment input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_type_concept_t_name select').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_causal_feasibility input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_viable select').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_well_viable input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_one input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_two input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_three input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_four input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_five input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_six input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_seven input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_eight input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_one select').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_two select').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_three select').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_four select').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_five select').prop('disabled', true);

			//$(this).closest('tr').find('td.lbl_azp_ibn_property_t_nro_registration input').removeClass('border-success');
			//$(this).closest('tr').find('td.lbl_azp_ibn_property_t_department input').removeClass('border-success');
			//$(this).closest('tr').find('td.lbl_azp_ibn_property_t_municipality input').removeClass('border-success');
			//$(this).closest('tr').find('td.lbl_azp_ibn_property_t_address input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_state_t_name select').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_type_property_t_name select').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_area input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_purchase_annotation input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_market_value input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_ownership input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_assessment input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_type_concept_t_name select').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_causal_feasibility input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_viable select').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_well_viable input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_one input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_two input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_three input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_four input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_five input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_six input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_seven input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_text_eight input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_one select').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_two select').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_three select').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_four select').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_property_t_sel_five select').removeClass('border-success');
		}
	});
};
			...
			buttons: {
				...
				ok: {
					...
					callback: function() {
						$.ajax({
							type : "POST",
							url : "api/azp_ibn_property/multiple",
...
function event_val_market(mvalue) {
	if (mvalue == 'create') {
		if ($('#check_cr_market_value').is(':checked')) {
			$("#field_cr_market_value").inputmask("remove");
			$('#field_cr_market_value').attr('placeholder','Digita el texto ...');
			$('#field_cr_market_value').attr('style','text-align: left;');
			document.getElementById('field_cr_market_value').value = 'SIN DETERMINAR';
		} else {
			$("#field_cr_market_value").inputmask("mask", { "currency": "$ 0" });
			//$(document).ready(function() { $('#field_cr_market_value').inputmask('$ 999.999.999.999', { numericInput: true }); });
		}
	} else if (mvalue == 'update') {
		if ($('#check_up_market_value').is(':checked')) {
			$("#field_up_market_value").inputmask("remove");
			$('#field_up_market_value').attr('placeholder','Digita el texto ...');
			$('#field_up_market_value').attr('style','text-align: left;');
			document.getElementById('field_up_market_value').value = 'SIN DETERMINAR';
		} else {
			$("#field_up_market_value").inputmask("mask", { "currency": "$ 0" });
			//$(document).ready(function() { $('#field_up_market_value').inputmask('$ 999.999.999.999', { numericInput: true }); });
		}
	} else if (mvalue == 'massive') {
		if ($('#check_ms_market_value').is(':checked')) {
			$("#field_ms_market_value").inputmask("remove");
			$('#field_ms_market_value').attr('placeholder','Digita el texto ...');
			$('#field_ms_market_value').attr('style','text-align: left;');
			document.getElementById('field_ms_market_value').value = 'SIN DETERMINAR';
		} else {
			$("#field_ms_market_value").inputmask("mask", { "currency": "$ 0" });
			//$(document).ready(function() { $('#field_ms_market_value').inputmask('$ 999.999.999.999', { numericInput: true }); });
		}
	}
};

function event_pay_market(mvalue) {
	if (mvalue == 'create') {
		if ($('#check_cr_market_value').is(':checked')) {
			$("#field_cr_market_value").inputmask("remove");
			$('#field_cr_market_value').attr('placeholder','Digita el texto ...');
...
function event_state(mvalue) {
	if (mvalue == 'create') {
		...
		if (v_ibn_state == '' || v_ibn_state == '2' || v_ibn_state == '10' || v_ibn_state == '11') {
			...
			document.getElementById('field_cr_ibn_type_concept').value = '2';
			document.getElementById('field_cr_ibn_type_property').value = '1';
			...
			$('#field_cr_st_returnable').removeAttr('disabled', '');
			$('#check_cr_st_returnable').removeAttr('disabled', '');
			$('#field_cr_st_receipt').removeAttr('disabled', '');
			$('#field_cr_st_date').removeAttr('disabled', '');
			$('#field_cr_st_value').removeAttr('disabled', '');
		} else {
			var querys = document.querySelector('#form_create');
			var elements = querys.querySelectorAll('select, input, textarea');
			[].forEach.call(elements, function(items) {
	...
	if (mvalue == 'update') {
		...
		if (v_ibn_state == '' || v_ibn_state == '2' || v_ibn_state == '10' || v_ibn_state == '11') {
			...
			$('#field_up_st_returnable').removeAttr('disabled', '');
			$('#check_up_st_returnable').removeAttr('disabled', '');
			$('#field_up_st_receipt').removeAttr('disabled', '');
			$('#field_up_st_date').removeAttr('disabled', '');
			$('#field_up_st_value').removeAttr('disabled', '');
		} else {
			var querys = document.querySelector('#form_update');
			var elements = querys.querySelectorAll('select, input, textarea');
			[].forEach.call(elements, function(items) {
...
function event_returnable(mvalue) {
	if (mvalue == 'create') {
		if ($('#check_cr_st_returnable').is(':checked')) {
			$('#field_cr_st_receipt').removeAttr('readonly','');
			$('#field_cr_st_date').removeAttr('readonly','');
			$('#field_cr_st_value').removeAttr('readonly','');
			document.getElementById('field_cr_st_returnable').value = 'SI';
		} else {
			$('#field_cr_st_receipt').attr('readonly','');
			$('#field_cr_st_date').attr('readonly','');
			$('#field_cr_st_value').attr('readonly','');
			document.getElementById('field_cr_st_returnable').value = 'NO';
		}
	} else if (mvalue == 'update') {
		if ($('#check_up_st_returnable').is(':checked')) {
			$('#field_up_st_receipt').removeAttr('readonly','');
			$('#field_up_st_date').removeAttr('readonly','');
			$('#field_up_st_value').removeAttr('readonly','');
			document.getElementById('field_up_st_returnable').value = 'SI';
			$('#check_up_st_returnable').prop('checked', true);
		} else {
			$('#field_up_st_receipt').attr('readonly','');
			$('#field_up_st_date').attr('readonly','');
			$('#field_up_st_value').attr('readonly','');
			document.getElementById('field_up_st_returnable').value = 'NO';
			$('#check_up_st_returnable').prop('checked', false);
		}
	}
};
...
function field_area() {
	var se_field = document.getElementById('field_se_area').value;
	let sf_field = document.getElementById('field_sf_area');
	sf_field.value += "'" + se_field + "',";
};

function field_assessment() {
	var se_field = document.getElementById('field_se_assessment').value;
	let sf_field = document.getElementById('field_sf_assessment');
	sf_field.value += "'" + se_field + "',";
};

function field_causal_feasibility() {
	var se_field = document.getElementById('field_se_causal_feasibility').value;
	let sf_field = document.getElementById('field_sf_causal_feasibility');
	sf_field.value += "'" + se_field + "',";
};
...
function field_market_value() {
	var se_field = document.getElementById('field_se_market_value').value;
	let sf_field = document.getElementById('field_sf_market_value');
	sf_field.value += "'" + se_field + "',";
};
...
function field_nro_registration() {
	var se_field = document.getElementById('field_se_nro_registration').value;
	let sf_field = document.getElementById('field_sf_nro_registration');
	sf_field.value += "'" + se_field + "',";
};
...
function field_ownership() {
	var se_field = document.getElementById('field_se_ownership').value;
	let sf_field = document.getElementById('field_sf_ownership');
	sf_field.value += "'" + se_field + "',";
};
...
function field_purchase_annotation() {
	var se_field = document.getElementById('field_se_purchase_annotation').value;
	let sf_field = document.getElementById('field_sf_purchase_annotation');
	sf_field.value += "'" + se_field + "',";
};

function field_viable() {
	var se_field = document.getElementById('field_se_viable').value;
	let sf_field = document.getElementById('field_sf_viable');
	sf_field.value += "'" + se_field + "',";
};
...
function field_ibn_type_property() {
	var se_field = document.getElementById('field_se_ibn_type_property').value;
	let sf_field = document.getElementById('field_sf_ibn_type_property');
	sf_field.value += "'" + se_field + "',";
};
