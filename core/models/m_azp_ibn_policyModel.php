<?php
	...
	//------------------------------------------------
	final class m_azp_ibn_policyModel extends Models implements OCREND {
		/*=========================================================================================================================*/
		...
		final public function sql_controller_by_create() {
			...
			return $this->db->query("
				...
				-- ---------------------------------------------------------------
				WHERE tc_azp_ibn_policy." . d_azp_ibn_policy_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "'
					AND tc_azp_ibn_policy." . d_azp_ibn_policy_m_deleted . " = '1'
				ORDER BY tc_azp_ibn_policy." . d_azp_ibn_policy_id_azp_ibn_policy . " ASC
			");
		}
		...
		final public function sql_controller_change() {
			...
			return $this->db->query("
				SELECT
					tc_azs_ibn_policy." . d_azs_ibn_policy_id_azs_ibn_policy . " AS 'lbl_azs_ibn_policy_id_azs_ibn_policy',
					tc_azs_ibn_policy." . d_azs_ibn_policy_m_date_modified . " AS 'lbl_azs_ibn_policy_m_date_modified',
					tc_azp_user_created." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_created',
					tc_azp_user_modified." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_modified',
					tc_azs_ibn_policy." . d_azs_ibn_policy_m_date_created . " AS 'lbl_azs_ibn_policy_m_date_created',
					tc_azs_ibn_policy." . d_azs_ibn_policy_m_date_modified . " AS 'lbl_azs_ibn_policy_m_date_modified',
					tc_azs_ibn_policy." . d_azs_ibn_policy_m_description . " AS 'lbl_azs_ibn_policy_m_description',
					tc_azp_sys_level." . d_azp_sys_level_t_name . " AS 'lbl_azp_sys_level_t_name',
					tc_azp_sys_state." . d_azp_sys_state_t_name . " AS 'lbl_azp_sys_state_t_name',
					tc_azs_ibn_policy." . d_azs_ibn_policy_u_ibn_client . " AS 'lbl_azs_ibn_policy_u_ibn_client',
					tc_azs_ibn_policy." . d_azs_ibn_policy_u_ibn_conditional . " AS 'lbl_azs_ibn_policy_u_ibn_conditional'
				FROM " . t_azs_ibn_policy . " tc_azs_ibn_policy
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azs_ibn_policy." . d_azs_ibn_policy_m_by_created . "
						= tc_azp_user_created." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_user . " tc_azp_user_modified
					ON tc_azs_ibn_policy." . d_azs_ibn_policy_m_by_modified . "
						= tc_azp_user_modified." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_sys_level . " tc_azp_sys_level
					ON tc_azs_ibn_policy." . d_azs_ibn_policy_m_level . "
						= tc_azp_sys_level." . d_azp_sys_level_t_value . "
				INNER JOIN " . t_azp_sys_state . " tc_azp_sys_state
					ON tc_azs_ibn_policy." . d_azs_ibn_policy_m_status . "
						= tc_azp_sys_state." . d_azp_sys_state_t_value . "
				-- ---------------------------------------------------------------
				WHERE tc_azs_ibn_policy." . d_azs_ibn_policy_v_id_azp_ibn_policy . " = '" . $this->id . "'
				ORDER BY tc_azs_ibn_policy." . d_azs_ibn_policy_m_date_modified . " DESC
			");
		}
		...
		final public function sql_controller_delete() : array {
			...
			$var_sql = $this->db->query("
				SELECT * FROM " . t_azp_ibn_policy . "
				WHERE " . d_azp_ibn_policy_id_azp_ibn_policy . " = '" . $this->id . "'
					AND " . d_azp_ibn_policy_m_deleted . " = '2'
				LIMIT 1
			");
			...
			if (false != $var_result) {
				...
				Func::redir(URL . url_query_azp_ibn_policy);
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_ibn_module . " tc_azp_ibn_module
					ON tc_azp_ibn_conditional." . d_azp_ibn_conditional_v_id_azp_ibn_module . "
						= tc_azp_ibn_module." . d_azp_ibn_module_id_azp_ibn_module . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_ibn_policy." . d_azp_ibn_policy_id_azp_ibn_policy . " = '" . $this->id . "'
					AND tc_azp_ibn_policy." . d_azp_ibn_policy_m_deleted . " = '1'
				LIMIT 1
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_ibn_module . " tc_azp_ibn_module
					ON tc_azp_ibn_conditional." . d_azp_ibn_conditional_v_id_azp_ibn_module . "
						= tc_azp_ibn_module." . d_azp_ibn_module_id_azp_ibn_module . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_ibn_policy." . d_azp_ibn_policy_m_deleted . " = '3'
				ORDER BY tc_azp_ibn_policy." . d_azp_ibn_policy_id_azp_ibn_policy . " ASC
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_ibn_module . " tc_azp_ibn_module
					ON tc_azp_ibn_conditional." . d_azp_ibn_conditional_v_id_azp_ibn_module . "
						= tc_azp_ibn_module." . d_azp_ibn_module_id_azp_ibn_module . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_ibn_policy." . d_azp_ibn_policy_m_deleted . " = '2'
				ORDER BY tc_azp_ibn_policy." . d_azp_ibn_policy_id_azp_ibn_policy . " ASC
			");
		}
		...
		final public function sql_controller_update() {
			...
			return $this->db->query("
				SELECT
					tc_azp_ibn_policy." . d_azp_ibn_policy_id_azp_ibn_policy . " AS 'lbl_azp_ibn_policy_id_azp_ibn_policy',
					tc_azp_ibn_policy." . d_azp_ibn_policy_m_by_created . " AS 'lbl_azp_ibn_policy_m_by_created',
					tc_azp_ibn_policy." . d_azp_ibn_policy_m_by_modified . " AS 'lbl_azp_ibn_policy_m_by_modified',
					tc_azp_ibn_policy." . d_azp_ibn_policy_m_date_created . " AS 'lbl_azp_ibn_policy_m_date_created',
					tc_azp_ibn_policy." . d_azp_ibn_policy_m_date_modified . " AS 'lbl_azp_ibn_policy_m_date_modified',
					tc_azp_ibn_policy." . d_azp_ibn_policy_m_description . " AS 'lbl_azp_ibn_policy_m_description',
					tc_azp_ibn_policy." . d_azp_ibn_policy_m_level . " AS 'lbl_azp_ibn_policy_m_level',
					tc_azp_ibn_policy." . d_azp_ibn_policy_m_status . " AS 'lbl_azp_ibn_policy_m_status',
					tc_azp_ibn_policy." . d_azp_ibn_policy_v_id_azp_ibn_client . " AS 'lbl_azp_ibn_policy_v_id_azp_ibn_client',
					tc_azp_ibn_policy." . d_azp_ibn_policy_v_id_azp_ibn_conditional . " AS 'lbl_azp_ibn_policy_v_id_azp_ibn_conditional'
				FROM " . t_azp_ibn_policy . " tc_azp_ibn_policy
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azp_ibn_policy." . d_azp_ibn_policy_m_by_created . "
		...
		final private function error_sql_ibn_policy_delete(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				$sql_id = $this->db->select('*', t_azp_ibn_policy, d_azp_ibn_policy_id_azp_ibn_policy . " = '" . $empty_id . "'");
				...
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select('*', t_azp_ibn_policy, d_azp_ibn_policy_id_azp_ibn_policy . " = '" . $empty_id . "' AND " . d_azp_ibn_policy_m_deleted . " = '2'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (false == $sql_id) {
					# Verificar si el resultado devuleto no existe para asignar un valor especifico
					if (strtolower($sql_id) == '') { $sql_id[0][0] = 0; }
				...
				$sql_session = $this->db->select('*', t_azp_ibn_policy, d_azp_ibn_policy_id_azp_ibn_policy . " = '" . $empty_id . "' AND " . d_azp_ibn_policy_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "' AND " . d_azp_ibn_policy_m_level . " = '1'");
				# Verificar si el registro creado es igual el valor del campo nivel al valor dos
				$sql_level = $this->db->select('*', t_azp_ibn_policy, d_azp_ibn_policy_id_azp_ibn_policy . " = '" . $empty_id . "' AND " . d_azp_ibn_policy_m_level . " = '2'");
				# Verificar si el resultado de la sql es verdadero o falso
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_ibn_policy_delete(array $data) : array {
			$var_error = $this->error_sql_azp_ibn_policy_delete($data);
			...
			if (!isset($_SESSION[SESS_APP_ID])) {
				...
				$var_array = array(d_azp_ibn_policy_m_deleted => '3',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_ibn_policy, $var_array, d_azp_ibn_policy_id_azp_ibn_policy . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
		...
		final private function error_sql_azp_ibn_policy_insert(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				if (!isset($data['field_cr_ibn_conditional'])) { throw new Exception('<b>Error:</b> El campo de condicional esta prohibido modificar.'); }
				#-------------------------------------------------------------------------#
				$empty_description = $this->db->scape($data['field_cr_description']);
				$empty_ibn_client = $this->db->scape($data['field_cr_ibn_client']);
				$empty_ibn_conditional = $this->db->scape($data['field_cr_ibn_conditional']);
				#-------------------------------------------------------------------------#
				if (isset($_SESSION['pe_time']) and end($_SESSION['pe_time']) >= time()) {
					# Informar un mensaje al usuario por medio de una excepcion
					throw new Exception('No puedes realizar tantas acciones seguidas.');
				...
				#-------------------------------------------------------------------------#
				if (Func::emp($empty_ibn_conditional) || strtolower($empty_ibn_conditional) == strtolower('seleccionar') || $empty_ibn_conditional == 0) {
					# Informar un mensaje al usuario por medio de una excepcion
					throw new Exception('<b>Error:</b> El campo de condicional es obligatorio.');
				}
				#---------------------------------------------#
				if (!is_numeric($empty_ibn_conditional)) {
					# Informar un mensaje al usuario por medio de una excepcion
				...
				#-------------------------------------------------------------------------#
				# Verificar en la base de datos si existen el registro
				$sql_ibn_conditional = $this->db->select('*', t_azp_ibn_conditional, d_azp_ibn_conditional_id_azp_ibn_conditional . " = '" . $empty_ibn_conditional . "'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (false == $sql_ibn_conditional) {
					# Verificar si el resultado devuleto no existe para asignar un valor especifico
					if (strtolower($sql_ibn_conditional) == '') { $sql_ibn_conditional[0][0] = 0; }
					# Verificiar si el valor recibido de la sql es diferente del digitado
					if (strtolower($sql_ibn_conditional[0][0]) != strtolower($empty_ibn_conditional)) {
						# Informar un mensaje al usuario por medio de una excepcion
						throw new Exception('<b>Error:</b> El condicional seleccionado no se encuentra registrado.');
					}
				}
				#-------------------------------------------------------------------------#
				# Verificar si el valor ingresado se encuentra repetido en los demas registros
				$var_sql = $this->db->select('*', t_azp_ibn_policy,
					d_azp_ibn_policy_v_id_azp_ibn_client . " = '" . $empty_ibn_client . "' AND " .
					d_azp_ibn_policy_v_id_azp_ibn_conditional . " = '" . $empty_ibn_conditional . "'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (true == $var_sql) {
					# Informar un mensaje al usuario por medio de una excepcion
		...
		/*=========================================================================================================================*/
		# Query Sql Insert
		final public function sql_azp_ibn_policy_insert(array $data) : array {
			$var_error = $this->error_sql_azp_ibn_policy_insert($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				$var_array = array(
					...
					d_azp_ibn_policy_m_description => $empty_description,
					d_azp_ibn_policy_m_level => '2',
					d_azp_ibn_policy_m_status => '1',
					d_azp_ibn_policy_m_temp => '1',
					d_azp_ibn_policy_v_id_azp_ibn_client => $empty_ibn_client,
					d_azp_ibn_policy_v_id_azp_ibn_conditional => $empty_ibn_conditional,
				);
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_ibn_policy_remove(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select('*', t_azp_ibn_policy, d_azp_ibn_policy_id_azp_ibn_policy . " = '" . $empty_id . "' AND " . d_azp_ibn_policy_m_deleted . " = '1'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (false == $sql_id) {
					# Verificar si el resultado devuleto no existe para asignar un valor especifico
					if (strtolower($sql_id) == '') { $sql_id[0][0] = 0; }
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_ibn_policy_remove(array $data) : array {
			$var_error = $this->error_sql_azp_ibn_policy_remove($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_ibn_policy_m_deleted => '2',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_ibn_policy, $var_array, d_azp_ibn_policy_id_azp_ibn_policy . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_ibn_policy_restore(array $data) {
			try {
				#-------------------------------------------------------------------------#
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_ibn_policy_restore(array $data) : array {
			$var_error = $this->error_sql_azp_ibn_policy_restore($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_ibn_policy_m_deleted => '1',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_ibn_policy, $var_array, d_azp_ibn_policy_id_azp_ibn_policy . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_ibn_policy_update(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				if (!isset($data['field_up_ibn_conditional'])) { throw new Exception('<b>Error:</b> El campo de condicional esta prohibido modificar.'); }
				#-------------------------------------------------------------------------#
				...
				# Verificar si el valor ingresado se encuentra repetido en los demas registros
				$var_sql = $this->db->select('*', t_azp_ibn_policy,
					d_azp_ibn_policy_id_azp_ibn_policy . " != '" . $empty_id . "' AND " .
					d_azp_ibn_policy_v_id_azp_ibn_client . " = '" . $empty_ibn_client . "' AND " .
					d_azp_ibn_policy_v_id_azp_ibn_conditional . " = '" . $empty_ibn_conditional . "'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (true == $var_sql) {
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_ibn_policy_update(array $data) : array {
			$var_error = $this->error_sql_azp_ibn_policy_update($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				#-------------------------------------------------------------------------#
				$empty_ibn_client = $this->db->scape($data['field_up_ibn_client']);
				$empty_ibn_conditional = $this->db->scape($data['field_up_ibn_conditional']);
				#-------------------------------------------------------------------------#
				# Linea de codigo con una variable y array para seleccionar los datos de la tabla segun el id
				$var_sql_select = $this->db->select('*', t_azp_ibn_policy, d_azp_ibn_policy_id_azp_ibn_policy . " = '" . $empty_id . "'");
				# Validar si la sentencia query ejecutada es correcta y no falsa
				if (false != $var_sql_select) {
					# El constructor foreach proporciona un modo sencillo de iterar sobre arrays.
					foreach ($var_sql_select as $key_sql_select):
						$var_array = array(
							d_azs_ibn_policy_m_by_created => $_SESSION[SESS_APP_ID],
							d_azs_ibn_policy_m_by_modified => $_SESSION[SESS_APP_ID],
							d_azs_ibn_policy_m_date_created => DATE_HOUR,
							d_azs_ibn_policy_m_date_modified => DATE_HOUR,
							d_azs_ibn_policy_m_deleted => $key_sql_select[d_azp_ibn_policy_m_deleted],
							d_azs_ibn_policy_m_description => $key_sql_select[d_azp_ibn_policy_m_description],
							d_azs_ibn_policy_m_level => $key_sql_select[d_azp_ibn_policy_m_level],
							d_azs_ibn_policy_m_status => $key_sql_select[d_azp_ibn_policy_m_status],
							d_azs_ibn_policy_m_temp => $key_sql_select[d_azp_ibn_policy_m_temp],
							d_azs_ibn_policy_u_ibn_client => strtoupper($key_sql_select[d_azp_ibn_policy_v_id_azp_ibn_client]),
							d_azs_ibn_policy_u_ibn_conditional => strtoupper($key_sql_select[d_azp_ibn_policy_v_id_azp_ibn_conditional]),
							d_azs_ibn_policy_v_id_azp_ibn_policy => $empty_id,
						);
						# Query Sql Insert: Insertar datos en la tabla con sus campos respectivos y asignados
						$this->db->insert(t_azs_ibn_policy, $var_array);
					endforeach;
				}
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(
					...
					d_azp_ibn_policy_m_date_modified => DATE_HOUR,
					d_azp_ibn_policy_m_description => $empty_description,
					d_azp_ibn_policy_m_status => $empty_state,
					d_azp_ibn_policy_v_id_azp_ibn_client => $empty_ibn_client,
					d_azp_ibn_policy_v_id_azp_ibn_conditional => $empty_ibn_conditional,
				);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
		...
		final public function sql_select_tc_azp_ibn_client() {
			# Seleccionar los registros de la tabla
			return $this->db->select('*', t_azp_ibn_client, d_azp_ibn_client_m_deleted . " = '1' AND " . d_azp_ibn_client_m_status . " = '1' ORDER BY " . d_azp_ibn_client_t_name . " ASC");
		}
