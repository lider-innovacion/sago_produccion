...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_contact_id_azs_contact",
				data: "lbl_azs_contact_id_azs_contact",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_contact_m_date_created",
				data: "lbl_azs_contact_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_contact_m_date_modified",
				data: "lbl_azs_contact_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_contact_m_description",
				data: "lbl_azs_contact_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Asunto",
				id: "lbl_azs_contact_t_affair",
				data: "lbl_azs_contact_t_affair",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Respuesta",
				id: "lbl_azs_contact_t_answer",
				data: "lbl_azs_contact_t_answer",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Codigo",
				id: "lbl_azs_contact_t_code",
				data: "lbl_azs_contact_t_code",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Fecha",
				id: "lbl_azs_contact_t_date",
				data: "lbl_azs_contact_t_date",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_contact_t_email",
				data: "lbl_azs_contact_t_email",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Mensaje",
				id: "lbl_azs_contact_t_message",
				data: "lbl_azs_contact_t_message",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Nombres",
				id: "lbl_azs_contact_t_names",
				data: "lbl_azs_contact_t_names",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Telefono Fijo",
				id: "lbl_azs_contact_t_phone_fixed",
				data: "lbl_azs_contact_t_phone_fixed",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_contact_t_phone_movil",
				data: "lbl_azs_contact_t_phone_movil",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Apellidos",
				id: "lbl_azs_contact_t_surnames",
				data: "lbl_azs_contact_t_surnames",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Pais",
				id: "lbl_azs_contact_u_id_azp_country_t_name",
				data: "lbl_azs_contact_u_id_azp_country_t_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Tramite",
				id: "lbl_azs_contact_u_id_azp_transact_t_name",
				data: "lbl_azs_contact_u_id_azp_transact_t_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_contact_id_azp_contact").innerHTML = objData.data.lbl_azp_contact_id_azp_contact;
					...
					document.querySelector("#lbl_azp_contact_m_date_created").innerHTML = objData.data.lbl_azp_contact_m_date_created;
					document.querySelector("#lbl_azp_contact_m_date_modified").innerHTML = objData.data.lbl_azp_contact_m_date_modified;
					document.querySelector("#lbl_azp_contact_m_description").innerHTML = objData.data.lbl_azp_contact_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_contact_t_affair").innerHTML = objData.data.lbl_azp_contact_t_affair;
					document.querySelector("#lbl_azp_contact_t_answer").innerHTML = objData.data.lbl_azp_contact_t_answer;
					document.querySelector("#lbl_azp_contact_t_code").innerHTML = objData.data.lbl_azp_contact_t_code;
					document.querySelector("#lbl_azp_contact_t_date").innerHTML = objData.data.lbl_azp_contact_t_date;
					document.querySelector("#lbl_azp_contact_t_email").innerHTML = objData.data.lbl_azp_contact_t_email;
					document.querySelector("#lbl_azp_contact_t_message").innerHTML = objData.data.lbl_azp_contact_t_message;
					document.querySelector("#lbl_azp_contact_t_names").innerHTML = objData.data.lbl_azp_contact_t_names;
					document.querySelector("#lbl_azp_contact_t_phone_fixed").innerHTML = objData.data.lbl_azp_contact_t_phone_fixed;
					document.querySelector("#lbl_azp_contact_t_phone_movil").innerHTML = objData.data.lbl_azp_contact_t_phone_movil;
					document.querySelector("#lbl_azp_contact_t_surnames").innerHTML = objData.data.lbl_azp_contact_t_surnames;
					document.querySelector("#lbl_azp_country_t_name").innerHTML = objData.data.lbl_azp_country_t_name;
					document.querySelector("#lbl_azp_transact_t_name").innerHTML = objData.data.lbl_azp_transact_t_name;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_contact_id_azp_contact;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_contact_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_contact_m_status;
					document.querySelector("#field_up_affair").value = objData.data.lbl_azp_contact_t_affair;
					document.querySelector("#field_up_email").value = objData.data.lbl_azp_contact_t_email;
					document.querySelector("#field_up_message").value = objData.data.lbl_azp_contact_t_message;
					document.querySelector("#field_up_names").value = objData.data.lbl_azp_contact_t_names;
					document.querySelector("#field_up_phone_fixed").value = objData.data.lbl_azp_contact_t_phone_fixed;
					document.querySelector("#field_up_phone_movil").value = objData.data.lbl_azp_contact_t_phone_movil;
					document.querySelector("#field_up_surnames").value = objData.data.lbl_azp_contact_t_surnames;
					document.querySelector("#field_up_country").value = objData.data.lbl_azp_contact_v_id_azp_country;
					document.querySelector("#field_up_transact").value = objData.data.lbl_azp_contact_v_id_azp_transact;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
