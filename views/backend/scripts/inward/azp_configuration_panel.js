...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_configuration_panel_id_azs_configuration_panel",
				data: "lbl_azs_configuration_panel_id_azs_configuration_panel",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_configuration_panel_m_date_created",
				data: "lbl_azs_configuration_panel_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_configuration_panel_m_date_modified",
				data: "lbl_azs_configuration_panel_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_configuration_panel_m_description",
				data: "lbl_azs_configuration_panel_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Cambios",
				id: "lbl_azs_configuration_panel_t_pnl_change",
				data: "lbl_azs_configuration_panel_t_pnl_change",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Nuevo",
				id: "lbl_azs_configuration_panel_t_pnl_create",
				data: "lbl_azs_configuration_panel_t_pnl_create",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Eliminar",
				id: "lbl_azs_configuration_panel_t_pnl_delete",
				data: "lbl_azs_configuration_panel_t_pnl_delete",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Detalles",
				id: "lbl_azs_configuration_panel_t_pnl_detail",
				data: "lbl_azs_configuration_panel_t_pnl_detail",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Correos",
				id: "lbl_azs_configuration_panel_t_pnl_email",
				data: "lbl_azs_configuration_panel_t_pnl_email",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Importar",
				id: "lbl_azs_configuration_panel_t_pnl_import",
				data: "lbl_azs_configuration_panel_t_pnl_import",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Remover",
				id: "lbl_azs_configuration_panel_t_pnl_remove",
				data: "lbl_azs_configuration_panel_t_pnl_remove",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Reportes",
				id: "lbl_azs_configuration_panel_t_pnl_report",
				data: "lbl_azs_configuration_panel_t_pnl_report",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Restaurar",
				id: "lbl_azs_configuration_panel_t_pnl_restore",
				data: "lbl_azs_configuration_panel_t_pnl_restore",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Sub Menu",
				id: "lbl_azs_configuration_panel_t_pnl_sub_menu",
				data: "lbl_azs_configuration_panel_t_pnl_sub_menu",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Actualizar",
				id: "lbl_azs_configuration_panel_t_pnl_update",
				data: "lbl_azs_configuration_panel_t_pnl_update",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Usuario",
				id: "lbl_azs_configuration_panel_u_user",
				data: "lbl_azs_configuration_panel_u_user",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_configuration_panel/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_configuration_panel/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_configuration_panel_id_azp_configuration_panel").innerHTML = objData.data.lbl_azp_configuration_panel_id_azp_configuration_panel;
					...
					document.querySelector("#lbl_azp_configuration_panel_m_date_created").innerHTML = objData.data.lbl_azp_configuration_panel_m_date_created;
					document.querySelector("#lbl_azp_configuration_panel_m_date_modified").innerHTML = objData.data.lbl_azp_configuration_panel_m_date_modified;
					document.querySelector("#lbl_azp_configuration_panel_m_description").innerHTML = objData.data.lbl_azp_configuration_panel_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_configuration_panel_t_pnl_change").innerHTML = objData.data.lbl_azp_configuration_panel_t_pnl_change;
					document.querySelector("#lbl_azp_configuration_panel_t_pnl_create").innerHTML = objData.data.lbl_azp_configuration_panel_t_pnl_create;
					document.querySelector("#lbl_azp_configuration_panel_t_pnl_delete").innerHTML = objData.data.lbl_azp_configuration_panel_t_pnl_delete;
					document.querySelector("#lbl_azp_configuration_panel_t_pnl_detail").innerHTML = objData.data.lbl_azp_configuration_panel_t_pnl_detail;
					document.querySelector("#lbl_azp_configuration_panel_t_pnl_email").innerHTML = objData.data.lbl_azp_configuration_panel_t_pnl_email;
					document.querySelector("#lbl_azp_configuration_panel_t_pnl_import").innerHTML = objData.data.lbl_azp_configuration_panel_t_pnl_import;
					document.querySelector("#lbl_azp_configuration_panel_t_pnl_remove").innerHTML = objData.data.lbl_azp_configuration_panel_t_pnl_remove;
					document.querySelector("#lbl_azp_configuration_panel_t_pnl_report").innerHTML = objData.data.lbl_azp_configuration_panel_t_pnl_report;
					document.querySelector("#lbl_azp_configuration_panel_t_pnl_restore").innerHTML = objData.data.lbl_azp_configuration_panel_t_pnl_restore;
					document.querySelector("#lbl_azp_configuration_panel_t_pnl_sub_menu").innerHTML = objData.data.lbl_azp_configuration_panel_t_pnl_sub_menu;
					document.querySelector("#lbl_azp_configuration_panel_t_pnl_update").innerHTML = objData.data.lbl_azp_configuration_panel_t_pnl_update;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_configuration_panel/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_configuration_panel/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_configuration_panel/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_configuration_panel_id_azp_configuration_panel;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_configuration_panel_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_configuration_panel_m_status;
					document.querySelector("#field_up_pnl_change").value = objData.data.lbl_azp_configuration_panel_t_pnl_change;
					document.querySelector("#field_up_pnl_create").value = objData.data.lbl_azp_configuration_panel_t_pnl_create;
					document.querySelector("#field_up_pnl_delete").value = objData.data.lbl_azp_configuration_panel_t_pnl_delete;
					document.querySelector("#field_up_pnl_detail").value = objData.data.lbl_azp_configuration_panel_t_pnl_detail;
					document.querySelector("#field_up_pnl_email").value = objData.data.lbl_azp_configuration_panel_t_pnl_email;
					document.querySelector("#field_up_pnl_import").value = objData.data.lbl_azp_configuration_panel_t_pnl_import;
					document.querySelector("#field_up_pnl_remove").value = objData.data.lbl_azp_configuration_panel_t_pnl_remove;
					document.querySelector("#field_up_pnl_report").value = objData.data.lbl_azp_configuration_panel_t_pnl_report;
					document.querySelector("#field_up_pnl_restore").value = objData.data.lbl_azp_configuration_panel_t_pnl_restore;
					document.querySelector("#field_up_pnl_sub_menu").value = objData.data.lbl_azp_configuration_panel_t_pnl_sub_menu;
					document.querySelector("#field_up_pnl_update").value = objData.data.lbl_azp_configuration_panel_t_pnl_update;
					document.querySelector("#field_up_user").value = objData.data.lbl_azp_configuration_panel_v_id_azp_user;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
