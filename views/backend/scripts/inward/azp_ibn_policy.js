...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_policy_id_azs_ibn_policy",
				data: "lbl_azs_ibn_policy_id_azs_ibn_policy",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_policy_m_date_created",
				data: "lbl_azs_ibn_policy_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_policy_m_date_modified",
				data: "lbl_azs_ibn_policy_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_policy_m_description",
				data: "lbl_azs_ibn_policy_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Nombre",
				id: "lbl_azs_ibn_policy_t_name",
				data: "lbl_azs_ibn_policy_t_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Cliente",
				id: "lbl_azs_ibn_policy_u_ibn_client",
				data: "lbl_azs_ibn_policy_u_ibn_client",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_policy_id_azp_ibn_policy").innerHTML = objData.data.lbl_azp_ibn_policy_id_azp_ibn_policy;
					...
					document.querySelector("#lbl_azp_ibn_policy_m_date_created").innerHTML = objData.data.lbl_azp_ibn_policy_m_date_created;
					document.querySelector("#lbl_azp_ibn_policy_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_policy_m_date_modified;
					document.querySelector("#lbl_azp_ibn_policy_m_description").innerHTML = objData.data.lbl_azp_ibn_policy_m_description;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_policy/restore",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_policy_id_azp_ibn_policy;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_policy_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_policy_m_status;
					document.querySelector("#field_up_ibn_client").value = objData.data.lbl_azp_ibn_policy_v_id_azp_ibn_client;
					document.querySelector("#field_up_ibn_conditional").value = objData.data.lbl_azp_ibn_policy_v_id_azp_ibn_conditional;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
