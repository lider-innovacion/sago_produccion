<?php
	...
	//------------------------------------------------
	class azproleController extends Controllers {
		public function __construct() {
			...
			$var_m_azp_authorized_permits = new m_azp_authorized_permitsModel;
			# Instanciando clases del modelo
			$var_m_azp_role = new m_azp_roleModel;
			# Instanciando clases del modelo
			...
			$var_sql = $var_m_zz_design->sql_select_azp_menu_crud_t_url($var_controller);
			# Instanciado funciones de la clase y asignando a variable
			if (true == $var_sql) { foreach ($var_sql as $key => $value) : $key_controller = $value[d_azp_menu_crud_id_azp_menu_crud]; endforeach; }
			...
			if (NULL != $var_get_method && Strings::only_letters($var_get_method)) {
				...
				switch ($var_get_method) {
					...
					case 'error':
						...
						if (true == $var_m_zz_design->sql_permits_value_error($var_controller)) {
							# Cargar en el metodo por url la plantilla con su contenido a visualizar
					...
					case 'info':
						# Control para validar el acceso a los resultados de la base de datos
						if (true == $var_m_zz_design->sql_permits_menu_value($var_controller)) {
							# Cargar en el metodo por url la plantilla con su contenido a visualizar
							echo $this->template->render('backend/inward/azp_role', array(
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_read_state' => $var_m_azp_sys_state->sql_controller_read(),

								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_btn_action' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_btn_export' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_btn_search' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_btn_visible' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_data_by_create' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_data_change' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_data_eliminate' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_data_read' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_data_remove' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_menu_value' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_module_value' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_associate' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_change' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_close' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_column_toggle' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_colvis_column' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_colvis_restore' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_copy' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_create' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_csv' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_delete' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_detail' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_email' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_error' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_excel' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_file' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_import' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_page_length' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_pdf' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_print' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_remove' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_report' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_restore' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_sub_menu' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_sync' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_template' => $var_m_azp_sys_state->sql_controller_read(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'var_ap_value_update' => $var_m_azp_sys_state->sql_controller_read(),
								...
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_platform' => $var_m_azp_role->sql_select_tc_azp_platform(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_rols' => $var_m_azp_role->sql_select_tc_azp_rols(),
