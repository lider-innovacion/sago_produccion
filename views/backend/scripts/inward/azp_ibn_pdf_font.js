...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_pdf_font_id_azs_ibn_pdf_font",
				data: "lbl_azs_ibn_pdf_font_id_azs_ibn_pdf_font",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_pdf_font_m_date_created",
				data: "lbl_azs_ibn_pdf_font_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_pdf_font_m_date_modified",
				data: "lbl_azs_ibn_pdf_font_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_pdf_font_m_description",
				data: "lbl_azs_ibn_pdf_font_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Fuente",
				id: "lbl_azs_ibn_pdf_font_t_family",
				data: "lbl_azs_ibn_pdf_font_t_family",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Estilo",
				id: "lbl_azs_ibn_pdf_font_t_style",
				data: "lbl_azs_ibn_pdf_font_t_style",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Tamaño",
				id: "lbl_azs_ibn_pdf_font_t_size",
				data: "lbl_azs_ibn_pdf_font_t_size",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "DIT",
				id: "lbl_azs_ibn_pdf_font_u_ibn_interface_dit",
				data: "lbl_azs_ibn_pdf_font_u_ibn_interface_dit",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_pdf_font/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_pdf_font/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_pdf_font_id_azp_ibn_pdf_font").innerHTML = objData.data.lbl_azp_ibn_pdf_font_id_azp_ibn_pdf_font;
					...
					document.querySelector("#lbl_azp_ibn_pdf_font_m_date_created").innerHTML = objData.data.lbl_azp_ibn_pdf_font_m_date_created;
					document.querySelector("#lbl_azp_ibn_pdf_font_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_pdf_font_m_date_modified;
					document.querySelector("#lbl_azp_ibn_pdf_font_m_description").innerHTML = objData.data.lbl_azp_ibn_pdf_font_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_ibn_pdf_font_t_family").innerHTML = objData.data.lbl_azp_ibn_pdf_font_t_family;
					document.querySelector("#lbl_azp_ibn_pdf_font_t_size").innerHTML = objData.data.lbl_azp_ibn_pdf_font_t_size;
					document.querySelector("#lbl_azp_ibn_pdf_font_t_style").innerHTML = objData.data.lbl_azp_ibn_pdf_font_t_style;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_pdf_font/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_pdf_font/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_pdf_font/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_pdf_font_id_azp_ibn_pdf_font;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_pdf_font_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_pdf_font_m_status;
					document.querySelector("#field_up_family").value = objData.data.lbl_azp_ibn_pdf_font_t_family;
					document.querySelector("#field_up_size").value = objData.data.lbl_azp_ibn_pdf_font_t_size;
					document.querySelector("#field_up_style").value = objData.data.lbl_azp_ibn_pdf_font_t_style;
					document.querySelector("#field_up_ibn_interface_dit").value = objData.data.lbl_azp_ibn_pdf_font_v_id_azp_ibn_interface_dit;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
