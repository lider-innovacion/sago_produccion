<?php
	...
	//------------------------------------------------
	final class m_azp_gsc_email_requestModel extends Models implements OCREND {
		/*=========================================================================================================================*/
		...
		final public function sql_controller_by_create() {
			...
			return $this->db->query("
				SELECT
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_id_azp_gsc_email_request . " AS 'lbl_azp_gsc_email_request_id_azp_gsc_email_request',
					tc_azp_user_created." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_created',
					tc_azp_user_modified." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_modified',
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_date_created . " AS 'lbl_azp_gsc_email_request_m_date_created',
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_date_modified . " AS 'lbl_azp_gsc_email_request_m_date_modified',
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_description . " AS 'lbl_azp_gsc_email_request_m_description',
					tc_azp_sys_level." . d_azp_sys_level_t_name . " AS 'lbl_azp_sys_level_t_name',
					tc_azp_sys_state." . d_azp_sys_state_t_name . " AS 'lbl_azp_sys_state_t_name',
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_t_email . " AS 'lbl_azp_gsc_email_request_t_email',
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_t_names . " AS 'lbl_azp_gsc_email_request_t_names',
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_t_surnames . " AS 'lbl_azp_gsc_email_request_t_surnames',
				...
				FROM " . t_azp_gsc_email_request . " tc_azp_gsc_email_request
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_by_created . "
						= tc_azp_user_created." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_user . " tc_azp_user_modified
					ON tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_by_modified . "
						= tc_azp_user_modified." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_sys_level . " tc_azp_sys_level
					ON tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_level . "
						= tc_azp_sys_level." . d_azp_sys_level_t_value . "
				INNER JOIN " . t_azp_sys_state . " tc_azp_sys_state
					ON tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_status . "
						= tc_azp_sys_state." . d_azp_sys_state_t_value . "
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_fct_client . " tc_azp_fct_client
					ON tc_azp_gsc_email_request." . d_azp_gsc_email_request_v_id_azp_fct_client . "
						= tc_azp_fct_client." . d_azp_fct_client_id_azp_fct_client . "
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_fct_sector . " tc_azp_fct_sector
					ON tc_azp_gsc_email_request." . d_azp_gsc_email_request_v_id_azp_fct_sector . "
						= tc_azp_fct_sector." . d_azp_fct_sector_id_azp_fct_sector . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "'
					AND tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_deleted . " = '1'
				ORDER BY tc_azp_gsc_email_request." . d_azp_gsc_email_request_id_azp_gsc_email_request . " ASC
			");
		}
		...
		final public function sql_controller_change() {
			...
			return $this->db->query("
				SELECT
					tc_azs_gsc_email_request." . d_azs_gsc_email_request_id_azs_gsc_email_request . " AS 'lbl_azs_gsc_email_request_id_azs_gsc_email_request',
					tc_azs_gsc_email_request." . d_azs_gsc_email_request_m_date_modified . " AS 'lbl_azs_gsc_email_request_m_date_modified',
					tc_azp_user_created." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_created',
					tc_azp_user_modified." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_modified',
					tc_azs_gsc_email_request." . d_azs_gsc_email_request_m_date_created . " AS 'lbl_azs_gsc_email_request_m_date_created',
					tc_azs_gsc_email_request." . d_azs_gsc_email_request_m_date_modified . " AS 'lbl_azs_gsc_email_request_m_date_modified',
					tc_azs_gsc_email_request." . d_azs_gsc_email_request_m_description . " AS 'lbl_azs_gsc_email_request_m_description',
					tc_azp_sys_level." . d_azp_sys_level_t_name . " AS 'lbl_azp_sys_level_t_name',
					tc_azp_sys_state." . d_azp_sys_state_t_name . " AS 'lbl_azp_sys_state_t_name',
					tc_azs_gsc_email_request." . d_azs_gsc_email_request_t_email . " AS 'lbl_azs_gsc_email_request_t_email',
					tc_azs_gsc_email_request." . d_azs_gsc_email_request_t_names . " AS 'lbl_azs_gsc_email_request_t_names',
					tc_azs_gsc_email_request." . d_azs_gsc_email_request_t_surnames . " AS 'lbl_azs_gsc_email_request_t_surnames',
					tc_azs_gsc_email_request." . d_azs_gsc_email_request_u_fct_client . " AS 'lbl_azs_gsc_email_request_u_fct_client',
					tc_azs_gsc_email_request." . d_azs_gsc_email_request_u_fct_sector . " AS 'lbl_azs_gsc_email_request_u_fct_sector'
				FROM " . t_azs_gsc_email_request . " tc_azs_gsc_email_request
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azs_gsc_email_request." . d_azs_gsc_email_request_m_by_created . "
						= tc_azp_user_created." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_user . " tc_azp_user_modified
					ON tc_azs_gsc_email_request." . d_azs_gsc_email_request_m_by_modified . "
						= tc_azp_user_modified." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_sys_level . " tc_azp_sys_level
					ON tc_azs_gsc_email_request." . d_azs_gsc_email_request_m_level . "
						= tc_azp_sys_level." . d_azp_sys_level_t_value . "
				INNER JOIN " . t_azp_sys_state . " tc_azp_sys_state
					ON tc_azs_gsc_email_request." . d_azs_gsc_email_request_m_status . "
						= tc_azp_sys_state." . d_azp_sys_state_t_value . "
				-- ---------------------------------------------------------------
				WHERE tc_azs_gsc_email_request." . d_azs_gsc_email_request_v_id_azp_gsc_email_request . " = '" . $this->id . "'
				ORDER BY tc_azs_gsc_email_request." . d_azs_gsc_email_request_m_date_modified . " DESC
			");
		}
		...
		final public function sql_controller_delete() : array {
			...
			$var_sql = $this->db->query("
				SELECT * FROM " . t_azp_gsc_email_request . "
				WHERE " . d_azp_gsc_email_request_id_azp_gsc_email_request . " = '" . $this->id . "'
					AND " . d_azp_gsc_email_request_m_deleted . " = '2'
				LIMIT 1
			");
			...
			if (false != $var_result) {
				...
				Func::redir(URL . url_query_azp_gsc_email_request);
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_fct_sector . " tc_azp_fct_sector
					ON tc_azp_gsc_email_request." . d_azp_gsc_email_request_v_id_azp_fct_sector . "
						= tc_azp_fct_sector." . d_azp_fct_sector_id_azp_fct_sector . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_gsc_email_request." . d_azp_gsc_email_request_id_azp_gsc_email_request . " = '" . $this->id . "'
					AND tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_deleted . " = '1'
				LIMIT 1
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_fct_sector . " tc_azp_fct_sector
					ON tc_azp_gsc_email_request." . d_azp_gsc_email_request_v_id_azp_fct_sector . "
						= tc_azp_fct_sector." . d_azp_fct_sector_id_azp_fct_sector . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_deleted . " = '3'
				ORDER BY tc_azp_gsc_email_request." . d_azp_gsc_email_request_id_azp_gsc_email_request . " ASC
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_fct_sector . " tc_azp_fct_sector
					ON tc_azp_gsc_email_request." . d_azp_gsc_email_request_v_id_azp_fct_sector . "
						= tc_azp_fct_sector." . d_azp_fct_sector_id_azp_fct_sector . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_deleted . " = '1'
				ORDER BY tc_azp_gsc_email_request." . d_azp_gsc_email_request_id_azp_gsc_email_request . " ASC
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_fct_sector . " tc_azp_fct_sector
					ON tc_azp_gsc_email_request." . d_azp_gsc_email_request_v_id_azp_fct_sector . "
						= tc_azp_fct_sector." . d_azp_fct_sector_id_azp_fct_sector . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_deleted . " = '2'
				ORDER BY tc_azp_gsc_email_request." . d_azp_gsc_email_request_id_azp_gsc_email_request . " ASC
			");
		}
		...
		final public function sql_controller_update() {
			...
			return $this->db->query("
				SELECT
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_id_azp_gsc_email_request . " AS 'lbl_azp_gsc_email_request_id_azp_gsc_email_request',
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_by_created . " AS 'lbl_azp_gsc_email_request_m_by_created',
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_by_modified . " AS 'lbl_azp_gsc_email_request_m_by_modified',
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_date_created . " AS 'lbl_azp_gsc_email_request_m_date_created',
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_date_modified . " AS 'lbl_azp_gsc_email_request_m_date_modified',
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_description . " AS 'lbl_azp_gsc_email_request_m_description',
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_level . " AS 'lbl_azp_gsc_email_request_m_level',
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_status . " AS 'lbl_azp_gsc_email_request_m_status',
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_t_email . " AS 'lbl_azp_gsc_email_request_t_email',
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_t_names . " AS 'lbl_azp_gsc_email_request_t_names',
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_t_surnames . " AS 'lbl_azp_gsc_email_request_t_surnames',
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_v_id_azp_fct_client . " AS 'lbl_azp_gsc_email_request_v_id_azp_fct_client',
					tc_azp_gsc_email_request." . d_azp_gsc_email_request_v_id_azp_fct_sector . " AS 'lbl_azp_gsc_email_request_v_id_azp_fct_sector'
				FROM " . t_azp_gsc_email_request . " tc_azp_gsc_email_request
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azp_gsc_email_request." . d_azp_gsc_email_request_m_by_created . "
		...
		final private function error_sql_gsc_email_request_delete(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				$sql_id = $this->db->select('*', t_azp_gsc_email_request, d_azp_gsc_email_request_id_azp_gsc_email_request . " = '" . $empty_id . "'");
				...
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select('*', t_azp_gsc_email_request, d_azp_gsc_email_request_id_azp_gsc_email_request . " = '" . $empty_id . "' AND " . d_azp_gsc_email_request_m_deleted . " = '2'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (false == $sql_id) {
					# Verificar si el resultado devuleto no existe para asignar un valor especifico
					if (strtolower($sql_id) == '') { $sql_id[0][0] = 0; }
				...
				$sql_session = $this->db->select('*', t_azp_gsc_email_request, d_azp_gsc_email_request_id_azp_gsc_email_request . " = '" . $empty_id . "' AND " . d_azp_gsc_email_request_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "' AND " . d_azp_gsc_email_request_m_level . " = '1'");
				# Verificar si el registro creado es igual el valor del campo nivel al valor dos
				$sql_level = $this->db->select('*', t_azp_gsc_email_request, d_azp_gsc_email_request_id_azp_gsc_email_request . " = '" . $empty_id . "' AND " . d_azp_gsc_email_request_m_level . " = '2'");
				# Verificar si el resultado de la sql es verdadero o falso
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_gsc_email_request_delete(array $data) : array {
			$var_error = $this->error_sql_azp_gsc_email_request_delete($data);
			...
			if (!isset($_SESSION[SESS_APP_ID])) {
				...
				$var_array = array(d_azp_gsc_email_request_m_deleted => '3',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_gsc_email_request, $var_array, d_azp_gsc_email_request_id_azp_gsc_email_request . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
		...
		final private function error_sql_azp_gsc_email_request_insert(array $data) {
			try {
				#-------------------------------------------------------------------------#
		...
		/*=========================================================================================================================*/
		# Query Sql Insert
		final public function sql_azp_gsc_email_request_insert(array $data) : array {
			$var_error = $this->error_sql_azp_gsc_email_request_insert($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(
					d_azp_gsc_email_request_m_by_created => $_SESSION[SESS_APP_ID],
					d_azp_gsc_email_request_m_by_modified => $_SESSION[SESS_APP_ID],
					d_azp_gsc_email_request_m_date_created => DATE_HOUR,
					d_azp_gsc_email_request_m_date_modified => DATE_HOUR,
					d_azp_gsc_email_request_m_deleted => '1',
					d_azp_gsc_email_request_m_description => $empty_description,
					d_azp_gsc_email_request_m_level => '2',
					d_azp_gsc_email_request_m_status => '1',
					d_azp_gsc_email_request_m_temp => '2',
					d_azp_gsc_email_request_t_email => strtolower($empty_email),
					d_azp_gsc_email_request_t_names => ucwords(strtolower($empty_names)),
					d_azp_gsc_email_request_t_surnames => ucwords(strtolower($empty_surnames)),
					d_azp_gsc_email_request_v_id_azp_fct_client => $empty_client,
					d_azp_gsc_email_request_v_id_azp_fct_sector => $empty_sector,
				);
				# Query Sql Insert: Registrar valores en la tabla segun sus campos
				$this->db->insert(t_azp_gsc_email_request, $var_array);
				#-------------------------------------------------------------------------#
				# Verificar en la base de datos si existen el registro
				$var_sql = $this->db->select('*', t_azp_gsc_email_request, d_azp_gsc_email_request_m_temp . " = '2'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (true == $var_sql) { foreach ($var_sql as $key => $value): $var_client = $value[d_azp_gsc_email_request_v_id_azp_fct_client]; endforeach; } else { $var_client = 0; }
				#-------------------------------------------------------------------------#
				# Verificar en la base de datos si existen el registro
				...
				if (true == $var_sql) {
					...
					foreach ($var_sql as $key => $value):
						# Array para asignar argumentos o valores a los elementos
						$var_array = array(d_azp_gsc_email_request_t_name => $value[d_azp_fct_client_t_name],);
						# Query Sql Insert: Insertar datos en la tabla con sus campos respectivos y asignados
						$this->db->update(t_azp_gsc_email_request, $var_array, d_azp_gsc_email_request_m_temp . " = '2'");
					endforeach;
				}*/
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_gsc_email_request_m_temp => '1',);
				# Query Sql Insert: Insertar datos en la tabla con sus campos respectivos y asignados
				$this->db->update(t_azp_gsc_email_request, $var_array, d_azp_gsc_email_request_m_temp . " = '2'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_gsc_email_request_remove(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select('*', t_azp_gsc_email_request, d_azp_gsc_email_request_id_azp_gsc_email_request . " = '" . $empty_id . "' AND " . d_azp_gsc_email_request_m_deleted . " = '1'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (false == $sql_id) {
					# Verificar si el resultado devuleto no existe para asignar un valor especifico
					if (strtolower($sql_id) == '') { $sql_id[0][0] = 0; }
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_gsc_email_request_remove(array $data) : array {
			$var_error = $this->error_sql_azp_gsc_email_request_remove($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_gsc_email_request_m_deleted => '2',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_gsc_email_request, $var_array, d_azp_gsc_email_request_id_azp_gsc_email_request . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_gsc_email_request_restore(array $data) {
			try {
				#-------------------------------------------------------------------------#
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_gsc_email_request_restore(array $data) : array {
			$var_error = $this->error_sql_azp_gsc_email_request_restore($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_gsc_email_request_m_deleted => '1',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_gsc_email_request, $var_array, d_azp_gsc_email_request_id_azp_gsc_email_request . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_gsc_email_request_update(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				/*$sql_name = $this->db->select(d_azp_gsc_email_request_t_name, t_azp_gsc_email_request, d_azp_gsc_email_request_id_azp_gsc_email_request . " != '" . $empty_id . "' AND " . d_azp_gsc_email_request_t_name . " = '" . $empty_name . "'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (true == $sql_name) {
					# Verificiar si el valor recibido de la sql es diferente del digitado
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_gsc_email_request_update(array $data) : array {
			$var_error = $this->error_sql_azp_gsc_email_request_update($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				$var_sql_select = $this->db->select('*', t_azp_gsc_email_request, d_azp_gsc_email_request_id_azp_gsc_email_request . " = '" . $empty_id . "'");
				# Validar si la sentencia query ejecutada es correcta y no falsa
				if (false != $var_sql_select) {
					# El constructor foreach proporciona un modo sencillo de iterar sobre arrays.
					foreach ($var_sql_select as $key_sql_select):
						$var_array = array(
							d_azs_gsc_email_request_m_by_created => $_SESSION[SESS_APP_ID],
							d_azs_gsc_email_request_m_by_modified => $_SESSION[SESS_APP_ID],
							d_azs_gsc_email_request_m_date_created => DATE_HOUR,
							d_azs_gsc_email_request_m_date_modified => DATE_HOUR,
							d_azs_gsc_email_request_m_deleted => $key_sql_select[d_azp_gsc_email_request_m_deleted],
							d_azs_gsc_email_request_m_description => $key_sql_select[d_azp_gsc_email_request_m_description],
							d_azs_gsc_email_request_m_level => $key_sql_select[d_azp_gsc_email_request_m_level],
							d_azs_gsc_email_request_m_status => $key_sql_select[d_azp_gsc_email_request_m_status],
							d_azs_gsc_email_request_m_temp => $key_sql_select[d_azp_gsc_email_request_m_temp],
							d_azs_gsc_email_request_t_email => strtolower($key_sql_select[d_azp_gsc_email_request_t_email]),
							d_azs_gsc_email_request_t_names => ucwords(strtolower($key_sql_select[d_azp_gsc_email_request_t_names])),
							d_azs_gsc_email_request_t_surnames => ucwords(strtolower($key_sql_select[d_azp_gsc_email_request_t_surnames])),
							d_azs_gsc_email_request_u_fct_client => $key_sql_select[d_azp_gsc_email_request_v_id_azp_fct_client],
							d_azs_gsc_email_request_u_fct_sector => $key_sql_select[d_azp_gsc_email_request_v_id_azp_fct_sector],
							d_azs_gsc_email_request_v_id_azp_gsc_email_request => $empty_id,
						);
						# Query Sql Insert: Insertar datos en la tabla con sus campos respectivos y asignados
						$this->db->insert(t_azs_gsc_email_request, $var_array);
					endforeach;
				}
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(
					...
					d_azp_gsc_email_request_m_date_modified => DATE_HOUR,
					d_azp_gsc_email_request_m_description => $empty_description,
					d_azp_gsc_email_request_m_status => $empty_state,
					d_azp_gsc_email_request_t_email => strtolower($empty_email),
					d_azp_gsc_email_request_t_names => ucwords(strtolower($empty_names)),
					d_azp_gsc_email_request_t_surnames => ucwords(strtolower($empty_surnames)),
					d_azp_gsc_email_request_v_id_azp_fct_client => $empty_client,
				...
				#-------------------------------------------------------------------------#
				# Verificar en la base de datos si existen el registro
				$var_sql = $this->db->select('*', t_azp_gsc_email_request, d_azp_gsc_email_request_id_azp_gsc_email_request . " = '" . $empty_id . "'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (true == $var_sql) { foreach ($var_sql as $key => $value): $var_client = $value[d_azp_gsc_email_request_v_id_azp_fct_client]; endforeach; } else { $var_client = 0; }
				#-------------------------------------------------------------------------#
				# Verificar en la base de datos si existen el registro
