<?php
	...
	//------------------------------------------------
	final class m_azp_fct_scaleModel extends Models implements OCREND {
		/*=========================================================================================================================*/
		...
		final public function sql_controller_by_create() {
			...
			return $this->db->query("
				SELECT
					tc_azp_fct_scale." . d_azp_fct_scale_id_azp_fct_scale . " AS 'lbl_azp_fct_scale_id_azp_fct_scale',
					tc_azp_user_created." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_created',
					tc_azp_user_modified." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_modified',
					tc_azp_fct_scale." . d_azp_fct_scale_m_date_created . " AS 'lbl_azp_fct_scale_m_date_created',
					tc_azp_fct_scale." . d_azp_fct_scale_m_date_modified . " AS 'lbl_azp_fct_scale_m_date_modified',
					tc_azp_fct_scale." . d_azp_fct_scale_m_description . " AS 'lbl_azp_fct_scale_m_description',
				...
				FROM " . t_azp_fct_scale . " tc_azp_fct_scale
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azp_fct_scale." . d_azp_fct_scale_m_by_created . "
						= tc_azp_user_created." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_user . " tc_azp_user_modified
					ON tc_azp_fct_scale." . d_azp_fct_scale_m_by_modified . "
						= tc_azp_user_modified." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_sys_level . " tc_azp_sys_level
					ON tc_azp_fct_scale." . d_azp_fct_scale_m_level . "
						= tc_azp_sys_level." . d_azp_sys_level_t_value . "
				INNER JOIN " . t_azp_sys_state . " tc_azp_sys_state
					ON tc_azp_fct_scale." . d_azp_fct_scale_m_status . "
						= tc_azp_sys_state." . d_azp_sys_state_t_value . "
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_fct_client . " tc_azp_fct_client
					ON tc_azp_fct_scale." . d_azp_fct_scale_v_id_azp_fct_client . "
						= tc_azp_fct_client." . d_azp_fct_client_id_azp_fct_client . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_fct_scale." . d_azp_fct_scale_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "'
					AND tc_azp_fct_scale." . d_azp_fct_scale_m_deleted . " = '1'
					AND tc_azp_fct_scale." . d_azp_fct_scale_t_name . " != 'SIN_ESCALA'
				ORDER BY tc_azp_fct_scale." . d_azp_fct_scale_id_azp_fct_scale . " ASC
			");
		}
		...
		final public function sql_controller_change() {
			...
			return $this->db->query("
				SELECT
					tc_azs_fct_scale." . d_azs_fct_scale_id_azs_fct_scale . " AS 'lbl_azs_fct_scale_id_azs_fct_scale',
					tc_azs_fct_scale." . d_azs_fct_scale_m_date_modified . " AS 'lbl_azs_fct_scale_m_date_modified',
					tc_azp_user_created." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_created',
					tc_azp_user_modified." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_modified',
					tc_azs_fct_scale." . d_azs_fct_scale_m_date_created . " AS 'lbl_azs_fct_scale_m_date_created',
					tc_azs_fct_scale." . d_azs_fct_scale_m_date_modified . " AS 'lbl_azs_fct_scale_m_date_modified',
					tc_azs_fct_scale." . d_azs_fct_scale_m_description . " AS 'lbl_azs_fct_scale_m_description',
					tc_azp_sys_level." . d_azp_sys_level_t_name . " AS 'lbl_azp_sys_level_t_name',
					tc_azp_sys_state." . d_azp_sys_state_t_name . " AS 'lbl_azp_sys_state_t_name',
					tc_azs_fct_scale." . d_azs_fct_scale_t_name . " AS 'lbl_azs_fct_scale_t_name'
				FROM " . t_azs_fct_scale . " tc_azs_fct_scale
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azs_fct_scale." . d_azs_fct_scale_m_by_created . "
						= tc_azp_user_created." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_user . " tc_azp_user_modified
					ON tc_azs_fct_scale." . d_azs_fct_scale_m_by_modified . "
						= tc_azp_user_modified." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_sys_level . " tc_azp_sys_level
					ON tc_azs_fct_scale." . d_azs_fct_scale_m_level . "
						= tc_azp_sys_level." . d_azp_sys_level_t_value . "
				INNER JOIN " . t_azp_sys_state . " tc_azp_sys_state
					ON tc_azs_fct_scale." . d_azs_fct_scale_m_status . "
						= tc_azp_sys_state." . d_azp_sys_state_t_value . "
				-- ---------------------------------------------------------------
				WHERE tc_azs_fct_scale." . d_azs_fct_scale_v_id_azp_fct_scale . " = '" . $this->id . "'
				ORDER BY tc_azs_fct_scale." . d_azs_fct_scale_m_date_modified . " DESC
			");
		}
		...
		final public function sql_controller_delete() : array {
			...
			$var_sql = $this->db->query("
				SELECT * FROM " . t_azp_fct_scale . "
				WHERE " . d_azp_fct_scale_id_azp_fct_scale . " = '" . $this->id . "'
					AND " . d_azp_fct_scale_m_deleted . " = '2'
				LIMIT 1
			");
			...
			if (false != $var_result) {
				...
				Func::redir(URL . url_query_azp_fct_scale);
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_fct_client . " tc_azp_fct_client
					ON tc_azp_fct_scale." . d_azp_fct_scale_v_id_azp_fct_client . "
						= tc_azp_fct_client." . d_azp_fct_client_id_azp_fct_client . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_fct_scale." . d_azp_fct_scale_id_azp_fct_scale . " = '" . $this->id . "'
					AND tc_azp_fct_scale." . d_azp_fct_scale_m_deleted . " = '1'
					AND tc_azp_fct_scale." . d_azp_fct_scale_t_name . " != 'SIN_ESCALA'
				LIMIT 1
			");
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_fct_client . " tc_azp_fct_client
					ON tc_azp_fct_scale." . d_azp_fct_scale_v_id_azp_fct_client . "
						= tc_azp_fct_client." . d_azp_fct_client_id_azp_fct_client . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_fct_scale." . d_azp_fct_scale_m_deleted . " = '3'
					AND tc_azp_fct_scale." . d_azp_fct_scale_t_name . " != 'SIN_ESCALA'
				ORDER BY tc_azp_fct_scale." . d_azp_fct_scale_id_azp_fct_scale . " ASC
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_fct_client . " tc_azp_fct_client
					ON tc_azp_fct_scale." . d_azp_fct_scale_v_id_azp_fct_client . "
						= tc_azp_fct_client." . d_azp_fct_client_id_azp_fct_client . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_fct_scale." . d_azp_fct_scale_m_deleted . " = '1'
					AND tc_azp_fct_scale." . d_azp_fct_scale_t_name . " != 'SIN_ESCALA'
				ORDER BY tc_azp_fct_scale." . d_azp_fct_scale_id_azp_fct_scale . " ASC
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_fct_client . " tc_azp_fct_client
					ON tc_azp_fct_scale." . d_azp_fct_scale_v_id_azp_fct_client . "
						= tc_azp_fct_client." . d_azp_fct_client_id_azp_fct_client . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_fct_scale." . d_azp_fct_scale_m_deleted . " = '2'
					AND tc_azp_fct_scale." . d_azp_fct_scale_t_name . " != 'SIN_ESCALA'
				ORDER BY tc_azp_fct_scale." . d_azp_fct_scale_id_azp_fct_scale . " ASC
			");
		}
		...
		final public function sql_controller_update() {
			...
			return $this->db->query("
				SELECT
					tc_azp_fct_scale." . d_azp_fct_scale_id_azp_fct_scale . " AS 'lbl_azp_fct_scale_id_azp_fct_scale',
					tc_azp_fct_scale." . d_azp_fct_scale_m_by_created . " AS 'lbl_azp_fct_scale_m_by_created',
					tc_azp_fct_scale." . d_azp_fct_scale_m_by_modified . " AS 'lbl_azp_fct_scale_m_by_modified',
					tc_azp_fct_scale." . d_azp_fct_scale_m_date_created . " AS 'lbl_azp_fct_scale_m_date_created',
					tc_azp_fct_scale." . d_azp_fct_scale_m_date_modified . " AS 'lbl_azp_fct_scale_m_date_modified',
					tc_azp_fct_scale." . d_azp_fct_scale_m_description . " AS 'lbl_azp_fct_scale_m_description',
					tc_azp_fct_scale." . d_azp_fct_scale_m_level . " AS 'lbl_azp_fct_scale_m_level',
					tc_azp_fct_scale." . d_azp_fct_scale_m_status . " AS 'lbl_azp_fct_scale_m_status',
					tc_azp_fct_scale." . d_azp_fct_scale_t_max . " AS 'lbl_azp_fct_scale_t_max',
					tc_azp_fct_scale." . d_azp_fct_scale_t_min . " AS 'lbl_azp_fct_scale_t_min',
					tc_azp_fct_scale." . d_azp_fct_scale_t_name . " AS 'lbl_azp_fct_scale_t_name',
					tc_azp_fct_scale." . d_azp_fct_scale_v_id_azp_fct_client . " AS 'lbl_azp_fct_scale_v_id_azp_fct_client'
				FROM " . t_azp_fct_scale . " tc_azp_fct_scale
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azp_fct_scale." . d_azp_fct_scale_m_by_created . "
		...
		final private function error_sql_fct_scale_delete(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				$sql_id = $this->db->select('*', t_azp_fct_scale, d_azp_fct_scale_id_azp_fct_scale . " = '" . $empty_id . "'");
				...
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select('*', t_azp_fct_scale, d_azp_fct_scale_id_azp_fct_scale . " = '" . $empty_id . "' AND " . d_azp_fct_scale_m_deleted . " = '2'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (false == $sql_id) {
					# Verificar si el resultado devuleto no existe para asignar un valor especifico
					if (strtolower($sql_id) == '') { $sql_id[0][0] = 0; }
				...
				$sql_session = $this->db->select('*', t_azp_fct_scale, d_azp_fct_scale_id_azp_fct_scale . " = '" . $empty_id . "' AND " . d_azp_fct_scale_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "' AND " . d_azp_fct_scale_m_level . " = '1'");
				# Verificar si el registro creado es igual el valor del campo nivel al valor dos
				$sql_level = $this->db->select('*', t_azp_fct_scale, d_azp_fct_scale_id_azp_fct_scale . " = '" . $empty_id . "' AND " . d_azp_fct_scale_m_level . " = '2'");
				# Verificar si el resultado de la sql es verdadero o falso
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_fct_scale_delete(array $data) : array {
			$var_error = $this->error_sql_azp_fct_scale_delete($data);
			...
			if (!isset($_SESSION[SESS_APP_ID])) {
				...
				$var_array = array(d_azp_fct_scale_m_deleted => '3',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_fct_scale, $var_array, d_azp_fct_scale_id_azp_fct_scale . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
		...
		final private function error_sql_azp_fct_scale_insert(array $data) {
			try {
				#-------------------------------------------------------------------------#
				if (!isset($data['field_cr_description'])) { throw new Exception('<b>Error:</b> El campo de descripcion esta prohibido modificar.'); }
				if (!isset($data['field_cr_max'])) { throw new Exception('<b>Error:</b> El campo de max esta prohibido modificar.'); }
				if (!isset($data['field_cr_min'])) { throw new Exception('<b>Error:</b> El campo de min esta prohibido modificar.'); }
				if (!isset($data['field_cr_name'])) { throw new Exception('<b>Error:</b> El campo de descripciones esta prohibido modificar.'); }
				...
				$empty_max = $this->db->scape($data['field_cr_max']);
				$empty_min = $this->db->scape($data['field_cr_min']);
		...
		/*=========================================================================================================================*/
		# Query Sql Insert
		final public function sql_azp_fct_scale_insert(array $data) : array {
			$var_error = $this->error_sql_azp_fct_scale_insert($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_fct_scale_remove(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select('*', t_azp_fct_scale, d_azp_fct_scale_id_azp_fct_scale . " = '" . $empty_id . "' AND " . d_azp_fct_scale_m_deleted . " = '1'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (false == $sql_id) {
					# Verificar si el resultado devuleto no existe para asignar un valor especifico
					if (strtolower($sql_id) == '') { $sql_id[0][0] = 0; }
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_fct_scale_remove(array $data) : array {
			$var_error = $this->error_sql_azp_fct_scale_remove($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_fct_scale_m_deleted => '2',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_fct_scale, $var_array, d_azp_fct_scale_id_azp_fct_scale . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_fct_scale_restore(array $data) {
			try {
				#-------------------------------------------------------------------------#
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_fct_scale_restore(array $data) : array {
			$var_error = $this->error_sql_azp_fct_scale_restore($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_fct_scale_m_deleted => '1',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_fct_scale, $var_array, d_azp_fct_scale_id_azp_fct_scale . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_fct_scale_update(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				#-------------------------------------------------------------------------#
				if (!isset($data['field_up_max'])) { throw new Exception('<b>Error:</b> El campo de max esta prohibido modificar.'); }
				if (!isset($data['field_up_min'])) { throw new Exception('<b>Error:</b> El campo de min esta prohibido modificar.'); }
				if (!isset($data['field_up_name'])) { throw new Exception('<b>Error:</b> El campo de descripciones esta prohibido modificar.'); }
				if (!isset($data['field_up_client'])) { throw new Exception('<b>Error:</b> El campo de cliente esta prohibido modificar.'); }
				#-------------------------------------------------------------------------#
				$empty_max = $this->db->scape($data['field_up_max']);
				$empty_min = $this->db->scape($data['field_up_min']);
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_fct_scale_update(array $data) : array {
			$var_error = $this->error_sql_azp_fct_scale_update($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				$var_sql_select = $this->db->select('*', t_azp_fct_scale, d_azp_fct_scale_id_azp_fct_scale . " = '" . $empty_id . "'");
				# Validar si la sentencia query ejecutada es correcta y no falsa
				if (false != $var_sql_select) {
					# El constructor foreach proporciona un modo sencillo de iterar sobre arrays.
					foreach ($var_sql_select as $key_sql_select):
						$var_array = array(
							d_azs_fct_scale_m_by_created => $_SESSION[SESS_APP_ID],
							d_azs_fct_scale_m_by_modified => $_SESSION[SESS_APP_ID],
							d_azs_fct_scale_m_date_created => DATE_HOUR,
							d_azs_fct_scale_m_date_modified => DATE_HOUR,
							d_azs_fct_scale_m_deleted => $key_sql_select[d_azp_fct_scale_m_deleted],
							d_azs_fct_scale_m_description => $key_sql_select[d_azp_fct_scale_m_description],
							d_azs_fct_scale_m_level => $key_sql_select[d_azp_fct_scale_m_level],
							d_azs_fct_scale_m_status => $key_sql_select[d_azp_fct_scale_m_status],
							d_azs_fct_scale_m_temp => $key_sql_select[d_azp_fct_scale_m_temp],
							d_azs_fct_scale_t_max => strtoupper($key_sql_select[d_azp_fct_scale_t_max]),
							d_azs_fct_scale_t_min => strtoupper($key_sql_select[d_azp_fct_scale_t_min]),
							d_azs_fct_scale_t_name => strtoupper($key_sql_select[d_azp_fct_scale_t_name]),
							d_azs_fct_scale_u_fct_client => strtoupper($key_sql_select[d_azp_fct_scale_v_id_azp_fct_client]),
							d_azs_fct_scale_v_id_azp_fct_scale => $empty_id,
						);
						# Query Sql Insert: Insertar datos en la tabla con sus campos respectivos y asignados
						$this->db->insert(t_azs_fct_scale, $var_array);
					endforeach;
				}
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(
					...
					d_azp_fct_scale_m_date_modified => DATE_HOUR,
					d_azp_fct_scale_m_description => $empty_description,
					d_azp_fct_scale_m_status => $empty_state,
					d_azp_fct_scale_t_max => strtoupper($empty_max),
					d_azp_fct_scale_t_min => strtoupper($empty_min),
					d_azp_fct_scale_t_name => strtoupper($empty_name),
					d_azp_fct_scale_v_id_azp_fct_client => strtoupper($empty_client),
		...
		final public function sql_select_tc_azp_fct_client() {
			...
			return $this->db->select('*', t_azp_fct_client,
				...
				d_azp_fct_client_m_status . " = '1' ORDER BY " .
				d_azp_fct_client_t_name . " ASC"
			);
		}
