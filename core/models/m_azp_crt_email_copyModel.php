<?php
	...
	//------------------------------------------------
	final class m_azp_crt_email_copyModel extends Models implements OCREND {
		/*=========================================================================================================================*/
		...
		final public function sql_controller_by_create() {
			...
			return $this->db->query("
				...
				-- ---------------------------------------------------------------
				WHERE tc_azp_crt_email_copy." . d_azp_crt_email_copy_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "'
					AND tc_azp_crt_email_copy." . d_azp_crt_email_copy_m_deleted . " = '1'
		...
		final public function sql_controller_change() {
			...
			return $this->db->query("
				SELECT
					tc_azs_crt_email_copy." . d_azs_crt_email_copy_id_azs_crt_email_copy . " AS 'lbl_azs_crt_email_copy_id_azs_crt_email_copy',
					tc_azs_crt_email_copy." . d_azs_crt_email_copy_m_date_modified . " AS 'lbl_azs_crt_email_copy_m_date_modified',
					tc_azp_user_created." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_created',
					tc_azp_user_modified." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_modified',
					tc_azs_crt_email_copy." . d_azs_crt_email_copy_m_date_created . " AS 'lbl_azs_crt_email_copy_m_date_created',
					tc_azs_crt_email_copy." . d_azs_crt_email_copy_m_date_modified . " AS 'lbl_azs_crt_email_copy_m_date_modified',
					tc_azs_crt_email_copy." . d_azs_crt_email_copy_m_description . " AS 'lbl_azs_crt_email_copy_m_description',
					tc_azp_sys_level." . d_azp_sys_level_t_name . " AS 'lbl_azp_sys_level_t_name',
					tc_azp_sys_state." . d_azp_sys_state_t_name . " AS 'lbl_azp_sys_state_t_name',
					tc_azs_crt_email_copy." . d_azs_crt_email_copy_t_email . " AS 'lbl_azs_crt_email_copy_t_email',
					tc_azs_crt_email_copy." . d_azs_crt_email_copy_t_names . " AS 'lbl_azs_crt_email_copy_t_names',
					tc_azs_crt_email_copy." . d_azs_crt_email_copy_t_surnames . " AS 'lbl_azs_crt_email_copy_t_surnames'
				FROM " . t_azs_crt_email_copy . " tc_azs_crt_email_copy
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azs_crt_email_copy." . d_azs_crt_email_copy_m_by_created . "
						= tc_azp_user_created." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_user . " tc_azp_user_modified
					ON tc_azs_crt_email_copy." . d_azs_crt_email_copy_m_by_modified . "
						= tc_azp_user_modified." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_sys_level . " tc_azp_sys_level
					ON tc_azs_crt_email_copy." . d_azs_crt_email_copy_m_level . "
						= tc_azp_sys_level." . d_azp_sys_level_t_value . "
				INNER JOIN " . t_azp_sys_state . " tc_azp_sys_state
					ON tc_azs_crt_email_copy." . d_azs_crt_email_copy_m_status . "
						= tc_azp_sys_state." . d_azp_sys_state_t_value . "
				-- ---------------------------------------------------------------
				WHERE tc_azs_crt_email_copy." . d_azs_crt_email_copy_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "'
					AND tc_azs_crt_email_copy." . d_azs_crt_email_copy_v_id_azp_crt_email_copy . " = '" . $this->id . "'
				ORDER BY tc_azs_crt_email_copy." . d_azs_crt_email_copy_m_date_modified . " DESC
			");
		}
		...
		final public function sql_controller_delete() : array {
			...
			$var_sql = $this->db->query("
				SELECT * FROM " . t_azp_crt_email_copy . "
				WHERE " . d_azp_crt_email_copy_id_azp_crt_email_copy . " = '" . $this->id . "'
					AND " . d_azp_crt_email_copy_m_deleted . " = '2'
				LIMIT 1
			");
			...
			if (false != $var_result) {
				...
				Func::redir(URL . url_query_azp_crt_email_copy);
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_sys_state . " tc_azp_sys_state
					ON tc_azp_crt_email_copy." . d_azp_crt_email_copy_m_status . "
						= tc_azp_sys_state." . d_azp_sys_state_t_value . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_crt_email_copy." . d_azp_crt_email_copy_id_azp_crt_email_copy . " = '" . $this->id . "'
					AND tc_azp_crt_email_copy." . d_azp_crt_email_copy_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "'
					AND tc_azp_crt_email_copy." . d_azp_crt_email_copy_m_deleted . " = '1'
				LIMIT 1
			");
		}
		...
		final public function sql_controller_eliminate() {
			...
			return $this->db->query("
				...
				-- ---------------------------------------------------------------
				WHERE tc_azp_crt_email_copy." . d_azp_crt_email_copy_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "'
					AND tc_azp_crt_email_copy." . d_azp_crt_email_copy_m_deleted . " = '3'
				ORDER BY tc_azp_crt_email_copy." . d_azp_crt_email_copy_id_azp_crt_email_copy . " ASC
			");
		}
		...
		final public function sql_controller_remove() {
			...
			return $this->db->query("
				...
				-- ---------------------------------------------------------------
				WHERE tc_azp_crt_email_copy." . d_azp_crt_email_copy_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "'
					AND tc_azp_crt_email_copy." . d_azp_crt_email_copy_m_deleted . " = '2'
				ORDER BY tc_azp_crt_email_copy." . d_azp_crt_email_copy_id_azp_crt_email_copy . " ASC
			");
		}
		...
		final public function sql_controller_update() {
			...
			return $this->db->query("
				SELECT
					tc_azp_crt_email_copy." . d_azp_crt_email_copy_id_azp_crt_email_copy . " AS 'lbl_azp_crt_email_copy_id_azp_crt_email_copy',
					tc_azp_crt_email_copy." . d_azp_crt_email_copy_m_by_created . " AS 'lbl_azp_crt_email_copy_m_by_created',
					tc_azp_crt_email_copy." . d_azp_crt_email_copy_m_by_modified . " AS 'lbl_azp_crt_email_copy_m_by_modified',
					tc_azp_crt_email_copy." . d_azp_crt_email_copy_m_date_created . " AS 'lbl_azp_crt_email_copy_m_date_created',
					tc_azp_crt_email_copy." . d_azp_crt_email_copy_m_date_modified . " AS 'lbl_azp_crt_email_copy_m_date_modified',
					tc_azp_crt_email_copy." . d_azp_crt_email_copy_m_description . " AS 'lbl_azp_crt_email_copy_m_description',
					tc_azp_crt_email_copy." . d_azp_crt_email_copy_m_level . " AS 'lbl_azp_crt_email_copy_m_level',
					tc_azp_crt_email_copy." . d_azp_crt_email_copy_m_status . " AS 'lbl_azp_crt_email_copy_m_status',
					tc_azp_crt_email_copy." . d_azp_crt_email_copy_t_email . " AS 'lbl_azp_crt_email_copy_t_email',
					tc_azp_crt_email_copy." . d_azp_crt_email_copy_t_names . " AS 'lbl_azp_crt_email_copy_t_names',
					tc_azp_crt_email_copy." . d_azp_crt_email_copy_t_surnames . " AS 'lbl_azp_crt_email_copy_t_surnames'
				FROM " . t_azp_crt_email_copy . " tc_azp_crt_email_copy
				...
				-- ---------------------------------------------------------------
				WHERE tc_azp_crt_email_copy." . d_azp_crt_email_copy_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "'
					AND tc_azp_crt_email_copy." . d_azp_crt_email_copy_id_azp_crt_email_copy . " = '" . $this->id . "'
					AND tc_azp_crt_email_copy." . d_azp_crt_email_copy_m_deleted . " = '1'
				LIMIT 1
			");
		}
		...
		final private function error_sql_crt_email_copy_delete(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				$sql_id = $this->db->select('*', t_azp_crt_email_copy, d_azp_crt_email_copy_id_azp_crt_email_copy . " = '" . $empty_id . "'");
				...
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select('*', t_azp_crt_email_copy, d_azp_crt_email_copy_id_azp_crt_email_copy . " = '" . $empty_id . "' AND " . d_azp_crt_email_copy_m_deleted . " = '2'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (false == $sql_id) {
					# Verificar si el resultado devuleto no existe para asignar un valor especifico
					if (strtolower($sql_id) == '') { $sql_id[0][0] = 0; }
				...
				$sql_session = $this->db->select('*', t_azp_crt_email_copy, d_azp_crt_email_copy_id_azp_crt_email_copy . " = '" . $empty_id . "' AND " . d_azp_crt_email_copy_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "' AND " . d_azp_crt_email_copy_m_level . " = '1'");
				# Verificar si el registro creado es igual el valor del campo nivel al valor dos
				$sql_level = $this->db->select('*', t_azp_crt_email_copy, d_azp_crt_email_copy_id_azp_crt_email_copy . " = '" . $empty_id . "' AND " . d_azp_crt_email_copy_m_level . " = '2'");
				# Verificar si el resultado de la sql es verdadero o falso
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_crt_email_copy_delete(array $data) : array {
			$var_error = $this->error_sql_azp_crt_email_copy_delete($data);
			...
			if (!isset($_SESSION[SESS_APP_ID])) {
				...
				$var_array = array(d_azp_crt_email_copy_m_deleted => '3',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_crt_email_copy, $var_array, d_azp_crt_email_copy_id_azp_crt_email_copy . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
		...
		final private function error_sql_azp_crt_email_copy_insert(array $data) {
			try {
				#-------------------------------------------------------------------------#
		...
		/*=========================================================================================================================*/
		# Query Sql Insert
		final public function sql_azp_crt_email_copy_insert(array $data) : array {
			$var_error = $this->error_sql_azp_crt_email_copy_insert($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				$var_array = array(
					...
					d_azp_crt_email_copy_m_by_modified => $_SESSION[SESS_APP_ID],
					d_azp_crt_email_copy_m_date_created => DATE_HOUR,
					d_azp_crt_email_copy_m_date_modified => DATE_HOUR,
					d_azp_crt_email_copy_m_deleted => '1',
					d_azp_crt_email_copy_m_description => $empty_description,
					d_azp_crt_email_copy_m_level => '2',
					d_azp_crt_email_copy_m_status => '1',
					d_azp_crt_email_copy_m_temp => '1',
					d_azp_crt_email_copy_t_email => strtolower($empty_email),
					d_azp_crt_email_copy_t_names => ucwords(strtolower($empty_names)),
					d_azp_crt_email_copy_t_surnames => ucwords(strtolower($empty_surnames)),
				);
				# Query Sql Insert: Registrar valores en la tabla segun sus campos
				$this->db->insert(t_azp_crt_email_copy, $var_array);
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_crt_email_copy_remove(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select('*', t_azp_crt_email_copy, d_azp_crt_email_copy_id_azp_crt_email_copy . " = '" . $empty_id . "' AND " . d_azp_crt_email_copy_m_deleted . " = '1'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (false == $sql_id) {
					# Verificar si el resultado devuleto no existe para asignar un valor especifico
					if (strtolower($sql_id) == '') { $sql_id[0][0] = 0; }
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_crt_email_copy_remove(array $data) : array {
			$var_error = $this->error_sql_azp_crt_email_copy_remove($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_crt_email_copy_m_deleted => '2',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_crt_email_copy, $var_array, d_azp_crt_email_copy_id_azp_crt_email_copy . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_crt_email_copy_restore(array $data) {
			try {
				#-------------------------------------------------------------------------#
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_crt_email_copy_restore(array $data) : array {
			$var_error = $this->error_sql_azp_crt_email_copy_restore($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_crt_email_copy_m_deleted => '1',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_crt_email_copy, $var_array, d_azp_crt_email_copy_id_azp_crt_email_copy . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_crt_email_copy_update(array $data) {
			try {
				#-------------------------------------------------------------------------#
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_crt_email_copy_update(array $data) : array {
			$var_error = $this->error_sql_azp_crt_email_copy_update($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				$var_sql_select = $this->db->select('*', t_azp_crt_email_copy, d_azp_crt_email_copy_id_azp_crt_email_copy . " = '" . $empty_id . "'");
				# Validar si la sentencia query ejecutada es correcta y no falsa
				if (false != $var_sql_select) {
					# El constructor foreach proporciona un modo sencillo de iterar sobre arrays.
					foreach ($var_sql_select as $key_sql_select):
						$var_array = array(
							d_azs_crt_email_copy_m_by_created => $_SESSION[SESS_APP_ID],
							d_azs_crt_email_copy_m_by_modified => $_SESSION[SESS_APP_ID],
							d_azs_crt_email_copy_m_date_created => DATE_HOUR,
							d_azs_crt_email_copy_m_date_modified => DATE_HOUR,
							d_azs_crt_email_copy_m_deleted => $key_sql_select[d_azp_crt_email_copy_m_deleted],
							d_azs_crt_email_copy_m_description => $key_sql_select[d_azp_crt_email_copy_m_description],
							d_azs_crt_email_copy_m_level => $key_sql_select[d_azp_crt_email_copy_m_level],
							d_azs_crt_email_copy_m_status => $key_sql_select[d_azp_crt_email_copy_m_status],
							d_azs_crt_email_copy_m_temp => $key_sql_select[d_azp_crt_email_copy_m_temp],
							d_azs_crt_email_copy_t_email => strtolower($key_sql_select[d_azp_crt_email_copy_t_email]),
							d_azs_crt_email_copy_t_names => ucwords(strtolower($key_sql_select[d_azp_crt_email_copy_t_names])),
							d_azs_crt_email_copy_t_surnames => ucwords(strtolower($key_sql_select[d_azp_crt_email_copy_t_surnames])),
							d_azs_crt_email_copy_v_id_azp_crt_email_copy => $empty_id,
						);
						# Query Sql Insert: Insertar datos en la tabla con sus campos respectivos y asignados
						$this->db->insert(t_azs_crt_email_copy, $var_array);
					endforeach;
				}
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(
					...
					d_azp_crt_email_copy_m_date_modified => DATE_HOUR,
					d_azp_crt_email_copy_m_description => $empty_description,
					d_azp_crt_email_copy_m_status => $empty_state,
					d_azp_crt_email_copy_t_email => strtolower($empty_email),
					d_azp_crt_email_copy_t_names => ucwords(strtolower($empty_names)),
					d_azp_crt_email_copy_t_surnames => ucwords(strtolower($empty_surnames)),
				);
