...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_format_file_id_azs_ibn_format_file",
				data: "lbl_azs_ibn_format_file_id_azs_ibn_format_file",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_format_file_m_date_created",
				data: "lbl_azs_ibn_format_file_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_format_file_m_date_modified",
				data: "lbl_azs_ibn_format_file_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_format_file_m_description",
				data: "lbl_azs_ibn_format_file_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Nombre",
				id: "lbl_azs_ibn_format_file_t_name",
				data: "lbl_azs_ibn_format_file_t_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			{
				title: "Modulo",
				id: "lbl_azs_ibn_format_file_u_ibn_format_type",
				data: "lbl_azs_ibn_format_file_u_ibn_format_type",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_format_file/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_format_file/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_format_file_id_azp_ibn_format_file").innerHTML = objData.data.lbl_azp_ibn_format_file_id_azp_ibn_format_file;
					...
					document.querySelector("#lbl_azp_ibn_format_file_m_date_created").innerHTML = objData.data.lbl_azp_ibn_format_file_m_date_created;
					document.querySelector("#lbl_azp_ibn_format_file_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_format_file_m_date_modified;
					document.querySelector("#lbl_azp_ibn_format_file_m_description").innerHTML = objData.data.lbl_azp_ibn_format_file_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_ibn_format_file_t_name").innerHTML = objData.data.lbl_azp_ibn_format_file_t_name;
					document.querySelector("#lbl_azp_ibn_format_file_t_original").innerHTML = objData.data.lbl_azp_ibn_format_file_t_original;
					document.querySelector("#lbl_azp_ibn_format_type_t_name").innerHTML = objData.data.lbl_azp_ibn_format_type_t_name;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_format_file/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_format_file/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_format_file/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_format_file_id_azp_ibn_format_file;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_format_file_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_format_file_m_status;
					document.querySelector("#field_up_name").value = objData.data.lbl_azp_ibn_format_file_t_name;
					document.querySelector("#field_up_original").value = objData.data.lbl_azp_ibn_format_file_t_original;
					document.querySelector("#field_up_ibn_format_type").value = objData.data.lbl_azp_ibn_format_file_v_id_azp_ibn_format_type;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					...
					document.querySelector('#field_fl_id').value = objData.data.lbl_azp_ibn_format_file_id_azp_ibn_format_file;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				var objData = JSON.parse(request.responseText);
				if (objData.status) {
					var fdocument = objData.data.lbl_azp_ibn_format_file_w_document;
					if (fdocument == '' || fdocument == 'null') {
						...
						var wdocument = objData.data.lbl_azp_ibn_format_file_w_document;
						var wfolder = objData.data.lbl_azp_ibn_format_file_w_folder;
						var wroute = objData.data.lbl_azp_ibn_format_file_w_route;
			...
			ok: {
				...
				callback: function() {
					...
					if (!extensions.exec(path)) { document.getElementById('field_fl_file').value = ''; } else {
						$.ajax({
							type: "POST",
							url: "api/azp_ibn_format_file/file",
							datatype: "HTML",
