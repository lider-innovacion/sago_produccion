...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_crt_copy_client_id_azs_crt_copy_client",
				data: "lbl_azs_crt_copy_client_id_azs_crt_copy_client",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_crt_copy_client_m_date_created",
				data: "lbl_azs_crt_copy_client_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_crt_copy_client_m_date_modified",
				data: "lbl_azs_crt_copy_client_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_crt_copy_client_m_description",
				data: "lbl_azs_crt_copy_client_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			},
			{
				...
				id: "lbl_azs_crt_copy_client_t_email",
				data: "lbl_azs_crt_copy_client_t_email",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Nombres",
				id: "lbl_azs_crt_copy_client_t_names",
				data: "lbl_azs_crt_copy_client_t_names",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Apellidos",
				id: "lbl_azs_crt_copy_client_t_surnames",
				data: "lbl_azs_crt_copy_client_t_surnames",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Cliente",
				id: "lbl_azs_crt_copy_client_u_crt_client",
				data: "lbl_azs_crt_copy_client_u_crt_client",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_crt_copy_client/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_crt_copy_client/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_crt_copy_client_id_azp_crt_copy_client").innerHTML = objData.data.lbl_azp_crt_copy_client_id_azp_crt_copy_client;
					...
					document.querySelector("#lbl_azp_crt_copy_client_m_date_created").innerHTML = objData.data.lbl_azp_crt_copy_client_m_date_created;
					document.querySelector("#lbl_azp_crt_copy_client_m_date_modified").innerHTML = objData.data.lbl_azp_crt_copy_client_m_date_modified;
					document.querySelector("#lbl_azp_crt_copy_client_m_description").innerHTML = objData.data.lbl_azp_crt_copy_client_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_crt_copy_client_t_email").innerHTML = objData.data.lbl_azp_crt_copy_client_t_email;
					document.querySelector("#lbl_azp_crt_copy_client_t_names").innerHTML = objData.data.lbl_azp_crt_copy_client_t_names;
					document.querySelector("#lbl_azp_crt_copy_client_t_surnames").innerHTML = objData.data.lbl_azp_crt_copy_client_t_surnames;
					document.querySelector("#lbl_azp_crt_client_t_name").innerHTML = objData.data.lbl_azp_crt_client_t_name;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_crt_copy_client/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_crt_copy_client/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_crt_copy_client/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_crt_copy_client_id_azp_crt_copy_client;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_crt_copy_client_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_crt_copy_client_m_status;
					document.querySelector("#field_up_email").value = objData.data.lbl_azp_crt_copy_client_t_email;
					document.querySelector("#field_up_email_confirm").value = objData.data.lbl_azp_crt_copy_client_t_email;
					document.querySelector("#field_up_names").value = objData.data.lbl_azp_crt_copy_client_t_names;
					document.querySelector("#field_up_surnames").value = objData.data.lbl_azp_crt_copy_client_t_surnames;
					document.querySelector("#field_up_crt_client").value = objData.data.lbl_azp_crt_copy_client_v_id_azp_crt_client;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
