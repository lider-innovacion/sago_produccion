...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_pdf_text_color_id_azs_ibn_pdf_text_color",
				data: "lbl_azs_ibn_pdf_text_color_id_azs_ibn_pdf_text_color",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_pdf_text_color_m_date_created",
				data: "lbl_azs_ibn_pdf_text_color_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_pdf_text_color_m_date_modified",
				data: "lbl_azs_ibn_pdf_text_color_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_pdf_text_color_m_description",
				data: "lbl_azs_ibn_pdf_text_color_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Etiqueta",
				id: "lbl_azs_ibn_pdf_text_color_t_label",
				data: "lbl_azs_ibn_pdf_text_color_t_label",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "R",
				id: "lbl_azs_ibn_pdf_text_color_t_red",
				data: "lbl_azs_ibn_pdf_text_color_t_red",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "G",
				id: "lbl_azs_ibn_pdf_text_color_t_green",
				data: "lbl_azs_ibn_pdf_text_color_t_green",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "B",
				id: "lbl_azs_ibn_pdf_text_color_t_blue",
				data: "lbl_azs_ibn_pdf_text_color_t_blue",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "DIT",
				id: "lbl_azs_ibn_pdf_text_color_u_ibn_interface_dit",
				data: "lbl_azs_ibn_pdf_text_color_u_ibn_interface_dit",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_pdf_text_color/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_pdf_text_color/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_pdf_text_color_id_azp_ibn_pdf_text_color").innerHTML = objData.data.lbl_azp_ibn_pdf_text_color_id_azp_ibn_pdf_text_color;
					...
					document.querySelector("#lbl_azp_ibn_pdf_text_color_m_date_created").innerHTML = objData.data.lbl_azp_ibn_pdf_text_color_m_date_created;
					document.querySelector("#lbl_azp_ibn_pdf_text_color_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_pdf_text_color_m_date_modified;
					document.querySelector("#lbl_azp_ibn_pdf_text_color_m_description").innerHTML = objData.data.lbl_azp_ibn_pdf_text_color_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_ibn_pdf_text_color_t_blue").innerHTML = objData.data.lbl_azp_ibn_pdf_text_color_t_blue;
					document.querySelector("#lbl_azp_ibn_pdf_text_color_t_green").innerHTML = objData.data.lbl_azp_ibn_pdf_text_color_t_green;
					document.querySelector("#lbl_azp_ibn_pdf_text_color_t_label").innerHTML = objData.data.lbl_azp_ibn_pdf_text_color_t_label;
					document.querySelector("#lbl_azp_ibn_pdf_text_color_t_red").innerHTML = objData.data.lbl_azp_ibn_pdf_text_color_t_red;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_pdf_text_color/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_pdf_text_color/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_pdf_text_color/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_pdf_text_color_id_azp_ibn_pdf_text_color;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_pdf_text_color_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_pdf_text_color_m_status;
					document.querySelector("#field_up_blue").value = objData.data.lbl_azp_ibn_pdf_text_color_t_blue;
					document.querySelector("#field_up_green").value = objData.data.lbl_azp_ibn_pdf_text_color_t_green;
					document.querySelector("#field_up_label").value = objData.data.lbl_azp_ibn_pdf_text_color_t_label;
					document.querySelector("#field_up_red").value = objData.data.lbl_azp_ibn_pdf_text_color_t_red;
					document.querySelector("#field_up_ibn_interface_dit").value = objData.data.lbl_azp_ibn_pdf_text_color_v_id_azp_ibn_interface_dit;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
