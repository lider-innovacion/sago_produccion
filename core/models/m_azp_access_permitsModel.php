<?php
	...
	//------------------------------------------------
	final class m_azp_access_permitsModel extends Models implements OCREND {
		/*=========================================================================================================================*/
		...
		final public function sql_controller_by_create() {
			...
			return $this->db->query("
				...
				-- ---------------------------------------------------------------
				WHERE tc_azp_access_permits." . d_azp_access_permits_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "'
					AND tc_azp_access_permits." . d_azp_access_permits_m_deleted . " = '1'
			");
		}
		...
		final public function sql_controller_change() {
			...
			return $this->db->query("
				SELECT
					tc_azs_access_permits." . d_azs_access_permits_id_azs_access_permits . " AS 'lbl_azs_access_permits_id_azs_access_permits',
					tc_azs_access_permits." . d_azs_access_permits_m_date_modified . " AS 'lbl_azs_access_permits_m_date_modified',
					tc_azp_user_created." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_created',
					tc_azp_user_modified." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_modified',
					tc_azs_access_permits." . d_azs_access_permits_m_date_created . " AS 'lbl_azs_access_permits_m_date_created',
					tc_azs_access_permits." . d_azs_access_permits_m_date_modified . " AS 'lbl_azs_access_permits_m_date_modified',
					tc_azs_access_permits." . d_azs_access_permits_m_description . " AS 'lbl_azs_access_permits_m_description',
					tc_azp_sys_level." . d_azp_sys_level_t_name . " AS 'lbl_azp_sys_level_t_name',
					tc_azp_sys_state." . d_azp_sys_state_t_name . " AS 'lbl_azp_sys_state_t_name',
					tc_azs_access_permits." . d_azs_access_permits_u_access_type . " AS 'lbl_azs_access_permits_u_access_type',
					tc_azs_access_permits." . d_azs_access_permits_u_application . " AS 'lbl_azs_access_permits_u_application',
					tc_azs_access_permits." . d_azs_access_permits_u_role . " AS 'lbl_azs_access_permits_u_role'
				FROM " . t_azs_access_permits . " tc_azs_access_permits
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azs_access_permits." . d_azs_access_permits_m_by_created . "
						= tc_azp_user_created." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_user . " tc_azp_user_modified
					ON tc_azs_access_permits." . d_azs_access_permits_m_by_modified . "
						= tc_azp_user_modified." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_sys_level . " tc_azp_sys_level
					ON tc_azs_access_permits." . d_azs_access_permits_m_level . "
						= tc_azp_sys_level." . d_azp_sys_level_t_value . "
				INNER JOIN " . t_azp_sys_state . " tc_azp_sys_state
					ON tc_azs_access_permits." . d_azs_access_permits_m_status . "
						= tc_azp_sys_state." . d_azp_sys_state_t_value . "
				-- ---------------------------------------------------------------
				WHERE tc_azs_access_permits." . d_azs_access_permits_v_id_azp_access_permits . " = '" . $this->id . "'
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_role . " tc_azp_role
					ON tc_azp_access_permits. " . d_azp_access_permits_v_id_azp_role . "
						= tc_azp_role. " . d_azp_role_id_azp_role . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_access_permits." . d_azp_access_permits_id_azp_access_permits . " = '" . $this->id . "'
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_role . " tc_azp_role
					ON tc_azp_access_permits. " . d_azp_access_permits_v_id_azp_role . "
						= tc_azp_role. " . d_azp_role_id_azp_role . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_access_permits." . d_azp_access_permits_m_deleted . " = '3'
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_role . " tc_azp_role
					ON tc_azp_access_permits. " . d_azp_access_permits_v_id_azp_role . "
						= tc_azp_role. " . d_azp_role_id_azp_role . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_access_permits." . d_azp_access_permits_m_deleted . " = '2'
			");
		}
		...
		final public function sql_controller_update() {
			...
			return $this->db->query("
				SELECT
					tc_azp_access_permits." . d_azp_access_permits_id_azp_access_permits . " AS 'lbl_azp_access_permits_id_azp_access_permits',
					tc_azp_access_permits." . d_azp_access_permits_m_by_created . " AS 'lbl_azp_access_permits_m_by_created',
					tc_azp_access_permits." . d_azp_access_permits_m_by_modified . " AS 'lbl_azp_access_permits_m_by_modified',
					tc_azp_access_permits." . d_azp_access_permits_m_date_created . " AS 'lbl_azp_access_permits_m_date_created',
					tc_azp_access_permits." . d_azp_access_permits_m_date_modified . " AS 'lbl_azp_access_permits_m_date_modified',
					tc_azp_access_permits." . d_azp_access_permits_m_description . " AS 'lbl_azp_access_permits_m_description',
					tc_azp_access_permits." . d_azp_access_permits_m_level . " AS 'lbl_azp_access_permits_m_level',
					tc_azp_access_permits." . d_azp_access_permits_m_status . " AS 'lbl_azp_access_permits_m_status',
					tc_azp_access_permits." . d_azp_access_permits_v_id_azp_access_type . " AS 'lbl_azp_access_permits_v_id_azp_access_type',
					tc_azp_access_permits." . d_azp_access_permits_v_id_azp_application . " AS 'lbl_azp_access_permits_v_id_azp_application',
					tc_azp_access_permits." . d_azp_access_permits_v_id_azp_role . " AS 'lbl_azp_access_permits_v_id_azp_role'
				FROM " . t_azp_access_permits . " tc_azp_access_permits
				-- ---------------------------------------------------------------
				WHERE tc_azp_access_permits." . d_azp_access_permits_id_azp_access_permits . " = '" . $this->id . "'
			");
		...
		final private function error_sql_azp_access_permits_delete(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				$sql_id = $this->db->select("*", t_azp_access_permits, d_azp_access_permits_id_azp_access_permits . " = '" . $empty_id . "'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (true != $sql_id) { throw new Exception('El registro que está eliminando no se encuentra registrado.'); }
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select("*", t_azp_access_permits, d_azp_access_permits_id_azp_access_permits . " = '" . $empty_id . "' AND " . d_azp_access_permits_m_deleted . " = '3'");
				# Verificar si el resultado de la sql es verdadero o falso
				...
				$sql_session = $this->db->select("*", t_azp_access_permits,
					d_azp_access_permits_id_azp_access_permits . " = '" . $empty_id . "' AND " .
					d_azp_access_permits_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "' AND " .
					d_azp_access_permits_m_level . " = '1'"
				);
				# Verificar si el registro creado es igual el valor del campo nivel al valor dos
				$sql_level = $this->db->select("*", t_azp_access_permits,
					d_azp_access_permits_id_azp_access_permits . " = '" . $empty_id . "' AND " .
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_access_permits_delete(array $data) : array {
			# Validar el envio de informacion de los formularios
			$var_error = $this->error_sql_azp_access_permits_delete($data);
			...
			if (!isset($_SESSION[SESS_APP_ID])) {
				...
				$var_array = array(d_azp_access_permits_m_deleted => '3',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_access_permits, $var_array, d_azp_access_permits_id_azp_access_permits . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		final private function error_sql_azp_access_permits_insert(array $data) {
			try {
				#-------------------------------------------------------------------------#
				if (!isset($data['field_cr_description'])) { throw new Exception('El campo de descripcion esta prohibido modificar.'); }
				#-------------------------------------------------------------------------#
				if (!isset($data['field_cr_access_type'])) { throw new Exception('El campo de tipo acceso esta prohibido modificar.'); }
				if (!isset($data['field_cr_application'])) { throw new Exception('El campo de aplicacion esta prohibido modificar.'); }
				if (!isset($data['field_cr_role'])) { throw new Exception('El campo de rol esta prohibido modificar.'); }
				#-------------------------------------------------------------------------#
				$empty_description = $this->db->scape($data['field_cr_description']);
				#-------------------------------------------------------------------------#
				$empty_access_type = $this->db->scape($data['field_cr_access_type']);
				...
				#-------------------------------------------------------------------------#
				if (Func::emp($empty_access_type) || strtolower($empty_access_type) == strtolower('seleccionar') || $empty_access_type == 0) {
					# Informar un mensaje al usuario por medio de una excepcion
					throw new Exception('El campo de tipo acceso es obligatorio.');
				}
				#---------------------------------------------#
				if (!is_numeric($empty_access_type)) {
					# Informar un mensaje al usuario por medio de una excepcion
					throw new Exception('El campo de tipo acceso solo permite numeros.');
				}
				#-------------------------------------------------------------------------#
				if (Func::emp($empty_application) || strtolower($empty_application) == strtolower('seleccionar') || $empty_application == 0) {
					# Informar un mensaje al usuario por medio de una excepcion
					throw new Exception('El campo de aplicacion es obligatorio.');
				}
				#---------------------------------------------#
				if (!is_numeric($empty_application)) {
					# Informar un mensaje al usuario por medio de una excepcion
					throw new Exception('El campo de aplicacion solo permite numeros.');
				}
				#-------------------------------------------------------------------------#
				if (Func::emp($empty_role) || strtolower($empty_role) == strtolower('seleccionar') || $empty_role == 0) {
					# Informar un mensaje al usuario por medio de una excepcion
					throw new Exception('El campo de rol es obligatorio.');
				}
				#---------------------------------------------#
				if (!is_numeric($empty_role)) {
					# Informar un mensaje al usuario por medio de una excepcion
					throw new Exception('El campo de rol solo permite numeros.');
				}
				#-------------------------------------------------------------------------#
				# Verificar en la base de datos si existen el registro
				$sql_found = $this->db->select("*", t_azp_access_type, d_azp_access_type_id_azp_access_type . " = '" . $empty_access_type . "'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (true != $sql_found) { throw new Exception('El tipo de acceso seleccionado no se encuentra registrado.'); }
				#-------------------------------------------------------------------------#
				# Verificar en la base de datos si existen el registro
				$sql_found = $this->db->select("*", t_azp_application, d_azp_application_id_azp_application . " = '" . $empty_application . "'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (true != $sql_found) { throw new Exception('El aplicativo seleccionado no se encuentra registrado.'); }
				#-------------------------------------------------------------------------#
				# Verificar en la base de datos si existen el registro
				$sql_found = $this->db->select("*", t_azp_role, d_azp_role_id_azp_role . " = '" . $empty_role . "'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (true != $sql_found) { throw new Exception('El rol seleccionado no se encuentra registrado.'); }
				#-------------------------------------------------------------------------#
				# Verificar si el valor ingresado se encuentra repetido en los demas registros
				$sql_query = $this->db->select("*", t_azp_access_permits,
					d_azp_access_permits_v_id_azp_application . " = '" . $empty_application . "' AND " .
					d_azp_access_permits_v_id_azp_role . " = '" . $empty_role . "'"
				);
				# Verificar si el resultado de la sql es verdadero o falso
				if (true == $sql_query) { throw new Exception('El aplicativo y rol seleccionados ya existen registrados.'); }
				#-------------------------------------------------------------------------#
				return false;
			} catch (Exception $e) {
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Query Sql Insert
		final public function sql_azp_access_permits_insert(array $data) : array {
			# Validar el envio de informacion de los formularios
			$var_error = $this->error_sql_azp_access_permits_insert($data);
			# Validar errores de los datos recibidos del formulario
			if (!is_bool($var_error)) { return $var_error; }
			# Control de validacion de sesion de usuario
			if (!isset($_SESSION[SESS_APP_ID])) {
				...
				$var_array = array(
					...
					d_azp_access_permits_m_description => $empty_description,
					//d_azp_access_permits_m_import => '0',
					d_azp_access_permits_m_level => '1',
					//d_azp_access_permits_m_record => '1',
					d_azp_access_permits_m_status => '1',
					d_azp_access_permits_m_temp => '2',
					d_azp_access_permits_v_id_azp_access_type => $empty_access_type,
					d_azp_access_permits_v_id_azp_application => $empty_application,
					d_azp_access_permits_v_id_azp_role => $empty_role,
				);
				# Query Sql Insert: Registrar valores en la tabla segun sus campos
				...
				$var_sql_appl = $this->db->select("*", t_azp_application, d_azp_application_m_temp . " = '2' AND " . d_azp_application_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "'", "LIMIT 1");
				# Validar si la sentencia query ejecutada es correcta y no falsa
				if (true == $var_sql_appl) {
					...
					foreach ($var_sql_appl as $key_appl => $value_appl):
						# Query Sql: Ejecutar codigo sql en la base de datos
						$var_sql_role = $this->db->select("*", t_azp_role);
						# Validar si la sentencia query ejecutada es correcta y no falsa
				...
				#-------------------------------------------------------------------------#
				# Linea de codigo con una variable y array para seleccionar los datos y asignarlo uno a uno
				$var_array = array(d_azp_application_m_temp => '1');
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_application, $var_array, d_azp_application_m_temp . " = '2'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_access_permits_remove(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select("*", t_azp_access_permits, d_azp_access_permits_id_azp_access_permits . " = '" . $empty_id . "' AND " . d_azp_access_permits_m_deleted . " = '2'");
				# Verificar si el resultado de la sql es verdadero o falso
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_access_permits_remove(array $data) : array {
			# Validar el envio de informacion de los formularios
			$var_error = $this->error_sql_azp_access_permits_remove($data);
			# Validar errores de los datos recibidos del formulario
			if (!is_bool($var_error)) { return $var_error; }
			# Control de validacion de sesion de usuario
			if (!isset($_SESSION[SESS_APP_ID])) {
				...
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_access_permits_m_deleted => '2',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_access_permits, $var_array, d_azp_access_permits_id_azp_access_permits . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_access_permits_restore(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select("*", t_azp_access_permits, d_azp_access_permits_id_azp_access_permits . " = '" . $empty_id . "' AND " . d_azp_access_permits_m_deleted . " = '1'");
				# Verificar si el resultado de la sql es verdadero o falso
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_access_permits_restore(array $data) : array {
			# Validar el envio de informacion de los formularios
			$var_error = $this->error_sql_azp_access_permits_restore($data);
			# Validar errores de los datos recibidos del formulario
			if (!is_bool($var_error)) { return $var_error; }
			# Control de validacion de sesion de usuario
			if (!isset($_SESSION[SESS_APP_ID])) {
				...
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_access_permits_m_deleted => '1',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_access_permits, $var_array, d_azp_access_permits_id_azp_access_permits . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_access_permits_update(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				#-------------------------------------------------------------------------#
				if (!isset($data['field_up_access_type'])) { throw new Exception('El campo de tipo acceso esta prohibido modificar.'); }
				if (!isset($data['field_up_application'])) { throw new Exception('El campo de aplicacion esta prohibido modificar.'); }
				if (!isset($data['field_up_role'])) { throw new Exception('El campo de rol esta prohibido modificar.'); }
				#-------------------------------------------------------------------------#
				...
				#-------------------------------------------------------------------------#
				$empty_access_type = $this->db->scape($data['field_up_access_type']);
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_access_permits_update(array $data) : array {
			# Validar el envio de informacion de los formularios
			$var_error = $this->error_sql_azp_access_permits_update($data);
			# Validar errores de los datos recibidos del formulario
			if (!is_bool($var_error)) { return $var_error; }
			# Control de validacion de sesion de usuario
			if (!isset($_SESSION[SESS_APP_ID])) {
				...
				$var_sql = $this->db->select("*", t_azp_access_permits, d_azp_access_permits_id_azp_access_permits . " = '" . $empty_id . "'");
				# Validar si la sentencia query ejecutada es correcta y no falsa
				if (true == $var_sql) {
					# El constructor foreach proporciona un modo sencillo de iterar sobre arrays.
					foreach ($var_sql as $key => $value) :
						# Array para asignar argumentos o valores a los elementos
						$var_array = array(
							d_azs_access_permits_m_by_created => $_SESSION[SESS_APP_ID],
							d_azs_access_permits_m_by_modified => $_SESSION[SESS_APP_ID],
							d_azs_access_permits_m_date_created => DATE_HOUR,
							d_azs_access_permits_m_date_modified => DATE_HOUR,
							d_azs_access_permits_m_deleted => $value[d_azp_access_permits_m_deleted],
							d_azs_access_permits_m_description => $value[d_azp_access_permits_m_description],
							//d_azs_access_permits_m_import => $value[d_azp_access_permits_m_import],
							d_azs_access_permits_m_level => $value[d_azp_access_permits_m_level],
							//d_azs_access_permits_m_record => $value[d_azp_access_permits_m_record],
							d_azs_access_permits_m_status => $value[d_azp_access_permits_m_status],
							d_azs_access_permits_m_temp => $value[d_azp_access_permits_m_temp],
							d_azs_access_permits_u_access_type => $value[d_azp_access_permits_v_id_azp_access_type],
							d_azs_access_permits_u_application => $value[d_azp_access_permits_v_id_azp_application],
							d_azs_access_permits_u_role => $value[d_azp_access_permits_v_id_azp_role],
							d_azs_access_permits_v_id_azp_access_permits => $empty_id,
						);
						# Query Sql Insert: Insertar datos en la tabla con sus campos respectivos y asignados
						$this->db->insert(t_azs_access_permits, $var_array);
						#-------------------------------------------------------------------------#
						# Asignacion de valores a nuevas variables
						$exc_access_type = $value[d_azp_access_permits_v_id_azp_access_type];
						$exc_application = $value[d_azp_access_permits_v_id_azp_application];
						$exc_role = $value[d_azp_access_permits_v_id_azp_role];
						#-------------------------------------------------------------------------#
						# Linea de codigo con una variable y array para seleccionar los datos de la tabla segun el id
						$var_sql = $this->db->select("*", t_azp_access_type, d_azp_access_type_id_azp_access_type . " = '" . $exc_access_type . "'");
						# Validar si la sentencia query ejecutada es correcta y no falsa
						if (true == $var_sql) {
							# El constructor foreach proporciona un modo sencillo de iterar sobre arrays.
							foreach ($var_sql as $key => $valuo) :
								# Array para asignar argumentos o valores a los elementos
								$var_array = array(d_azs_access_permits_u_access_type => $valuo[d_azp_access_type_t_name],);
								# Query Sql Update: Actualizar valores de la tabla segun sus campos
								$this->db->update(t_azs_access_permits, $var_array, d_azs_access_permits_u_access_type . " = '" . $exc_access_type . "'");
							endforeach;
						}
						#-------------------------------------------------------------------------#
						# Linea de codigo con una variable y array para seleccionar los datos de la tabla segun el id
						$var_sql = $this->db->select("*", t_azp_application, d_azp_application_id_azp_application . " = '" . $exc_application . "'");
						# Validar si la sentencia query ejecutada es correcta y no falsa
						if (true == $var_sql) {
							# El constructor foreach proporciona un modo sencillo de iterar sobre arrays.
							foreach ($var_sql as $key => $valuo) :
								# Array para asignar argumentos o valores a los elementos
								$var_array = array(d_azs_access_permits_u_application => $valuo[d_azp_application_t_name],);
								# Query Sql Update: Actualizar valores de la tabla segun sus campos
								$this->db->update(t_azs_access_permits, $var_array, d_azs_access_permits_u_application . " = '" . $exc_application . "'");
							endforeach;
						}
						#-------------------------------------------------------------------------#
						# Linea de codigo con una variable y array para seleccionar los datos de la tabla segun el id
						$var_sql = $this->db->select("*", t_azp_role, d_azp_role_id_azp_role . " = '" . $exc_role . "'");
						# Validar si la sentencia query ejecutada es correcta y no falsa
						if (true == $var_sql) {
							# El constructor foreach proporciona un modo sencillo de iterar sobre arrays.
							foreach ($var_sql as $key => $valuo) :
								# Array para asignar argumentos o valores a los elementos
								$var_array = array(d_azs_access_permits_u_role => $valuo[d_azp_role_t_name],);
								# Query Sql Update: Actualizar valores de la tabla segun sus campos
								$this->db->update(t_azs_access_permits, $var_array, d_azs_access_permits_u_role . " = '" . $exc_role . "'");
							endforeach;
						}
					endforeach;
				}
				...
				$var_array = array(
					...
					d_azp_access_permits_m_date_modified => DATE_HOUR,
					d_azp_access_permits_m_description => $empty_description,
					d_azp_access_permits_m_status => $empty_state,
					d_azp_access_permits_v_id_azp_access_type => $empty_access_type,
					d_azp_access_permits_v_id_azp_application => $empty_application,
					d_azp_access_permits_v_id_azp_role => $empty_role,
				);
		...
		/*=========================================================================================================================*/
		# Query Sql Select
		final public function sql_select_tc_azp_access_type() {
			# Seleccionar los registros de la tabla
			return $this->db->select("*", t_azp_access_type,
				d_azp_access_type_m_deleted . " = '1' AND " .
				d_azp_access_type_m_status . " = '1' ORDER BY " .
				d_azp_access_type_id_azp_access_type . " DESC"
			);
		}
		...
		final public function sql_select_tc_azp_application() {
			# Seleccionar los registros de la tabla
			return $this->db->select("*", t_azp_application,
				d_azp_application_m_deleted . " = '1' AND " .
				d_azp_application_m_status . " = '1' ORDER BY " .
				d_azp_application_id_azp_application . " DESC"
			);
		}
		
		/*=========================================================================================================================*/
		# Query Sql Select
		final public function sql_select_tc_azp_role() {
			# Seleccionar los registros de la tabla
			return $this->db->select("*", t_azp_role,
				d_azp_role_m_deleted . " = '1' AND " .
				d_azp_role_m_status . " = '1' ORDER BY " .
				d_azp_role_id_azp_role . " DESC"
			);
		}
