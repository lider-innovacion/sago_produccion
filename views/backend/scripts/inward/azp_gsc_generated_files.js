...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_gsc_generated_files_id_azs_gsc_generated_files",
				data: "lbl_azs_gsc_generated_files_id_azs_gsc_generated_files",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_gsc_generated_files_m_date_created",
				data: "lbl_azs_gsc_generated_files_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_gsc_generated_files_m_date_modified",
				data: "lbl_azs_gsc_generated_files_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_gsc_generated_files_m_description",
				data: "lbl_azs_gsc_generated_files_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Fecha Cargado",
				id: "lbl_azs_gsc_generated_files_t_date_load",
				data: "lbl_azs_gsc_generated_files_t_date_load",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Vencimiento",
				id: "lbl_azs_gsc_generated_files_t_expiration",
				data: "lbl_azs_gsc_generated_files_t_expiration",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Extension",
				id: "lbl_azs_gsc_generated_files_t_extension",
				data: "lbl_azs_gsc_generated_files_t_extension",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Modulo",
				id: "lbl_azs_gsc_generated_files_t_module",
				data: "lbl_azs_gsc_generated_files_t_module",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_gsc_generated_files_t_name_file",
				data: "lbl_azs_gsc_generated_files_t_name_file",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Plantilla",
				id: "lbl_azs_gsc_generated_files_t_template",
				data: "lbl_azs_gsc_generated_files_t_template",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Tipo",
				id: "lbl_azs_gsc_generated_files_t_type",
				data: "lbl_azs_gsc_generated_files_t_type",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_generated_files/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_generated_files/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_gsc_generated_files_id_azp_gsc_generated_files").innerHTML = objData.data.lbl_azp_gsc_generated_files_id_azp_gsc_generated_files;
					...
					document.querySelector("#lbl_azp_gsc_generated_files_m_date_created").innerHTML = objData.data.lbl_azp_gsc_generated_files_m_date_created;
					document.querySelector("#lbl_azp_gsc_generated_files_m_date_modified").innerHTML = objData.data.lbl_azp_gsc_generated_files_m_date_modified;
					document.querySelector("#lbl_azp_gsc_generated_files_m_description").innerHTML = objData.data.lbl_azp_gsc_generated_files_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_gsc_generated_files_t_date_load").innerHTML = objData.data.lbl_azp_gsc_generated_files_t_date_load;
					document.querySelector("#lbl_azp_gsc_generated_files_t_expiration").innerHTML = objData.data.lbl_azp_gsc_generated_files_t_expiration;
					document.querySelector("#lbl_azp_gsc_generated_files_t_extension").innerHTML = objData.data.lbl_azp_gsc_generated_files_t_extension;
					document.querySelector("#lbl_azp_gsc_generated_files_t_module").innerHTML = objData.data.lbl_azp_gsc_generated_files_t_module;
					document.querySelector("#lbl_azp_gsc_generated_files_t_name_file").innerHTML = objData.data.lbl_azp_gsc_generated_files_t_name_file;
					document.querySelector("#lbl_azp_gsc_generated_files_t_template").innerHTML = objData.data.lbl_azp_gsc_generated_files_t_template;
					document.querySelector("#lbl_azp_gsc_generated_files_t_type").innerHTML = objData.data.lbl_azp_gsc_generated_files_t_type;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_generated_files/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_generated_files/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_generated_files/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_gsc_generated_files_id_azp_gsc_generated_files;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_gsc_generated_files_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_gsc_generated_files_m_status;
					document.querySelector("#field_up_name").value = objData.data.lbl_azp_gsc_generated_files_t_name;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
