<?php
	...
	//------------------------------------------------
	final class m_azp_gsc_cityModel extends Models implements OCREND {
		/*=========================================================================================================================*/
		...
		final public function sql_controller_by_create() {
			...
			return $this->db->query("
				SELECT
					tc_azp_gsc_city." . d_azp_gsc_city_id_azp_gsc_city . " AS 'lbl_azp_gsc_city_id_azp_gsc_city',
					tc_azp_user_created." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_created',
					tc_azp_user_modified." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_modified',
					tc_azp_gsc_city." . d_azp_gsc_city_m_date_created . " AS 'lbl_azp_gsc_city_m_date_created',
					tc_azp_gsc_city." . d_azp_gsc_city_m_date_modified . " AS 'lbl_azp_gsc_city_m_date_modified',
					tc_azp_gsc_city." . d_azp_gsc_city_m_description . " AS 'lbl_azp_gsc_city_m_description',
					tc_azp_sys_level." . d_azp_sys_level_t_name . " AS 'lbl_azp_sys_level_t_name',
					tc_azp_sys_state." . d_azp_sys_state_t_name . " AS 'lbl_azp_sys_state_t_name',
					tc_azp_gsc_city." . d_azp_gsc_city_t_code . " AS 'lbl_azp_gsc_city_t_code',
				...
				FROM " . t_azp_gsc_city . " tc_azp_gsc_city
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azp_gsc_city." . d_azp_gsc_city_m_by_created . "
						= tc_azp_user_created." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_user . " tc_azp_user_modified
					ON tc_azp_gsc_city." . d_azp_gsc_city_m_by_modified . "
						= tc_azp_user_modified." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_sys_level . " tc_azp_sys_level
					ON tc_azp_gsc_city." . d_azp_gsc_city_m_level . "
						= tc_azp_sys_level." . d_azp_sys_level_t_value . "
				INNER JOIN " . t_azp_sys_state . " tc_azp_sys_state
					ON tc_azp_gsc_city." . d_azp_gsc_city_m_status . "
						= tc_azp_sys_state." . d_azp_sys_state_t_value . "
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_gsc_department ." tc_azp_gsc_department
					ON tc_azp_gsc_city." . d_azp_gsc_city_v_id_azp_gsc_department . "
						= tc_azp_gsc_department." . d_azp_gsc_department_id_azp_gsc_department . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_gsc_city." . d_azp_gsc_city_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "'
					AND tc_azp_gsc_city." . d_azp_gsc_city_m_deleted . " = '1'
				ORDER BY tc_azp_gsc_city." . d_azp_gsc_city_id_azp_gsc_city . " ASC
			");
		}
		...
		final public function sql_controller_change() {
			...
			return $this->db->query("
				SELECT
					tc_azs_gsc_city." . d_azs_gsc_city_id_azs_gsc_city . " AS 'lbl_azs_gsc_city_id_azs_gsc_city',
					tc_azs_gsc_city." . d_azs_gsc_city_m_date_modified . " AS 'lbl_azs_gsc_city_m_date_modified',
					tc_azp_user_created." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_created',
					tc_azp_user_modified." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_modified',
					tc_azs_gsc_city." . d_azs_gsc_city_m_date_created . " AS 'lbl_azs_gsc_city_m_date_created',
					tc_azs_gsc_city." . d_azs_gsc_city_m_date_modified . " AS 'lbl_azs_gsc_city_m_date_modified',
					tc_azs_gsc_city." . d_azs_gsc_city_m_description . " AS 'lbl_azs_gsc_city_m_description',
					tc_azp_sys_level." . d_azp_sys_level_t_name . " AS 'lbl_azp_sys_level_t_name',
					tc_azp_sys_state." . d_azp_sys_state_t_name . " AS 'lbl_azp_sys_state_t_name',
					tc_azp_gsc_city." . d_azp_gsc_city_t_code . " AS 'lbl_azp_gsc_city_t_code',
					tc_azp_gsc_city." . d_azp_gsc_city_t_name . " AS 'lbl_azp_gsc_city_t_name',
					tc_azp_gsc_city." . d_azp_gsc_city_u_gsc_department . " AS 'lbl_azp_gsc_city_u_gsc_department'
				FROM " . t_azs_gsc_city . " tc_azs_gsc_city
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azs_gsc_city." . d_azs_gsc_city_m_by_created . "
						= tc_azp_user_created." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_user . " tc_azp_user_modified
					ON tc_azs_gsc_city." . d_azs_gsc_city_m_by_modified . "
						= tc_azp_user_modified." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_sys_level . " tc_azp_sys_level
					ON tc_azs_gsc_city." . d_azs_gsc_city_m_level . "
						= tc_azp_sys_level." . d_azp_sys_level_t_value . "
				INNER JOIN " . t_azp_sys_state . " tc_azp_sys_state
					ON tc_azs_gsc_city." . d_azs_gsc_city_m_status . "
						= tc_azp_sys_state." . d_azp_sys_state_t_value . "
				-- ---------------------------------------------------------------
				WHERE tc_azs_gsc_city." . d_azs_gsc_city_v_id_azp_gsc_city . " = '" . $this->id . "'
				ORDER BY tc_azs_gsc_city." . d_azs_gsc_city_m_date_modified . " DESC
			");
		}
		...
		final public function sql_controller_delete() : array {
			...
			$var_sql = $this->db->query("
				SELECT * FROM " . t_azp_gsc_city . "
				WHERE " . d_azp_gsc_city_id_azp_gsc_city . " = '" . $this->id . "'
					AND " . d_azp_gsc_city_m_deleted . " = '2'
				LIMIT 1
			");
			...
			if (false != $var_result) {
				...
				Func::redir(URL . url_query_azp_gsc_city);
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_gsc_department ." tc_azp_gsc_department
					ON tc_azp_gsc_city." . d_azp_gsc_city_v_id_azp_gsc_department . "
						= tc_azp_gsc_department." . d_azp_gsc_department_id_azp_gsc_department . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_gsc_city." . d_azp_gsc_city_id_azp_gsc_city . " = '" . $this->id . "'
					AND tc_azp_gsc_city." . d_azp_gsc_city_m_deleted . " = '1'
				LIMIT 1
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_gsc_department ." tc_azp_gsc_department
					ON tc_azp_gsc_city." . d_azp_gsc_city_v_id_azp_gsc_department . "
						= tc_azp_gsc_department." . d_azp_gsc_department_id_azp_gsc_department . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_gsc_city." . d_azp_gsc_city_m_deleted . " = '3'
				ORDER BY tc_azp_gsc_city." . d_azp_gsc_city_id_azp_gsc_city . " ASC
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_gsc_department ." tc_azp_gsc_department
					ON tc_azp_gsc_city." . d_azp_gsc_city_v_id_azp_gsc_department . "
						= tc_azp_gsc_department." . d_azp_gsc_department_id_azp_gsc_department . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_gsc_city." . d_azp_gsc_city_m_deleted . " = '1'
				ORDER BY tc_azp_gsc_city." . d_azp_gsc_city_id_azp_gsc_city . " ASC
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_gsc_department ." tc_azp_gsc_department
					ON tc_azp_gsc_city." . d_azp_gsc_city_v_id_azp_gsc_department . "
						= tc_azp_gsc_department." . d_azp_gsc_department_id_azp_gsc_department . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_gsc_city." . d_azp_gsc_city_m_deleted . " = '2'
				ORDER BY tc_azp_gsc_city." . d_azp_gsc_city_id_azp_gsc_city . " ASC
			");
		}
		...
		final public function sql_controller_update() {
			...
			return $this->db->query("
				SELECT
					tc_azp_gsc_city." . d_azp_gsc_city_id_azp_gsc_city . " AS 'lbl_azp_gsc_city_id_azp_gsc_city',
					tc_azp_gsc_city." . d_azp_gsc_city_m_by_created . " AS 'lbl_azp_gsc_city_m_by_created',
					tc_azp_gsc_city." . d_azp_gsc_city_m_by_modified . " AS 'lbl_azp_gsc_city_m_by_modified',
					tc_azp_gsc_city." . d_azp_gsc_city_m_date_created . " AS 'lbl_azp_gsc_city_m_date_created',
					tc_azp_gsc_city." . d_azp_gsc_city_m_date_modified . " AS 'lbl_azp_gsc_city_m_date_modified',
					tc_azp_gsc_city." . d_azp_gsc_city_m_description . " AS 'lbl_azp_gsc_city_m_description',
					tc_azp_gsc_city." . d_azp_gsc_city_m_level . " AS 'lbl_azp_gsc_city_m_level',
					tc_azp_gsc_city." . d_azp_gsc_city_m_status . " AS 'lbl_azp_gsc_city_m_status',
					tc_azp_gsc_city." . d_azp_gsc_city_t_code . " AS 'lbl_azp_gsc_city_t_code',
					tc_azp_gsc_city." . d_azp_gsc_city_t_name . " AS 'lbl_azp_gsc_city_t_name',
					tc_azp_gsc_city." . d_azp_gsc_city_v_id_azp_gsc_department . " AS 'lbl_azp_gsc_city_v_id_azp_gsc_department'
				FROM " . t_azp_gsc_city . " tc_azp_gsc_city
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azp_gsc_city." . d_azp_gsc_city_m_by_created . "
		...
		final private function error_sql_gsc_city_delete(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				$sql_id = $this->db->select('*', t_azp_gsc_city, d_azp_gsc_city_id_azp_gsc_city . " = '" . $empty_id . "'");
				...
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select('*', t_azp_gsc_city, d_azp_gsc_city_id_azp_gsc_city . " = '" . $empty_id . "' AND " . d_azp_gsc_city_m_deleted . " = '2'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (false == $sql_id) {
					# Verificar si el resultado devuleto no existe para asignar un valor especifico
					if (strtolower($sql_id) == '') { $sql_id[0][0] = 0; }
				...
				$sql_session = $this->db->select('*', t_azp_gsc_city, d_azp_gsc_city_id_azp_gsc_city . " = '" . $empty_id . "' AND " . d_azp_gsc_city_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "' AND " . d_azp_gsc_city_m_level . " = '1'");
				# Verificar si el registro creado es igual el valor del campo nivel al valor dos
				$sql_level = $this->db->select('*', t_azp_gsc_city, d_azp_gsc_city_id_azp_gsc_city . " = '" . $empty_id . "' AND " . d_azp_gsc_city_m_level . " = '2'");
				# Verificar si el resultado de la sql es verdadero o falso
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_gsc_city_delete(array $data) : array {
			$var_error = $this->error_sql_azp_gsc_city_delete($data);
			...
			if (!isset($_SESSION[SESS_APP_ID])) {
				...
				$var_array = array(d_azp_gsc_city_m_deleted => '3',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_gsc_city, $var_array, d_azp_gsc_city_id_azp_gsc_city . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
		...
		final private function error_sql_azp_gsc_city_insert(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				$sql_code = $this->db->select(d_azp_gsc_city_t_code, t_azp_gsc_city, d_azp_gsc_city_t_code . " = '" . $empty_code . "'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (true == $sql_code) {
					# Verificiar si el valor recibido de la sql es diferente del digitado
		...
		/*=========================================================================================================================*/
		# Query Sql Insert
		final public function sql_azp_gsc_city_insert(array $data) : array {
			$var_error = $this->error_sql_azp_gsc_city_insert($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(
					d_azp_gsc_city_m_by_created => $_SESSION[SESS_APP_ID],
					d_azp_gsc_city_m_by_modified => $_SESSION[SESS_APP_ID],
					d_azp_gsc_city_m_date_created => DATE_HOUR,
					d_azp_gsc_city_m_date_modified => DATE_HOUR,
					d_azp_gsc_city_m_deleted => '1',
					d_azp_gsc_city_m_description => $empty_description,
					d_azp_gsc_city_m_level => '2',
					d_azp_gsc_city_m_status => '1',
					d_azp_gsc_city_m_temp => '1',
					d_azp_gsc_city_t_code => $empty_code,
					d_azp_gsc_city_t_name => ucwords(strtolower($empty_name)),
					d_azp_gsc_city_v_id_azp_gsc_department => $empty_gsc_department,
				);
				# Query Sql Insert: Registrar valores en la tabla segun sus campos
				$this->db->insert(t_azp_gsc_city, $var_array);
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_gsc_city_remove(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select('*', t_azp_gsc_city, d_azp_gsc_city_id_azp_gsc_city . " = '" . $empty_id . "' AND " . d_azp_gsc_city_m_deleted . " = '1'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (false == $sql_id) {
					# Verificar si el resultado devuleto no existe para asignar un valor especifico
					if (strtolower($sql_id) == '') { $sql_id[0][0] = 0; }
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_gsc_city_remove(array $data) : array {
			$var_error = $this->error_sql_azp_gsc_city_remove($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_gsc_city_m_deleted => '2',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_gsc_city, $var_array, d_azp_gsc_city_id_azp_gsc_city . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_gsc_city_restore(array $data) {
			try {
				#-------------------------------------------------------------------------#
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_gsc_city_restore(array $data) : array {
			$var_error = $this->error_sql_azp_gsc_city_restore($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_gsc_city_m_deleted => '1',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_gsc_city, $var_array, d_azp_gsc_city_id_azp_gsc_city . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_gsc_city_update(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				#-------------------------------------------------------------------------#
				# Verificar si el valor ingresado se encuentra repetido en los demas registros
				$sql_code = $this->db->select(d_azp_gsc_city_t_code, t_azp_gsc_city, d_azp_gsc_city_id_azp_gsc_city . " != '" . $empty_id . "' AND " . d_azp_gsc_city_t_code . " = '" . $empty_code . "'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (true == $sql_code) {
					# Verificiar si el valor recibido de la sql es diferente del digitado
					if (strtolower($sql_code[0][0]) == strtolower($empty_code)) {
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_gsc_city_update(array $data) : array {
			$var_error = $this->error_sql_azp_gsc_city_update($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				$var_sql_select = $this->db->query("
					...
					SELECT
						tc_azp_gsc_city." . d_azp_gsc_city_id_azp_gsc_city . " AS 'lbl_azp_gsc_city_id_azp_gsc_city',
						tc_azp_gsc_city." . d_azp_gsc_city_m_deleted . " AS 'lbl_azp_gsc_city_m_deleted',
						tc_azp_gsc_city." . d_azp_gsc_city_m_description . " AS 'lbl_azp_gsc_city_m_description',
						tc_azp_gsc_city." . d_azp_gsc_city_m_level . " AS 'lbl_azp_gsc_city_m_level',
						tc_azp_gsc_city." . d_azp_gsc_city_m_status . " AS 'lbl_azp_gsc_city_m_status',
						tc_azp_gsc_city." . d_azp_gsc_city_m_temp . " AS 'lbl_azp_gsc_city_m_temp',
						tc_azp_gsc_city." . d_azp_gsc_city_t_code . " AS 'lbl_azp_gsc_city_t_code',
						tc_azp_gsc_city." . d_azp_gsc_city_t_name . " AS 'lbl_azp_gsc_city_t_name',
						tc_azp_gsc_department." . d_azp_gsc_department_t_name . " AS 'lbl_azp_gsc_department_t_name'
					FROM " . t_azp_gsc_city . " tc_azp_gsc_city
					...
					INNER JOIN " . t_azp_gsc_department . " tc_azp_gsc_department
						ON tc_azp_gsc_city." . d_azp_gsc_city_v_id_azp_gsc_department . "
							= tc_azp_gsc_department." . d_azp_gsc_department_id_azp_gsc_department . "
					-- ---------------------------------------------------------------
					WHERE tc_azp_gsc_city." . d_azp_gsc_city_id_azp_gsc_city . " = '" . $empty_id . "'
					LIMIT 1
				");
				#-------------------------------------------------------------------------#
				...
				if (false != $var_sql_select) {
					...
					foreach ($var_sql_select as $key_sql_select):
						$var_array = array(
							d_azs_gsc_city_m_by_created => $_SESSION[SESS_APP_ID],
							d_azs_gsc_city_m_by_modified => $_SESSION[SESS_APP_ID],
							d_azs_gsc_city_m_date_created => DATE_HOUR,
							d_azs_gsc_city_m_date_modified => DATE_HOUR,
							d_azs_gsc_city_m_deleted => $key_sql_select['lbl_azp_gsc_city_m_deleted'],
							d_azs_gsc_city_m_description => $key_sql_select['lbl_azp_gsc_city_m_description'],
							d_azs_gsc_city_m_level => $key_sql_select['lbl_azp_gsc_city_m_level'],
							d_azs_gsc_city_m_status => $key_sql_select['lbl_azp_gsc_city_m_status'],
							d_azs_gsc_city_m_temp => $key_sql_select['lbl_azp_gsc_city_m_temp'],
							d_azs_gsc_city_t_code => $key_sql_select['lbl_azp_gsc_city_t_code'],
							d_azs_gsc_city_t_name => ucwords(strtolower($key_sql_select['lbl_azp_gsc_city_t_name'])),
							d_azs_gsc_city_u_gsc_department => ucwords(strtolower($key_sql_select['lbl_azp_gsc_department_t_name'])),
							d_azs_gsc_city_v_id_azp_gsc_city => $empty_id,
						);
						# Query Sql Insert: Insertar datos en la tabla con sus campos respectivos y asignados
						$this->db->insert(t_azs_gsc_city, $var_array);
					endforeach;
				}
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(
					...
					d_azp_gsc_city_m_date_modified => DATE_HOUR,
					d_azp_gsc_city_m_description => $empty_description,
					d_azp_gsc_city_m_status => $empty_state,
					d_azp_gsc_city_t_code => $empty_code,
					d_azp_gsc_city_t_name => ucwords(strtolower($empty_name)),
					d_azp_gsc_city_v_id_azp_gsc_department => $empty_gsc_department,
				);
