...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_menu_main_id_azs_menu_main",
				data: "lbl_azs_menu_main_id_azs_menu_main",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_menu_main_m_date_created",
				data: "lbl_azs_menu_main_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_menu_main_m_date_modified",
				data: "lbl_azs_menu_main_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_menu_main_m_description",
				data: "lbl_azs_menu_main_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Nombre",
				id: "lbl_azs_menu_main_t_name",
				data: "lbl_azs_menu_main_t_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Orden",
				id: "lbl_azs_menu_main_t_order",
				data: "lbl_azs_menu_main_t_order",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Url",
				id: "lbl_azs_menu_main_t_url",
				data: "lbl_azs_menu_main_t_url",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Icono",
				id: "lbl_azs_menu_main_u_icon_code",
				data: "lbl_azs_menu_main_u_icon_code",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_menu_main_id_azp_menu_main").innerHTML = objData.data.lbl_azp_menu_main_id_azp_menu_main;
					...
					document.querySelector("#lbl_azp_menu_main_m_date_created").innerHTML = objData.data.lbl_azp_menu_main_m_date_created;
					document.querySelector("#lbl_azp_menu_main_m_date_modified").innerHTML = objData.data.lbl_azp_menu_main_m_date_modified;
					document.querySelector("#lbl_azp_menu_main_m_description").innerHTML = objData.data.lbl_azp_menu_main_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_menu_main_t_name").innerHTML = objData.data.lbl_azp_menu_main_t_name;
					document.querySelector("#lbl_azp_menu_main_t_order").innerHTML = objData.data.lbl_azp_menu_main_t_order;
					document.querySelector("#lbl_azp_menu_main_t_url").innerHTML = objData.data.lbl_azp_menu_main_t_url;
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_menu_main_id_azp_menu_main;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_menu_main_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_menu_main_m_status;
					document.querySelector("#field_up_name").value = objData.data.lbl_azp_menu_main_t_name;
					document.querySelector("#field_up_order").value = objData.data.lbl_azp_menu_main_t_order;
					document.querySelector("#field_up_url").value = objData.data.lbl_azp_menu_main_t_url;
					document.querySelector("#field_up_icon_code").value = objData.data.lbl_azp_menu_main_v_id_azp_icon_code;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
