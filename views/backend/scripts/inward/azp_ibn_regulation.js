...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_regulation_id_azs_ibn_regulation",
				data: "lbl_azs_ibn_regulation_id_azs_ibn_regulation",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_regulation_m_date_created",
				data: "lbl_azs_ibn_regulation_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_regulation_m_date_modified",
				data: "lbl_azs_ibn_regulation_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_regulation_m_description",
				data: "lbl_azs_ibn_regulation_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Seleccion",
				id: "lbl_azs_ibn_regulation_t_selector",
				data: "lbl_azs_ibn_regulation_t_selector",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Calificacion",
				id: "lbl_azs_ibn_regulation_u_ibn_calification",
				data: "lbl_azs_ibn_regulation_u_ibn_calification",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Cliente",
				id: "lbl_azs_ibn_regulation_u_ibn_client",
				data: "lbl_azs_ibn_regulation_u_ibn_client",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_regulation/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_regulation/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_regulation_id_azp_ibn_regulation").innerHTML = objData.data.lbl_azp_ibn_regulation_id_azp_ibn_regulation;
					...
					document.querySelector("#lbl_azp_ibn_regulation_m_date_created").innerHTML = objData.data.lbl_azp_ibn_regulation_m_date_created;
					document.querySelector("#lbl_azp_ibn_regulation_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_regulation_m_date_modified;
					document.querySelector("#lbl_azp_ibn_regulation_m_description").innerHTML = objData.data.lbl_azp_ibn_regulation_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_ibn_regulation_t_selector").innerHTML = objData.data.lbl_azp_ibn_regulation_t_selector;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_regulation/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_regulation/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_regulation/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_regulation_id_azp_ibn_regulation;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_regulation_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_regulation_m_status;
					document.querySelector("#field_up_selector").value = objData.data.lbl_azp_ibn_regulation_t_selector;
					document.querySelector("#field_up_ibn_calification").value = objData.data.lbl_azp_ibn_regulation_v_id_azp_ibn_calification;
					document.querySelector("#field_up_ibn_client").value = objData.data.lbl_azp_ibn_regulation_v_id_azp_ibn_client;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
