<?php
	...
	//------------------------------------------------
	final class m_azp_gsc_notaryModel extends Models implements OCREND {
		/*=========================================================================================================================*/
		...
		final public function sql_controller_by_create() {
			...
			return $this->db->query("
				SELECT
					tc_azp_gsc_notary." . d_azp_gsc_notary_id_azp_gsc_notary . " AS 'lbl_azp_gsc_notary_id_azp_gsc_notary',
					tc_azp_user_created." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_created',
					tc_azp_user_modified." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_modified',
					tc_azp_gsc_notary." . d_azp_gsc_notary_m_date_created . " AS 'lbl_azp_gsc_notary_m_date_created',
					tc_azp_gsc_notary." . d_azp_gsc_notary_m_date_modified . " AS 'lbl_azp_gsc_notary_m_date_modified',
					tc_azp_gsc_notary." . d_azp_gsc_notary_m_description . " AS 'lbl_azp_gsc_notary_m_description',
					tc_azp_sys_level." . d_azp_sys_level_t_name . " AS 'lbl_azp_sys_level_t_name',
					tc_azp_sys_state." . d_azp_sys_state_t_name . " AS 'lbl_azp_sys_state_t_name',
					tc_azp_gsc_notary." . d_azp_gsc_notary_t_address . " AS 'lbl_azp_gsc_notary_t_address',
					tc_azp_gsc_notary." . d_azp_gsc_notary_t_business_name . " AS 'lbl_azp_gsc_notary_t_business_name',
					tc_azp_gsc_notary." . d_azp_gsc_notary_t_contact . " AS 'lbl_azp_gsc_notary_t_contact',
					tc_azp_gsc_notary." . d_azp_gsc_notary_t_email . " AS 'lbl_azp_gsc_notary_t_email',
					tc_azp_gsc_notary." . d_azp_gsc_notary_t_phone_fixed . " AS 'lbl_azp_gsc_notary_t_phone_fixed',
					tc_azp_gsc_notary." . d_azp_gsc_notary_t_phone_movil . " AS 'lbl_azp_gsc_notary_t_phone_movil',
					tc_azp_gsc_city." . d_azp_gsc_city_t_name . " AS 'lbl_azp_gsc_city_t_name'
				FROM " . t_azp_gsc_notary . " tc_azp_gsc_notary
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azp_gsc_notary." . d_azp_gsc_notary_m_by_created . "
						= tc_azp_user_created." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_user . " tc_azp_user_modified
					ON tc_azp_gsc_notary." . d_azp_gsc_notary_m_by_modified . "
						= tc_azp_user_modified." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_sys_level . " tc_azp_sys_level
					ON tc_azp_gsc_notary." . d_azp_gsc_notary_m_level . "
						= tc_azp_sys_level." . d_azp_sys_level_t_value . "
				INNER JOIN " . t_azp_sys_state . " tc_azp_sys_state
					ON tc_azp_gsc_notary." . d_azp_gsc_notary_m_status . "
						= tc_azp_sys_state." . d_azp_sys_state_t_value . "
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_gsc_city ." tc_azp_gsc_city
					ON tc_azp_gsc_notary." . d_azp_gsc_notary_v_id_azp_gsc_city . "
						= tc_azp_gsc_city." . d_azp_gsc_city_id_azp_gsc_city . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_gsc_notary." . d_azp_gsc_notary_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "'
					AND tc_azp_gsc_notary." . d_azp_gsc_notary_m_deleted . " = '1'
				ORDER BY tc_azp_gsc_notary." . d_azp_gsc_notary_id_azp_gsc_notary . " ASC
			");
		}
		...
		final public function sql_controller_change() {
			...
			return $this->db->query("
				SELECT
					tc_azs_gsc_notary." . d_azs_gsc_notary_id_azs_gsc_notary . " AS 'lbl_azs_gsc_notary_id_azs_gsc_notary',
					tc_azs_gsc_notary." . d_azs_gsc_notary_m_date_modified . " AS 'lbl_azs_gsc_notary_m_date_modified',
					tc_azp_user_created." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_created',
					tc_azp_user_modified." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_modified',
					tc_azs_gsc_notary." . d_azs_gsc_notary_m_date_created . " AS 'lbl_azs_gsc_notary_m_date_created',
					tc_azs_gsc_notary." . d_azs_gsc_notary_m_date_modified . " AS 'lbl_azs_gsc_notary_m_date_modified',
					tc_azs_gsc_notary." . d_azs_gsc_notary_m_description . " AS 'lbl_azs_gsc_notary_m_description',
					tc_azp_sys_level." . d_azp_sys_level_t_name . " AS 'lbl_azp_sys_level_t_name',
					tc_azp_sys_state." . d_azp_sys_state_t_name . " AS 'lbl_azp_sys_state_t_name',
					tc_azs_gsc_notary." . d_azs_gsc_notary_t_address . " AS 'lbl_azs_gsc_notary_t_address',
					tc_azs_gsc_notary." . d_azs_gsc_notary_t_business_name . " AS 'lbl_azs_gsc_notary_t_business_name',
					tc_azs_gsc_notary." . d_azs_gsc_notary_t_contact . " AS 'lbl_azs_gsc_notary_t_contact',
					tc_azs_gsc_notary." . d_azs_gsc_notary_t_email . " AS 'lbl_azs_gsc_notary_t_email',
					tc_azs_gsc_notary." . d_azs_gsc_notary_t_phone_fixed . " AS 'lbl_azs_gsc_notary_t_phone_fixed',
					tc_azs_gsc_notary." . d_azs_gsc_notary_t_phone_movil . " AS 'lbl_azs_gsc_notary_t_phone_movil',
					tc_azs_gsc_notary." . d_azs_gsc_notary_u_gsc_city . " AS 'lbl_azs_gsc_notary_u_gsc_city',
					tc_azs_gsc_notary." . d_azs_gsc_notary_v_id_azp_gsc_notary . " AS 'lbl_azs_gsc_notary_v_id_azp_gsc_notary'
				FROM " . t_azs_gsc_notary . " tc_azs_gsc_notary
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azs_gsc_notary." . d_azs_gsc_notary_m_by_created . "
						= tc_azp_user_created." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_user . " tc_azp_user_modified
					ON tc_azs_gsc_notary." . d_azs_gsc_notary_m_by_modified . "
						= tc_azp_user_modified." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_sys_level . " tc_azp_sys_level
					ON tc_azs_gsc_notary." . d_azs_gsc_notary_m_level . "
						= tc_azp_sys_level." . d_azp_sys_level_t_value . "
				INNER JOIN " . t_azp_sys_state . " tc_azp_sys_state
					ON tc_azs_gsc_notary." . d_azs_gsc_notary_m_status . "
						= tc_azp_sys_state." . d_azp_sys_state_t_value . "
				-- ---------------------------------------------------------------
				WHERE tc_azs_gsc_notary." . d_azs_gsc_notary_v_id_azp_gsc_notary . " = '" . $this->id . "'
				ORDER BY tc_azs_gsc_notary." . d_azs_gsc_notary_m_date_modified . " DESC
			");
		}
		...
		final public function sql_controller_delete() : array {
			...
			$var_sql = $this->db->query("
				SELECT * FROM " . t_azp_gsc_notary . "
				WHERE " . d_azp_gsc_notary_id_azp_gsc_notary . " = '" . $this->id . "'
					AND " . d_azp_gsc_notary_m_deleted . " = '2'
				LIMIT 1
			");
			...
			if (false != $var_result) {
				...
				Func::redir(URL . url_query_azp_gsc_notary);
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_gsc_city ." tc_azp_gsc_city
					ON tc_azp_gsc_notary." . d_azp_gsc_notary_v_id_azp_gsc_city . "
						= tc_azp_gsc_city." . d_azp_gsc_city_id_azp_gsc_city . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_gsc_notary." . d_azp_gsc_notary_id_azp_gsc_notary . " = '" . $this->id . "'
					AND tc_azp_gsc_notary." . d_azp_gsc_notary_m_deleted . " = '1'
				LIMIT 1
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_gsc_city ." tc_azp_gsc_city
					ON tc_azp_gsc_notary." . d_azp_gsc_notary_v_id_azp_gsc_city . "
						= tc_azp_gsc_city." . d_azp_gsc_city_id_azp_gsc_city . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_gsc_notary." . d_azp_gsc_notary_m_deleted . " = '3'
				ORDER BY tc_azp_gsc_notary." . d_azp_gsc_notary_id_azp_gsc_notary . " ASC
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_gsc_city ." tc_azp_gsc_city
					ON tc_azp_gsc_notary." . d_azp_gsc_notary_v_id_azp_gsc_city . "
						= tc_azp_gsc_city." . d_azp_gsc_city_id_azp_gsc_city . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_gsc_notary." . d_azp_gsc_notary_m_deleted . " = '1'
				ORDER BY tc_azp_gsc_notary." . d_azp_gsc_notary_id_azp_gsc_notary . " ASC
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_gsc_city ." tc_azp_gsc_city
					ON tc_azp_gsc_notary." . d_azp_gsc_notary_v_id_azp_gsc_city . "
						= tc_azp_gsc_city." . d_azp_gsc_city_id_azp_gsc_city . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_gsc_notary." . d_azp_gsc_notary_m_deleted . " = '2'
				ORDER BY tc_azp_gsc_notary." . d_azp_gsc_notary_id_azp_gsc_notary . " ASC
			");
		}
		...
		final public function sql_controller_update() {
			...
			return $this->db->query("
				SELECT
					tc_azp_gsc_notary." . d_azp_gsc_notary_id_azp_gsc_notary . " AS 'lbl_azp_gsc_notary_id_azp_gsc_notary',
					tc_azp_gsc_notary." . d_azp_gsc_notary_m_by_created . " AS 'lbl_azp_gsc_notary_m_by_created',
					tc_azp_gsc_notary." . d_azp_gsc_notary_m_by_modified . " AS 'lbl_azp_gsc_notary_m_by_modified',
					tc_azp_gsc_notary." . d_azp_gsc_notary_m_date_created . " AS 'lbl_azp_gsc_notary_m_date_created',
					tc_azp_gsc_notary." . d_azp_gsc_notary_m_date_modified . " AS 'lbl_azp_gsc_notary_m_date_modified',
					tc_azp_gsc_notary." . d_azp_gsc_notary_m_description . " AS 'lbl_azp_gsc_notary_m_description',
					tc_azp_gsc_notary." . d_azp_gsc_notary_m_level . " AS 'lbl_azp_gsc_notary_m_level',
					tc_azp_gsc_notary." . d_azp_gsc_notary_m_status . " AS 'lbl_azp_gsc_notary_m_status',
					tc_azp_gsc_notary." . d_azp_gsc_notary_t_address . " AS 'lbl_azp_gsc_notary_t_address',
					tc_azp_gsc_notary." . d_azp_gsc_notary_t_business_name . " AS 'lbl_azp_gsc_notary_t_business_name',
					tc_azp_gsc_notary." . d_azp_gsc_notary_t_contact . " AS 'lbl_azp_gsc_notary_t_contact',
					tc_azp_gsc_notary." . d_azp_gsc_notary_t_email . " AS 'lbl_azp_gsc_notary_t_email',
					tc_azp_gsc_notary." . d_azp_gsc_notary_t_phone_fixed . " AS 'lbl_azp_gsc_notary_t_phone_fixed',
					tc_azp_gsc_notary." . d_azp_gsc_notary_t_phone_movil . " AS 'lbl_azp_gsc_notary_t_phone_movil',
					tc_azp_gsc_notary." . d_azp_gsc_notary_v_id_azp_gsc_city . " AS 'lbl_azp_gsc_notary_v_id_azp_gsc_city'
				FROM " . t_azp_gsc_notary . " tc_azp_gsc_notary
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azp_gsc_notary." . d_azp_gsc_notary_m_by_created . "
		...
		final private function error_sql_gsc_notary_delete(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				$sql_id = $this->db->select('*', t_azp_gsc_notary, d_azp_gsc_notary_id_azp_gsc_notary . " = '" . $empty_id . "'");
				...
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select('*', t_azp_gsc_notary, d_azp_gsc_notary_id_azp_gsc_notary . " = '" . $empty_id . "' AND " . d_azp_gsc_notary_m_deleted . " = '2'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (false == $sql_id) {
					# Verificar si el resultado devuleto no existe para asignar un valor especifico
					if (strtolower($sql_id) == '') { $sql_id[0][0] = 0; }
				...
				$sql_session = $this->db->select('*', t_azp_gsc_notary, d_azp_gsc_notary_id_azp_gsc_notary . " = '" . $empty_id . "' AND " . d_azp_gsc_notary_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "' AND " . d_azp_gsc_notary_m_level . " = '1'");
				# Verificar si el registro creado es igual el valor del campo nivel al valor dos
				$sql_level = $this->db->select('*', t_azp_gsc_notary, d_azp_gsc_notary_id_azp_gsc_notary . " = '" . $empty_id . "' AND " . d_azp_gsc_notary_m_level . " = '2'");
				# Verificar si el resultado de la sql es verdadero o falso
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_gsc_notary_delete(array $data) : array {
			$var_error = $this->error_sql_azp_gsc_notary_delete($data);
			...
			if (!isset($_SESSION[SESS_APP_ID])) {
				...
				$var_array = array(d_azp_gsc_notary_m_deleted => '3',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_gsc_notary, $var_array, d_azp_gsc_notary_id_azp_gsc_notary . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
		...
		final private function error_sql_azp_gsc_notary_insert(array $data) {
			try {
				#-------------------------------------------------------------------------#
		...
		/*=========================================================================================================================*/
		# Query Sql Insert
		final public function sql_azp_gsc_notary_insert(array $data) : array {
			$var_error = $this->error_sql_azp_gsc_notary_insert($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(
					d_azp_gsc_notary_m_by_created => $_SESSION[SESS_APP_ID],
					d_azp_gsc_notary_m_by_modified => $_SESSION[SESS_APP_ID],
					d_azp_gsc_notary_m_date_created => DATE_HOUR,
					d_azp_gsc_notary_m_date_modified => DATE_HOUR,
					d_azp_gsc_notary_m_deleted => '1',
					d_azp_gsc_notary_m_description => $empty_description,
					d_azp_gsc_notary_m_level => '2',
					d_azp_gsc_notary_m_status => '1',
					d_azp_gsc_notary_m_temp => '1',
					d_azp_gsc_notary_t_address => ucwords(strtolower($empty_address)),
					d_azp_gsc_notary_t_business_name => ucwords(strtolower($empty_business_name)),
					d_azp_gsc_notary_t_contact => ucwords(strtolower($empty_contact)),
					d_azp_gsc_notary_t_email => strtolower($empty_email),
					d_azp_gsc_notary_t_phone_fixed => $empty_phone_fixed,
					d_azp_gsc_notary_t_phone_movil => $empty_phone_movil,
					d_azp_gsc_notary_v_id_azp_gsc_city => $empty_gsc_city,
				);
				# Query Sql Insert: Registrar valores en la tabla segun sus campos
				$this->db->insert(t_azp_gsc_notary, $var_array);
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_gsc_notary_remove(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select('*', t_azp_gsc_notary, d_azp_gsc_notary_id_azp_gsc_notary . " = '" . $empty_id . "' AND " . d_azp_gsc_notary_m_deleted . " = '1'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (false == $sql_id) {
					# Verificar si el resultado devuleto no existe para asignar un valor especifico
					if (strtolower($sql_id) == '') { $sql_id[0][0] = 0; }
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_gsc_notary_remove(array $data) : array {
			$var_error = $this->error_sql_azp_gsc_notary_remove($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_gsc_notary_m_deleted => '2',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_gsc_notary, $var_array, d_azp_gsc_notary_id_azp_gsc_notary . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_gsc_notary_restore(array $data) {
			try {
				#-------------------------------------------------------------------------#
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_gsc_notary_restore(array $data) : array {
			$var_error = $this->error_sql_azp_gsc_notary_restore($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_gsc_notary_m_deleted => '1',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_gsc_notary, $var_array, d_azp_gsc_notary_id_azp_gsc_notary . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_gsc_notary_update(array $data) {
			try {
				#-------------------------------------------------------------------------#
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_gsc_notary_update(array $data) : array {
			$var_error = $this->error_sql_azp_gsc_notary_update($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				$var_sql_select = $this->db->select('*', t_azp_gsc_notary, d_azp_gsc_notary_id_azp_gsc_notary . " = '" . $empty_id . "'");
				# Validar si la sentencia query ejecutada es correcta y no falsa
				if (false != $var_sql_select) {
					# El constructor foreach proporciona un modo sencillo de iterar sobre arrays.
					foreach ($var_sql_select as $key_sql_select):
						$var_array = array(
							d_azs_gsc_notary_m_by_created => $_SESSION[SESS_APP_ID],
							d_azs_gsc_notary_m_by_modified => $_SESSION[SESS_APP_ID],
							d_azs_gsc_notary_m_date_created => DATE_HOUR,
							d_azs_gsc_notary_m_date_modified => DATE_HOUR,
							d_azs_gsc_notary_m_deleted => $key_sql_select[d_azp_gsc_notary_m_deleted],
							d_azs_gsc_notary_m_description => $key_sql_select[d_azp_gsc_notary_m_description],
							d_azs_gsc_notary_m_level => $key_sql_select[d_azp_gsc_notary_m_level],
							d_azs_gsc_notary_m_status => $key_sql_select[d_azp_gsc_notary_m_status],
							d_azs_gsc_notary_m_temp => $key_sql_select[d_azp_gsc_notary_m_temp],
							d_azs_gsc_notary_t_address => ucwords(strtolower($key_sql_select[d_azp_gsc_notary_t_address])),
							d_azs_gsc_notary_t_business_name => ucwords(strtolower($key_sql_select[d_azp_gsc_notary_t_business_name])),
							d_azs_gsc_notary_t_contact => ucwords(strtolower($key_sql_select[d_azp_gsc_notary_t_contact])),
							d_azs_gsc_notary_t_email => strtolower($key_sql_select[d_azp_gsc_notary_t_email]),
							d_azs_gsc_notary_t_phone_fixed => $key_sql_select[d_azp_gsc_notary_t_phone_fixed],
							d_azs_gsc_notary_t_phone_movil => $key_sql_select[d_azp_gsc_notary_t_phone_movil],
							d_azs_gsc_notary_u_gsc_city => $key_sql_select[d_azp_gsc_notary_v_id_azp_gsc_city],
							d_azs_gsc_notary_v_id_azp_gsc_notary => $empty_id,
						);
						# Query Sql Insert: Insertar datos en la tabla con sus campos respectivos y asignados
						$this->db->insert(t_azs_gsc_notary, $var_array);
					endforeach;
				}
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(
					...
					d_azp_gsc_notary_m_date_modified => DATE_HOUR,
					d_azp_gsc_notary_m_description => $empty_description,
					d_azp_gsc_notary_m_status => $empty_state,
					d_azp_gsc_notary_t_address => ucwords(strtolower($empty_address)),
					d_azp_gsc_notary_t_business_name => ucwords(strtolower($empty_business_name)),
					d_azp_gsc_notary_t_contact => ucwords(strtolower($empty_contact)),
					d_azp_gsc_notary_t_email => strtolower($empty_email),
