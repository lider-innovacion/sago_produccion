...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_crt_third_parties_id_azs_crt_third_parties",
				data: "lbl_azs_crt_third_parties_id_azs_crt_third_parties",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_crt_third_parties_m_date_created",
				data: "lbl_azs_crt_third_parties_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_crt_third_parties_m_date_modified",
				data: "lbl_azs_crt_third_parties_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_crt_third_parties_m_description",
				data: "lbl_azs_crt_third_parties_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Direccion",
				id: "lbl_azs_crt_third_parties_t_address",
				data: "lbl_azs_crt_third_parties_t_address",
				type: "readonly",
				visible: true,
			},
			{
				title: "Consecutivo",
				id: "lbl_azs_crt_third_parties_t_consecutive",
				data: "lbl_azs_crt_third_parties_t_consecutive",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Contacto",
				id: "lbl_azs_crt_third_parties_t_contact",
				data: "lbl_azs_crt_third_parties_t_contact",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_crt_third_parties_t_email",
				data: "lbl_azs_crt_third_parties_t_email",
				type: "readonly",
				visible: true,
			},
			{
				title: "Contraseña",
				id: "lbl_azs_crt_third_parties_t_password",
				data: "lbl_azs_crt_third_parties_t_password",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Telefono Fijo",
				id: "lbl_azs_crt_third_parties_t_phone_fixed",
				data: "lbl_azs_crt_third_parties_t_phone_fixed",
				type: "readonly",
				visible: true,
			},
			{
				title: "Telefono Movil",
				id: "lbl_azs_crt_third_parties_t_phone_movil",
				data: "lbl_azs_crt_third_parties_t_phone_movil",
				type: "readonly",
				visible: true,
			},
			{
				title: "Telefono Secundario",
				id: "lbl_azs_crt_third_parties_t_phone_second",
				data: "lbl_azs_crt_third_parties_t_phone_second",
				type: "readonly",
				visible: true,
			},
			{
				title: "Ciudad",
				id: "lbl_azs_crt_third_parties_u_crt_city",
				data: "lbl_azs_crt_third_parties_u_crt_city",
				type: "readonly",
				visible: true,
			},
			{
				title: "Tipo Proveedor",
				id: "lbl_azs_crt_third_parties_u_crt_third_type",
				data: "lbl_azs_crt_third_parties_u_crt_third_type",
				type: "readonly",
				visible: true,
			},
		];
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_crt_third_parties/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_crt_third_parties/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_crt_third_parties_id_azp_crt_third_parties").innerHTML = objData.data.lbl_azp_crt_third_parties_id_azp_crt_third_parties;
					...
					document.querySelector("#lbl_azp_crt_third_parties_m_date_created").innerHTML = objData.data.lbl_azp_crt_third_parties_m_date_created;
					document.querySelector("#lbl_azp_crt_third_parties_m_date_modified").innerHTML = objData.data.lbl_azp_crt_third_parties_m_date_modified;
					document.querySelector("#lbl_azp_crt_third_parties_m_description").innerHTML = objData.data.lbl_azp_crt_third_parties_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_crt_third_parties_t_address").innerHTML = objData.data.lbl_azp_crt_third_parties_t_address;
					document.querySelector("#lbl_azp_crt_third_parties_t_consecutive").innerHTML = objData.data.lbl_azp_crt_third_parties_t_consecutive;
					document.querySelector("#lbl_azp_crt_third_parties_t_contact").innerHTML = objData.data.lbl_azp_crt_third_parties_t_contact;
					document.querySelector("#lbl_azp_crt_third_parties_t_email").innerHTML = objData.data.lbl_azp_crt_third_parties_t_email;
					document.querySelector("#lbl_azp_crt_third_parties_t_password").innerHTML = objData.data.lbl_azp_crt_third_parties_t_password;
					document.querySelector("#lbl_azp_crt_third_parties_t_phone_fixed").innerHTML = objData.data.lbl_azp_crt_third_parties_t_phone_fixed;
					document.querySelector("#lbl_azp_crt_third_parties_t_phone_movil").innerHTML = objData.data.lbl_azp_crt_third_parties_t_phone_movil;
					document.querySelector("#lbl_azp_crt_third_parties_t_phone_second").innerHTML = objData.data.lbl_azp_crt_third_parties_t_phone_second;
					document.querySelector("#lbl_azp_crt_city_t_name").innerHTML = objData.data.lbl_azp_crt_city_t_name;
					document.querySelector("#lbl_azp_crt_third_type_t_name").innerHTML = objData.data.lbl_azp_crt_third_type_t_name;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_crt_third_parties/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_crt_third_parties/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_crt_third_parties/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_crt_third_parties_id_azp_crt_third_parties;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_crt_third_parties_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_crt_third_parties_m_status;
					document.querySelector("#field_up_address").value = objData.data.lbl_azp_crt_third_parties_t_address;
					document.querySelector("#field_up_consecutive").value = objData.data.lbl_azp_crt_third_parties_t_consecutive;
					document.querySelector("#field_up_contact").value = objData.data.lbl_azp_crt_third_parties_t_contact;
					document.querySelector("#field_up_email").value = objData.data.lbl_azp_crt_third_parties_t_email;
					document.querySelector("#field_up_email_confirm").value = objData.data.lbl_azp_crt_third_parties_t_email;
					document.querySelector("#field_up_password").value = objData.data.lbl_azp_crt_third_parties_t_password;
					document.querySelector("#field_up_phone_fixed").value = objData.data.lbl_azp_crt_third_parties_t_phone_fixed;
					document.querySelector("#field_up_phone_movil").value = objData.data.lbl_azp_crt_third_parties_t_phone_movil;
					document.querySelector("#field_up_phone_second").value = objData.data.lbl_azp_crt_third_parties_t_phone_second;
					document.querySelector("#field_up_crt_city").value = objData.data.lbl_azp_crt_third_parties_v_id_azp_crt_city;
					document.querySelector("#field_up_crt_third_type").value = objData.data.lbl_azp_crt_third_parties_v_id_azp_crt_third_type;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
