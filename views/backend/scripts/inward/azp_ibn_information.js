...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_information_id_azs_ibn_information",
				data: "lbl_azs_ibn_information_id_azs_ibn_information",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_information_m_date_created",
				data: "lbl_azs_ibn_information_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_information_m_date_modified",
				data: "lbl_azs_ibn_information_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_information_m_description",
				data: "lbl_azs_ibn_information_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Nombre",
				id: "lbl_azs_ibn_information_w_name",
				data: "lbl_azs_ibn_information_w_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Documento",
				id: "lbl_azs_ibn_information_w_document",
				data: "lbl_azs_ibn_information_w_document",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_information/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_information/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_information_id_azp_ibn_information").innerHTML = objData.data.lbl_azp_ibn_information_id_azp_ibn_information;
					...
					document.querySelector("#lbl_azp_ibn_information_m_date_created").innerHTML = objData.data.lbl_azp_ibn_information_m_date_created;
					document.querySelector("#lbl_azp_ibn_information_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_information_m_date_modified;
					document.querySelector("#lbl_azp_ibn_information_m_description").innerHTML = objData.data.lbl_azp_ibn_information_m_description;
					...
					document.querySelector("#lbl_azp_ibn_information_w_name").innerHTML = objData.data.lbl_azp_ibn_information_w_name;
					document.querySelector("#lbl_azp_ibn_information_w_document").innerHTML = objData.data.lbl_azp_ibn_information_w_document;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_information/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_information/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_information/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_information_id_azp_ibn_information;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_information_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_information_m_status;
					document.querySelector("#field_up_ibn_control").value = objData.data.lbl_azp_ibn_information_v_id_azp_ibn_control;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-file').modal('show');
					document.querySelector('#field_fl_id').value = objData.data.lbl_azp_ibn_information_id_azp_ibn_information;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
			...
			ok: {
				...
				callback: function() {
					...
					//if (!extensions.exec(path)) { document.getElementById('field_fl_file').value = ''; } else {
						$.ajax({
							type: "POST",
							url: "api/azp_ibn_information/file",
							datatype: "HTML",
