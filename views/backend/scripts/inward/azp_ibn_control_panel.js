...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_control_panel_id_azs_ibn_control_panel",
				data: "lbl_azs_ibn_control_panel_id_azs_ibn_control_panel",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_control_panel_m_date_created",
				data: "lbl_azs_ibn_control_panel_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_control_panel_m_date_modified",
				data: "lbl_azs_ibn_control_panel_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_control_panel_m_description",
				data: "lbl_azs_ibn_control_panel_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_control_panel_t_code_research",
				data: "lbl_azs_ibn_control_panel_t_code_research",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Fecha Llegada",
				id: "lbl_azs_ibn_control_panel_t_date_arrival",
				data: "lbl_azs_ibn_control_panel_t_date_arrival",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Fecha Final",
				id: "lbl_azs_ibn_control_panel_t_date_final",
				data: "lbl_azs_ibn_control_panel_t_date_final",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Fecha Cargue",
				id: "lbl_azs_ibn_control_panel_t_date_load",
				data: "lbl_azs_ibn_control_panel_t_date_load",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Entidad",
				id: "lbl_azs_ibn_control_panel_t_entity",
				data: "lbl_azs_ibn_control_panel_t_entity",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Finalizacion",
				id: "lbl_azs_ibn_control_panel_t_finished",
				data: "lbl_azs_ibn_control_panel_t_finished",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Cliente",
				id: "lbl_azs_ibn_control_panel_u_ibn_client",
				data: "lbl_azs_ibn_control_panel_u_ibn_client",
				type: "text",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_control_panel/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_control_panel/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_control_panel_id_azp_ibn_control_panel").innerHTML = objData.data.lbl_azp_ibn_control_panel_id_azp_ibn_control_panel;
					...
					document.querySelector("#lbl_azp_ibn_control_panel_m_date_created").innerHTML = objData.data.lbl_azp_ibn_control_panel_m_date_created;
					document.querySelector("#lbl_azp_ibn_control_panel_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_control_panel_m_date_modified;
					document.querySelector("#lbl_azp_ibn_control_panel_m_description").innerHTML = objData.data.lbl_azp_ibn_control_panel_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_ibn_control_panel_t_code_research").innerHTML = objData.data.lbl_azp_ibn_control_panel_t_code_research;
					document.querySelector("#lbl_azp_ibn_control_panel_t_date_arrival").innerHTML = objData.data.lbl_azp_ibn_control_panel_t_date_arrival;
					document.querySelector("#lbl_azp_ibn_control_panel_t_date_final").innerHTML = objData.data.lbl_azp_ibn_control_panel_t_date_final;
					document.querySelector("#lbl_azp_ibn_control_panel_t_date_load").innerHTML = objData.data.lbl_azp_ibn_control_panel_t_date_load;
					document.querySelector("#lbl_azp_ibn_control_panel_t_entity").innerHTML = objData.data.lbl_azp_ibn_control_panel_t_entity;
					document.querySelector("#lbl_azp_ibn_control_panel_t_finished").innerHTML = objData.data.lbl_azp_ibn_control_panel_t_finished;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_control_panel/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_control_panel/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_control_panel/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_control_panel_id_azp_ibn_control_panel;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_control_panel_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_control_panel_m_status;
					document.querySelector("#field_up_code_research").value = objData.data.lbl_azp_ibn_control_panel_t_code_research;
					document.querySelector("#field_up_date_arrival").value = objData.data.lbl_azp_ibn_control_panel_t_date_arrival;
					document.querySelector("#field_up_date_final").value = objData.data.lbl_azp_ibn_control_panel_t_date_final;
					document.querySelector("#field_up_date_load").value = objData.data.lbl_azp_ibn_control_panel_t_date_load;
					document.querySelector("#field_up_entity").value = objData.data.lbl_azp_ibn_control_panel_t_entity;
					document.querySelector("#field_up_finished").value = objData.data.lbl_azp_ibn_control_panel_t_finished;
					document.querySelector("#field_up_ibn_client").value = objData.data.lbl_azp_ibn_control_panel_v_id_azp_ibn_client;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
