...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_fct_tariff_id_azs_fct_tariff",
				data: "lbl_azs_fct_tariff_id_azs_fct_tariff",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_fct_tariff_m_date_created",
				data: "lbl_azs_fct_tariff_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_fct_tariff_m_date_modified",
				data: "lbl_azs_fct_tariff_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_fct_tariff_m_description",
				data: "lbl_azs_fct_tariff_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Nombre",
				id: "lbl_azs_fct_tariff_t_value",
				data: "lbl_azs_fct_tariff_t_value",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_fct_tariff_id_azp_fct_tariff").innerHTML = objData.data.lbl_azp_fct_tariff_id_azp_fct_tariff;
					...
					document.querySelector("#lbl_azp_fct_tariff_m_date_created").innerHTML = objData.data.lbl_azp_fct_tariff_m_date_created;
					document.querySelector("#lbl_azp_fct_tariff_m_date_modified").innerHTML = objData.data.lbl_azp_fct_tariff_m_date_modified;
					document.querySelector("#lbl_azp_fct_tariff_m_description").innerHTML = objData.data.lbl_azp_fct_tariff_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_fct_tariff_t_value").innerHTML = objData.data.lbl_azp_fct_tariff_t_value;
					...
					document.querySelector("#lbl_azp_fct_sub_service_t_name").innerHTML = objData.data.lbl_azp_fct_sub_service_t_name;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_fct_tariff/restore",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_fct_tariff_id_azp_fct_tariff;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_fct_tariff_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_fct_tariff_m_status;
					document.querySelector("#field_up_value").value = objData.data.lbl_azp_fct_tariff_t_value;
					document.querySelector("#field_up_client").value = objData.data.lbl_azp_fct_tariff_v_id_azp_fct_client;
					document.querySelector("#field_up_service").value = objData.data.lbl_azp_fct_tariff_v_id_azp_fct_service;
					document.querySelector("#field_up_sub_service").value = objData.data.lbl_azp_fct_tariff_v_id_azp_fct_sub_service;

					var id = document.getElementById('field_up_service').value;
					var ajaxurl = var_url + 'api' + var_controller + "subservice/" + id + "/";
					$.ajax({ type: 'POST', url: ajaxurl, }).done(function(argument) { $('#field_up_sub_service').html(argument); });

					var ajaxurl = var_url + 'api' + var_controller + "subservice/" + objData.data.lbl_azp_fct_tariff_v_id_azp_fct_service + "/";
...
function event_sub_service(mvalue) {
	if (mvalue == 'create') {
		// Obtener el primer valor seleccionado de la tabla
		var idtbl = document.getElementById('field_cr_service').value;
		// Validar si el id es mayor a cero
		if (idtbl > 0) {
			...
			$.ajax({
				...
				$('#field_cr_sub_service').html(argument);
			});
		}
	} else if (mvalue == 'update') {
		// Obtener el primer valor seleccionado de la tabla
		var idtbl = document.getElementById('field_up_service').value;
		// Validar si el id es mayor a cero
		if (idtbl > 0) {
			var ajaxurl = var_url + 'api' + var_controller + "subservice/" + idtbl + "/";
			$.ajax({
				...
				$('#field_up_sub_service').html(argument);
			});
		}
	}
};