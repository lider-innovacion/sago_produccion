<?php
	...
	//------------------------------------------------
	class azpibnfurnitureController extends Controllers {
		public function __construct() {
			...
			$var_m_azp_ibn_furniture = new m_azp_ibn_furnitureModel;
			# Instanciando clases del modelo
				...
				switch ($var_get_method) {
					...
					case 'delete':
						...
						if (false != $var_m_zz_design->sql_permits_value_delete($var_controller)) {
							...
							if ($this->isset_id) {
								...
								$var_m_azp_ibn_furniture->sql_controller_delete();
								# Consultar registros de la tabla por medio del modelo instanciado
								$var_m_azp_ibn_furniture->sql_azp_ibn_furniture_delete();
							} else {
					...
					case 'info':
						...
						if (false != $var_m_zz_design->sql_permits_menu_value($var_controller)) {
							# Cargar en el metodo por url la plantilla con su contenido a visualizar
							echo $this->template->render('backend/inward/azp_ibn_furniture', array(
								# Consultar registros de la tabla por medio del modelo instanciado
								...
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_ibn_control_panel' => $var_m_azp_ibn_furniture->sql_select_tc_azp_ibn_control_panel(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_ibn_outcome' => $var_m_azp_ibn_furniture->sql_select_tc_azp_ibn_outcome(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_ibn_rank' => $var_m_azp_ibn_furniture->sql_select_tc_azp_ibn_rank(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_ibn_regime' => $var_m_azp_ibn_furniture->sql_select_tc_azp_ibn_regime(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_ibn_state' => $var_m_azp_ibn_furniture->sql_select_tc_azp_ibn_state(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_ibn_type_affiliate' => $var_m_azp_ibn_furniture->sql_select_tc_azp_ibn_type_affiliate(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_ibn_type_concept' => $var_m_azp_ibn_furniture->sql_select_tc_azp_ibn_type_concept(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_ibn_type_contributor' => $var_m_azp_ibn_furniture->sql_select_tc_azp_ibn_type_contributor(),

								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_acount' => $var_m_azp_ibn_furniture->sql_field_t_acount($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_address' => $var_m_azp_ibn_furniture->sql_field_t_address($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_business_name' => $var_m_azp_ibn_furniture->sql_field_t_business_name($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_city' => $var_m_azp_ibn_furniture->sql_field_t_city($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_comment_legal' => $var_m_azp_ibn_furniture->sql_field_t_comment_legal($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_concept' => $var_m_azp_ibn_furniture->sql_field_t_concept($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_consecutive' => $var_m_azp_ibn_furniture->sql_field_t_consecutive($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_department' => $var_m_azp_ibn_furniture->sql_field_t_department($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_entity' => $var_m_azp_ibn_furniture->sql_field_t_entity($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_full_name' => $var_m_azp_ibn_furniture->sql_field_t_full_name($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_identification' => $var_m_azp_ibn_furniture->sql_field_t_identification($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_limitation' => $var_m_azp_ibn_furniture->sql_field_t_limitation($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_municipality' => $var_m_azp_ibn_furniture->sql_field_t_municipality($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_nit' => $var_m_azp_ibn_furniture->sql_field_t_nit($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_observation' => $var_m_azp_ibn_furniture->sql_field_t_observation($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_phone' => $var_m_azp_ibn_furniture->sql_field_t_phone($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_policy_effective' => $var_m_azp_ibn_furniture->sql_field_t_policy_effective($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_policy_final' => $var_m_azp_ibn_furniture->sql_field_t_policy_final($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_policy_viability' => $var_m_azp_ibn_furniture->sql_field_t_policy_viability($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_salary' => $var_m_azp_ibn_furniture->sql_field_t_salary($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_viable_causal' => $var_m_azp_ibn_furniture->sql_field_t_viable_causal($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_well_option' => $var_m_azp_ibn_furniture->sql_field_t_well_option($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_well_viable' => $var_m_azp_ibn_furniture->sql_field_t_well_viable($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_v_id_azp_ibn_control_panel' => $var_m_azp_ibn_furniture->sql_field_v_id_azp_ibn_control_panel($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_v_id_azp_ibn_outcome' => $var_m_azp_ibn_furniture->sql_field_v_id_azp_ibn_outcome($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_v_id_azp_ibn_rank' => $var_m_azp_ibn_furniture->sql_field_v_id_azp_ibn_rank($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_v_id_azp_ibn_regime' => $var_m_azp_ibn_furniture->sql_field_v_id_azp_ibn_regime($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_v_id_azp_ibn_state' => $var_m_azp_ibn_furniture->sql_field_v_id_azp_ibn_state($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_v_id_azp_ibn_type_affiliate' => $var_m_azp_ibn_furniture->sql_field_v_id_azp_ibn_type_affiliate($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_v_id_azp_ibn_type_concept' => $var_m_azp_ibn_furniture->sql_field_v_id_azp_ibn_type_concept($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_v_id_azp_ibn_type_contributor' => $var_m_azp_ibn_furniture->sql_field_v_id_azp_ibn_type_contributor($_GET['field_id']),
					...
					case 'remove':
						...
						if (false != $var_m_zz_design->sql_permits_value_remove($var_controller)) {
							...
							if ($this->isset_id) {
								# Consultar registros de la tabla por medio del modelo instanciado
								$var_m_azp_ibn_furniture->sql_controller_remove();
								# Consultar registros de la tabla por medio del modelo instanciado
								$var_m_azp_ibn_furniture->sql_azp_ibn_furniture_remove();
							} else {
								# Redireccionar a una pagina segun el metodo cargado
								Func::redir(URL . $var_controller . 'info/query/');
								# Detener la ejecucion
					...
					case 'restore':
						...
						if (false != $var_m_zz_design->sql_permits_value_restore($var_controller)) {
							...
							if ($this->isset_id) {
								# Consultar registros de la tabla por medio del modelo instanciado
								$var_m_azp_ibn_furniture->sql_controller_restore();
								# Consultar registros de la tabla por medio del modelo instanciado
								$var_m_azp_ibn_furniture->sql_azp_ibn_furniture_restore();
							} else {
								# Redireccionar a una pagina segun el metodo cargado
								Func::redir(URL . $var_controller . 'info/query/');
								# Detener la ejecucion
					...
					case 'xlsx':
						...
						#-------------------------------------------------------------------------#
						$var_control = $_GET['field_control'];
						#-------------------------------------------------------------------------#
						# Instanciado funciones de la clase y asignando a variable
						$var_sql_table = $var_m_azp_ibn_furniture->sql_controller_table($var_control);
						#-------------------------------------------------------------------------#
						# Ruta principal de la carpeta
						$var_fl_route = 'systemfiles/filesproject/';
						# Ruta de la carpeta principal
						$var_fl_folder = 'azp_ibn_furniture/';
						# Carpeta del año
						$var_fl_year = YEAR . '/';
						...
						Files::create_dir($var_fl_route . $var_fl_folder, 0777);
						# Creacion de carpetas en el desarrollo
						Files::create_dir($var_fl_route . $var_fl_folder . $var_fl_year, 0777);
						# Creacion de carpetas en el desarrollo
						Files::create_dir($var_fl_route . $var_fl_folder . $var_fl_year . $var_fl_month, 0777);
						# Creacion de carpetas en el desarrollo
						Files::create_dir($var_fl_route . $var_fl_folder . $var_fl_year . $var_fl_month . $var_fl_date, 0777);
						#-------------------------------------------------------------------------#
						# Dar permisos a la carpeta y archivo
						chmod($var_fl_route . $var_fl_folder, 0777);
						# Dar permisos a la carpeta y archivo
						chmod($var_fl_route . $var_fl_folder . $var_fl_year, 0777);
						# Dar permisos a la carpeta y archivo
						chmod($var_fl_route . $var_fl_folder . $var_fl_year . $var_fl_month, 0777);
						# Dar permisos a la carpeta y archivo
						chmod($var_fl_route . $var_fl_folder . $var_fl_year . $var_fl_month . $var_fl_date, 0777);
						#-------------------------------------------------------------------------#
						# Nombre del archivo a guardar con sus datos respectivos
						$var_file_name = 'Salarios' . '_' . HOUR_NUMBER . '.xlsx';
						# Ruta de la carpeta para almacenar sus respectivos archivos
						$var_file_route = $var_fl_route . $var_fl_folder . $var_fl_year . $var_fl_month . $var_fl_date;
						...
						$var_sheet->setCellValue('C1', html_entity_decode('Cliente'));
						#-------------------------------------------------------------------------#
						...
						if (false != $var_sql_table) {
							...
							foreach ($var_sql_table as $key => $value) {
								# Asignar valores a las celdas de excel
								$var_sheet->setCellValue('A' . $i, html_entity_decode($value['lbl_azp_ibn_furniture_t_identification']));
								$var_sheet->setCellValue('B' . $i, html_entity_decode($value['lbl_azp_ibn_furniture_t_full_name']));
								$var_sheet->setCellValue('C' . $i, html_entity_decode($value['lbl_azp_ibn_client_t_name']));
								# Incrementar valores
								$i++;
							}
						} else {
						...
						$var_route = $var_file_route;
						$var_module = 'Salarios';
						$var_template = 'Email';
						#-------------------------------------------------------------------------#
						# Enviar datos a traves del modelo
						$var_m_azp_ibn_furniture->sql_azp_ibn_files_insert(
							$var_extension,
							$var_file,
							$var_module,
							$var_name,
