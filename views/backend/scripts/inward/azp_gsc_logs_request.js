...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_gsc_logs_request_id_azs_gsc_logs_request",
				data: "lbl_azs_gsc_logs_request_id_azs_gsc_logs_request",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_gsc_logs_request_m_date_created",
				data: "lbl_azs_gsc_logs_request_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_gsc_logs_request_m_date_modified",
				data: "lbl_azs_gsc_logs_request_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_gsc_logs_request_m_description",
				data: "lbl_azs_gsc_logs_request_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Accion",
				id: "lbl_azs_gsc_logs_request_t_action",
				data: "lbl_azs_gsc_logs_request_t_action",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Solicitud",
				id: "lbl_azs_gsc_logs_request_u_gsc_request",
				data: "lbl_azs_gsc_logs_request_u_gsc_request",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_logs_request/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_logs_request/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_gsc_logs_request_id_azp_gsc_logs_request").innerHTML = objData.data.lbl_azp_gsc_logs_request_id_azp_gsc_logs_request;
					...
					document.querySelector("#lbl_azp_gsc_logs_request_m_date_created").innerHTML = objData.data.lbl_azp_gsc_logs_request_m_date_created;
					document.querySelector("#lbl_azp_gsc_logs_request_m_date_modified").innerHTML = objData.data.lbl_azp_gsc_logs_request_m_date_modified;
					document.querySelector("#lbl_azp_gsc_logs_request_m_description").innerHTML = objData.data.lbl_azp_gsc_logs_request_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_gsc_logs_request_t_action").innerHTML = objData.data.lbl_azp_gsc_logs_request_t_action;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_logs_request/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_logs_request/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_logs_request/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_gsc_logs_request_id_azp_gsc_logs_request;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_gsc_logs_request_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_gsc_logs_request_m_status;
					document.querySelector("#field_up_action").value = objData.data.lbl_azp_gsc_logs_request_t_action;
					document.querySelector("#field_up_gsc_request").value = objData.data.lbl_azp_gsc_logs_request_v_id_azp_gsc_request;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
