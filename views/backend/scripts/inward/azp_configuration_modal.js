...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_configuration_modal_id_azs_configuration_modal",
				data: "lbl_azs_configuration_modal_id_azs_configuration_modal",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_configuration_modal_m_date_created",
				data: "lbl_azs_configuration_modal_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_configuration_modal_m_date_modified",
				data: "lbl_azs_configuration_modal_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_configuration_modal_m_description",
				data: "lbl_azs_configuration_modal_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Cambios",
				id: "lbl_azs_configuration_modal_t_md_change",
				data: "lbl_azs_configuration_modal_t_md_change",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Nuevo",
				id: "lbl_azs_configuration_modal_t_md_create",
				data: "lbl_azs_configuration_modal_t_md_create",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Eliminar",
				id: "lbl_azs_configuration_modal_t_md_delete",
				data: "lbl_azs_configuration_modal_t_md_delete",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Detalles",
				id: "lbl_azs_configuration_modal_t_md_detail",
				data: "lbl_azs_configuration_modal_t_md_detail",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Correos",
				id: "lbl_azs_configuration_modal_t_md_email",
				data: "lbl_azs_configuration_modal_t_md_email",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Importar",
				id: "lbl_azs_configuration_modal_t_md_import",
				data: "lbl_azs_configuration_modal_t_md_import",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Remover",
				id: "lbl_azs_configuration_modal_t_md_remove",
				data: "lbl_azs_configuration_modal_t_md_remove",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Reportes",
				id: "lbl_azs_configuration_modal_t_md_report",
				data: "lbl_azs_configuration_modal_t_md_report",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Restaurar",
				id: "lbl_azs_configuration_modal_t_md_restore",
				data: "lbl_azs_configuration_modal_t_md_restore",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Sub Menu",
				id: "lbl_azs_configuration_modal_t_md_sub_menu",
				data: "lbl_azs_configuration_modal_t_md_sub_menu",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Actualizar",
				id: "lbl_azs_configuration_modal_t_md_update",
				data: "lbl_azs_configuration_modal_t_md_update",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Usuario",
				id: "lbl_azs_configuration_modal_u_user",
				data: "lbl_azs_configuration_modal_u_user",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_configuration_modal/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_configuration_modal/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_configuration_modal_id_azp_configuration_modal").innerHTML = objData.data.lbl_azp_configuration_modal_id_azp_configuration_modal;
					...
					document.querySelector("#lbl_azp_configuration_modal_m_date_created").innerHTML = objData.data.lbl_azp_configuration_modal_m_date_created;
					document.querySelector("#lbl_azp_configuration_modal_m_date_modified").innerHTML = objData.data.lbl_azp_configuration_modal_m_date_modified;
					document.querySelector("#lbl_azp_configuration_modal_m_description").innerHTML = objData.data.lbl_azp_configuration_modal_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_configuration_modal_t_md_change").innerHTML = objData.data.lbl_azp_configuration_modal_t_md_change;
					document.querySelector("#lbl_azp_configuration_modal_t_md_create").innerHTML = objData.data.lbl_azp_configuration_modal_t_md_create;
					document.querySelector("#lbl_azp_configuration_modal_t_md_delete").innerHTML = objData.data.lbl_azp_configuration_modal_t_md_delete;
					document.querySelector("#lbl_azp_configuration_modal_t_md_detail").innerHTML = objData.data.lbl_azp_configuration_modal_t_md_detail;
					document.querySelector("#lbl_azp_configuration_modal_t_md_email").innerHTML = objData.data.lbl_azp_configuration_modal_t_md_email;
					document.querySelector("#lbl_azp_configuration_modal_t_md_import").innerHTML = objData.data.lbl_azp_configuration_modal_t_md_import;
					document.querySelector("#lbl_azp_configuration_modal_t_md_remove").innerHTML = objData.data.lbl_azp_configuration_modal_t_md_remove;
					document.querySelector("#lbl_azp_configuration_modal_t_md_report").innerHTML = objData.data.lbl_azp_configuration_modal_t_md_report;
					document.querySelector("#lbl_azp_configuration_modal_t_md_restore").innerHTML = objData.data.lbl_azp_configuration_modal_t_md_restore;
					document.querySelector("#lbl_azp_configuration_modal_t_md_sub_menu").innerHTML = objData.data.lbl_azp_configuration_modal_t_md_sub_menu;
					document.querySelector("#lbl_azp_configuration_modal_t_md_update").innerHTML = objData.data.lbl_azp_configuration_modal_t_md_update;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_configuration_modal/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_configuration_modal/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_configuration_modal/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_configuration_modal_id_azp_configuration_modal;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_configuration_modal_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_configuration_modal_m_status;
					document.querySelector("#field_up_md_change").value = objData.data.lbl_azp_configuration_modal_t_md_change;
					document.querySelector("#field_up_md_create").value = objData.data.lbl_azp_configuration_modal_t_md_create;
					document.querySelector("#field_up_md_delete").value = objData.data.lbl_azp_configuration_modal_t_md_delete;
					document.querySelector("#field_up_md_detail").value = objData.data.lbl_azp_configuration_modal_t_md_detail;
					document.querySelector("#field_up_md_email").value = objData.data.lbl_azp_configuration_modal_t_md_email;
					document.querySelector("#field_up_md_import").value = objData.data.lbl_azp_configuration_modal_t_md_import;
					document.querySelector("#field_up_md_remove").value = objData.data.lbl_azp_configuration_modal_t_md_remove;
					document.querySelector("#field_up_md_report").value = objData.data.lbl_azp_configuration_modal_t_md_report;
					document.querySelector("#field_up_md_restore").value = objData.data.lbl_azp_configuration_modal_t_md_restore;
					document.querySelector("#field_up_md_sub_menu").value = objData.data.lbl_azp_configuration_modal_t_md_sub_menu;
					document.querySelector("#field_up_md_update").value = objData.data.lbl_azp_configuration_modal_t_md_update;
					document.querySelector("#field_up_user").value = objData.data.lbl_azp_configuration_modal_v_id_azp_user;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
