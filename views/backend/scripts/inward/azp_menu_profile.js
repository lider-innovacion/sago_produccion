...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_menu_profile_id_azs_menu_profile",
				data: "lbl_azs_menu_profile_id_azs_menu_profile",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_menu_profile_m_date_created",
				data: "lbl_azs_menu_profile_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_menu_profile_m_date_modified",
				data: "lbl_azs_menu_profile_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_menu_profile_m_description",
				data: "lbl_azs_menu_profile_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Nombre",
				id: "lbl_azs_menu_profile_t_name",
				data: "lbl_azs_menu_profile_t_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Orden",
				id: "lbl_azs_menu_profile_t_order",
				data: "lbl_azs_menu_profile_t_order",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Url Pagina",
				id: "lbl_azs_menu_profile_t_url",
				data: "lbl_azs_menu_profile_t_url",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Icono",
				id: "lbl_azs_menu_profile_u_icon_code",
				data: "lbl_azs_menu_profile_u_icon_code",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_menu_profile/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_menu_profile/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_menu_profile_id_azp_menu_profile").innerHTML = objData.data.lbl_azp_menu_profile_id_azp_menu_profile;
					...
					document.querySelector("#lbl_azp_menu_profile_m_date_created").innerHTML = objData.data.lbl_azp_menu_profile_m_date_created;
					document.querySelector("#lbl_azp_menu_profile_m_date_modified").innerHTML = objData.data.lbl_azp_menu_profile_m_date_modified;
					document.querySelector("#lbl_azp_menu_profile_m_description").innerHTML = objData.data.lbl_azp_menu_profile_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_menu_profile_t_name").innerHTML = objData.data.lbl_azp_menu_profile_t_name;
					document.querySelector("#lbl_azp_menu_profile_t_order").innerHTML = objData.data.lbl_azp_menu_profile_t_order;
					document.querySelector("#lbl_azp_menu_profile_t_url").innerHTML = objData.data.lbl_azp_menu_profile_t_url;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_menu_profile/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_menu_profile/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_menu_profile/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_menu_profile_id_azp_menu_profile;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_menu_profile_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_menu_profile_m_status;
					document.querySelector("#field_up_name").value = objData.data.lbl_azp_menu_profile_t_name;
					document.querySelector("#field_up_order").value = objData.data.lbl_azp_menu_profile_t_order;
					document.querySelector("#field_up_url").value = objData.data.lbl_azp_menu_profile_t_url;
					document.querySelector("#field_up_icon_code").value = objData.data.lbl_azp_menu_profile_v_id_azp_icon_code;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
