...
if (document.getElementById('form_btn_design')) {
	document.getElementById('form_btn_design').onclick = function(e) {
		e.preventDefault();
		event_design();
	};
}

if (document.getElementById('form_design')) {
	document.getElementById('form_design').onkeypress = function(e) {
		if (!e) e = window.event;
		var keyCode = e.keyCode || e.which;
		if (keyCode == '13') {
			event_design();
...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_interface_dit_id_azs_ibn_interface_dit",
				data: "lbl_azs_ibn_interface_dit_id_azs_ibn_interface_dit",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_interface_dit_m_date_created",
				data: "lbl_azs_ibn_interface_dit_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_interface_dit_m_date_modified",
				data: "lbl_azs_ibn_interface_dit_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_interface_dit_m_description",
				data: "lbl_azs_ibn_interface_dit_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Nombre",
				id: "lbl_azs_ibn_interface_dit_t_name",
				data: "lbl_azs_ibn_interface_dit_t_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_interface_dit/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_interface_dit/delete",
...
function event_design() {
	// Definir los iconos para los correspondientes mensajes
	var error_icon = '<span class="far fa-times-circle" aria-hidden="true"></span>' + ' ';
	var success_icon = '<span class="far fa-check-circle" aria-hidden="true"></span>' + ' ';
	var process_icon = '<span class="far fa-spinner fa-spin" aria-hidden="true"></span>' + ' ';
	// Añadir y remover las clases incorporadas de las hojas de estilo
	$('#form_ajax_design').removeClass('alert-danger');
	$('#form_ajax_design').removeClass('alert-success');
	$('#form_ajax_design').removeClass('alert-warning');
	// Añadir y remover las clases incorporadas de las hojas de estilo
	$('#form_ajax_design').addClass('alert-warning');
	$("#form_ajax_design").html(process_icon  + 'Advertencia: Procesando información, por favor espere...');
	$('#form_ajax_design').removeClass('hide');
	$('#form_ajax_design').addClass('alert');
	// Configuracion de la ventana modal
	//$('#modal-id-design').modal('hide');
	// Mensaje de audio para mostrar en la pagina web
	initApp.playSound('views/templates/smart/dist/media/sound', 'bigbox');
	var dialog = bootbox.dialog({
		title: '¿Estas seguro de continuar con el proceso?',
		...
		buttons: {
			cancel: {
				...
				callback: function() {
					// Añadir y remover las clases incorporadas de las hojas de estilo
					setTimeout(function() {
						$('#form_ajax_design').removeClass('alert');
						$('#form_ajax_design').addClass('hide');
						$('#form_ajax_design').html('');
					}, 0);
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_interface_dit/design",
						...
						success : function(json) {
							...
							if (obj.success == 1) {
								...
								if ($("#dt_info").length) { $('#dt_info').DataTable().ajax.reload(); }
								// Mensaje a mostrar una vez terminada la accion
								$('#form_ajax_design').html(success_icon + obj.message);
								$("#form_ajax_design").removeClass('alert-warning');
								$("#form_ajax_design").addClass('alert-success');
								// Configuracion de la ventana modal
								$('#modal-id-design').modal('hide');
								// Añadir y remover las clases incorporadas de las hojas de estilo
								setTimeout(function() {
								...
								$('#modal-id-design').modal('show');
								// Mensaje a mostrar una vez terminada la accion
								$('#form_ajax_design').html(error_icon + obj.message);
								$("#form_ajax_design").removeClass('alert-warning');
								$("#form_ajax_design").addClass('alert-danger');
							}
						},
						error : function() {
							$('#form_ajax_design').addClass('alert-danger');
							$("#form_ajax_design").html(process_icon  + 'Error: Problema detectado en el sistema, por favor comuniquese con el administrador');
							$('#form_ajax_design').removeClass('hide');
						},
					});
				},
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_interface_dit_id_azp_ibn_interface_dit").innerHTML = objData.data.lbl_azp_ibn_interface_dit_id_azp_ibn_interface_dit;
					...
					document.querySelector("#lbl_azp_ibn_interface_dit_m_date_created").innerHTML = objData.data.lbl_azp_ibn_interface_dit_m_date_created;
					document.querySelector("#lbl_azp_ibn_interface_dit_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_interface_dit_m_date_modified;
					document.querySelector("#lbl_azp_ibn_interface_dit_m_description").innerHTML = objData.data.lbl_azp_ibn_interface_dit_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_ibn_interface_dit_t_name").innerHTML = objData.data.lbl_azp_ibn_interface_dit_t_name;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_interface_dit/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_interface_dit/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_interface_dit/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_interface_dit_id_azp_ibn_interface_dit;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_interface_dit_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_interface_dit_m_status;
					document.querySelector("#field_up_name").value = objData.data.lbl_azp_ibn_interface_dit_t_name;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
...
function modal_design() {
	// Obtener el primer valor seleccionado de la tabla
	var idtbl = $("#dt_info tr.selected td:first").html();
	// Validar si el id es mayor a cero
	if (idtbl > 0) {
		var request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
		var ajaxurl = var_url + 'api' + var_controller + "design/" + idtbl + "/";
		request.open("GET", ajaxurl, true);
		request.send();
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-design').modal('show');
					document.querySelector("#field_ds_id").value = objData.data.lbl_azp_ibn_interface_dit_id_azp_ibn_interface_dit;

					document.querySelector("#field_ds_cl_align").value = objData.data.lbl_azp_ibn_pdf_cell_t_align;
					document.querySelector("#field_ds_cl_border").value = objData.data.lbl_azp_ibn_pdf_cell_t_border;
					document.querySelector("#field_ds_cl_fill").value = objData.data.lbl_azp_ibn_pdf_cell_t_fill;
					document.querySelector("#field_ds_cl_height").value = objData.data.lbl_azp_ibn_pdf_cell_t_height;
					document.querySelector("#field_ds_cl_line").value = objData.data.lbl_azp_ibn_pdf_cell_t_line;
					document.querySelector("#field_ds_cl_link").value = objData.data.lbl_azp_ibn_pdf_cell_t_link;
					document.querySelector("#field_ds_cl_text").value = objData.data.lbl_azp_ibn_pdf_cell_t_text;
					document.querySelector("#field_ds_cl_width").value = objData.data.lbl_azp_ibn_pdf_cell_t_width;

					document.querySelector("#field_ds_fc_blue").value = objData.data.lbl_azp_ibn_pdf_fill_color_t_blue;
					document.querySelector("#field_ds_fc_green").value = objData.data.lbl_azp_ibn_pdf_fill_color_t_green;
					document.querySelector("#field_ds_fc_label").value = objData.data.lbl_azp_ibn_pdf_fill_color_t_label;
					document.querySelector("#field_ds_fc_red").value = objData.data.lbl_azp_ibn_pdf_fill_color_t_red;

					document.querySelector("#field_ds_ft_family").value = objData.data.lbl_azp_ibn_pdf_font_t_family;
					document.querySelector("#field_ds_ft_size").value = objData.data.lbl_azp_ibn_pdf_font_t_size;
					document.querySelector("#field_ds_ft_style").value = objData.data.lbl_azp_ibn_pdf_font_t_style;

					document.querySelector("#field_ds_tc_blue").value = objData.data.lbl_azp_ibn_pdf_text_color_t_blue;
					document.querySelector("#field_ds_tc_green").value = objData.data.lbl_azp_ibn_pdf_text_color_t_green;
					document.querySelector("#field_ds_tc_label").value = objData.data.lbl_azp_ibn_pdf_text_color_t_label;
					document.querySelector("#field_ds_tc_red").value = objData.data.lbl_azp_ibn_pdf_text_color_t_red;
...
function event_font() {
	var field = document.getElementById('field_ds_ft_family').value;

	if (field == 'Courier' || field == 'Helvetica' || field == 'Arial' || field == 'Times' || field == 'Symbol' || field == 'Zapfdingbats') {
		document.getElementById('field_ds_ft_style').value = 'B';
		$('#id_ds_ft_style').removeClass('d-none');
	} else {
		document.getElementById('field_ds_ft_style').value = 'NINGUNO';
		$('#id_ds_ft_style').addClass('d-none');
	}
};