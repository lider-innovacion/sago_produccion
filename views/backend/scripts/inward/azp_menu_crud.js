...
function event_ap_update() {
	...
	$('#form_ajax_ap_update').removeClass('alert-danger');
	$('#form_ajax_ap_update').removeClass('alert-success');
	$('#form_ajax_ap_update').removeClass('alert-warning');
	// Añadir y remover las clases incorporadas de las hojas de estilo
	$('#form_ajax_ap_update').addClass('alert-warning');
	$("#form_ajax_ap_update").html(process_icon  + 'Advertencia: Procesando información, por favor espere...');
	$('#form_ajax_ap_update').removeClass('hide');
	$('#form_ajax_ap_update').addClass('alert');
	// Configuracion de la ventana modal
	//$('#modal-id-ap_update').modal('hide');
		...
		buttons: {
			cancel: {
				...
				callback: function() {
					// Añadir y remover las clases incorporadas de las hojas de estilo
					setTimeout(function() {
						$('#form_ajax_ap_update').removeClass('alert');
						$('#form_ajax_ap_update').addClass('hide');
						$('#form_ajax_ap_update').html('');
					}, 0);
					// Mensaje de audio para mostrar en la pagina web
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : var_controller + "apupdate/",
						data : $('#form_ap_update').serialize(),
						beforeSend : function() {
							// Deshabilitar botones de la vista
							$('#btn_value_visible').attr('disabled','disabled');
							$('#btn_value_sub_menu').attr('disabled','disabled');
							$('#btn_value_report').attr('disabled','disabled');
							$('#btn_value_create').attr('disabled','disabled');
							$('#btn_value_update').attr('disabled','disabled');
							$('#btn_value_remove').attr('disabled','disabled');
							$('#btn_value_change').attr('disabled','disabled');
							$('#btn_value_detail').attr('disabled','disabled');
							$('#btn_value_sync').attr('disabled','disabled');
							$('#btn_value_copy').attr('disabled','disabled');
							$('#btn_value_pdf').attr('disabled','disabled');
							$('#btn_value_excel').attr('disabled','disabled');
							$('#btn_value_csv').attr('disabled','disabled');
							$('#btn_value_print').attr('disabled','disabled');
							$('#btn_value_update').attr('disabled','disabled');
						},
						success : function(json) {
							// Habilitar botones de la vista
							$('#btn_value_visible').removeAttr('disabled');
							$('#btn_value_sub_menu').removeAttr('disabled');
							$('#btn_value_report').removeAttr('disabled');
							$('#btn_value_create').removeAttr('disabled');
							$('#btn_value_update').removeAttr('disabled');
							$('#btn_value_remove').removeAttr('disabled');
							$('#btn_value_change').removeAttr('disabled');
							$('#btn_value_detail').removeAttr('disabled');
							$('#btn_value_sync').removeAttr('disabled');
							$('#btn_value_copy').removeAttr('disabled');
							$('#btn_value_pdf').removeAttr('disabled');
							$('#btn_value_excel').removeAttr('disabled');
							$('#btn_value_csv').removeAttr('disabled');
							$('#btn_value_print').removeAttr('disabled');
							$('#btn_value_update').removeAttr('disabled');
							// Mensaje a mostrar una vez terminada la accion
							$('#form_ajax_ap_update').html(success_icon + 'Exito: Registro actualizado correctamente');
							$("#form_ajax_ap_update").removeClass('alert-warning');
							$("#form_ajax_ap_update").addClass('alert-success');
							// Configuracion de la ventana modal
							$('#modal-id-ap_update').modal('hide');
							// Añadir y remover las clases incorporadas de las hojas de estilo
							setTimeout(function() {
						...
						error : function() {
							$('#form_ajax_ap_update').addClass('alert-danger');
							$("#form_ajax_ap_update").html(process_icon  + 'Error: Problema detectado en el sistema, por favor comuniquese con el administrador');
							$('#form_ajax_ap_update').removeClass('hide');
						},
					});
				},
...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_menu_crud_id_azs_menu_crud",
				data: "lbl_azs_menu_crud_id_azs_menu_crud",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_menu_crud_m_date_created",
				data: "lbl_azs_menu_crud_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_menu_crud_m_date_modified",
				data: "lbl_azs_menu_crud_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_menu_crud_m_description",
				data: "lbl_azs_menu_crud_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Nombre",
				id: "lbl_azs_menu_crud_t_name",
				data: "lbl_azs_menu_crud_t_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Script",
				id: "lbl_azs_menu_crud_t_script",
				data: "lbl_azs_menu_crud_t_script",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Tabla Cambios",
				id: "lbl_azs_menu_crud_t_table_change",
				data: "lbl_azs_menu_crud_t_table_change",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_menu_crud_t_table_main",
				data: "lbl_azs_menu_crud_t_table_main",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Url",
				id: "lbl_azs_menu_crud_t_url",
				data: "lbl_azs_menu_crud_t_url",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Aplicacion",
				id: "lbl_azs_menu_crud_u_application",
				data: "lbl_azs_menu_crud_u_application",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Icono",
				id: "lbl_azs_menu_crud_u_icon_code",
				data: "lbl_azs_menu_crud_u_icon_code",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Prefijo Tablas",
				id: "lbl_azs_menu_crud_u_table_prefix",
				data: "lbl_azs_menu_crud_u_table_prefix",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_menu_crud_id_azp_menu_crud").innerHTML = objData.data.lbl_azp_menu_crud_id_azp_menu_crud;
					...
					document.querySelector("#lbl_azp_menu_crud_m_date_created").innerHTML = objData.data.lbl_azp_menu_crud_m_date_created;
					document.querySelector("#lbl_azp_menu_crud_m_date_modified").innerHTML = objData.data.lbl_azp_menu_crud_m_date_modified;
					document.querySelector("#lbl_azp_menu_crud_m_description").innerHTML = objData.data.lbl_azp_menu_crud_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_menu_crud_t_name").innerHTML = objData.data.lbl_azp_menu_crud_t_name;
					document.querySelector("#lbl_azp_menu_crud_t_script").innerHTML = objData.data.lbl_azp_menu_crud_t_script;
					document.querySelector("#lbl_azp_menu_crud_t_table_change").innerHTML = objData.data.lbl_azp_menu_crud_t_table_change;
					document.querySelector("#lbl_azp_menu_crud_t_table_main").innerHTML = objData.data.lbl_azp_menu_crud_t_table_main;
					document.querySelector("#lbl_azp_menu_crud_t_url").innerHTML = objData.data.lbl_azp_menu_crud_t_url;
					document.querySelector("#lbl_azp_application_t_name").innerHTML = objData.data.lbl_azp_application_t_name;
					document.querySelector("#lbl_azp_icon_code_t_name").innerHTML = objData.data.lbl_azp_icon_code_t_name;
					document.querySelector("#lbl_azp_table_prefix_t_name").innerHTML = objData.data.lbl_azp_table_prefix_t_name;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
...
function modal_ap_update() {
	// Visualizar ventana modal
	$('#modal-id-ap_update').modal('show');
};
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_menu_crud_id_azp_menu_crud;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_menu_crud_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_menu_crud_m_status;
					document.querySelector("#field_up_name").value = objData.data.lbl_azp_menu_crud_t_name;
					//document.querySelector("#field_up_script").value = objData.data.lbl_azp_menu_crud_t_script;
					//document.querySelector("#field_up_table_change").value = objData.data.lbl_azp_menu_crud_t_table_change;
					document.querySelector("#field_up_table_main").value = objData.data.lbl_azp_menu_crud_t_table_main;
					//document.querySelector("#field_up_url").value = objData.data.lbl_azp_menu_crud_t_url;
					document.querySelector("#field_up_application").value = objData.data.lbl_azp_menu_crud_v_id_azp_application;
					document.querySelector("#field_up_icon_code").value = objData.data.lbl_azp_menu_crud_v_id_azp_icon_code;
					document.querySelector("#field_up_table_prefix").value = objData.data.lbl_azp_menu_crud_v_id_azp_table_prefix;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
