...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_limitation_id_azs_ibn_limitation",
				data: "lbl_azs_ibn_limitation_id_azs_ibn_limitation",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_limitation_m_date_created",
				data: "lbl_azs_ibn_limitation_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_limitation_m_date_modified",
				data: "lbl_azs_ibn_limitation_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_limitation_m_description",
				data: "lbl_azs_ibn_limitation_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Nombre",
				id: "lbl_azs_ibn_limitation_t_name",
				data: "lbl_azs_ibn_limitation_t_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Frase 1",
				id: "lbl_azs_ibn_limitation_t_sentence_1",
				data: "lbl_azs_ibn_limitation_t_sentence_1",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Frase 2",
				id: "lbl_azs_ibn_limitation_t_sentence_2",
				data: "lbl_azs_ibn_limitation_t_sentence_2",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Modulo",
				id: "lbl_azs_ibn_limitation_u_ibn_module",
				data: "lbl_azs_ibn_limitation_u_ibn_module",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_limitation/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_limitation/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_limitation_id_azp_ibn_limitation").innerHTML = objData.data.lbl_azp_ibn_limitation_id_azp_ibn_limitation;
					...
					document.querySelector("#lbl_azp_ibn_limitation_m_date_created").innerHTML = objData.data.lbl_azp_ibn_limitation_m_date_created;
					document.querySelector("#lbl_azp_ibn_limitation_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_limitation_m_date_modified;
					document.querySelector("#lbl_azp_ibn_limitation_m_description").innerHTML = objData.data.lbl_azp_ibn_limitation_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_ibn_limitation_t_name").innerHTML = objData.data.lbl_azp_ibn_limitation_t_name;
					document.querySelector("#lbl_azp_ibn_limitation_t_sentence_1").innerHTML = objData.data.lbl_azp_ibn_limitation_t_sentence_1;
					document.querySelector("#lbl_azp_ibn_limitation_t_sentence_2").innerHTML = objData.data.lbl_azp_ibn_limitation_t_sentence_2;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_limitation/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_limitation/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_limitation/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_limitation_id_azp_ibn_limitation;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_limitation_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_limitation_m_status;
					document.querySelector("#field_up_name").value = objData.data.lbl_azp_ibn_limitation_t_name;
					document.querySelector("#field_up_sentence_1").value = objData.data.lbl_azp_ibn_limitation_t_sentence_1;
					document.querySelector("#field_up_sentence_2").value = objData.data.lbl_azp_ibn_limitation_t_sentence_2;
					document.querySelector("#field_up_ibn_module").value = objData.data.lbl_azp_ibn_limitation_v_id_azp_ibn_module;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
