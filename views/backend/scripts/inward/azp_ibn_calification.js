...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_calification_id_azs_ibn_calification",
				data: "lbl_azs_ibn_calification_id_azs_ibn_calification",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_calification_m_date_created",
				data: "lbl_azs_ibn_calification_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_calification_m_date_modified",
				data: "lbl_azs_ibn_calification_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_calification_m_description",
				data: "lbl_azs_ibn_calification_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Condicion",
				id: "lbl_azs_ibn_calification_u_ibn_type_condition",
				data: "lbl_azs_ibn_calification_u_ibn_type_condition",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Principal",
				id: "lbl_azs_ibn_calification_t_principal",
				data: "lbl_azs_ibn_calification_t_principal",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Concepto",
				id: "lbl_azs_ibn_calification_t_concept",
				data: "lbl_azs_ibn_calification_t_concept",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Secundario",
				id: "lbl_azs_ibn_calification_t_secondary",
				data: "lbl_azs_ibn_calification_t_secondary",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Concepto",
				id: "lbl_azs_ibn_calification_t_determination",
				data: "lbl_azs_ibn_calification_t_determination",
				type: "text",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_calification/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_calification/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_calification_id_azp_ibn_calification").innerHTML = objData.data.lbl_azp_ibn_calification_id_azp_ibn_calification;
					...
					document.querySelector("#lbl_azp_ibn_calification_m_date_created").innerHTML = objData.data.lbl_azp_ibn_calification_m_date_created;
					document.querySelector("#lbl_azp_ibn_calification_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_calification_m_date_modified;
					document.querySelector("#lbl_azp_ibn_calification_m_description").innerHTML = objData.data.lbl_azp_ibn_calification_m_description;
					...
					document.querySelector("#lbl_azp_ibn_calification_t_principal").innerHTML = objData.data.lbl_azp_ibn_calification_t_principal;
					document.querySelector("#lbl_azp_ibn_calification_t_concept").innerHTML = objData.data.lbl_azp_ibn_calification_t_concept;
					document.querySelector("#lbl_azp_ibn_calification_t_secondary").innerHTML = objData.data.lbl_azp_ibn_calification_t_secondary;
					document.querySelector("#lbl_azp_ibn_calification_t_determination").innerHTML = objData.data.lbl_azp_ibn_calification_t_determination;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_calification/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_calification/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_calification/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_calification_id_azp_ibn_calification;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_calification_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_calification_m_status;
					document.querySelector("#field_up_concept").value = objData.data.lbl_azp_ibn_calification_t_concept;
					document.querySelector("#field_up_determination").value = objData.data.lbl_azp_ibn_calification_t_determination;
					document.querySelector("#field_up_principal").value = objData.data.lbl_azp_ibn_calification_t_principal;
					document.querySelector("#field_up_secondary").value = objData.data.lbl_azp_ibn_calification_t_secondary;
					document.querySelector("#field_up_ibn_type_condition").value = objData.data.lbl_azp_ibn_calification_v_id_azp_ibn_type_condition;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
