...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_gsc_follow_email_id_azs_gsc_follow_email",
				data: "lbl_azs_gsc_follow_email_id_azs_gsc_follow_email",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_gsc_follow_email_m_date_created",
				data: "lbl_azs_gsc_follow_email_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_gsc_follow_email_m_date_modified",
				data: "lbl_azs_gsc_follow_email_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_gsc_follow_email_m_description",
				data: "lbl_azs_gsc_follow_email_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Plantilla",
				id: "lbl_azs_gsc_follow_email_t_template",
				data: "lbl_azs_gsc_follow_email_t_template",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Registro",
				id: "lbl_azs_gsc_follow_email_t_register",
				data: "lbl_azs_gsc_follow_email_t_register",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Solicitud",
				id: "lbl_azs_gsc_follow_email_u_gsc_request",
				data: "lbl_azs_gsc_follow_email_u_gsc_request",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_follow_email/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_follow_email/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_gsc_follow_email_id_azp_gsc_follow_email").innerHTML = objData.data.lbl_azp_gsc_follow_email_id_azp_gsc_follow_email;
					...
					document.querySelector("#lbl_azp_gsc_follow_email_m_date_created").innerHTML = objData.data.lbl_azp_gsc_follow_email_m_date_created;
					document.querySelector("#lbl_azp_gsc_follow_email_m_date_modified").innerHTML = objData.data.lbl_azp_gsc_follow_email_m_date_modified;
					document.querySelector("#lbl_azp_gsc_follow_email_m_description").innerHTML = objData.data.lbl_azp_gsc_follow_email_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_gsc_follow_email_t_template").innerHTML = objData.data.lbl_azp_gsc_follow_email_t_template;
					document.querySelector("#lbl_azp_gsc_follow_email_t_register").innerHTML = objData.data.lbl_azp_gsc_follow_email_t_register;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_follow_email/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_follow_email/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_follow_email/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_gsc_follow_email_id_azp_gsc_follow_email;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_gsc_follow_email_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_gsc_follow_email_m_status;
					document.querySelector("#field_up_template").value = objData.data.lbl_azp_gsc_follow_email_t_template;
					document.querySelector("#field_up_register").value = objData.data.lbl_azp_gsc_follow_email_t_register;
					document.querySelector("#field_up_gsc_request").value = objData.data.lbl_azp_gsc_follow_email_v_id_azp_gsc_request;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
