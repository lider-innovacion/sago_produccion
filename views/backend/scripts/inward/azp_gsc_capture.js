...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_gsc_capture_id_azs_gsc_capture",
				data: "lbl_azs_gsc_capture_id_azs_gsc_capture",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_gsc_capture_m_date_created",
				data: "lbl_azs_gsc_capture_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_gsc_capture_m_date_modified",
				data: "lbl_azs_gsc_capture_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_gsc_capture_m_description",
				data: "lbl_azs_gsc_capture_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Fecha Visible",
				id: "lbl_azs_gsc_capture_t_date_visible",
				data: "lbl_azs_gsc_capture_t_date_visible",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Error",
				id: "lbl_azs_gsc_capture_t_error",
				data: "lbl_azs_gsc_capture_t_error",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Carpeta",
				id: "lbl_azs_gsc_capture_t_folder",
				data: "lbl_azs_gsc_capture_t_folder",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Archivo",
				id: "lbl_azs_gsc_capture_t_name",
				data: "lbl_azs_gsc_capture_t_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Ruta",
				id: "lbl_azs_gsc_capture_t_route",
				data: "lbl_azs_gsc_capture_t_route",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Tamaño",
				id: "lbl_azs_gsc_capture_t_size",
				data: "lbl_azs_gsc_capture_t_size",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Titulo",
				id: "lbl_azs_gsc_capture_t_title",
				data: "lbl_azs_gsc_capture_t_title",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_gsc_capture_t_tmp_name",
				data: "lbl_azs_gsc_capture_t_tmp_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Tipo",
				id: "lbl_azs_gsc_capture_t_type",
				data: "lbl_azs_gsc_capture_t_type",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Solicitud",
				id: "lbl_azs_gsc_request_t_full_name",
				data: "lbl_azs_gsc_request_t_full_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_capture/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_capture/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_gsc_capture_id_azp_gsc_capture").innerHTML = objData.data.lbl_azp_gsc_capture_id_azp_gsc_capture;
					...
					document.querySelector("#lbl_azp_gsc_capture_m_date_created").innerHTML = objData.data.lbl_azp_gsc_capture_m_date_created;
					document.querySelector("#lbl_azp_gsc_capture_m_date_modified").innerHTML = objData.data.lbl_azp_gsc_capture_m_date_modified;
					document.querySelector("#lbl_azp_gsc_capture_m_description").innerHTML = objData.data.lbl_azp_gsc_capture_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_gsc_capture_t_date_load").innerHTML = objData.data.lbl_azp_gsc_capture_t_date_load;
					document.querySelector("#lbl_azp_gsc_capture_t_date_visible").innerHTML = objData.data.lbl_azp_sys_answer_t_date_visible;
					//document.querySelector("#lbl_azp_gsc_capture_t_error").innerHTML = objData.data.lbl_azp_gsc_capture_t_error;
					//document.querySelector("#lbl_azp_gsc_capture_t_folder").innerHTML = objData.data.lbl_azp_gsc_capture_t_folder;
					//document.querySelector("#lbl_azp_gsc_capture_t_name").innerHTML = objData.data.lbl_azp_gsc_capture_t_name;
					//document.querySelector("#lbl_azp_gsc_capture_t_route").innerHTML = objData.data.lbl_azp_gsc_capture_t_route;
					//document.querySelector("#lbl_azp_gsc_capture_t_size").innerHTML = objData.data.lbl_azp_gsc_capture_t_size;
					document.querySelector("#lbl_azp_gsc_capture_t_title").innerHTML = objData.data.lbl_azp_gsc_capture_t_title;
					//document.querySelector("#lbl_azp_gsc_capture_t_tmp_name").innerHTML = objData.data.lbl_azp_gsc_capture_t_tmp_name;
					//document.querySelector("#lbl_azp_gsc_capture_t_type").innerHTML = objData.data.lbl_azp_gsc_capture_t_type;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_capture/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_capture/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_capture/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_gsc_capture_id_azp_gsc_capture;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_gsc_capture_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_gsc_capture_m_status;
					document.querySelector("#field_up_date_visible").value = objData.data.lbl_azp_gsc_capture_t_date_visible;
					document.querySelector("#field_up_title").value = objData.data.lbl_azp_gsc_capture_t_title;
					document.querySelector("#field_up_gsc_request").value = objData.data.lbl_azp_gsc_capture_v_id_azp_gsc_request;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
...
function modal_file() {
	document.querySelector("#div_fl_associate").style.display = 'none';
	document.querySelector("#div_fl_count").style.display = 'none';
	document.querySelector("#field_fl_associate").value = '';
	// Obtener el primer valor seleccionado de la tabla
	var idtbl = $("#dt_info tr.selected td:first").html();
	// Validar si el id es mayor a cero
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-file').modal('show');
					document.querySelector("#field_fl_id").value = objData.data.lbl_azp_gsc_capture_id_azp_gsc_capture;
					...
					var ditbl = objData.data.lbl_azp_gsc_capture_t_folder;
					var sequest = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
					var bjaxurl = var_url + 'api' + var_controller + "folder/" + ditbl + "/";
					...
					sequest.onreadystatechange = function(){
						if (sequest.readyState == 4 && sequest.status == 200) {
							...
							if (pbjData.status) {
								if (pbjData.data.lbl_azp_gsc_capture_t_count >= 2) {
									document.querySelector("#div_fl_associate").style.display = '';
									document.querySelector("#div_fl_count").style.display = '';
									document.querySelector("#field_fl_count").value = pbjData.data.lbl_azp_gsc_capture_t_count;
								}
							}
						}
					}
			...
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					...
					if (fdocument == '' || fdocument == 'null') {
						...
						document.getElementById("field_dcrt_document").value = objData.data.lbl_azp_gsc_capture_t_document;
						$('#modal-id-file_capture').modal('show');
						...
						$('#iframe_file_capture').attr('src', route + file);
					}
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
