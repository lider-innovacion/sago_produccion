...
function action_checkbox_info() {
	...
	if ($('#field_ck_checkbox_info').is(':checked')) {
		...
		//Array.prototype.forEach.call(list, function (item) {
			...
			var querys = document.querySelector('#dt_info');
			var elements = querys.querySelectorAll('tr td.lbl_azp_ibn_vehicle_t_identification input');
			[].forEach.call(elements, function(items) {
			...
			var querys = document.querySelector('#dt_info');
			var elements = querys.querySelectorAll('tr td.lbl_azp_ibn_vehicle_t_full_name input');
			[].forEach.call(elements, function(items) {
				items.className = 'form-control input-xs';
				items.disabled = true;
			});
			...
			var querys = document.querySelector('#dt_info');
			var elements = querys.querySelectorAll('tr td.lbl_azp_ibn_vehicle_t_plaque input');
			[].forEach.call(elements, function(items) {
				items.className = 'form-control input-xs';
				items.disabled = true;
			});
			...
			var querys = document.querySelector('#dt_info');
			var elements = querys.querySelectorAll('tr lbl_azp_ibn_vehicle_t_plaque.lbl_azp_ibn_property_t_nro_registration input');
			[].forEach.call(elements, function(items) {
				items.className = 'form-control input-xs';
				items.disabled = true;
			});
			...
			var querys = document.querySelector('#dt_info');
			var elements = querys.querySelectorAll('tr td.lbl_azp_ibn_vehicle_t_city input');
			[].forEach.call(elements, function(items) {
				items.className = 'form-control input-xs';
				items.disabled = true;
			});
			...
			var querys = document.querySelector('#dt_info');
			var elements = querys.querySelectorAll('tr td.lbl_azp_ibn_vehicle_t_mark input');
			[].forEach.call(elements, function(items) {
				items.className = 'form-control input-xs';
				items.disabled = true;
			});
			...
			var querys = document.querySelector('#dt_info');
			var elements = querys.querySelectorAll('tr td.lbl_azp_ibn_vehicle_t_line input');
			[].forEach.call(elements, function(items) {
				items.className = 'form-control input-xs';
				items.disabled = true;
			});
			...
			var querys = document.querySelector('#dt_info');
			var elements = querys.querySelectorAll('tr td.lbl_azp_ibn_vehicle_t_model input');
			[].forEach.call(elements, function(items) {
				items.className = 'form-control input-xs';
				items.disabled = true;
			});
			...
			var querys = document.querySelector('#dt_info');
			var elements = querys.querySelectorAll('tr td.lbl_azp_ibn_vehicle_t_class input');
			[].forEach.call(elements, function(items) {
				items.className = 'form-control input-xs';
				items.disabled = true;
			});
			...
			var querys = document.querySelector('#dt_info');
			var elements = querys.querySelectorAll('tr td.lbl_azp_ibn_vehicle_t_service input');
			[].forEach.call(elements, function(items) {
				items.className = 'form-control input-xs';
				items.disabled = true;
			});
			...
			var querys = document.querySelector('#dt_info');
			var elements = querys.querySelectorAll('tr td.lbl_azp_ibn_vehicle_t_color input');
			[].forEach.call(elements, function(items) {
				items.className = 'form-control input-xs';
				items.disabled = true;
			});
...
function event_assessment(mvalue) {
	...
	if (idtbl > 0) {
		...
		if (mvalue == 'create') {
			...
			f_observation.value += v_limitation + ' ' + c_registered + ', ';
...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_vehicle_id_azs_ibn_vehicle",
				data: "lbl_azs_ibn_vehicle_id_azs_ibn_vehicle",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_vehicle_m_date_created",
				data: "lbl_azs_ibn_vehicle_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_vehicle_m_date_modified",
				data: "lbl_azs_ibn_vehicle_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_vehicle_m_description",
				data: "lbl_azs_ibn_vehicle_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Consecutivo",
				id: "lbl_azs_ibn_vehicle_t_consecutive",
				data: "lbl_azs_ibn_vehicle_t_consecutive",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Cedula",
				id: "lbl_azs_ibn_vehicle_t_identification",
				data: "lbl_azs_ibn_vehicle_t_identification",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Nombre",
				id: "lbl_azs_ibn_vehicle_t_full_name",
				data: "lbl_azs_ibn_vehicle_t_full_name",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Placa",
				id: "lbl_azs_ibn_vehicle_t_plaque",
				data: "lbl_azs_ibn_vehicle_t_plaque",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Ciudad",
				id: "lbl_azs_ibn_vehicle_t_city",
				data: "lbl_azs_ibn_vehicle_t_city",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Marca",
				id: "lbl_azs_ibn_vehicle_t_mark",
				data: "lbl_azs_ibn_vehicle_t_mark",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Linea",
				id: "lbl_azs_ibn_vehicle_t_line",
				data: "lbl_azs_ibn_vehicle_t_line",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Modelo",
				id: "lbl_azs_ibn_vehicle_t_model",
				data: "lbl_azs_ibn_vehicle_t_model",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Clase",
				id: "lbl_azs_ibn_vehicle_t_class",
				data: "lbl_azs_ibn_vehicle_t_class",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Servicio",
				id: "lbl_azs_ibn_vehicle_t_service",
				data: "lbl_azs_ibn_vehicle_t_service",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Color",
				id: "lbl_azs_ibn_vehicle_t_color",
				data: "lbl_azs_ibn_vehicle_t_color",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Estado",
				id: "lbl_azs_ibn_vehicle_u_ibn_state",
				data: "lbl_azs_ibn_vehicle_u_ibn_state",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Valor Vehiculo",
				id: "lbl_azs_ibn_vehicle_t_value_vehicle",
				data: "lbl_azs_ibn_vehicle_t_value_vehicle",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Confecamaras",
				id: "lbl_azs_ibn_vehicle_t_make_camera",
				data: "lbl_azs_ibn_vehicle_t_make_camera",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Valor Gravamen",
				id: "lbl_azs_ibn_vehicle_t_value_assessment",
				data: "lbl_azs_ibn_vehicle_t_value_assessment",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Gravamen",
				id: "lbl_azs_ibn_vehicle_t_assessment",
				data: "lbl_azs_ibn_vehicle_t_assessment",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Tipo Concepto",
				id: "lbl_azs_ibn_vehicle_u_ibn_type_concept",
				data: "lbl_azs_ibn_vehicle_u_ibn_type_concept",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_ibn_vehicle_t_causal_feasibility",
				data: "lbl_azs_ibn_vehicle_t_causal_feasibility",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Viable",
				id: "lbl_azs_ibn_vehicle_t_viable",
				data: "lbl_azs_ibn_vehicle_t_viable",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Bien Viable",
				id: "lbl_azs_ibn_vehicle_t_well_viable",
				data: "lbl_azs_ibn_vehicle_t_well_viable",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Observacion",
				id: "lbl_azs_ibn_vehicle_t_observation",
				data: "lbl_azs_ibn_vehicle_t_observation",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Campo 1",
				id: "lbl_azs_ibn_vehicle_t_text_one",
				data: "lbl_azs_ibn_vehicle_t_text_one",
				type: "text",
				className: "text-dark lbl_azs_ibn_vehicle_t_text_one",
				visible: true,
			},
			{
				title: "Campo 2",
				id: "lbl_azs_ibn_vehicle_t_text_two",
				data: "lbl_azs_ibn_vehicle_t_text_two",
				type: "text",
				className: "text-dark lbl_azs_ibn_vehicle_t_text_two",
				visible: true,
			},
			{
				title: "Campo 3",
				id: "lbl_azs_ibn_vehicle_t_text_three",
				data: "lbl_azs_ibn_vehicle_t_text_three",
				type: "text",
				className: "text-dark lbl_azs_ibn_vehicle_t_text_three",
				visible: true,
			},
			{
				title: "Campo 4",
				id: "lbl_azs_ibn_vehicle_t_text_four",
				data: "lbl_azs_ibn_vehicle_t_text_four",
				type: "text",
				className: "text-dark lbl_azs_ibn_vehicle_t_text_four",
				visible: true,
			},
			{
				title: "Campo 5",
				id: "lbl_azs_ibn_vehicle_t_text_five",
				data: "lbl_azs_ibn_vehicle_t_text_five",
				type: "text",
				className: "text-dark lbl_azs_ibn_vehicle_t_text_five",
				visible: true,
			},
			{
				title: "Lista 1",
				id: "lbl_azs_ibn_vehicle_t_sel_one",
				data: "lbl_azs_ibn_vehicle_t_sel_one",
				type: "text",
				className: "text-dark lbl_azs_ibn_vehicle_t_sel_one",
				visible: true,
			},
			{
				title: "Lista 2",
				id: "lbl_azs_ibn_vehicle_t_sel_two",
				data: "lbl_azs_ibn_vehicle_t_sel_two",
				type: "text",
				className: "text-dark lbl_azs_ibn_vehicle_t_sel_two",
				visible: true,
			},
			{
				title: "Lista 3",
				id: "lbl_azs_ibn_vehicle_t_sel_three",
				data: "lbl_azs_ibn_vehicle_t_sel_three",
				type: "text",
				className: "text-dark lbl_azs_ibn_vehicle_t_sel_three",
				visible: true,
			},
		];
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_vehicle/create",
								...
								if (obj.register > 0) {
									...
									request.onreadystatechange = function(){
										if (request.readyState == 4 && request.status == 200) {
											...
											if (objData.status) {
												var v_concept = objData.data.lbl_azp_ibn_vehicle_t_concept;
												if (v_concept == '') {
													// Configuracion de la ventana modal
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_vehicle/delete",
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					...
					//vtable.column(0).visible(false);
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_vehicle_id_azp_ibn_vehicle").innerHTML = objData.data.lbl_azp_ibn_vehicle_id_azp_ibn_vehicle;
					...
					document.querySelector("#lbl_azp_ibn_vehicle_m_date_created").innerHTML = objData.data.lbl_azp_ibn_vehicle_m_date_created;
					document.querySelector("#lbl_azp_ibn_vehicle_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_vehicle_m_date_modified;
					document.querySelector("#lbl_azp_ibn_vehicle_m_description").innerHTML = objData.data.lbl_azp_ibn_vehicle_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_ibn_vehicle_t_assessment").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_assessment;
					document.querySelector("#lbl_azp_ibn_vehicle_t_causal_feasibility").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_causal_feasibility;
					document.querySelector("#lbl_azp_ibn_vehicle_t_city").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_city;
					document.querySelector("#lbl_azp_ibn_vehicle_t_class").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_class;
					document.querySelector("#lbl_azp_ibn_vehicle_t_color").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_color;
					document.querySelector("#lbl_azp_ibn_vehicle_t_comment_legal").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_comment_legal;
					document.querySelector("#lbl_azp_ibn_vehicle_t_concept").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_concept;
					document.querySelector("#lbl_azp_ibn_vehicle_t_consecutive").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_consecutive;
					document.querySelector("#lbl_azp_ibn_vehicle_t_full_name").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_full_name;
					document.querySelector("#lbl_azp_ibn_vehicle_t_identification").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_identification;
					document.querySelector("#lbl_azp_ibn_vehicle_t_line").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_line;
					document.querySelector("#lbl_azp_ibn_vehicle_t_make_camera").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_make_camera;
					document.querySelector("#lbl_azp_ibn_vehicle_t_mark").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_mark;
					document.querySelector("#lbl_azp_ibn_vehicle_t_model").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_model;
					document.querySelector("#lbl_azp_ibn_vehicle_t_observation").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_observation;
					document.querySelector("#lbl_azp_ibn_vehicle_t_plaque").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_plaque;
					document.querySelector("#lbl_azp_ibn_vehicle_t_service").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_service;
					document.querySelector("#lbl_azp_ibn_vehicle_t_value_assessment").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_value_assessment;
					document.querySelector("#lbl_azp_ibn_vehicle_t_value_vehicle").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_value_vehicle;
					document.querySelector("#lbl_azp_ibn_vehicle_t_viable").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_viable;
					document.querySelector("#lbl_azp_ibn_vehicle_t_well_viable").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_well_viable;
					document.querySelector("#lbl_azp_ibn_vehicle_t_text_one").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_text_one;
					document.querySelector("#lbl_azp_ibn_vehicle_t_text_two").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_text_two;
					document.querySelector("#lbl_azp_ibn_vehicle_t_text_three").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_text_three;
					document.querySelector("#lbl_azp_ibn_vehicle_t_text_four").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_text_four;
					document.querySelector("#lbl_azp_ibn_vehicle_t_text_five").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_text_five;
					document.querySelector("#lbl_azp_ibn_vehicle_t_text_six").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_text_six;
					document.querySelector("#lbl_azp_ibn_vehicle_t_text_seven").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_text_seven;
					document.querySelector("#lbl_azp_ibn_vehicle_t_text_eight").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_text_eight;
					document.querySelector("#lbl_azp_ibn_vehicle_t_sel_one").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_sel_one;
					document.querySelector("#lbl_azp_ibn_vehicle_t_sel_two").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_sel_two;
					document.querySelector("#lbl_azp_ibn_vehicle_t_sel_three").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_sel_three;
					document.querySelector("#lbl_azp_ibn_vehicle_t_sel_four").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_sel_four;
					document.querySelector("#lbl_azp_ibn_vehicle_t_sel_five").innerHTML = objData.data.lbl_azp_ibn_vehicle_t_sel_five;
				...
				callback: function() {
					...
					if (load === 0) {
						...
						if (!extensions.exec(path)) {
							...
							$.ajax({
								type : "POST",
								url : "api/azp_ibn_vehicle/import",
								datatype: "HTML",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_vehicle/finish",
			...
			buttons: {
				...
				ok: {
					...
					callback: function() {
						$.ajax({
							type : "POST",
							url : "api/azp_ibn_vehicle/massive",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_vehicle/fl_remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_vehicle/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_vehicle/restore",
...
function event_save() {
	...
	if (idtbl > 0) {
		...
		var v_plaque = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_plaque").html();
		var v_city = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_city").find('input').val();
		var v_mark = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_mark").find('input').val();
		var v_line = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_line").find('input').val();
		var v_model = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_model").find('input').val();
		var v_class = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_class").find('input').val();
		var v_service = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_service").find('input').val();
		var v_color = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_color").find('input').val();
		var v_ibn_state = $("#dt_info tr.selected td.lbl_azp_ibn_state_t_name").find('select').val();
		var v_value_vehicle = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_value_vehicle").find('input').val();
		var v_make_camera = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_make_camera").find('input').val();
		var v_value_assessment = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_value_assessment").find('input').val();
		var v_assessment = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_assessment").find('input').val();
		var v_ibn_type_concept = $("#dt_info tr.selected td.lbl_azp_ibn_type_concept_t_name").find('select').val();
		var v_causal_feasibility = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_causal_feasibility").find('input').val();
		var v_viable = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_viable").find('select').val();
		var v_well_viable = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_well_viable").find('input').val();
		var v_text_one = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_text_one").find('input').val();
		var v_text_two = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_text_two").find('input').val();
		var v_text_three = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_text_three").find('input').val();
		var v_text_four = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_text_four").find('input').val();
		var v_text_five = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_text_five").find('input').val();
		var v_sel_one = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_sel_one").find('select').val();
		var v_sel_two = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_sel_two").find('select').val();
		var v_sel_three = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_sel_three").find('select').val();
		// Mensaje de audio para mostrar en la pagina web
		initApp.playSound('views/templates/smart/dist/media/sound', 'bigbox');
		var dialog = bootbox.dialog({
			title: '¿Estas seguro de continuar con el proceso?',
			...
			buttons: {
				...
				ok: {
					...
					callback: function() {
						$.ajax({
							type : "POST",
							url : "api/azp_ibn_vehicle/save",
							data : {
								field_sv_id: idtbl,
								field_sv_plaque: v_plaque,
								field_sv_city: v_city,
								field_sv_mark: v_mark,
								field_sv_line: v_line,
								field_sv_model: v_model,
								field_sv_class: v_class,
								field_sv_service: v_service,
								field_sv_color: v_color,
								field_sv_ibn_state: v_ibn_state,
								field_sv_value_vehicle: v_value_vehicle,
								field_sv_make_camera: v_make_camera,
								field_sv_value_assessment: v_value_assessment,
	...
	if (mvalue == 'create') {
		...
		if (idtbl > 0) {
			...
			if (tp != '') {
				...
				request.onreadystatechange = function(){
					if (request.readyState == 4 && request.status == 200) {
						...
						if (objData.status) {
							var name = objData.data.lbl_azp_ibn_type_concept_t_name;
							var text = objData.data.lbl_azp_ibn_type_concept_t_text;
							$("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_causal_feasibility").find('input').val(text);
							// Obtener valores de un campo en especifico
							var obvt = document.getElementById('field_tb_observation').value;
							if (name == 'CREAR') {
								//$('#field_tb_causal_feasibility').removeAttr('readonly','');
								document.getElementById('field_tb_causal_feasibility').value = 'REGISTRA' + ' ' + 'REGISTRA' + ' ' + obvt + text;
							} else {
				...
				$("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_causal_feasibility").find('input').val('');
			}
		}
	}
};
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					...
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_vehicle/update",
						...
						success : function(json) {
							...
							if (obj.success == 1) {
								...
								if (v_ibn_state == '' || v_ibn_state == '3' || v_ibn_state == '14') {
									var querys = document.querySelector('#form_update');
									var elements = querys.querySelectorAll('select, input, textarea');
									[].forEach.call(elements, function(items) {
										items.disabled = true;
...
function event_viable(mvalue) {
	if (mvalue == 'create') {
		...
		var cr_plaque = document.getElementById('field_cr_plaque').value;
		if (cr_viable == 'SI') {
			if (cr_plaque != '') {
				var new_value = 'VEHICULO DE PLACA ' + cr_plaque;
				document.getElementById('field_cr_well_viable').value = new_value;
			} else if (cr_plaque == '') {
				// Mensaje de audio para mostrar en la pagina web
				initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
				bootbox.alert({
					...
					message: "<span><strong>Lo sentimos:</strong> No haz digitado ningun valor en el campo de placa.</span>",
					centerVertical: true,
					className: "modal-alert",
					closeButton: false,
				});
		...
		var up_plaque = document.getElementById('field_up_plaque').value;
		if (up_viable == 'SI') {
			if (up_plaque != '') {
				var new_value = 'VEHICULO DE PLACA ' + up_plaque;
				document.getElementById('field_up_well_viable').value = new_value;
			} else if (up_plaque == '') {
				// Mensaje de audio para mostrar en la pagina web
				initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
				bootbox.alert({
		...
		$('#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_well_viable').attr('readonly','');
		var v_viable = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_viable").find('select').val();
		var v_plaque = $("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_plaque").html();
		if (v_viable == 'SI') {
			if (v_plaque != '') {
				var text = 'VEHICULO DE PLACA ' + v_plaque;
				$("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_well_viable").find('input').val(text);
			} else if (v_plaque == '') {
				// Mensaje de audio para mostrar en la pagina web
				initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
				bootbox.alert({
			...
			$("#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_well_viable").find('input').val('');
		}
		$('#dt_info tr.selected td.lbl_azp_ibn_vehicle_t_well_viable').removeAttr('readonly','');
	}
};
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					...
					//vtable.column(0).visible(false);
					$('#modal-id-update').modal('show');
					document.querySelector("#field_fl_id").value = objData.data.lbl_azp_ibn_vehicle_id_azp_ibn_vehicle;
					document.querySelector('#field_fl_control').value = objData.data.lbl_azp_ibn_vehicle_v_id_azp_ibn_control_panel;
					document.querySelector('#field_fl_detection').value = objData.data.lbl_azp_ibn_vehicle_t_identification;

					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_vehicle_id_azp_ibn_vehicle;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_vehicle_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_vehicle_m_status;
					document.querySelector("#field_up_assessment").value = objData.data.lbl_azp_ibn_vehicle_t_assessment;
					document.querySelector("#field_up_causal_feasibility").value = objData.data.lbl_azp_ibn_vehicle_t_causal_feasibility;
					document.querySelector("#field_up_city").value = objData.data.lbl_azp_ibn_vehicle_t_city;
					document.querySelector("#field_up_class").value = objData.data.lbl_azp_ibn_vehicle_t_class;
					document.querySelector("#field_up_color").value = objData.data.lbl_azp_ibn_vehicle_t_color;
					document.querySelector("#field_up_comment_legal").value = objData.data.lbl_azp_ibn_vehicle_t_comment_legal;
					//document.querySelector("#field_up_concept").value = objData.data.lbl_azp_ibn_vehicle_t_concept;
					document.querySelector("#field_up_consecutive").value = objData.data.lbl_azp_ibn_vehicle_t_consecutive;
					document.querySelector("#field_up_full_name").value = objData.data.lbl_azp_ibn_vehicle_t_full_name;
					document.querySelector("#field_up_identification").value = objData.data.lbl_azp_ibn_vehicle_t_identification;
					document.querySelector("#field_up_limitation").value = objData.data.lbl_azp_ibn_vehicle_t_limitation;
					document.querySelector("#field_up_line").value = objData.data.lbl_azp_ibn_vehicle_t_line;
					document.querySelector("#field_up_make_camera").value = objData.data.lbl_azp_ibn_vehicle_t_make_camera;
					document.querySelector("#field_up_mark").value = objData.data.lbl_azp_ibn_vehicle_t_mark;
					document.querySelector("#field_up_model").value = objData.data.lbl_azp_ibn_vehicle_t_model;
					//document.querySelector("#field_up_observation").value = objData.data.lbl_azp_ibn_vehicle_t_observation;
					document.querySelector("#field_up_plaque").value = objData.data.lbl_azp_ibn_vehicle_t_plaque;
					document.querySelector("#field_up_service").value = objData.data.lbl_azp_ibn_vehicle_t_service;
					document.querySelector("#field_up_value_assessment").value = objData.data.lbl_azp_ibn_vehicle_t_value_assessment;
					document.querySelector("#field_up_value_vehicle").value = objData.data.lbl_azp_ibn_vehicle_t_value_vehicle;
					document.querySelector("#field_up_viable").value = objData.data.lbl_azp_ibn_vehicle_t_viable;
					document.querySelector("#field_up_well_viable").value = objData.data.lbl_azp_ibn_vehicle_t_well_viable;
					document.querySelector("#field_up_st_returnable").value = objData.data.lbl_azp_ibn_vehicle_t_st_returnable;
					document.querySelector("#field_up_st_receipt").value = objData.data.lbl_azp_ibn_vehicle_t_st_receipt;
					document.querySelector("#field_up_st_date").value = objData.data.lbl_azp_ibn_vehicle_t_st_date;
					document.querySelector("#field_up_st_value").value = objData.data.lbl_azp_ibn_vehicle_t_st_value;
					document.querySelector("#field_up_text_one").value = objData.data.lbl_azp_ibn_vehicle_t_text_one;
					document.querySelector("#field_up_text_two").value = objData.data.lbl_azp_ibn_vehicle_t_text_two;
					document.querySelector("#field_up_text_three").value = objData.data.lbl_azp_ibn_vehicle_t_text_three;
					document.querySelector("#field_up_text_four").value = objData.data.lbl_azp_ibn_vehicle_t_text_four;
					document.querySelector("#field_up_text_five").value = objData.data.lbl_azp_ibn_vehicle_t_text_five;
					document.querySelector("#field_up_sel_one").value = objData.data.lbl_azp_ibn_vehicle_t_sel_one;
					document.querySelector("#field_up_sel_two").value = objData.data.lbl_azp_ibn_vehicle_t_sel_two;
					document.querySelector("#field_up_sel_three").value = objData.data.lbl_azp_ibn_vehicle_t_sel_three;
					document.querySelector("#field_up_ibn_observation").value = objData.data.lbl_azp_ibn_vehicle_v_id_azp_ibn_observation;
					document.querySelector("#field_up_ibn_state").value = objData.data.lbl_azp_ibn_vehicle_v_id_azp_ibn_state;
					document.querySelector("#field_up_ibn_type_concept").value = objData.data.lbl_azp_ibn_vehicle_v_id_azp_ibn_type_concept;

					event_state('update');
					event_val_vehicle('update');
					event_pay_vehicle('update');

					if (objData.data.lbl_azp_ibn_vehicle_t_st_returnable == 'SI') {
...
function event_check() {
	$("#dt_info input.dt_table_info").change(function () {
		if ($(this).prop("checked")) {
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_city input').prop('disabled', false);
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_mark input').prop('disabled', false);
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_line input').prop('disabled', false);
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_model input').prop('disabled', false);
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_class input').prop('disabled', false);
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_service input').prop('disabled', false);
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_color input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_state_t_name select').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_value_vehicle input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_make_camera input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_value_assessment input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_assessment input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_type_concept_t_name select').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_causal_feasibility input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_viable select').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_well_viable input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_one input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_two input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_three input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_four input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_five input').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_sel_one select').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_sel_two select').prop('disabled', false);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_sel_three select').prop('disabled', false);

			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_city input').addClass('border-success');
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_mark input').addClass('border-success');
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_line input').addClass('border-success');
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_model input').addClass('border-success');
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_class input').addClass('border-success');
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_service input').addClass('border-success');
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_color input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_state_t_name select').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_value_vehicle input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_make_camera input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_value_assessment input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_assessment input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_type_concept_t_name select').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_causal_feasibility input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_viable select').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_well_viable input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_one input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_two input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_three input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_four input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_five input').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_sel_one select').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_sel_two select').addClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_sel_three select').addClass('border-success');
		} else {
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_city input').prop('disabled', true);
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_mark input').prop('disabled', true);
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_line input').prop('disabled', true);
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_model input').prop('disabled', true);
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_class input').prop('disabled', true);
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_service input').prop('disabled', true);
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_color input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_state_t_name select').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_value_vehicle input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_make_camera input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_value_assessment input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_assessment input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_type_concept_t_name select').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_causal_feasibility input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_viable select').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_well_viable input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_one input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_two input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_three input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_four input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_five input').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_sel_one select').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_sel_two select').prop('disabled', true);
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_sel_three select').prop('disabled', true);

			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_city input').removeClass('border-success');
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_mark input').removeClass('border-success');
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_line input').removeClass('border-success');
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_model input').removeClass('border-success');
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_class input').removeClass('border-success');
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_service input').removeClass('border-success');
			//$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_color input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_state_t_name select').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_value_vehicle input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_make_camera input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_value_assessment input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_assessment input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_type_concept_t_name select').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_causal_feasibility input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_viable select').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_well_viable input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_one input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_two input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_three input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_four input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_text_five input').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_sel_one select').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_sel_two select').removeClass('border-success');
			$(this).closest('tr').find('td.lbl_azp_ibn_vehicle_t_sel_three select').removeClass('border-success');
		}
	});
};
			...
			buttons: {
				...
				ok: {
					...
					callback: function() {
						$.ajax({
							type : "POST",
							url : "api/azp_ibn_vehicle/multiple",
...
function event_val_vehicle(mvalue) {
	if (mvalue == 'create') {
		if ($('#check_cr_value_vehicle').is(':checked')) {
			$("#field_cr_value_vehicle").inputmask("remove");
			$('#field_cr_value_vehicle').attr('placeholder','Digita el texto ...');
			$('#field_cr_value_vehicle').attr('style','text-align: left;');
			document.getElementById('field_cr_value_vehicle').value = 'SIN DETERMINAR';
		} else {
			$("#field_cr_value_vehicle").inputmask("mask", { "currency": "$ 0" });
			//$(document).ready(function() { $('#field_cr_value_vehicle').inputmask('$ 999.999.999.999', { numericInput: true }); });
		}
	} else if (mvalue == 'update') {
		if ($('#check_up_value_vehicle').is(':checked')) {
			$("#field_up_value_vehicle").inputmask("remove");
			$('#field_up_value_vehicle').attr('placeholder','Digita el texto ...');
			$('#field_up_value_vehicle').attr('style','text-align: left;');
			document.getElementById('field_up_value_vehicle').value = 'SIN DETERMINAR';
		} else {
			$("#field_up_value_vehicle").inputmask("mask", { "currency": "$ 0" });
			//$(document).ready(function() { $('#field_up_value_vehicle').inputmask('$ 999.999.999.999', { numericInput: true }); });
		}
	} else if (mvalue == 'massive') {
		if ($('#check_ms_value_vehicle').is(':checked')) {
			$("#field_ms_value_vehicle").inputmask("remove");
			$('#field_ms_value_vehicle').attr('placeholder','Digita el texto ...');
			$('#field_ms_value_vehicle').attr('style','text-align: left;');
			document.getElementById('field_ms_value_vehicle').value = 'SIN DETERMINAR';
		} else {
			$("#field_ms_value_vehicle").inputmask("mask", { "currency": "$ 0" });
			//$(document).ready(function() { $('#field_ms_value_vehicle').inputmask('$ 999.999.999.999', { numericInput: true }); });
		}
	}
};

function event_pay_vehicle(mvalue) {
	if (mvalue == 'create') {
		if ($('#check_cr_value_vehicle').is(':checked')) {
			$("#field_cr_value_vehicle").inputmask("remove");
			$('#field_cr_value_vehicle').attr('placeholder','Digita el texto ...');
...
function event_state(mvalue) {
	if (mvalue == 'create') {
		...
		if (v_ibn_state == '' || v_ibn_state == '3' || v_ibn_state == '14') {
			...
			document.getElementById('field_cr_ibn_type_concept').value = '3';
...
function field_class() {
	var se_field = document.getElementById('field_se_class').value;
	let sf_field = document.getElementById('field_sf_class');
	sf_field.value += "'" + se_field + "',";
};

function field_color() {
	var se_field = document.getElementById('field_se_color').value;
	let sf_field = document.getElementById('field_sf_color');
	sf_field.value += "'" + se_field + "',";
};
...
function field_line() {
	var se_field = document.getElementById('field_se_line').value;
	let sf_field = document.getElementById('field_sf_line');
	sf_field.value += "'" + se_field + "',";
};

function field_make_camera() {
	var se_field = document.getElementById('field_se_make_camera').value;
	let sf_field = document.getElementById('field_sf_make_camera');
	sf_field.value += "'" + se_field + "',";
};

function field_mark() {
	var se_field = document.getElementById('field_se_mark').value;
	let sf_field = document.getElementById('field_sf_mark');
	sf_field.value += "'" + se_field + "',";
};

function field_model() {
	var se_field = document.getElementById('field_se_model').value;
	let sf_field = document.getElementById('field_sf_model');
	sf_field.value += "'" + se_field + "',";
};
...
function field_plaque() {
	var se_field = document.getElementById('field_se_plaque').value;
	let sf_field = document.getElementById('field_sf_plaque');
	sf_field.value += "'" + se_field + "',";
};
...
function field_service() {
	var se_field = document.getElementById('field_se_service').value;
	let sf_field = document.getElementById('field_sf_service');
	sf_field.value += "'" + se_field + "',";
};

function field_value_assessment() {
	var se_field = document.getElementById('field_se_value_assessment').value;
	let sf_field = document.getElementById('field_sf_value_assessment');
	sf_field.value += "'" + se_field + "',";
};

function field_value_vehicle() {
	var se_field = document.getElementById('field_se_value_vehicle').value;
	let sf_field = document.getElementById('field_sf_value_vehicle');
	sf_field.value += "'" + se_field + "',";
};
