...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_calendar_festive_id_azs_ibn_calendar_festive",
				data: "lbl_azs_ibn_calendar_festive_id_azs_ibn_calendar_festive",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_calendar_festive_m_date_created",
				data: "lbl_azs_ibn_calendar_festive_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_calendar_festive_m_date_modified",
				data: "lbl_azs_ibn_calendar_festive_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_calendar_festive_m_description",
				data: "lbl_azs_ibn_calendar_festive_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Fecha",
				id: "lbl_azs_ibn_calendar_festive_t_date",
				data: "lbl_azs_ibn_calendar_festive_t_date",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_calendar_festive/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_calendar_festive/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_calendar_festive_id_azp_ibn_calendar_festive").innerHTML = objData.data.lbl_azp_ibn_calendar_festive_id_azp_ibn_calendar_festive;
					...
					document.querySelector("#lbl_azp_ibn_calendar_festive_m_date_created").innerHTML = objData.data.lbl_azp_ibn_calendar_festive_m_date_created;
					document.querySelector("#lbl_azp_ibn_calendar_festive_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_calendar_festive_m_date_modified;
					document.querySelector("#lbl_azp_ibn_calendar_festive_m_description").innerHTML = objData.data.lbl_azp_ibn_calendar_festive_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_ibn_calendar_festive_t_date").innerHTML = objData.data.lbl_azp_ibn_calendar_festive_t_date;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_calendar_festive/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_calendar_festive/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_calendar_festive/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_calendar_festive_id_azp_ibn_calendar_festive;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_calendar_festive_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_calendar_festive_m_status;
					document.querySelector("#field_up_date").value = objData.data.lbl_azp_ibn_calendar_festive_t_date;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
