		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type: 'POST',
						url: 'api/azp_access_permits/create',
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type: 'POST',
						url: 'api/azp_access_permits/delete',
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					...
					$.ajax({
						type: 'POST',
						url: 'api/azp_access_permits/enforce',
			...
			ok: {
				...
				callback: function() {
					...
					if (!extensions.exec(path)) { document.getElementById('field_im_file').value = ''; } else {
						$.ajax({
							type: 'POST',
							url: 'api/azp_access_permits/import',
							datatype: "HTML",
...
function event_release() {
	...
	if (value_checked == '') {
		...
		$.ajax({
			type : "POST",
			url : "api/azp_access_permits/release",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type: 'POST',
						url: 'api/azp_access_permits/remove',
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type: 'POST',
						url: 'api/azp_access_permits/restore',
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type: 'POST',
						url: 'api/azp_access_permits/update',
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function() {
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector('#lbl_azp_access_permits_id_azp_access_permits').innerHTML = objData.data.lbl_azp_access_permits_id_azp_access_permits;
					...
					document.querySelector('#lbl_azp_access_permits_m_date_created').innerHTML = objData.data.lbl_azp_access_permits_m_date_created;
					document.querySelector('#lbl_azp_access_permits_m_date_modified').innerHTML = objData.data.lbl_azp_access_permits_m_date_modified;
					document.querySelector('#lbl_azp_access_permits_m_description').innerHTML = objData.data.lbl_azp_access_permits_m_description;
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function() {
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector('#field_up_id').value = objData.data.lbl_azp_access_permits_id_azp_access_permits;
					document.querySelector('#field_up_description').value = objData.data.lbl_azp_access_permits_m_description;
					document.querySelector('#field_up_state').value = objData.data.lbl_azp_access_permits_m_status;
					document.querySelector('#field_up_access_type').value = objData.data.lbl_azp_access_permits_v_id_azp_access_type;
					document.querySelector('#field_up_application').value = objData.data.lbl_azp_access_permits_v_id_azp_application;
					document.querySelector('#field_up_role').value = objData.data.lbl_azp_access_permits_v_id_azp_role;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
