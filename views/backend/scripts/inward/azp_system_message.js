...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_system_message_id_azs_system_message",
				data: "lbl_azs_system_message_id_azs_system_message",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_system_message_m_date_created",
				data: "lbl_azs_system_message_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_system_message_m_date_modified",
				data: "lbl_azs_system_message_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_system_message_m_description",
				data: "lbl_azs_system_message_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Nombre",
				id: "lbl_azs_system_message_t_name",
				data: "lbl_azs_system_message_t_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Alerta",
				id: "lbl_azs_system_message_u_configuration_alert",
				data: "lbl_azs_system_message_u_configuration_alert",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Mensage General",
				id: "lbl_azs_system_message_u_message_general",
				data: "lbl_azs_system_message_u_message_general",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Mensaje Get",
				id: "lbl_azs_system_message_u_message_get",
				data: "lbl_azs_system_message_u_message_get",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Mensaje",
				id: "lbl_azs_system_message_t_message",
				data: "lbl_azs_system_message_t_message",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_system_message/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_system_message/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_system_message_id_azp_system_message").innerHTML = objData.data.lbl_azp_system_message_id_azp_system_message;
					...
					document.querySelector("#lbl_azp_system_message_m_date_created").innerHTML = objData.data.lbl_azp_system_message_m_date_created;
					document.querySelector("#lbl_azp_system_message_m_date_modified").innerHTML = objData.data.lbl_azp_system_message_m_date_modified;
					document.querySelector("#lbl_azp_system_message_m_description").innerHTML = objData.data.lbl_azp_system_message_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_system_message_t_message").innerHTML = objData.data.lbl_azp_system_message_t_message;
					document.querySelector("#lbl_azp_system_message_t_name").innerHTML = objData.data.lbl_azp_system_message_t_name;
					document.querySelector("#lbl_azp_configuration_alert_t_name").innerHTML = objData.data.lbl_azp_configuration_alert_t_name;
					document.querySelector("#lbl_azp_message_general_t_name").innerHTML = objData.data.lbl_azp_message_general_t_name;
					document.querySelector("#lbl_azp_message_get_t_name").innerHTML = objData.data.lbl_azp_message_get_t_name;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_system_message/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_system_message/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_system_message/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_system_message_id_azp_system_message;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_system_message_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_system_message_m_status;
					document.querySelector("#field_up_message").value = objData.data.lbl_azp_system_message_t_message;
					document.querySelector("#field_up_name").value = objData.data.lbl_azp_system_message_t_name;
					document.querySelector("#field_up_configuration_alert").value = objData.data.lbl_azp_system_message_v_id_azp_configuration_alert;
					document.querySelector("#field_up_message_general").value = objData.data.lbl_azp_system_message_v_id_azp_message_general;
					document.querySelector("#field_up_message_get").value = objData.data.lbl_azp_system_message_v_id_azp_message_get;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
