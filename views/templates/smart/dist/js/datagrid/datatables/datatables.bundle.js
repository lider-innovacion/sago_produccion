	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( lang ) {
			...
			if ( ! lang.sEmptyTable && zeroRecords &&
				defaults.sEmptyTable === "Ningun dato disponible" )
			{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"oAria": {
				 ...
				 *    } );
				 */
				"sSortAscending": ": Activar para ordenar columna de forma ascendente",
				 ...
				 *    } );
				 */
				"sSortDescending": ": Activar para ordenar columna de forma descendente"
			},
			 ...
			 *  @type string
			 *  @default Ningun dato disponible
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "loadingRecords": "Please wait - Cargando..."
			 *        }
			 *      } );
			 *    } );
			 */
