...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_sys_answer_id_azs_sys_answer",
				data: "lbl_azs_sys_answer_id_azs_sys_answer",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_sys_answer_m_date_created",
				data: "lbl_azs_sys_answer_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_sys_answer_m_date_modified",
				data: "lbl_azs_sys_answer_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_sys_answer_m_description",
				data: "lbl_azs_sys_answer_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Nombre",
				id: "lbl_azs_sys_answer_t_name",
				data: "lbl_azs_sys_answer_t_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Valor",
				id: "lbl_azs_sys_answer_t_value",
				data: "lbl_azs_sys_answer_t_value",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_sys_answer_id_azp_sys_answer").innerHTML = objData.data.lbl_azp_sys_answer_id_azp_sys_answer;
					...
					document.querySelector("#lbl_azp_sys_answer_m_date_created").innerHTML = objData.data.lbl_azp_sys_answer_m_date_created;
					document.querySelector("#lbl_azp_sys_answer_m_date_modified").innerHTML = objData.data.lbl_azp_sys_answer_m_date_modified;
					document.querySelector("#lbl_azp_sys_answer_m_description").innerHTML = objData.data.lbl_azp_sys_answer_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_sys_answer_t_name").innerHTML = objData.data.lbl_azp_sys_answer_t_name;
					document.querySelector("#lbl_azp_sys_answer_t_value").innerHTML = objData.data.lbl_azp_sys_answer_t_value;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_sys_answer/restore",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_sys_answer_id_azp_sys_answer;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_sys_answer_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_sys_answer_m_status;
					document.querySelector("#field_up_name").value = objData.data.lbl_azp_sys_answer_t_name;
					document.querySelector("#field_up_value").value = objData.data.lbl_azp_sys_answer_t_value;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
