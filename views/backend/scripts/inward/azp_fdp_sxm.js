...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_fdp_sxm_id_azs_fdp_sxm",
				data: "lbl_azs_fdp_sxm_id_azs_fdp_sxm",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_fdp_sxm_m_date_created",
				data: "lbl_azs_fdp_sxm_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_fdp_sxm_m_date_modified",
				data: "lbl_azs_fdp_sxm_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_fdp_sxm_m_description",
				data: "lbl_azs_fdp_sxm_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Nivel",
				id: "lbl_azs_sys_level_t_name",
				data: "lbl_azs_sys_level_t_name",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Estado",
				id: "lbl_azs_sys_state_t_name",
				data: "lbl_azs_sys_state_t_name",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Base",
				id: "lbl_azs_fdp_sxm_t_base",
				data: "lbl_azs_fdp_sxm_t_base",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Remitente",
				id: "lbl_azs_fdp_sxm_t_remitente",
				data: "lbl_azs_fdp_sxm_t_remitente",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_fdp_sxm_t_radicado_de_entrada",
				data: "lbl_azs_fdp_sxm_t_radicado_de_entrada",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Fecha Radicado De Entrada",
				id: "lbl_azs_fdp_sxm_t_fecha_radicado_de_entrada",
				data: "lbl_azs_fdp_sxm_t_fecha_radicado_de_entrada",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_fdp_sxm_t_nombre_docente",
				data: "lbl_azs_fdp_sxm_t_nombre_docente",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Ced Docente",
				id: "lbl_azs_fdp_sxm_t_ced_docente",
				data: "lbl_azs_fdp_sxm_t_ced_docente",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			/*{
				title: "Res",
				id: "lbl_azs_fdp_sxm_t_res",
				data: "lbl_azs_fdp_sxm_t_res",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},*/
			/*{
				...
				id: "lbl_azs_fdp_sxm_t_fecha_resolucion",
				data: "lbl_azs_fdp_sxm_t_fecha_resolucion",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},*/
			/*{
				title: "Tipo Cesantia",
				id: "lbl_azs_fdp_sxm_t_tipo_cesantia",
				data: "lbl_azs_fdp_sxm_t_tipo_cesantia",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},*/
			/*{
				title: "Nombre De Apoderado",
				id: "lbl_azs_fdp_sxm_t_nombre_de_apoderado",
				data: "lbl_azs_fdp_sxm_t_nombre_de_apoderado",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},*/
			/*{
				title: "Firma",
				id: "lbl_azs_fdp_sxm_t_firma",
				data: "lbl_azs_fdp_sxm_t_firma",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},*/
			/*{
				...
				id: "lbl_azs_fdp_sxm_t_resultado_estudio",
				data: "lbl_azs_fdp_sxm_t_resultado_estudio",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},*/
			/*{
				title: "Analisis Sustanciador Negadas",
				id: "lbl_azs_fdp_sxm_t_analisis_sustanciador_negadas",
				data: "lbl_azs_fdp_sxm_t_analisis_sustanciador_negadas",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},*/
			/*{
				title: "Medio De Liquidacion",
				id: "lbl_azs_fdp_sxm_t_medio_de_liquidacion",
				data: "lbl_azs_fdp_sxm_t_medio_de_liquidacion",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},*/
			/*{
				title: "NOcasion Del Pagoombre",
				id: "lbl_azs_fdp_sxm_t_ocasion_del_pago",
				data: "lbl_azs_fdp_sxm_t_ocasion_del_pago",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},*/
			/*{
				title: "Fecha De Actualizacion Dpe",
				id: "lbl_azs_fdp_sxm_t_fecha_de_actualizacion_dpe",
				data: "lbl_azs_fdp_sxm_t_fecha_de_actualizacion_dpe",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},*/
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_fdp_sxm_id_azp_fdp_sxm").innerHTML = objData.data.lbl_azp_fdp_sxm_id_azp_fdp_sxm;
					...
					document.querySelector("#lbl_azp_fdp_sxm_m_date_created").innerHTML = objData.data.lbl_azp_fdp_sxm_m_date_created;
					document.querySelector("#lbl_azp_fdp_sxm_m_date_modified").innerHTML = objData.data.lbl_azp_fdp_sxm_m_date_modified;
					document.querySelector("#lbl_azp_fdp_sxm_m_description").innerHTML = objData.data.lbl_azp_fdp_sxm_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_fdp_sxm_t_base").innerHTML = objData.data.lbl_azp_fdp_sxm_t_base;
					document.querySelector("#lbl_azp_fdp_sxm_t_remitente").innerHTML = objData.data.lbl_azp_fdp_sxm_t_remitente;
					document.querySelector("#lbl_azp_fdp_sxm_t_radicado_de_entrada").innerHTML = objData.data.lbl_azp_fdp_sxm_t_radicado_de_entrada;
					document.querySelector("#lbl_azp_fdp_sxm_t_fecha_radicado_de_entrada").innerHTML = objData.data.lbl_azp_fdp_sxm_t_fecha_radicado_de_entrada;
					document.querySelector("#lbl_azp_fdp_sxm_t_nombre_docente").innerHTML = objData.data.lbl_azp_fdp_sxm_t_nombre_docente;
					document.querySelector("#lbl_azp_fdp_sxm_t_ced_docente").innerHTML = objData.data.lbl_azp_fdp_sxm_t_ced_docente;
					document.querySelector("#lbl_azp_fdp_sxm_t_res").innerHTML = objData.data.lbl_azp_fdp_sxm_t_res;
					document.querySelector("#lbl_azp_fdp_sxm_t_fecha_resolucion").innerHTML = objData.data.lbl_azp_fdp_sxm_t_fecha_resolucion;
					document.querySelector("#lbl_azp_fdp_sxm_t_tipo_cesantia").innerHTML = objData.data.lbl_azp_fdp_sxm_t_tipo_cesantia;
					document.querySelector("#lbl_azp_fdp_sxm_t_nombre_de_apoderado").innerHTML = objData.data.lbl_azp_fdp_sxm_t_nombre_de_apoderado;
					document.querySelector("#lbl_azp_fdp_sxm_t_firma").innerHTML = objData.data.lbl_azp_fdp_sxm_t_firma;
					document.querySelector("#lbl_azp_fdp_sxm_t_resultado_estudio").innerHTML = objData.data.lbl_azp_fdp_sxm_t_resultado_estudio;
					document.querySelector("#lbl_azp_fdp_sxm_t_analisis_sustanciador_negadas").innerHTML = objData.data.lbl_azp_fdp_sxm_t_analisis_sustanciador_negadas;
					document.querySelector("#lbl_azp_fdp_sxm_t_medio_de_liquidacion").innerHTML = objData.data.lbl_azp_fdp_sxm_t_medio_de_liquidacion;
					document.querySelector("#lbl_azp_fdp_sxm_t_ocasion_del_pago").innerHTML = objData.data.lbl_azp_fdp_sxm_t_ocasion_del_pago;
					document.querySelector("#lbl_azp_fdp_sxm_t_fecha_de_actualizacion_dpe").innerHTML = objData.data.lbl_azp_fdp_sxm_t_fecha_de_actualizacion_dpe;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
						...
						if (!allowedExtensions.exec(filePath)){
							...
							$.ajax({
								...
								success: function(data) {
									...
									$.ajax({
										type : "POST",
										url : "api/azp_fdp_sxm/extra_import",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_fdp_sxm_id_azp_fdp_sxm;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_fdp_sxm_m_description;
					//document.querySelector("#field_up_state").value = objData.data.lbl_azp_fdp_sxm_m_status;
					document.querySelector("#field_up_base").value = objData.data.lbl_azp_fdp_sxm_t_base;
					document.querySelector("#field_up_remitente").value = objData.data.lbl_azp_fdp_sxm_t_remitente;
					document.querySelector("#field_up_radicado_de_entrada").value = objData.data.lbl_azp_fdp_sxm_t_radicado_de_entrada;
					document.querySelector("#field_up_fecha_radicado_de_entrada").value = objData.data.lbl_azp_fdp_sxm_t_fecha_radicado_de_entrada;
					document.querySelector("#field_up_nombre_docente").value = objData.data.lbl_azp_fdp_sxm_t_nombre_docente;
					document.querySelector("#field_up_ced_docente").value = objData.data.lbl_azp_fdp_sxm_t_ced_docente;
					document.querySelector("#field_up_res").value = objData.data.lbl_azp_fdp_sxm_t_res;
					document.querySelector("#field_up_fecha_resolucion").value = objData.data.lbl_azp_fdp_sxm_t_fecha_resolucion;
					document.querySelector("#field_up_tipo_cesantia").value = objData.data.lbl_azp_fdp_sxm_t_tipo_cesantia;
					document.querySelector("#field_up_nombre_de_apoderado").value = objData.data.lbl_azp_fdp_sxm_t_nombre_de_apoderado;
					document.querySelector("#field_up_firma").value = objData.data.lbl_azp_fdp_sxm_t_firma;
					document.querySelector("#field_up_resultado_estudio").value = objData.data.lbl_azp_fdp_sxm_t_resultado_estudio;
					document.querySelector("#field_up_analisis_sustanciador_negadas").value = objData.data.lbl_azp_fdp_sxm_t_analisis_sustanciador_negadas;
					document.querySelector("#field_up_medio_de_liquidacion").value = objData.data.lbl_azp_fdp_sxm_t_medio_de_liquidacion;
					document.querySelector("#field_up_ocasion_del_pago").value = objData.data.lbl_azp_fdp_sxm_t_ocasion_del_pago;
					document.querySelector("#field_up_fecha_de_actualizacion_dpe").value = objData.data.lbl_azp_fdp_sxm_t_fecha_de_actualizacion_dpe;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
