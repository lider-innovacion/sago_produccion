...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_conditional_id_azs_ibn_conditional",
				data: "lbl_azs_ibn_conditional_id_azs_ibn_conditional",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_conditional_m_date_created",
				data: "lbl_azs_ibn_conditional_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_conditional_m_date_modified",
				data: "lbl_azs_ibn_conditional_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_conditional_m_description",
				data: "lbl_azs_ibn_conditional_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Nombre",
				id: "lbl_azs_ibn_conditional_t_operator",
				data: "lbl_azs_ibn_conditional_t_operator",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Valor",
				id: "lbl_azs_ibn_conditional_t_value",
				data: "lbl_azs_ibn_conditional_t_value",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Modulo",
				id: "lbl_azs_ibn_conditional_u_ibn_module",
				data: "lbl_azs_ibn_conditional_u_ibn_module",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_ibn_conditional_u_ibn_type_condition",
				data: "lbl_azs_ibn_conditional_u_ibn_type_condition",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_conditional/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_conditional/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_conditional_id_azp_ibn_conditional").innerHTML = objData.data.lbl_azp_ibn_conditional_id_azp_ibn_conditional;
					...
					document.querySelector("#lbl_azp_ibn_conditional_m_date_created").innerHTML = objData.data.lbl_azp_ibn_conditional_m_date_created;
					document.querySelector("#lbl_azp_ibn_conditional_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_conditional_m_date_modified;
					document.querySelector("#lbl_azp_ibn_conditional_m_description").innerHTML = objData.data.lbl_azp_ibn_conditional_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_ibn_conditional_t_land").innerHTML = objData.data.lbl_azp_ibn_conditional_t_land;
					document.querySelector("#lbl_azp_ibn_conditional_t_result").innerHTML = objData.data.lbl_azp_ibn_conditional_t_result;
					document.querySelector("#lbl_azp_ibn_conditional_t_operator").innerHTML = objData.data.lbl_azp_ibn_conditional_t_operator;
					document.querySelector("#lbl_azp_ibn_conditional_t_value").innerHTML = objData.data.lbl_azp_ibn_conditional_t_value;
					document.querySelector("#lbl_azp_ibn_module_t_name").innerHTML = objData.data.lbl_azp_ibn_module_t_name;
					document.querySelector("#lbl_azp_ibn_type_condition_t_name").innerHTML = objData.data.lbl_azp_ibn_type_condition_t_name;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_conditional/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_conditional/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_conditional/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_conditional_id_azp_ibn_conditional;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_conditional_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_conditional_m_status;
					//document.querySelector("#field_up_land").value = objData.data.lbl_azp_ibn_conditional_t_land;
					document.querySelector("#field_up_operator").value = objData.data.lbl_azp_ibn_conditional_t_operator;
					document.querySelector("#field_up_result").value = objData.data.lbl_azp_ibn_conditional_t_result;
					document.querySelector("#field_up_value").value = objData.data.lbl_azp_ibn_conditional_t_value;
					document.querySelector("#field_up_ibn_module").value = objData.data.lbl_azp_ibn_conditional_v_id_azp_ibn_module;
					document.querySelector("#field_up_ibn_type_condition").value = objData.data.lbl_azp_ibn_conditional_v_id_azp_ibn_type_condition;

					event_field('update');

					var ajaxurl = var_url + 'api' + var_controller + "tablefieldup/" + objData.data.lbl_azp_ibn_conditional_t_land + "/";
