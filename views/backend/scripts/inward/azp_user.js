...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_user_id_azs_user",
				data: "lbl_azs_user_id_azs_user",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_user_m_date_created",
				data: "lbl_azs_user_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_user_m_date_modified",
				data: "lbl_azs_user_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_user_m_description",
				data: "lbl_azs_user_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			},
			{
				...
				id: "lbl_azs_user_t_email",
				data: "lbl_azs_user_t_email",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Usuario",
				id: "lbl_azs_user_t_login",
				data: "lbl_azs_user_t_login",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Aplicacion",
				id: "lbl_azs_user_u_application",
				data: "lbl_azs_user_u_application",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Rol",
				id: "lbl_azs_user_u_role",
				data: "lbl_azs_user_u_role",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Cliente",
				id: "lbl_azs_user_u_fct_client",
				data: "lbl_azs_user_u_fct_client",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Nombres",
				id: "lbl_azs_data_personal_t_names",
				data: "lbl_azs_data_personal_t_names",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Apellidos",
				id: "lbl_azs_data_personal_t_surnames",
				data: "lbl_azs_data_personal_t_surnames",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_data_personal_u_document_type",
				data: "lbl_azs_data_personal_u_document_type",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_data_personal_t_identification",
				data: "lbl_azs_data_personal_t_identification",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_data_personal_t_birth_date",
				data: "lbl_azs_data_personal_t_birth_date",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Telefono Fijo",
				id: "lbl_azs_data_personal_t_phone_fixed",
				data: "lbl_azs_data_personal_t_phone_fixed",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_data_personal_t_phone_movil",
				data: "lbl_azs_data_personal_t_phone_movil",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Pais",
				id: "lbl_azs_data_personal_u_country",
				data: "lbl_azs_data_personal_u_country",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Direccion",
				id: "lbl_azs_data_personal_t_address",
				data: "lbl_azs_data_personal_t_address",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_user_id_azp_user").innerHTML = objData.data.lbl_azp_user_id_azp_user;
					...
					document.querySelector("#lbl_azp_user_m_date_created").innerHTML = objData.data.lbl_azp_user_m_date_created;
					document.querySelector("#lbl_azp_user_m_date_modified").innerHTML = objData.data.lbl_azp_user_m_date_modified;
					document.querySelector("#lbl_azp_user_m_description").innerHTML = objData.data.lbl_azp_user_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_user_t_email").innerHTML = objData.data.lbl_azp_user_t_email;
					//document.querySelector("#lbl_azp_user_t_key_active").innerHTML = objData.data.lbl_azp_user_t_key_active;
					//document.querySelector("#lbl_azp_user_t_key_password").innerHTML = objData.data.lbl_azp_user_t_key_password;
					//document.querySelector("#lbl_azp_user_t_key_password_temp").innerHTML = objData.data.lbl_azp_user_t_key_password_temp;
					//document.querySelector("#lbl_azp_user_t_key_status").innerHTML = objData.data.lbl_azp_user_t_key_status;
					//document.querySelector("#lbl_azp_user_t_last_connection").innerHTML = objData.data.lbl_azp_user_t_last_connection;
					document.querySelector("#lbl_azp_user_t_login").innerHTML = objData.data.lbl_azp_user_t_login;
					//document.querySelector("#lbl_azp_user_t_password").innerHTML = objData.data.lbl_azp_user_t_password;
					//document.querySelector("#lbl_azp_user_t_session").innerHTML = objData.data.lbl_azp_user_t_session;
					//document.querySelector("#lbl_azp_application_t_name").innerHTML = objData.data.lbl_azp_application_t_name;
					document.querySelector("#lbl_azp_fct_client_t_name").innerHTML = objData.data.lbl_azp_fct_client_t_name;
					document.querySelector("#lbl_azp_role_t_name").innerHTML = objData.data.lbl_azp_role_t_name;
					//document.querySelector("#lbl_azp_data_personal_t_address").innerHTML = objData.data.lbl_azp_data_personal_t_address;
					//document.querySelector("#lbl_azp_data_personal_t_birth_date").innerHTML = objData.data.lbl_azp_data_personal_t_birth_date;
					document.querySelector("#lbl_azp_data_personal_t_identification").innerHTML = objData.data.lbl_azp_data_personal_t_identification;
					document.querySelector("#lbl_azp_data_personal_t_names").innerHTML = objData.data.lbl_azp_data_personal_t_names;
					//document.querySelector("#lbl_azp_data_personal_t_phone_fixed").innerHTML = objData.data.lbl_azp_data_personal_t_phone_fixed;
					//document.querySelector("#lbl_azp_data_personal_t_phone_movil").innerHTML = objData.data.lbl_azp_data_personal_t_phone_movil;
					document.querySelector("#lbl_azp_data_personal_t_surnames").innerHTML = objData.data.lbl_azp_data_personal_t_surnames;
					//document.querySelector("#lbl_azp_country_t_name").innerHTML = objData.data.lbl_azp_country_t_name;
					document.querySelector("#lbl_azp_document_type_t_name").innerHTML = objData.data.lbl_azp_document_type_t_name;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_user_id_azp_user;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_user_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_user_m_status;
					document.querySelector("#field_up_email").value = objData.data.lbl_azp_user_t_email;
					document.querySelector("#field_up_email_confirm").value = objData.data.lbl_azp_user_t_email;
					document.querySelector("#field_up_login").value = objData.data.lbl_azp_user_t_login;
					//document.querySelector("#field_up_application").value = objData.data.lbl_azp_user_v_id_azp_application;
					document.querySelector("#field_up_fct_client").value = objData.data.lbl_azp_user_v_id_azp_fct_client;
					document.querySelector("#field_up_role").value = objData.data.lbl_azp_user_v_id_azp_role;
					//document.querySelector("#field_up_address").value = objData.data.lbl_azp_data_personal_t_address;
					//document.querySelector("#field_up_birth_date").value = objData.data.lbl_azp_data_personal_t_birth_date;
					document.querySelector("#field_up_identification").value = objData.data.lbl_azp_data_personal_t_identification;
					document.querySelector("#field_up_names").value = objData.data.lbl_azp_data_personal_t_names;
					//document.querySelector("#field_up_phone_fixed").value = objData.data.lbl_azp_data_personal_t_phone_fixed;
					//document.querySelector("#field_up_phone_movil").value = objData.data.lbl_azp_data_personal_t_phone_movil;
					document.querySelector("#field_up_surnames").value = objData.data.lbl_azp_data_personal_t_surnames;
					//document.querySelector("#field_up_country").value = objData.data.lbl_azp_data_personal_v_id_azp_country;
					document.querySelector("#field_up_document_type").value = objData.data.lbl_azp_data_personal_v_id_azp_document_type;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
