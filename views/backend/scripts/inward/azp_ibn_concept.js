...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_concept_id_azs_ibn_concept",
				data: "lbl_azs_ibn_concept_id_azs_ibn_concept",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_concept_m_date_created",
				data: "lbl_azs_ibn_concept_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_concept_m_date_modified",
				data: "lbl_azs_ibn_concept_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_concept_m_description",
				data: "lbl_azs_ibn_concept_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Cliente",
				id: "lbl_azs_ibn_concept_u_ibn_client",
				data: "lbl_azs_ibn_concept_u_ibn_client",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Modulo",
				id: "lbl_azs_ibn_concept_u_ibn_module",
				data: "lbl_azs_ibn_concept_u_ibn_module",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Texto 01",
				id: "lbl_azs_ibn_concept_t_text_01",
				data: "lbl_azs_ibn_concept_t_text_01",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Campo 01",
				id: "lbl_azs_ibn_concept_t_land_01",
				data: "lbl_azs_ibn_concept_t_land_01",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Texto 02",
				id: "lbl_azs_ibn_concept_t_text_02",
				data: "lbl_azs_ibn_concept_t_text_02",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Campo 02",
				id: "lbl_azs_ibn_concept_t_land_02",
				data: "lbl_azs_ibn_concept_t_land_02",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Texto 03",
				id: "lbl_azs_ibn_concept_t_text_03",
				data: "lbl_azs_ibn_concept_t_text_03",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Campo 03",
				id: "lbl_azs_ibn_concept_t_land_03",
				data: "lbl_azs_ibn_concept_t_land_03",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Texto 04",
				id: "lbl_azs_ibn_concept_t_text_04",
				data: "lbl_azs_ibn_concept_t_text_04",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Campo 04",
				id: "lbl_azs_ibn_concept_t_land_04",
				data: "lbl_azs_ibn_concept_t_land_04",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Texto 05",
				id: "lbl_azs_ibn_concept_t_text_05",
				data: "lbl_azs_ibn_concept_t_text_05",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Campo 05",
				id: "lbl_azs_ibn_concept_t_land_05",
				data: "lbl_azs_ibn_concept_t_land_05",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Texto 06",
				id: "lbl_azs_ibn_concept_t_text_06",
				data: "lbl_azs_ibn_concept_t_text_06",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Campo 06",
				id: "lbl_azs_ibn_concept_t_land_06",
				data: "lbl_azs_ibn_concept_t_land_06",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Texto 07",
				id: "lbl_azs_ibn_concept_t_text_07",
				data: "lbl_azs_ibn_concept_t_text_07",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Campo 07",
				id: "lbl_azs_ibn_concept_t_land_07",
				data: "lbl_azs_ibn_concept_t_land_07",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Texto 08",
				id: "lbl_azs_ibn_concept_t_text_08",
				data: "lbl_azs_ibn_concept_t_text_08",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Campo 08",
				id: "lbl_azs_ibn_concept_t_land_08",
				data: "lbl_azs_ibn_concept_t_land_08",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Texto 09",
				id: "lbl_azs_ibn_concept_t_text_09",
				data: "lbl_azs_ibn_concept_t_text_09",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Campo 09",
				id: "lbl_azs_ibn_concept_t_land_09",
				data: "lbl_azs_ibn_concept_t_land_09",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Texto 10",
				id: "lbl_azs_ibn_concept_t_text_10",
				data: "lbl_azs_ibn_concept_t_text_10",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Campo 10",
				id: "lbl_azs_ibn_concept_t_land_10",
				data: "lbl_azs_ibn_concept_t_land_10",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Texto 11",
				id: "lbl_azs_ibn_concept_t_text_11",
				data: "lbl_azs_ibn_concept_t_text_11",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Campo 11",
				id: "lbl_azs_ibn_concept_t_land_11",
				data: "lbl_azs_ibn_concept_t_land_11",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Texto 12",
				id: "lbl_azs_ibn_concept_t_text_12",
				data: "lbl_azs_ibn_concept_t_text_12",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Campo 12",
				id: "lbl_azs_ibn_concept_t_land_12",
				data: "lbl_azs_ibn_concept_t_land_12",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Texto 13",
				id: "lbl_azs_ibn_concept_t_text_13",
				data: "lbl_azs_ibn_concept_t_text_13",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Campo 13",
				id: "lbl_azs_ibn_concept_t_land_13",
				data: "lbl_azs_ibn_concept_t_land_13",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Texto 14",
				id: "lbl_azs_ibn_concept_t_text_14",
				data: "lbl_azs_ibn_concept_t_text_14",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Campo 14",
				id: "lbl_azs_ibn_concept_t_land_14",
				data: "lbl_azs_ibn_concept_t_land_14",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Texto 15",
				id: "lbl_azs_ibn_concept_t_text_15",
				data: "lbl_azs_ibn_concept_t_text_15",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Campo 15",
				id: "lbl_azs_ibn_concept_t_land_15",
				data: "lbl_azs_ibn_concept_t_land_15",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Texto 16",
				id: "lbl_azs_ibn_concept_t_text_16",
				data: "lbl_azs_ibn_concept_t_text_16",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Campo 16",
				id: "lbl_azs_ibn_concept_t_land_16",
				data: "lbl_azs_ibn_concept_t_land_16",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Texto 17",
				id: "lbl_azs_ibn_concept_t_text_17",
				data: "lbl_azs_ibn_concept_t_text_17",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Campo 17",
				id: "lbl_azs_ibn_concept_t_land_17",
				data: "lbl_azs_ibn_concept_t_land_17",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Texto 18",
				id: "lbl_azs_ibn_concept_t_text_18",
				data: "lbl_azs_ibn_concept_t_text_18",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Campo 18",
				id: "lbl_azs_ibn_concept_t_land_18",
				data: "lbl_azs_ibn_concept_t_land_18",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Texto 19",
				id: "lbl_azs_ibn_concept_t_text_19",
				data: "lbl_azs_ibn_concept_t_text_19",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Campo 19",
				id: "lbl_azs_ibn_concept_t_land_19",
				data: "lbl_azs_ibn_concept_t_land_19",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Texto 20",
				id: "lbl_azs_ibn_concept_t_text_20",
				data: "lbl_azs_ibn_concept_t_text_20",
				type: "text",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Campo 20",
				id: "lbl_azs_ibn_concept_t_land_20",
				data: "lbl_azs_ibn_concept_t_land_20",
				type: "text",
				className: "text-dark",
				visible: false,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_concept/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_concept/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_concept_id_azp_ibn_concept").innerHTML = objData.data.lbl_azp_ibn_concept_id_azp_ibn_concept;
					...
					document.querySelector("#lbl_azp_ibn_concept_m_date_created").innerHTML = objData.data.lbl_azp_ibn_concept_m_date_created;
					document.querySelector("#lbl_azp_ibn_concept_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_concept_m_date_modified;
					document.querySelector("#lbl_azp_ibn_concept_m_description").innerHTML = objData.data.lbl_azp_ibn_concept_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_ibn_concept_t_text_01").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_01;
					document.querySelector("#lbl_azp_ibn_concept_t_land_01").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_01;
					document.querySelector("#lbl_azp_ibn_concept_t_text_02").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_02;
					document.querySelector("#lbl_azp_ibn_concept_t_land_02").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_02;
					document.querySelector("#lbl_azp_ibn_concept_t_text_03").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_03;
					document.querySelector("#lbl_azp_ibn_concept_t_land_03").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_03;
					document.querySelector("#lbl_azp_ibn_concept_t_text_04").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_04;
					document.querySelector("#lbl_azp_ibn_concept_t_land_04").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_04;
					document.querySelector("#lbl_azp_ibn_concept_t_text_05").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_05;
					document.querySelector("#lbl_azp_ibn_concept_t_land_05").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_05;
					document.querySelector("#lbl_azp_ibn_concept_t_text_06").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_06;
					document.querySelector("#lbl_azp_ibn_concept_t_land_06").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_06;
					document.querySelector("#lbl_azp_ibn_concept_t_text_07").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_07;
					document.querySelector("#lbl_azp_ibn_concept_t_land_07").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_07;
					document.querySelector("#lbl_azp_ibn_concept_t_text_08").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_08;
					document.querySelector("#lbl_azp_ibn_concept_t_land_08").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_08;
					document.querySelector("#lbl_azp_ibn_concept_t_text_09").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_09;
					document.querySelector("#lbl_azp_ibn_concept_t_land_09").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_09;
					document.querySelector("#lbl_azp_ibn_concept_t_text_10").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_10;
					document.querySelector("#lbl_azp_ibn_concept_t_land_10").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_10;
					document.querySelector("#lbl_azp_ibn_concept_t_text_11").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_11;
					document.querySelector("#lbl_azp_ibn_concept_t_land_11").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_11;
					document.querySelector("#lbl_azp_ibn_concept_t_text_12").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_12;
					document.querySelector("#lbl_azp_ibn_concept_t_land_12").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_12;
					document.querySelector("#lbl_azp_ibn_concept_t_text_13").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_13;
					document.querySelector("#lbl_azp_ibn_concept_t_land_13").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_13;
					document.querySelector("#lbl_azp_ibn_concept_t_text_14").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_14;
					document.querySelector("#lbl_azp_ibn_concept_t_land_14").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_14;
					document.querySelector("#lbl_azp_ibn_concept_t_text_15").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_15;
					document.querySelector("#lbl_azp_ibn_concept_t_land_15").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_15;
					document.querySelector("#lbl_azp_ibn_concept_t_text_16").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_16;
					document.querySelector("#lbl_azp_ibn_concept_t_land_16").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_16;
					document.querySelector("#lbl_azp_ibn_concept_t_text_17").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_17;
					document.querySelector("#lbl_azp_ibn_concept_t_land_17").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_17;
					document.querySelector("#lbl_azp_ibn_concept_t_text_18").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_18;
					document.querySelector("#lbl_azp_ibn_concept_t_land_18").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_18;
					document.querySelector("#lbl_azp_ibn_concept_t_text_19").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_19;
					document.querySelector("#lbl_azp_ibn_concept_t_land_19").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_19;
					document.querySelector("#lbl_azp_ibn_concept_t_text_20").innerHTML = objData.data.lbl_azp_ibn_concept_t_text_20;
					document.querySelector("#lbl_azp_ibn_concept_t_land_20").innerHTML = objData.data.lbl_azp_ibn_concept_t_land_20;
					document.querySelector("#lbl_azp_ibn_client_t_name").innerHTML = objData.data.lbl_azp_ibn_client_t_name;
					document.querySelector("#lbl_azp_ibn_module_t_name").innerHTML = objData.data.lbl_azp_ibn_module_t_name;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_concept/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_concept/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_concept/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_concept_id_azp_ibn_concept;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_concept_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_concept_m_status;
					document.querySelector("#field_up_text_01").value = objData.data.lbl_azp_ibn_concept_t_text_01;
					//document.querySelector("#field_up_land_01").value = objData.data.lbl_azp_ibn_concept_t_land_01;
					document.querySelector("#field_up_text_02").value = objData.data.lbl_azp_ibn_concept_t_text_02;
					//document.querySelector("#field_up_land_02").value = objData.data.lbl_azp_ibn_concept_t_land_02;
					document.querySelector("#field_up_text_03").value = objData.data.lbl_azp_ibn_concept_t_text_03;
					//document.querySelector("#field_up_land_03").value = objData.data.lbl_azp_ibn_concept_t_land_03;
					document.querySelector("#field_up_text_04").value = objData.data.lbl_azp_ibn_concept_t_text_04;
					//document.querySelector("#field_up_land_04").value = objData.data.lbl_azp_ibn_concept_t_land_04;
					document.querySelector("#field_up_text_05").value = objData.data.lbl_azp_ibn_concept_t_text_05;
					//document.querySelector("#field_up_land_05").value = objData.data.lbl_azp_ibn_concept_t_land_05;
					document.querySelector("#field_up_text_06").value = objData.data.lbl_azp_ibn_concept_t_text_06;
					//document.querySelector("#field_up_land_06").value = objData.data.lbl_azp_ibn_concept_t_land_06;
					document.querySelector("#field_up_text_07").value = objData.data.lbl_azp_ibn_concept_t_text_07;
					//document.querySelector("#field_up_land_07").value = objData.data.lbl_azp_ibn_concept_t_land_07;
					document.querySelector("#field_up_text_08").value = objData.data.lbl_azp_ibn_concept_t_text_08;
					//document.querySelector("#field_up_land_08").value = objData.data.lbl_azp_ibn_concept_t_land_08;
					document.querySelector("#field_up_text_09").value = objData.data.lbl_azp_ibn_concept_t_text_09;
					//document.querySelector("#field_up_land_09").value = objData.data.lbl_azp_ibn_concept_t_land_09;
					document.querySelector("#field_up_text_10").value = objData.data.lbl_azp_ibn_concept_t_text_10;
					//document.querySelector("#field_up_land_10").value = objData.data.lbl_azp_ibn_concept_t_land_10;
					document.querySelector("#field_up_text_11").value = objData.data.lbl_azp_ibn_concept_t_text_11;
					//document.querySelector("#field_up_land_11").value = objData.data.lbl_azp_ibn_concept_t_land_11;
					document.querySelector("#field_up_text_12").value = objData.data.lbl_azp_ibn_concept_t_text_12;
					//document.querySelector("#field_up_land_12").value = objData.data.lbl_azp_ibn_concept_t_land_12;
					document.querySelector("#field_up_text_13").value = objData.data.lbl_azp_ibn_concept_t_text_13;
					//document.querySelector("#field_up_land_13").value = objData.data.lbl_azp_ibn_concept_t_land_13;
					document.querySelector("#field_up_text_14").value = objData.data.lbl_azp_ibn_concept_t_text_14;
					//document.querySelector("#field_up_land_14").value = objData.data.lbl_azp_ibn_concept_t_land_14;
					document.querySelector("#field_up_text_15").value = objData.data.lbl_azp_ibn_concept_t_text_15;
					//document.querySelector("#field_up_land_15").value = objData.data.lbl_azp_ibn_concept_t_land_15;
					document.querySelector("#field_up_text_16").value = objData.data.lbl_azp_ibn_concept_t_text_16;
					//document.querySelector("#field_up_land_16").value = objData.data.lbl_azp_ibn_concept_t_land_16;
					document.querySelector("#field_up_text_17").value = objData.data.lbl_azp_ibn_concept_t_text_17;
					//document.querySelector("#field_up_land_17").value = objData.data.lbl_azp_ibn_concept_t_land_17;
					document.querySelector("#field_up_text_18").value = objData.data.lbl_azp_ibn_concept_t_text_18;
					//document.querySelector("#field_up_land_18").value = objData.data.lbl_azp_ibn_concept_t_land_18;
					document.querySelector("#field_up_text_19").value = objData.data.lbl_azp_ibn_concept_t_text_19;
					//document.querySelector("#field_up_land_19").value = objData.data.lbl_azp_ibn_concept_t_land_19;
					document.querySelector("#field_up_text_20").value = objData.data.lbl_azp_ibn_concept_t_text_20;
					//document.querySelector("#field_up_land_20").value = objData.data.lbl_azp_ibn_concept_t_land_20;
					document.querySelector("#field_up_ibn_client").value = objData.data.lbl_azp_ibn_concept_v_id_azp_ibn_client;
					document.querySelector("#field_up_ibn_module").value = objData.data.lbl_azp_ibn_concept_v_id_azp_ibn_module;
...
function event_field(mvalue) {
	if (mvalue == 'create') {
		var id = document.getElementById('field_cr_ibn_module').value;
		var ajaxurl = var_url + 'api' + var_controller + "tablefieldrd/" + id + "/";
		$.ajax({
			type: 'POST',
			url: ajaxurl,
		}).done(function(argument) {
			$('#field_cr_land_01').html(argument);
			$('#field_cr_land_02').html(argument);
			$('#field_cr_land_03').html(argument);
			$('#field_cr_land_04').html(argument);
			$('#field_cr_land_05').html(argument);
			$('#field_cr_land_06').html(argument);
			$('#field_cr_land_07').html(argument);
			$('#field_cr_land_08').html(argument);
			$('#field_cr_land_09').html(argument);
			$('#field_cr_land_10').html(argument);

			$('#field_cr_land_11').html(argument);
			$('#field_cr_land_12').html(argument);
			$('#field_cr_land_13').html(argument);
			$('#field_cr_land_14').html(argument);
			$('#field_cr_land_15').html(argument);
			$('#field_cr_land_16').html(argument);
			$('#field_cr_land_17').html(argument);
			$('#field_cr_land_18').html(argument);
			$('#field_cr_land_19').html(argument);
			$('#field_cr_land_20').html(argument);
		});
	}
	if (mvalue == 'update') {
		var id = document.getElementById('field_up_ibn_module').value;
		var ajaxurl = var_url + 'api' + var_controller + "tablefieldrd/" + id + "/";
		$.ajax({
			type: 'POST',
			url: ajaxurl,
		}).done(function(argument) {
			$('#field_up_land_01').html(argument);
			$('#field_up_land_02').html(argument);
			$('#field_up_land_03').html(argument);
			$('#field_up_land_04').html(argument);
			$('#field_up_land_05').html(argument);
			$('#field_up_land_06').html(argument);
			$('#field_up_land_07').html(argument);
			$('#field_up_land_08').html(argument);
			$('#field_up_land_09').html(argument);
			$('#field_up_land_10').html(argument);

			$('#field_up_land_11').html(argument);
			$('#field_up_land_12').html(argument);
			$('#field_up_land_13').html(argument);
			$('#field_up_land_14').html(argument);
			$('#field_up_land_15').html(argument);
			$('#field_up_land_16').html(argument);
			$('#field_up_land_17').html(argument);
			$('#field_up_land_18').html(argument);
			$('#field_up_land_19').html(argument);
			$('#field_up_land_20').html(argument);
		});
	}
}