...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_supplier_id_azs_ibn_supplier",
				data: "lbl_azs_ibn_supplier_id_azs_ibn_supplier",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_supplier_m_date_created",
				data: "lbl_azs_ibn_supplier_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_supplier_m_date_modified",
				data: "lbl_azs_ibn_supplier_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_supplier_m_description",
				data: "lbl_azs_ibn_supplier_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_supplier_t_email",
				data: "lbl_azs_ibn_supplier_t_email",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Nombres",
				id: "lbl_azs_ibn_supplier_t_names",
				data: "lbl_azs_ibn_supplier_t_names",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Apellidos",
				id: "lbl_azs_ibn_supplier_t_surnames",
				data: "lbl_azs_ibn_supplier_t_surnames",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_ibn_supplier_t_phone_movil",
				data: "lbl_azs_ibn_supplier_t_phone_movil",
				type: "text",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_supplier/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_supplier/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_supplier_id_azp_ibn_supplier").innerHTML = objData.data.lbl_azp_ibn_supplier_id_azp_ibn_supplier;
					...
					document.querySelector("#lbl_azp_ibn_supplier_m_date_created").innerHTML = objData.data.lbl_azp_ibn_supplier_m_date_created;
					document.querySelector("#lbl_azp_ibn_supplier_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_supplier_m_date_modified;
					document.querySelector("#lbl_azp_ibn_supplier_m_description").innerHTML = objData.data.lbl_azp_ibn_supplier_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_ibn_supplier_t_email").innerHTML = objData.data.lbl_azp_ibn_supplier_t_email;
					document.querySelector("#lbl_azp_ibn_supplier_t_names").innerHTML = objData.data.lbl_azp_ibn_supplier_t_names;
					document.querySelector("#lbl_azp_ibn_supplier_t_surnames").innerHTML = objData.data.lbl_azp_ibn_supplier_t_surnames;
					document.querySelector("#lbl_azp_ibn_supplier_t_phone_movil").innerHTML = objData.data.lbl_azp_ibn_supplier_t_phone_movil;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_supplier/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_supplier/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_supplier/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_supplier_id_azp_ibn_supplier;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_supplier_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_supplier_m_status;
					document.querySelector("#field_up_email").value = objData.data.lbl_azp_ibn_supplier_t_email;
					document.querySelector("#field_up_email_confirm").value = objData.data.lbl_azp_ibn_supplier_t_email;
					document.querySelector("#field_up_names").value = objData.data.lbl_azp_ibn_supplier_t_names;
					document.querySelector("#field_up_surnames").value = objData.data.lbl_azp_ibn_supplier_t_surnames;
					document.querySelector("#field_up_phone_movil").value = objData.data.lbl_azp_ibn_supplier_t_phone_movil;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
