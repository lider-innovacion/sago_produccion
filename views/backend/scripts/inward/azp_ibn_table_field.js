...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_table_field_id_azs_ibn_table_field",
				data: "lbl_azs_ibn_table_field_id_azs_ibn_table_field",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_table_field_m_date_created",
				data: "lbl_azs_ibn_table_field_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_table_field_m_date_modified",
				data: "lbl_azs_ibn_table_field_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_table_field_m_description",
				data: "lbl_azs_ibn_table_field_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Definicion",
				id: "lbl_azs_ibn_table_field_t_define",
				data: "lbl_azs_ibn_table_field_t_define",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Indice",
				id: "lbl_azs_ibn_table_field_t_index",
				data: "lbl_azs_ibn_table_field_t_index",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Etiqueta",
				id: "lbl_azs_ibn_table_field_t_label",
				data: "lbl_azs_ibn_table_field_t_label",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Modulo",
				id: "lbl_azs_ibn_table_field_u_ibn_module",
				data: "lbl_azs_ibn_table_field_u_ibn_module",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_table_field/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_table_field/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_table_field_id_azp_ibn_table_field").innerHTML = objData.data.lbl_azp_ibn_table_field_id_azp_ibn_table_field;
					...
					document.querySelector("#lbl_azp_ibn_table_field_m_date_created").innerHTML = objData.data.lbl_azp_ibn_table_field_m_date_created;
					document.querySelector("#lbl_azp_ibn_table_field_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_table_field_m_date_modified;
					document.querySelector("#lbl_azp_ibn_table_field_m_description").innerHTML = objData.data.lbl_azp_ibn_table_field_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_ibn_table_field_t_define").innerHTML = objData.data.lbl_azp_ibn_table_field_t_define;
					document.querySelector("#lbl_azp_ibn_table_field_t_index").innerHTML = objData.data.lbl_azp_ibn_table_field_t_index;
					document.querySelector("#lbl_azp_ibn_table_field_t_label").innerHTML = objData.data.lbl_azp_ibn_table_field_t_label;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_table_field/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_table_field/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_table_field/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_table_field_id_azp_ibn_table_field;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_table_field_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_table_field_m_status;
					document.querySelector("#field_up_define").value = objData.data.lbl_azp_ibn_table_field_t_define;
					document.querySelector("#field_up_index").value = objData.data.lbl_azp_ibn_table_field_t_index;
					document.querySelector("#field_up_label").value = objData.data.lbl_azp_ibn_table_field_t_label;
					document.querySelector("#field_up_ibn_module").value = objData.data.lbl_azp_ibn_table_field_v_id_azp_ibn_module;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
