...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_crt_client_id_azs_crt_client",
				data: "lbl_azs_crt_client_id_azs_crt_client",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_crt_client_m_date_created",
				data: "lbl_azs_crt_client_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_crt_client_m_date_modified",
				data: "lbl_azs_crt_client_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_crt_client_m_description",
				data: "lbl_azs_crt_client_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Codigo",
				id: "lbl_azs_crt_client_t_code",
				data: "lbl_azs_crt_client_t_code",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_crt_client_t_email",
				data: "lbl_azs_crt_client_t_email",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Contraseña",
				id: "lbl_azs_crt_client_t_password",
				data: "lbl_azs_crt_client_t_password",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Persona",
				id: "lbl_azs_crt_client_t_person",
				data: "lbl_azs_crt_client_t_person",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Cargo",
				id: "lbl_azs_crt_client_t_position",
				data: "lbl_azs_crt_client_t_position",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Direccion",
				id: "lbl_azs_crt_client_t_address",
				data: "lbl_azs_crt_client_t_address",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Banco",
				id: "lbl_azs_crt_client_u_crt_bank",
				data: "lbl_azs_crt_client_u_crt_bank",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Ciudad",
				id: "lbl_azs_crt_client_u_crt_city",
				data: "lbl_azs_crt_client_u_crt_city",
				type: "text",
				className: "text-dark",
				visible: true,
			},
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_crt_client_id_azp_crt_client").innerHTML = objData.data.lbl_azp_crt_client_id_azp_crt_client;
					...
					document.querySelector("#lbl_azp_crt_client_m_date_created").innerHTML = objData.data.lbl_azp_crt_client_m_date_created;
					document.querySelector("#lbl_azp_crt_client_m_date_modified").innerHTML = objData.data.lbl_azp_crt_client_m_date_modified;
					document.querySelector("#lbl_azp_crt_client_m_description").innerHTML = objData.data.lbl_azp_crt_client_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_crt_client_t_address").innerHTML = objData.data.lbl_azp_crt_client_t_address;
					document.querySelector("#lbl_azp_crt_client_t_code").innerHTML = objData.data.lbl_azp_crt_client_t_code;
					document.querySelector("#lbl_azp_crt_client_t_email").innerHTML = objData.data.lbl_azp_crt_client_t_email;
					document.querySelector("#lbl_azp_crt_client_t_password").innerHTML = objData.data.lbl_azp_crt_client_t_password;
					document.querySelector("#lbl_azp_crt_client_t_person").innerHTML = objData.data.lbl_azp_crt_client_t_person;
					document.querySelector("#lbl_azp_crt_client_t_position").innerHTML = objData.data.lbl_azp_crt_client_t_position;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_crt_client/restore",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_crt_client_id_azp_crt_client;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_crt_client_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_crt_client_m_status;
					document.querySelector("#field_up_address").value = objData.data.lbl_azp_crt_client_t_address;
					document.querySelector("#field_up_code").value = objData.data.lbl_azp_crt_client_t_code;
					document.querySelector("#field_up_email").value = objData.data.lbl_azp_crt_client_t_email;
					document.querySelector("#field_up_email_confirm").value = objData.data.lbl_azp_crt_client_t_email;
					document.querySelector("#field_up_password").value = objData.data.lbl_azp_crt_client_t_password;
					document.querySelector("#field_up_person").value = objData.data.lbl_azp_crt_client_t_person;
					document.querySelector("#field_up_position").value = objData.data.lbl_azp_crt_client_t_position;
					document.querySelector("#field_up_crt_bank").value = objData.data.lbl_azp_crt_client_v_id_azp_crt_bank;
					document.querySelector("#field_up_crt_city").value = objData.data.lbl_azp_crt_client_v_id_azp_crt_city;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
