<?php
	...
	//------------------------------------------------
	final class m_azp_ibn_captureModel extends Models implements OCREND {
		/*=========================================================================================================================*/
		...
		final public function sql_controller_by_create() {
			...
			return $this->db->query("
				SELECT
					...
					tc_azp_ibn_capture." . d_azp_ibn_capture_v_id_azp_ibn_control_panel . " AS 'lbl_azp_ibn_capture_v_id_azp_ibn_control_panel',
				...
				-- ---------------------------------------------------------------
				WHERE tc_azp_ibn_capture." . d_azp_ibn_capture_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "'
		...
		final public function sql_controller_change() {
			...
			return $this->db->query("
				SELECT
					tc_azs_ibn_capture." . d_azs_ibn_capture_id_azs_ibn_capture . " AS 'lbl_azs_ibn_capture_id_azs_ibn_capture',
					tc_azs_ibn_capture." . d_azs_ibn_capture_m_date_modified . " AS 'lbl_azs_ibn_capture_m_date_modified',
					tc_azp_user_created." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_created',
					tc_azp_user_modified." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_modified',
					tc_azs_ibn_capture." . d_azs_ibn_capture_m_date_created . " AS 'lbl_azs_ibn_capture_m_date_created',
					tc_azs_ibn_capture." . d_azs_ibn_capture_m_date_modified . " AS 'lbl_azs_ibn_capture_m_date_modified',
					tc_azs_ibn_capture." . d_azs_ibn_capture_m_description . " AS 'lbl_azs_ibn_capture_m_description',
					tc_azp_sys_level." . d_azp_sys_level_t_name . " AS 'lbl_azp_sys_level_t_name',
					tc_azp_sys_state." . d_azp_sys_state_t_name . " AS 'lbl_azp_sys_state_t_name',
					tc_azs_ibn_capture." . d_azs_ibn_capture_w_document . " AS 'lbl_azs_ibn_capture_w_document',
					tc_azs_ibn_capture." . d_azs_ibn_capture_w_error . " AS 'lbl_azs_ibn_capture_w_error',
					tc_azs_ibn_capture." . d_azs_ibn_capture_w_folder . " AS 'lbl_azs_ibn_capture_w_folder',
					tc_azs_ibn_capture." . d_azs_ibn_capture_w_name . " AS 'lbl_azs_ibn_capture_w_name',
					tc_azs_ibn_capture." . d_azs_ibn_capture_w_route . " AS 'lbl_azs_ibn_capture_w_route',
					tc_azs_ibn_capture." . d_azs_ibn_capture_w_size . " AS 'lbl_azs_ibn_capture_w_size',
					tc_azs_ibn_capture." . d_azs_ibn_capture_w_tmp_name . " AS 'lbl_azs_ibn_capture_w_tmp_name',
					tc_azs_ibn_capture." . d_azs_ibn_capture_w_type . " AS 'lbl_azs_ibn_capture_w_type',
					tc_azs_ibn_capture." . d_azs_ibn_capture_u_ibn_control_panel . " AS 'lbl_azs_ibn_capture_u_ibn_control_panel',
					tc_azs_ibn_capture." . d_azs_ibn_capture_u_ibn_module . " AS 'lbl_azs_ibn_capture_u_ibn_module',
					tc_azs_ibn_capture." . d_azs_ibn_capture_u_ibn_cfpvw . " AS 'lbl_azs_ibn_capture_u_ibn_cfpvw'
				FROM " . t_azs_ibn_capture . " tc_azs_ibn_capture
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azs_ibn_capture." . d_azs_ibn_capture_m_by_created . "
						= tc_azp_user_created." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_user . " tc_azp_user_modified
					ON tc_azs_ibn_capture." . d_azs_ibn_capture_m_by_modified . "
						= tc_azp_user_modified." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_sys_level . " tc_azp_sys_level
					ON tc_azs_ibn_capture." . d_azs_ibn_capture_m_level . "
						= tc_azp_sys_level." . d_azp_sys_level_t_value . "
				INNER JOIN " . t_azp_sys_state . " tc_azp_sys_state
					ON tc_azs_ibn_capture." . d_azs_ibn_capture_m_status . "
						= tc_azp_sys_state." . d_azp_sys_state_t_value . "
				-- ---------------------------------------------------------------
				WHERE tc_azs_ibn_capture." . d_azs_ibn_capture_v_id_azp_ibn_capture . " = '" . $this->id . "'
				ORDER BY tc_azs_ibn_capture." . d_azs_ibn_capture_m_date_modified . " DESC
			");
		}
		...
		final public function sql_controller_delete() : array {
			...
			$var_sql = $this->db->query("
				SELECT * FROM " . t_azp_ibn_capture . "
				WHERE " . d_azp_ibn_capture_id_azp_ibn_capture . " = '" . $this->id . "'
					AND " . d_azp_ibn_capture_m_deleted . " = '2'
				LIMIT 1
			");
			...
			if (false != $var_result) {
				...
				Func::redir(URL . url_query_azp_ibn_capture);
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_sys_state . " tc_azp_sys_state
					ON tc_azp_ibn_capture." . d_azp_ibn_capture_m_status . "
						= tc_azp_sys_state." . d_azp_sys_state_t_value . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_ibn_capture." . d_azp_ibn_capture_m_deleted . " = '3'
				ORDER BY tc_azp_ibn_capture." . d_azp_ibn_capture_id_azp_ibn_capture . " ASC
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_sys_state . " tc_azp_sys_state
					ON tc_azp_ibn_capture." . d_azp_ibn_capture_m_status . "
						= tc_azp_sys_state." . d_azp_sys_state_t_value . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_ibn_capture." . d_azp_ibn_capture_m_deleted . " = '2'
				ORDER BY tc_azp_ibn_capture." . d_azp_ibn_capture_id_azp_ibn_capture . " ASC
			");
		}
		...
		final public function sql_controller_update() {
			...
			return $this->db->query("
				SELECT
					tc_azp_ibn_capture." . d_azp_ibn_capture_id_azp_ibn_capture . " AS 'lbl_azp_ibn_capture_id_azp_ibn_capture',
					tc_azp_ibn_capture." . d_azp_ibn_capture_m_by_created . " AS 'lbl_azp_ibn_capture_m_by_created',
					tc_azp_ibn_capture." . d_azp_ibn_capture_m_by_modified . " AS 'lbl_azp_ibn_capture_m_by_modified',
					tc_azp_ibn_capture." . d_azp_ibn_capture_m_date_created . " AS 'lbl_azp_ibn_capture_m_date_created',
					tc_azp_ibn_capture." . d_azp_ibn_capture_m_date_modified . " AS 'lbl_azp_ibn_capture_m_date_modified',
					tc_azp_ibn_capture." . d_azp_ibn_capture_m_description . " AS 'lbl_azp_ibn_capture_m_description',
					tc_azp_ibn_capture." . d_azp_ibn_capture_m_level . " AS 'lbl_azp_ibn_capture_m_level',
					tc_azp_ibn_capture." . d_azp_ibn_capture_m_status . " AS 'lbl_azp_ibn_capture_m_status',
					tc_azp_ibn_capture." . d_azp_ibn_capture_w_document . " AS 'lbl_azp_ibn_capture_w_document',
					tc_azp_ibn_capture." . d_azp_ibn_capture_w_error . " AS 'lbl_azp_ibn_capture_w_error',
					tc_azp_ibn_capture." . d_azp_ibn_capture_w_folder . " AS 'lbl_azp_ibn_capture_w_folder',
					tc_azp_ibn_capture." . d_azp_ibn_capture_w_name . " AS 'lbl_azp_ibn_capture_w_name',
		...
		final private function error_sql_ibn_capture_delete(array $data) {
			try {
				#-------------------------------------------------------------------------#
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_ibn_capture_delete(array $data) : array {
			$var_error = $this->error_sql_azp_ibn_capture_delete($data);
			...
			if (!isset($_SESSION[SESS_APP_ID])) {
				...
				$var_array = array(d_azp_ibn_capture_m_deleted => '3',);
		...
		final private function error_sql_azp_ibn_capture_insert(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				$sql_name = $this->db->select(d_azp_ibn_capture_t_name, t_azp_ibn_capture, d_azp_ibn_capture_t_name . " = '" . $empty_name . "'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (true == $sql_name) {
					# Verificiar si el valor recibido de la sql es diferente del digitado
		...
		/*=========================================================================================================================*/
		# Query Sql Insert
		final public function sql_azp_ibn_capture_insert(array $data) : array {
			$var_error = $this->error_sql_azp_ibn_capture_insert($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				$var_array = array(
					...
					d_azp_ibn_capture_m_description => $empty_description,
					d_azp_ibn_capture_m_level => '2',
					d_azp_ibn_capture_m_status => '1',
					d_azp_ibn_capture_m_temp => '1',
					d_azp_ibn_capture_t_name => strtoupper($empty_name),
				);
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_ibn_capture_remove(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select('*', t_azp_ibn_capture, d_azp_ibn_capture_id_azp_ibn_capture . " = '" . $empty_id . "' AND " . d_azp_ibn_capture_m_deleted . " = '1'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (false == $sql_id) {
					# Verificar si el resultado devuleto no existe para asignar un valor especifico
					if (strtolower($sql_id) == '') { $sql_id[0][0] = 0; }
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_ibn_capture_remove(array $data) : array {
			$var_error = $this->error_sql_azp_ibn_capture_remove($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_ibn_capture_restore(array $data) {
			try {
				#-------------------------------------------------------------------------#
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_ibn_capture_restore(array $data) : array {
			$var_error = $this->error_sql_azp_ibn_capture_restore($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_ibn_capture_m_deleted => '1',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_ibn_capture, $var_array, d_azp_ibn_capture_id_azp_ibn_capture . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_ibn_capture_update(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				#-------------------------------------------------------------------------#
				# Verificar si el valor ingresado se encuentra repetido en los demas registros
				$sql_name = $this->db->select(d_azp_ibn_capture_t_name, t_azp_ibn_capture, d_azp_ibn_capture_id_azp_ibn_capture . " != '" . $empty_id . "' AND " . d_azp_ibn_capture_t_name . " = '" . $empty_name . "'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (true == $sql_name) {
					# Verificiar si el valor recibido de la sql es diferente del digitado
					if (strtolower($sql_name[0][0]) == strtolower($empty_name)) {
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_ibn_capture_update(array $data) : array {
			$var_error = $this->error_sql_azp_ibn_capture_update($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				$var_sql_select = $this->db->select('*', t_azp_ibn_capture, d_azp_ibn_capture_id_azp_ibn_capture . " = '" . $empty_id . "'");
				# Validar si la sentencia query ejecutada es correcta y no falsa
				if (false != $var_sql_select) {
					# El constructor foreach proporciona un modo sencillo de iterar sobre arrays.
					foreach ($var_sql_select as $key_sql_select):
						$var_array = array(
							d_azs_ibn_capture_m_by_created => $_SESSION[SESS_APP_ID],
							d_azs_ibn_capture_m_by_modified => $_SESSION[SESS_APP_ID],
							d_azs_ibn_capture_m_date_created => DATE_HOUR,
							d_azs_ibn_capture_m_date_modified => DATE_HOUR,
							d_azs_ibn_capture_m_deleted => $key_sql_select[d_azp_ibn_capture_m_deleted],
							d_azs_ibn_capture_m_description => $key_sql_select[d_azp_ibn_capture_m_description],
							d_azs_ibn_capture_m_level => $key_sql_select[d_azp_ibn_capture_m_level],
							d_azs_ibn_capture_m_status => $key_sql_select[d_azp_ibn_capture_m_status],
							d_azs_ibn_capture_m_temp => $key_sql_select[d_azp_ibn_capture_m_temp],
							d_azs_ibn_capture_t_name => strtoupper($key_sql_select[d_azp_ibn_capture_t_name]),
							d_azs_ibn_capture_v_id_azp_ibn_capture => $empty_id,
						);
						# Query Sql Insert: Insertar datos en la tabla con sus campos respectivos y asignados
						$this->db->insert(t_azs_ibn_capture, $var_array);
					endforeach;
				}
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(
					...
					d_azp_ibn_capture_m_date_modified => DATE_HOUR,
					d_azp_ibn_capture_m_description => $empty_description,
					d_azp_ibn_capture_m_status => $empty_state,
					d_azp_ibn_capture_t_name => strtoupper($empty_name),
				);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_ibn_capture, $var_array, d_azp_ibn_capture_id_azp_ibn_capture . " = '" . $empty_id . "'");
