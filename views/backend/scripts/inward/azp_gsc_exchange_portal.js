...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_gsc_exchange_portal_id_azs_gsc_exchange_portal",
				data: "lbl_azs_gsc_exchange_portal_id_azs_gsc_exchange_portal",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_gsc_exchange_portal_m_date_created",
				data: "lbl_azs_gsc_exchange_portal_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_gsc_exchange_portal_m_date_modified",
				data: "lbl_azs_gsc_exchange_portal_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_gsc_exchange_portal_m_description",
				data: "lbl_azs_gsc_exchange_portal_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Nombre",
				id: "lbl_azs_gsc_exchange_portal_w_name",
				data: "lbl_azs_gsc_exchange_portal_w_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Documento",
				id: "lbl_azs_gsc_exchange_portal_w_document",
				data: "lbl_azs_gsc_exchange_portal_w_document",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_exchange_portal/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_exchange_portal/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_gsc_exchange_portal_id_azp_gsc_exchange_portal").innerHTML = objData.data.lbl_azp_gsc_exchange_portal_id_azp_gsc_exchange_portal;
					...
					document.querySelector("#lbl_azp_gsc_exchange_portal_m_date_created").innerHTML = objData.data.lbl_azp_gsc_exchange_portal_m_date_created;
					document.querySelector("#lbl_azp_gsc_exchange_portal_m_date_modified").innerHTML = objData.data.lbl_azp_gsc_exchange_portal_m_date_modified;
					document.querySelector("#lbl_azp_gsc_exchange_portal_m_description").innerHTML = objData.data.lbl_azp_gsc_exchange_portal_m_description;
					...
					document.querySelector("#lbl_azp_gsc_exchange_portal_t_date_load").innerHTML = objData.data.lbl_azp_gsc_exchange_portal_t_date_load;
					document.querySelector("#lbl_azp_gsc_exchange_portal_w_name").innerHTML = objData.data.lbl_azp_gsc_exchange_portal_w_name;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_exchange_portal/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_exchange_portal/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_exchange_portal/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_gsc_exchange_portal_id_azp_gsc_exchange_portal;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_gsc_exchange_portal_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_gsc_exchange_portal_m_status;
					document.querySelector("#field_up_name").value = objData.data.lbl_azp_gsc_exchange_portal_t_name;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-file').modal('show');
					document.querySelector('#field_fl_id').value = objData.data.lbl_azp_gsc_exchange_portal_id_azp_gsc_exchange_portal;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				var objData = JSON.parse(request.responseText);
				if (objData.status) {
					var fdocument = objData.data.lbl_azp_gsc_exchange_portal_w_document;
					if (fdocument == '' || fdocument == 'null') {
						...
						var wdocument = objData.data.lbl_azp_gsc_exchange_portal_w_document;
						var wfolder = objData.data.lbl_azp_gsc_exchange_portal_w_folder;
						var wroute = objData.data.lbl_azp_gsc_exchange_portal_w_route;
			...
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					...
					if (fdocument == '' || fdocument == 'null') {
						...
						var wdocument = objData.data.lbl_azp_gsc_exchange_portal_w_document;
						var wfolder = objData.data.lbl_azp_gsc_exchange_portal_w_folder;
						var wname = objData.data.lbl_azp_gsc_exchange_portal_w_name;
			...
			ok: {
				...
				callback: function() {
					...
					if (!extensions.exec(path)) {
						...
						$.ajax({
							type: "POST",
							url: "api/azp_gsc_exchange_portal/file",
							datatype: "HTML",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_exchange_portal/archive",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_exchange_portal/urchive",
