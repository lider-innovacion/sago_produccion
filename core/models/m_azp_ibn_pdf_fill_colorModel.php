<?php
	...
	//------------------------------------------------
	final class m_azp_ibn_pdf_fill_colorModel extends Models implements OCREND {
		/*=========================================================================================================================*/
		...
		final public function sql_controller_by_create() {
			...
			return $this->db->query("
				...
				-- ---------------------------------------------------------------
				WHERE tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "'
					AND tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_m_deleted . " = '1'
		...
		final public function sql_controller_change() {
			...
			return $this->db->query("
				SELECT
					tc_azs_ibn_pdf_fill_color." . d_azs_ibn_pdf_fill_color_id_azs_ibn_pdf_fill_color . " AS 'lbl_azs_ibn_pdf_fill_color_id_azs_ibn_pdf_fill_color',
					tc_azs_ibn_pdf_fill_color." . d_azs_ibn_pdf_fill_color_m_date_modified . " AS 'lbl_azs_ibn_pdf_fill_color_m_date_modified',
					tc_azp_user_created." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_created',
					tc_azp_user_modified." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_modified',
					tc_azs_ibn_pdf_fill_color." . d_azs_ibn_pdf_fill_color_m_date_created . " AS 'lbl_azs_ibn_pdf_fill_color_m_date_created',
					tc_azs_ibn_pdf_fill_color." . d_azs_ibn_pdf_fill_color_m_date_modified . " AS 'lbl_azs_ibn_pdf_fill_color_m_date_modified',
					tc_azs_ibn_pdf_fill_color." . d_azs_ibn_pdf_fill_color_m_description . " AS 'lbl_azs_ibn_pdf_fill_color_m_description',
					tc_azp_sys_level." . d_azp_sys_level_t_name . " AS 'lbl_azp_sys_level_t_name',
					tc_azp_sys_state." . d_azp_sys_state_t_name . " AS 'lbl_azp_sys_state_t_name',
					tc_azs_ibn_pdf_fill_color." . d_azs_ibn_pdf_fill_color_t_blue . " AS 'lbl_azs_ibn_pdf_fill_color_t_blue',
					tc_azs_ibn_pdf_fill_color." . d_azs_ibn_pdf_fill_color_t_green . " AS 'lbl_azs_ibn_pdf_fill_color_t_green',
					tc_azs_ibn_pdf_fill_color." . d_azs_ibn_pdf_fill_color_t_label . " AS 'lbl_azs_ibn_pdf_fill_color_t_label',
					tc_azs_ibn_pdf_fill_color." . d_azs_ibn_pdf_fill_color_t_red . " AS 'lbl_azs_ibn_pdf_fill_color_t_red',
					tc_azs_ibn_pdf_fill_color." . d_azs_ibn_pdf_fill_color_u_ibn_interface_dit . " AS 'lbl_azs_ibn_pdf_fill_color_u_ibn_interface_dit'
				FROM " . t_azs_ibn_pdf_fill_color . " tc_azs_ibn_pdf_fill_color
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azs_ibn_pdf_fill_color." . d_azs_ibn_pdf_fill_color_m_by_created . "
						= tc_azp_user_created." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_user . " tc_azp_user_modified
					ON tc_azs_ibn_pdf_fill_color." . d_azs_ibn_pdf_fill_color_m_by_modified . "
						= tc_azp_user_modified." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_sys_level . " tc_azp_sys_level
					ON tc_azs_ibn_pdf_fill_color." . d_azs_ibn_pdf_fill_color_m_level . "
						= tc_azp_sys_level." . d_azp_sys_level_t_value . "
				INNER JOIN " . t_azp_sys_state . " tc_azp_sys_state
					ON tc_azs_ibn_pdf_fill_color." . d_azs_ibn_pdf_fill_color_m_status . "
						= tc_azp_sys_state." . d_azp_sys_state_t_value . "
				-- ---------------------------------------------------------------
				WHERE tc_azs_ibn_pdf_fill_color." . d_azs_ibn_pdf_fill_color_v_id_azp_ibn_pdf_fill_color . " = '" . $this->id . "'
				ORDER BY tc_azs_ibn_pdf_fill_color." . d_azs_ibn_pdf_fill_color_m_date_modified . " DESC
			");
		}
		...
		final public function sql_controller_delete() : array {
			...
			$var_sql = $this->db->query("
				SELECT * FROM " . t_azp_ibn_pdf_fill_color . "
				WHERE " . d_azp_ibn_pdf_fill_color_id_azp_ibn_pdf_fill_color . " = '" . $this->id . "'
					AND " . d_azp_ibn_pdf_fill_color_m_deleted . " = '2'
				LIMIT 1
			");
			...
			if (false != $var_result) {
				...
				Func::redir(URL . url_query_azp_ibn_pdf_fill_color);
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_ibn_interface_dit . " tc_azp_ibn_interface_dit
					ON tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_v_id_azp_ibn_interface_dit . "
						= tc_azp_ibn_interface_dit." . d_azp_ibn_interface_dit_id_azp_ibn_interface_dit . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_id_azp_ibn_pdf_fill_color . " = '" . $this->id . "'
					AND tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_m_deleted . " = '1'
				LIMIT 1
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_ibn_interface_dit . " tc_azp_ibn_interface_dit
					ON tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_v_id_azp_ibn_interface_dit . "
						= tc_azp_ibn_interface_dit." . d_azp_ibn_interface_dit_id_azp_ibn_interface_dit . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_m_deleted . " = '3'
				ORDER BY tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_id_azp_ibn_pdf_fill_color . " ASC
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_sys_state . " tc_azp_sys_state
					ON tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_m_status . "
						= tc_azp_sys_state." . d_azp_sys_state_t_value . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_m_deleted . " = '2'
				ORDER BY tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_id_azp_ibn_pdf_fill_color . " ASC
			");
		}
		...
		final public function sql_controller_update() {
			...
			return $this->db->query("
				SELECT
					tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_id_azp_ibn_pdf_fill_color . " AS 'lbl_azp_ibn_pdf_fill_color_id_azp_ibn_pdf_fill_color',
					tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_m_by_created . " AS 'lbl_azp_ibn_pdf_fill_color_m_by_created',
					tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_m_by_modified . " AS 'lbl_azp_ibn_pdf_fill_color_m_by_modified',
					tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_m_date_created . " AS 'lbl_azp_ibn_pdf_fill_color_m_date_created',
					tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_m_date_modified . " AS 'lbl_azp_ibn_pdf_fill_color_m_date_modified',
					tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_m_description . " AS 'lbl_azp_ibn_pdf_fill_color_m_description',
					tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_m_level . " AS 'lbl_azp_ibn_pdf_fill_color_m_level',
					tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_m_status . " AS 'lbl_azp_ibn_pdf_fill_color_m_status',
					tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_t_blue . " AS 'lbl_azp_ibn_pdf_fill_color_t_blue',
					tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_t_green . " AS 'lbl_azp_ibn_pdf_fill_color_t_green',
					tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_t_label . " AS 'lbl_azp_ibn_pdf_fill_color_t_label',
					tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_t_red . " AS 'lbl_azp_ibn_pdf_fill_color_t_red',
					tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_v_id_azp_ibn_interface_dit . " AS 'lbl_azp_ibn_pdf_fill_color_v_id_azp_ibn_interface_dit'
				FROM " . t_azp_ibn_pdf_fill_color . " tc_azp_ibn_pdf_fill_color
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azp_ibn_pdf_fill_color." . d_azp_ibn_pdf_fill_color_m_by_created . "
		...
		final private function error_sql_ibn_pdf_fill_color_delete(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				$sql_id = $this->db->select('*', t_azp_ibn_pdf_fill_color, d_azp_ibn_pdf_fill_color_id_azp_ibn_pdf_fill_color . " = '" . $empty_id . "'");
				...
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select('*', t_azp_ibn_pdf_fill_color, d_azp_ibn_pdf_fill_color_id_azp_ibn_pdf_fill_color . " = '" . $empty_id . "' AND " . d_azp_ibn_pdf_fill_color_m_deleted . " = '2'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (false == $sql_id) {
					# Verificar si el resultado devuleto no existe para asignar un valor especifico
					if (strtolower($sql_id) == '') { $sql_id[0][0] = 0; }
				...
				$sql_session = $this->db->select('*', t_azp_ibn_pdf_fill_color, d_azp_ibn_pdf_fill_color_id_azp_ibn_pdf_fill_color . " = '" . $empty_id . "' AND " . d_azp_ibn_pdf_fill_color_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "' AND " . d_azp_ibn_pdf_fill_color_m_level . " = '1'");
				# Verificar si el registro creado es igual el valor del campo nivel al valor dos
				$sql_level = $this->db->select('*', t_azp_ibn_pdf_fill_color, d_azp_ibn_pdf_fill_color_id_azp_ibn_pdf_fill_color . " = '" . $empty_id . "' AND " . d_azp_ibn_pdf_fill_color_m_level . " = '2'");
				# Verificar si el resultado de la sql es verdadero o falso
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_ibn_pdf_fill_color_delete(array $data) : array {
			$var_error = $this->error_sql_azp_ibn_pdf_fill_color_delete($data);
			...
			if (!isset($_SESSION[SESS_APP_ID])) {
				...
				$var_array = array(d_azp_ibn_pdf_fill_color_m_deleted => '3',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_ibn_pdf_fill_color, $var_array, d_azp_ibn_pdf_fill_color_id_azp_ibn_pdf_fill_color . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
		...
		final private function error_sql_azp_ibn_pdf_fill_color_insert(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				$var_sql = $this->db->select('*', t_azp_ibn_pdf_fill_color, d_azp_ibn_pdf_fill_color_v_id_azp_ibn_interface_dit . " = '" . $empty_ibn_interface_dit . "'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (true == $var_sql) {
					# Verificiar si el valor recibido de la sql es diferente del digitado
		...
		/*=========================================================================================================================*/
		# Query Sql Insert
		final public function sql_azp_ibn_pdf_fill_color_insert(array $data) : array {
			$var_error = $this->error_sql_azp_ibn_pdf_fill_color_insert($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				$var_array = array(
					...
					d_azp_ibn_pdf_fill_color_t_blue => strtoupper($empty_blue),
					d_azp_ibn_pdf_fill_color_t_green => strtoupper($empty_green),
					d_azp_ibn_pdf_fill_color_t_label => strtoupper($empty_label),
					d_azp_ibn_pdf_fill_color_t_red => strtoupper($empty_red),
					d_azp_ibn_pdf_fill_color_v_id_azp_ibn_interface_dit => $empty_ibn_interface_dit,
				);
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_ibn_pdf_fill_color_remove(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select('*', t_azp_ibn_pdf_fill_color, d_azp_ibn_pdf_fill_color_id_azp_ibn_pdf_fill_color . " = '" . $empty_id . "' AND " . d_azp_ibn_pdf_fill_color_m_deleted . " = '1'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (false == $sql_id) {
					# Verificar si el resultado devuleto no existe para asignar un valor especifico
					if (strtolower($sql_id) == '') { $sql_id[0][0] = 0; }
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_ibn_pdf_fill_color_remove(array $data) : array {
			$var_error = $this->error_sql_azp_ibn_pdf_fill_color_remove($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_ibn_pdf_fill_color_m_deleted => '2',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_ibn_pdf_fill_color, $var_array, d_azp_ibn_pdf_fill_color_id_azp_ibn_pdf_fill_color . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_ibn_pdf_fill_color_restore(array $data) {
			try {
				#-------------------------------------------------------------------------#
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_ibn_pdf_fill_color_restore(array $data) : array {
			$var_error = $this->error_sql_azp_ibn_pdf_fill_color_restore($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_ibn_pdf_fill_color_m_deleted => '1',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_ibn_pdf_fill_color, $var_array, d_azp_ibn_pdf_fill_color_id_azp_ibn_pdf_fill_color . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_ibn_pdf_fill_color_update(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				#-------------------------------------------------------------------------#
				# Verificar si el valor ingresado se encuentra repetido en los demas registros
				$var_sql = $this->db->select('*', t_azp_ibn_pdf_fill_color, d_azp_ibn_pdf_fill_color_id_azp_ibn_pdf_fill_color . " != '" . $empty_id . "' AND " . d_azp_ibn_pdf_fill_color_v_id_azp_ibn_interface_dit . " = '" . $empty_ibn_interface_dit . "'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (true == $var_sql) {
					# Verificiar si el valor recibido de la sql es diferente del digitado
					if (strtolower($var_sql[0][0]) == strtolower($empty_ibn_interface_dit)) {
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_ibn_pdf_fill_color_update(array $data) : array {
			$var_error = $this->error_sql_azp_ibn_pdf_fill_color_update($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				$var_sql_select = $this->db->select('*', t_azp_ibn_pdf_fill_color, d_azp_ibn_pdf_fill_color_id_azp_ibn_pdf_fill_color . " = '" . $empty_id . "'");
				...
				if (false != $var_sql_select) {
					...
					foreach ($var_sql_select as $key_sql_select):
						$var_array = array(
							...
							d_azs_ibn_pdf_fill_color_m_deleted => $key_sql_select[d_azp_ibn_pdf_fill_color_m_deleted],
							d_azs_ibn_pdf_fill_color_m_description => $key_sql_select[d_azp_ibn_pdf_fill_color_m_description],
							d_azs_ibn_pdf_fill_color_m_level => $key_sql_select[d_azp_ibn_pdf_fill_color_m_level],
							d_azs_ibn_pdf_fill_color_m_status => $key_sql_select[d_azp_ibn_pdf_fill_color_m_status],
							d_azs_ibn_pdf_fill_color_m_temp => $key_sql_select[d_azp_ibn_pdf_fill_color_m_temp],
							d_azs_ibn_pdf_fill_color_t_blue => strtoupper($key_sql_select[d_azp_ibn_pdf_fill_color_t_blue]),
							d_azs_ibn_pdf_fill_color_t_green => strtoupper($key_sql_select[d_azp_ibn_pdf_fill_color_t_green]),
							d_azs_ibn_pdf_fill_color_t_label => strtoupper($key_sql_select[d_azp_ibn_pdf_fill_color_t_label]),
							d_azs_ibn_pdf_fill_color_t_red => strtoupper($key_sql_select[d_azp_ibn_pdf_fill_color_t_red]),
							d_azs_ibn_pdf_fill_color_u_ibn_interface_dit => strtoupper($key_sql_select[d_azp_ibn_pdf_fill_color_v_id_azp_ibn_interface_dit]),
				...
				$var_array = array(
					...
					d_azp_ibn_pdf_fill_color_m_date_modified => DATE_HOUR,
					d_azp_ibn_pdf_fill_color_m_description => $empty_description,
					d_azp_ibn_pdf_fill_color_m_status => $empty_state,
					d_azp_ibn_pdf_fill_color_t_blue => strtoupper($empty_blue),
					d_azp_ibn_pdf_fill_color_t_green => strtoupper($empty_green),
					d_azp_ibn_pdf_fill_color_t_label => strtoupper($empty_label),
					d_azp_ibn_pdf_fill_color_t_red => strtoupper($empty_red),
