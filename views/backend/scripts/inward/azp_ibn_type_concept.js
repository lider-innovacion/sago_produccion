...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_type_concept_id_azs_ibn_type_concept",
				data: "lbl_azs_ibn_type_concept_id_azs_ibn_type_concept",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_type_concept_m_date_created",
				data: "lbl_azs_ibn_type_concept_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_type_concept_m_date_modified",
				data: "lbl_azs_ibn_type_concept_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_type_concept_m_description",
				data: "lbl_azs_ibn_type_concept_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Nombre",
				id: "lbl_azs_ibn_type_concept_t_name",
				data: "lbl_azs_ibn_type_concept_t_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Modulo",
				id: "lbl_azs_ibn_type_concept_u_ibn_module",
				data: "lbl_azs_ibn_type_concept_u_ibn_module",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Texto",
				id: "lbl_azs_ibn_type_concept_t_text",
				data: "lbl_azs_ibn_type_concept_t_text",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_type_concept/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_type_concept/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_type_concept_id_azp_ibn_type_concept").innerHTML = objData.data.lbl_azp_ibn_type_concept_id_azp_ibn_type_concept;
					...
					document.querySelector("#lbl_azp_ibn_type_concept_m_date_created").innerHTML = objData.data.lbl_azp_ibn_type_concept_m_date_created;
					document.querySelector("#lbl_azp_ibn_type_concept_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_type_concept_m_date_modified;
					document.querySelector("#lbl_azp_ibn_type_concept_m_description").innerHTML = objData.data.lbl_azp_ibn_type_concept_m_description;
					...
					document.querySelector("#lbl_azp_ibn_type_concept_t_text").innerHTML = objData.data.lbl_azp_ibn_type_concept_t_text;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_type_concept/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_type_concept/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_type_concept/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_type_concept_id_azp_ibn_type_concept;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_type_concept_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_type_concept_m_status;
					document.querySelector("#field_up_name").value = objData.data.lbl_azp_ibn_type_concept_t_name;
					document.querySelector("#field_up_text").value = objData.data.lbl_azp_ibn_type_concept_t_text;
					document.querySelector("#field_up_ibn_module").value = objData.data.lbl_azp_ibn_type_concept_v_id_azp_ibn_module;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
