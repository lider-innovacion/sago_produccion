if (document.getElementById('form_btn_zv_gsc_request')) {
	document.getElementById('form_btn_zv_gsc_request').onclick = function(e) {
		e.preventDefault();
		zv_gsc_request();
	};
}
	...
	if (date_since == '') {
		...
		if (date_until == '') {
			...
			if (date_since > date_until) {
				...
				$("#div_rf_filter").addClass('d-none');
				$('#div_jtf_4_full').addClass('d-none');
				$('#div_jtf_4_request').removeClass('d-none');
				...
				var columnSet = [
					...
					{
						title: "Cedulas",
						id: "lbl_azp_report_gsc_request_t_identification",
						data: "lbl_azp_report_gsc_request_t_identification",
						type: "readonly",
						"visible": true,
					},
					{
						title: "Entregado",
						id: "lbl_azp_report_gsc_request_t_c_delivered",
						data: "lbl_azp_report_gsc_request_t_c_delivered",
						type: "readonly",
						"visible": true,
					},
					{
						title: "En Tramite",
						id: "lbl_azp_report_gsc_request_t_c_in_process",
						data: "lbl_azp_report_gsc_request_t_c_in_process",
						type: "readonly",
						"visible": true,
					},
					{
						title: "Sin Entregar",
						id: "lbl_azp_report_gsc_request_t_c_without",
						data: "lbl_azp_report_gsc_request_t_c_without",
						type: "readonly",
						"visible": true,
					},
					{
						title: "Solicitud",
						id: "lbl_azp_report_gsc_request_t_c_request",
						data: "lbl_azp_report_gsc_request_t_c_request",
						type: "readonly",
						"visible": true,
					},
					{
				...
				var myTable = $('#dt_report_request').dataTable({
					...
					ajax: var_url + "dashboard/reportgscrequest/?field_rf_date_sice=" + date_since + "&field_rf_date_until=" + date_until,
