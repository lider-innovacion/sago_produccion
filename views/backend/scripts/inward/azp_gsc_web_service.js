...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_gsc_web_service_id_azs_gsc_web_service",
				data: "lbl_azs_gsc_web_service_id_azs_gsc_web_service",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_gsc_web_service_m_date_created",
				data: "lbl_azs_gsc_web_service_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_gsc_web_service_m_date_modified",
				data: "lbl_azs_gsc_web_service_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_gsc_web_service_m_description",
				data: "lbl_azs_gsc_web_service_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Cedula",
				id: "lbl_azs_gsc_web_service_t_identification",
				data: "lbl_azs_gsc_web_service_t_identification",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Estado",
				id: "lbl_azs_gsc_web_service_t_state",
				data: "lbl_azs_gsc_web_service_t_state",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_gsc_web_service_t_reported_bank",
				data: "lbl_azs_gsc_web_service_t_reported_bank",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Motivo",
				id: "lbl_azs_gsc_web_service_t_reason",
				data: "lbl_azs_gsc_web_service_t_reason",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_gsc_web_service_t_city_department",
				data: "lbl_azs_gsc_web_service_t_city_department",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_gsc_web_service_t_full_name",
				data: "lbl_azs_gsc_web_service_t_full_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Departamento",
				id: "lbl_azs_gsc_web_service_t_department",
				data: "lbl_azs_gsc_web_service_t_department",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_gsc_web_service_t_city_municipality",
				data: "lbl_azs_gsc_web_service_t_city_municipality",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Nro Envio",
				id: "lbl_azs_gsc_web_service_t_shipping_number",
				data: "lbl_azs_gsc_web_service_t_shipping_number",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Numero Serial",
				id: "lbl_azs_gsc_web_service_t_number_serial",
				data: "lbl_azs_gsc_web_service_t_number_serial",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Nro Notaria",
				id: "lbl_azs_gsc_web_service_t_notary_number",
				data: "lbl_azs_gsc_web_service_t_notary_number",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_gsc_web_service_t_notary_name",
				data: "lbl_azs_gsc_web_service_t_notary_name",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_gsc_web_service_t_notary_address",
				data: "lbl_azs_gsc_web_service_t_notary_address",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_gsc_web_service_t_death_date",
				data: "lbl_azs_gsc_web_service_t_death_date",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Observaciones",
				id: "lbl_azs_gsc_web_service_t_observation",
				data: "lbl_azs_gsc_web_service_t_observation",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_web_service/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_web_service/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_gsc_web_service_id_azp_gsc_web_service").innerHTML = objData.data.lbl_azp_gsc_web_service_id_azp_gsc_web_service;
					...
					document.querySelector("#lbl_azp_gsc_web_service_m_date_created").innerHTML = objData.data.lbl_azp_gsc_web_service_m_date_created;
					document.querySelector("#lbl_azp_gsc_web_service_m_date_modified").innerHTML = objData.data.lbl_azp_gsc_web_service_m_date_modified;
					document.querySelector("#lbl_azp_gsc_web_service_m_description").innerHTML = objData.data.lbl_azp_gsc_web_service_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_gsc_web_service_t_city_department").innerHTML = objData.data.lbl_azp_gsc_web_service_t_city_department;
					document.querySelector("#lbl_azp_gsc_web_service_t_city_municipality").innerHTML = objData.data.lbl_azp_gsc_web_service_t_city_municipality;
					document.querySelector("#lbl_azp_gsc_web_service_t_death_date").innerHTML = objData.data.lbl_azp_gsc_web_service_t_death_date;
					document.querySelector("#lbl_azp_gsc_web_service_t_department").innerHTML = objData.data.lbl_azp_gsc_web_service_t_department;
					document.querySelector("#lbl_azp_gsc_web_service_t_full_name").innerHTML = objData.data.lbl_azp_gsc_web_service_t_full_name;
					document.querySelector("#lbl_azp_gsc_web_service_t_identification").innerHTML = objData.data.lbl_azp_gsc_web_service_t_identification;
					document.querySelector("#lbl_azp_gsc_web_service_t_notary_address").innerHTML = objData.data.lbl_azp_gsc_web_service_t_notary_address;
					document.querySelector("#lbl_azp_gsc_web_service_t_notary_name").innerHTML = objData.data.lbl_azp_gsc_web_service_t_notary_name;
					document.querySelector("#lbl_azp_gsc_web_service_t_notary_number").innerHTML = objData.data.lbl_azp_gsc_web_service_t_notary_number;
					document.querySelector("#lbl_azp_gsc_web_service_t_number_serial").innerHTML = objData.data.lbl_azp_gsc_web_service_t_number_serial;
					document.querySelector("#lbl_azp_gsc_web_service_t_observation").innerHTML = objData.data.lbl_azp_gsc_web_service_t_observation;
					document.querySelector("#lbl_azp_gsc_web_service_t_reason").innerHTML = objData.data.lbl_azp_gsc_web_service_t_reason;
					document.querySelector("#lbl_azp_gsc_web_service_t_reported_bank").innerHTML = objData.data.lbl_azp_gsc_web_service_t_reported_bank;
					document.querySelector("#lbl_azp_gsc_web_service_t_shipping_number").innerHTML = objData.data.lbl_azp_gsc_web_service_t_shipping_number;
					document.querySelector("#lbl_azp_gsc_web_service_t_state").innerHTML = objData.data.lbl_azp_gsc_web_service_t_state;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_web_service/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_web_service/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_web_service/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_gsc_web_service_id_azp_gsc_web_service;
					document.querySelector("#field_up_city_department").value = objData.data.lbl_azp_gsc_web_service_t_city_department;
					document.querySelector("#field_up_city_municipality").value = objData.data.lbl_azp_gsc_web_service_t_city_municipality;
					document.querySelector("#field_up_death_date").value = objData.data.lbl_azp_gsc_web_service_t_death_date;
					document.querySelector("#field_up_department").value = objData.data.lbl_azp_gsc_web_service_t_department;
					document.querySelector("#field_up_full_name").value = objData.data.lbl_azp_gsc_web_service_t_full_name;
					document.querySelector("#field_up_identification").value = objData.data.lbl_azp_gsc_web_service_t_identification;
					document.querySelector("#field_up_notary_address").value = objData.data.lbl_azp_gsc_web_service_t_notary_address;
					document.querySelector("#field_up_notary_name").value = objData.data.lbl_azp_gsc_web_service_t_notary_name;
					document.querySelector("#field_up_notary_number").value = objData.data.lbl_azp_gsc_web_service_t_notary_number;
					document.querySelector("#field_up_number_serial").value = objData.data.lbl_azp_gsc_web_service_t_number_serial;
					document.querySelector("#field_up_observation").value = objData.data.lbl_azp_gsc_web_service_t_observation;
					document.querySelector("#field_up_reason").value = objData.data.lbl_azp_gsc_web_service_t_reason;
					document.querySelector("#field_up_reported_bank").value = objData.data.lbl_azp_gsc_web_service_t_reported_bank;
					document.querySelector("#field_up_shipping_number").value = objData.data.lbl_azp_gsc_web_service_t_shipping_number;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_gsc_web_service_t_state;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
