<?php
	...
	//------------------------------------------------
	final class m_azp_crt_alertModel extends Models implements OCREND {
		/*=========================================================================================================================*/
		...
		final public function sql_controller_by_create() {
			...
			return $this->db->query("
				SELECT
					tc_azp_crt_alert." . d_azp_crt_alert_id_azp_crt_alert . " AS 'lbl_azp_crt_alert_id_azp_crt_alert',
					tc_azp_user_created." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_created',
					tc_azp_user_modified." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_modified',
					tc_azp_crt_alert." . d_azp_crt_alert_m_date_created . " AS 'lbl_azp_crt_alert_m_date_created',
					tc_azp_crt_alert." . d_azp_crt_alert_m_date_modified . " AS 'lbl_azp_crt_alert_m_date_modified',
					tc_azp_crt_alert." . d_azp_crt_alert_m_description . " AS 'lbl_azp_crt_alert_m_description',
					tc_azp_sys_level." . d_azp_sys_level_t_name . " AS 'lbl_azp_sys_level_t_name',
					tc_azp_sys_state." . d_azp_sys_state_t_name . " AS 'lbl_azp_sys_state_t_name',
					tc_azp_crt_alert." . d_azp_crt_alert_t_next_time_d . " AS 'lbl_azp_crt_alert_t_next_time_d',
					tc_azp_crt_alert." . d_azp_crt_alert_t_next_time_h . " AS 'lbl_azp_crt_alert_t_next_time_h',
					tc_azp_crt_alert." . d_azp_crt_alert_t_next_time_m . " AS 'lbl_azp_crt_alert_t_next_time_m',
					tc_azp_crt_alert." . d_azp_crt_alert_t_next_time_s . " AS 'lbl_azp_crt_alert_t_next_time_s',

					REPLACE(tc_azp_crt_alert." . d_azp_crt_alert_t_next_time_d . ", '+', '') AS 'lbl_azp_crt_alert_t_next_time',

					tc_azp_crt_alert." . d_azp_crt_alert_t_time_expired_d . " AS 'lbl_azp_crt_alert_t_time_expired_d',
					tc_azp_crt_alert." . d_azp_crt_alert_t_time_expired_h . " AS 'lbl_azp_crt_alert_t_time_expired_h',
					tc_azp_crt_alert." . d_azp_crt_alert_t_time_expired_m . " AS 'lbl_azp_crt_alert_t_time_expired_m',
					tc_azp_crt_alert." . d_azp_crt_alert_t_time_expired_s . " AS 'lbl_azp_crt_alert_t_time_expired_s',

					REPLACE(tc_azp_crt_alert." . d_azp_crt_alert_t_time_expired_d . ", '+', '') AS 'lbl_azp_crt_alert_t_time_expired',

					tc_azp_crt_phase." . d_azp_crt_phase_t_name . " AS 'lbl_azp_crt_phase_t_name'
				FROM " . t_azp_crt_alert . " tc_azp_crt_alert
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azp_crt_alert." . d_azp_crt_alert_m_by_created . "
						= tc_azp_user_created." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_user . " tc_azp_user_modified
					ON tc_azp_crt_alert." . d_azp_crt_alert_m_by_modified . "
						= tc_azp_user_modified." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_sys_level . " tc_azp_sys_level
					ON tc_azp_crt_alert." . d_azp_crt_alert_m_level . "
						= tc_azp_sys_level." . d_azp_sys_level_t_value . "
				INNER JOIN " . t_azp_sys_state . " tc_azp_sys_state
					ON tc_azp_crt_alert." . d_azp_crt_alert_m_status . "
						= tc_azp_sys_state." . d_azp_sys_state_t_value . "
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_crt_phase ." tc_azp_crt_phase
					ON tc_azp_crt_alert." . d_azp_crt_alert_v_id_azp_crt_phase . "
						= tc_azp_crt_phase." . d_azp_crt_phase_id_azp_crt_phase . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_crt_alert." . d_azp_crt_alert_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "'
					AND tc_azp_crt_alert." . d_azp_crt_alert_m_deleted . " = '1'
				ORDER BY tc_azp_crt_alert." . d_azp_crt_alert_id_azp_crt_alert . " ASC
			");
		}
		...
		final public function sql_controller_change() {
			...
			return $this->db->query("
				SELECT
					tc_azs_crt_alert." . d_azs_crt_alert_id_azs_crt_alert . " AS 'lbl_azs_crt_alert_id_azs_crt_alert',
					tc_azs_crt_alert." . d_azs_crt_alert_m_date_modified . " AS 'lbl_azs_crt_alert_m_date_modified',
					tc_azp_user_created." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_created',
					tc_azp_user_modified." . d_azp_user_t_login . " AS 'lbl_azp_user_t_login_modified',
					tc_azs_crt_alert." . d_azs_crt_alert_m_date_created . " AS 'lbl_azs_crt_alert_m_date_created',
					tc_azs_crt_alert." . d_azs_crt_alert_m_date_modified . " AS 'lbl_azs_crt_alert_m_date_modified',
					tc_azs_crt_alert." . d_azs_crt_alert_m_description . " AS 'lbl_azs_crt_alert_m_description',
					tc_azp_sys_level." . d_azp_sys_level_t_name . " AS 'lbl_azp_sys_level_t_name',
					tc_azp_sys_state." . d_azp_sys_state_t_name . " AS 'lbl_azp_sys_state_t_name',
					tc_azs_crt_alert." . d_azs_crt_alert_t_next_time_d . " AS 'lbl_azs_crt_alert_t_next_time_d',
					tc_azs_crt_alert." . d_azs_crt_alert_t_next_time_h . " AS 'lbl_azs_crt_alert_t_next_time_h',
					tc_azs_crt_alert." . d_azs_crt_alert_t_next_time_m . " AS 'lbl_azs_crt_alert_t_next_time_m',
					tc_azs_crt_alert." . d_azs_crt_alert_t_next_time_s . " AS 'lbl_azs_crt_alert_t_next_time_s',

					CONCAT(
						REPLACE(tc_azs_crt_alert." . d_azs_crt_alert_t_next_time_d . ", '+', ''), ' ',
						REPLACE(tc_azs_crt_alert." . d_azs_crt_alert_t_next_time_h . ", '+', ''), ':',
						REPLACE(tc_azs_crt_alert." . d_azs_crt_alert_t_next_time_m . ", '+', ''), ':',
						REPLACE(tc_azs_crt_alert." . d_azs_crt_alert_t_next_time_s . ", '+', '')
					) AS 'lbl_azs_crt_alert_t_next_time',

					tc_azs_crt_alert." . d_azs_crt_alert_t_time_expired_d . " AS 'lbl_azs_crt_alert_t_time_expired_d',
					tc_azs_crt_alert." . d_azs_crt_alert_t_time_expired_h . " AS 'lbl_azs_crt_alert_t_time_expired_h',
					tc_azs_crt_alert." . d_azs_crt_alert_t_time_expired_m . " AS 'lbl_azs_crt_alert_t_time_expired_m',
					tc_azs_crt_alert." . d_azs_crt_alert_t_time_expired_s . " AS 'lbl_azs_crt_alert_t_time_expired_s',

					CONCAT(
						REPLACE(tc_azs_crt_alert." . d_azs_crt_alert_t_time_expired_d . ", '+', ''), ' ',
						REPLACE(tc_azs_crt_alert." . d_azs_crt_alert_t_time_expired_h . ", '+', ''), ':',
						REPLACE(tc_azs_crt_alert." . d_azs_crt_alert_t_time_expired_m . ", '+', ''), ':',
						REPLACE(tc_azs_crt_alert." . d_azs_crt_alert_t_time_expired_s . ", '+', '')
					) AS 'lbl_azs_crt_alert_t_time_expired',

					tc_azs_crt_alert." . d_azs_crt_alert_u_crt_phase . " AS 'lbl_azs_crt_alert_u_crt_phase'
				FROM " . t_azs_crt_alert . " tc_azs_crt_alert
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azs_crt_alert." . d_azs_crt_alert_m_by_created . "
						= tc_azp_user_created." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_user . " tc_azp_user_modified
					ON tc_azs_crt_alert." . d_azs_crt_alert_m_by_modified . "
						= tc_azp_user_modified." . d_azp_user_id_azp_user . "
				INNER JOIN " . t_azp_sys_level . " tc_azp_sys_level
					ON tc_azs_crt_alert." . d_azs_crt_alert_m_level . "
						= tc_azp_sys_level." . d_azp_sys_level_t_value . "
				INNER JOIN " . t_azp_sys_state . " tc_azp_sys_state
					ON tc_azs_crt_alert." . d_azs_crt_alert_m_status . "
						= tc_azp_sys_state." . d_azp_sys_state_t_value . "
				-- ---------------------------------------------------------------
				WHERE tc_azs_crt_alert." . d_azs_crt_alert_v_id_azp_crt_alert . " = '" . $this->id . "'
				ORDER BY tc_azs_crt_alert." . d_azs_crt_alert_m_date_modified . " DESC
			");
		}
		...
		final public function sql_controller_delete() : array {
			...
			$var_sql = $this->db->query("
				SELECT * FROM " . t_azp_crt_alert . "
				WHERE " . d_azp_crt_alert_id_azp_crt_alert . " = '" . $this->id . "'
					AND " . d_azp_crt_alert_m_deleted . " = '2'
				LIMIT 1
			");
			...
			if (false != $var_result) {
				...
				Func::redir(URL . url_query_azp_crt_alert);
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_crt_phase ." tc_azp_crt_phase
					ON tc_azp_crt_alert." . d_azp_crt_alert_v_id_azp_crt_phase . "
						= tc_azp_crt_phase." . d_azp_crt_phase_id_azp_crt_phase . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_crt_alert." . d_azp_crt_alert_id_azp_crt_alert . " = '" . $this->id . "'
					AND tc_azp_crt_alert." . d_azp_crt_alert_m_deleted . " = '1'
				LIMIT 1
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_crt_phase ." tc_azp_crt_phase
					ON tc_azp_crt_alert." . d_azp_crt_alert_v_id_azp_crt_phase . "
						= tc_azp_crt_phase." . d_azp_crt_phase_id_azp_crt_phase . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_crt_alert." . d_azp_crt_alert_m_deleted . " = '3'
				ORDER BY tc_azp_crt_alert." . d_azp_crt_alert_id_azp_crt_alert . " ASC
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_crt_phase ." tc_azp_crt_phase
					ON tc_azp_crt_alert." . d_azp_crt_alert_v_id_azp_crt_phase . "
						= tc_azp_crt_phase." . d_azp_crt_phase_id_azp_crt_phase . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_crt_alert." . d_azp_crt_alert_m_deleted . " = '1'
				ORDER BY tc_azp_crt_alert." . d_azp_crt_alert_id_azp_crt_alert . " ASC
			");
		}
			...
			return $this->db->query("
				...
				INNER JOIN " . t_azp_crt_phase ." tc_azp_crt_phase
					ON tc_azp_crt_alert." . d_azp_crt_alert_v_id_azp_crt_phase . "
						= tc_azp_crt_phase." . d_azp_crt_phase_id_azp_crt_phase . "
				-- ---------------------------------------------------------------
				WHERE tc_azp_crt_alert." . d_azp_crt_alert_m_deleted . " = '2'
				ORDER BY tc_azp_crt_alert." . d_azp_crt_alert_id_azp_crt_alert . " ASC
			");
		}
		...
		final public function sql_controller_update() {
			...
			return $this->db->query("
				SELECT
					tc_azp_crt_alert." . d_azp_crt_alert_id_azp_crt_alert . " AS 'lbl_azp_crt_alert_id_azp_crt_alert',
					tc_azp_crt_alert." . d_azp_crt_alert_m_by_created . " AS 'lbl_azp_crt_alert_m_by_created',
					tc_azp_crt_alert." . d_azp_crt_alert_m_by_modified . " AS 'lbl_azp_crt_alert_m_by_modified',
					tc_azp_crt_alert." . d_azp_crt_alert_m_date_created . " AS 'lbl_azp_crt_alert_m_date_created',
					tc_azp_crt_alert." . d_azp_crt_alert_m_date_modified . " AS 'lbl_azp_crt_alert_m_date_modified',
					tc_azp_crt_alert." . d_azp_crt_alert_m_description . " AS 'lbl_azp_crt_alert_m_description',
					tc_azp_crt_alert." . d_azp_crt_alert_m_level . " AS 'lbl_azp_crt_alert_m_level',
					tc_azp_crt_alert." . d_azp_crt_alert_m_status . " AS 'lbl_azp_crt_alert_m_status',
					tc_azp_crt_alert." . d_azp_crt_alert_t_next_time_d . " AS 'lbl_azp_crt_alert_t_next_time_d',
					tc_azp_crt_alert." . d_azp_crt_alert_t_next_time_h . " AS 'lbl_azp_crt_alert_t_next_time_h',
					tc_azp_crt_alert." . d_azp_crt_alert_t_next_time_m . " AS 'lbl_azp_crt_alert_t_next_time_m',
					tc_azp_crt_alert." . d_azp_crt_alert_t_next_time_s . " AS 'lbl_azp_crt_alert_t_next_time_s',
					...
					tc_azp_crt_alert." . d_azp_crt_alert_t_time_expired_m . " AS 'lbl_azp_crt_alert_t_time_expired_m',
					tc_azp_crt_alert." . d_azp_crt_alert_t_time_expired_s . " AS 'lbl_azp_crt_alert_t_time_expired_s',
					tc_azp_crt_alert." . d_azp_crt_alert_v_id_azp_crt_phase . " AS 'lbl_azp_crt_alert_v_id_azp_crt_phase'
				FROM " . t_azp_crt_alert . " tc_azp_crt_alert
				-- ---------------------------------------------------------------
				INNER JOIN " . t_azp_user . " tc_azp_user_created
					ON tc_azp_crt_alert." . d_azp_crt_alert_m_by_created . "
		...
		final private function error_sql_crt_alert_delete(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				$sql_id = $this->db->select('*', t_azp_crt_alert, d_azp_crt_alert_id_azp_crt_alert . " = '" . $empty_id . "'");
				...
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select('*', t_azp_crt_alert, d_azp_crt_alert_id_azp_crt_alert . " = '" . $empty_id . "' AND " . d_azp_crt_alert_m_deleted . " = '2'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (false == $sql_id) {
					# Verificar si el resultado devuleto no existe para asignar un valor especifico
					if (strtolower($sql_id) == '') { $sql_id[0][0] = 0; }
				...
				$sql_session = $this->db->select('*', t_azp_crt_alert, d_azp_crt_alert_id_azp_crt_alert . " = '" . $empty_id . "' AND " . d_azp_crt_alert_m_by_created . " = '" . $_SESSION[SESS_APP_ID] . "' AND " . d_azp_crt_alert_m_level . " = '1'");
				# Verificar si el registro creado es igual el valor del campo nivel al valor dos
				$sql_level = $this->db->select('*', t_azp_crt_alert, d_azp_crt_alert_id_azp_crt_alert . " = '" . $empty_id . "' AND " . d_azp_crt_alert_m_level . " = '2'");
				# Verificar si el resultado de la sql es verdadero o falso
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_crt_alert_delete(array $data) : array {
			$var_error = $this->error_sql_azp_crt_alert_delete($data);
			...
			if (!isset($_SESSION[SESS_APP_ID])) {
				...
				$var_array = array(d_azp_crt_alert_m_deleted => '3',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_crt_alert, $var_array, d_azp_crt_alert_id_azp_crt_alert . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
		...
		final private function error_sql_azp_crt_alert_insert(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				if (!isset($data['field_cr_crt_phase'])) { throw new Exception('<b>Error:</b> El campo de estado esta prohibido modificar.'); }
				#-------------------------------------------------------------------------#
				...
				$empty_crt_phase = $this->db->scape($data['field_cr_crt_phase']);
				#-------------------------------------------------------------------------#
				if (isset($_SESSION['pe_time']) and end($_SESSION['pe_time']) >= time()) {
					# Informar un mensaje al usuario por medio de una excepcion
					throw new Exception('No puedes realizar tantas acciones seguidas.');
				...
				#-------------------------------------------------------------------------#
				if (Func::emp($empty_crt_phase) || strtolower($empty_crt_phase) == strtolower('seleccionar') || $empty_crt_phase == 0) {
					# Informar un mensaje al usuario por medio de una excepcion
					throw new Exception('<b>Error:</b> El campo de estado es oblgitario.');
				}
				#---------------------------------------------#
				if (!is_numeric($empty_crt_phase)) {
					# Informar un mensaje al usuario por medio de una excepcion
					throw new Exception('<b>Error:</b> El campo de estado solo permite numeros.');
				}
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_crt_phase = $this->db->select('*', t_azp_crt_phase, d_azp_crt_phase_id_azp_crt_phase . " = '" . $empty_crt_phase . "'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (false == $sql_crt_phase) {
					# Verificar si el resultado devuleto no existe para asignar un valor especifico
					if (strtolower($sql_crt_phase) == '') { $sql_crt_phase[0][0] = 0; }
					# Verificiar si el valor recibido de la sql es diferente del digitado
					if (strtolower($sql_crt_phase[0][0]) != strtolower($empty_crt_phase)) {
						# Informar un mensaje al usuario por medio de una excepcion
				...
				$sql_crt_phase = $this->db->select(d_azp_crt_alert_v_id_azp_crt_phase, t_azp_crt_alert, d_azp_crt_alert_v_id_azp_crt_phase . " = '" . $empty_crt_phase . "'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (true == $sql_crt_phase) {
					# Verificiar si el valor recibido de la sql es diferente del digitado
					if (strtolower($sql_crt_phase[0][0]) == strtolower($empty_crt_phase)) {
						# Informar un mensaje al usuario por medio de una excepcion
						throw new Exception('<b>Error:</b> La fase seleccionada ya existe registrado.');
					}
				}
				#-------------------------------------------------------------------------#
				return false;
		...
		/*=========================================================================================================================*/
		# Query Sql Insert
		final public function sql_azp_crt_alert_insert(array $data) : array {
			$var_error = $this->error_sql_azp_crt_alert_insert($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(
					d_azp_crt_alert_m_by_created => $_SESSION[SESS_APP_ID],
					d_azp_crt_alert_m_by_modified => $_SESSION[SESS_APP_ID],
					d_azp_crt_alert_m_date_created => DATE_HOUR,
					d_azp_crt_alert_m_date_modified => DATE_HOUR,
					d_azp_crt_alert_m_deleted => '1',
					d_azp_crt_alert_m_description => $empty_description,
					d_azp_crt_alert_m_level => '2',
					d_azp_crt_alert_m_status => '1',
					d_azp_crt_alert_m_temp => '1',
					d_azp_crt_alert_t_next_time_d => $empty_next_time_d,
					d_azp_crt_alert_t_next_time_h => $empty_next_time_h,
					d_azp_crt_alert_t_next_time_m => $empty_next_time_m,
					d_azp_crt_alert_t_next_time_s => $empty_next_time_s,
					d_azp_crt_alert_t_time_expired_d => $empty_time_expired_d,
					d_azp_crt_alert_t_time_expired_h => $empty_time_expired_h,
					d_azp_crt_alert_t_time_expired_m => $empty_time_expired_m,
					d_azp_crt_alert_t_time_expired_s => $empty_time_expired_s,
					d_azp_crt_alert_v_id_azp_crt_phase => $empty_crt_phase,
				);
				# Query Sql Insert: Registrar valores en la tabla segun sus campos
				$this->db->insert(t_azp_crt_alert, $var_array);
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_crt_alert_remove(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				#-------------------------------------------------------------------------#
				# Verificar si el registro existe en la tabla
				$sql_id = $this->db->select('*', t_azp_crt_alert, d_azp_crt_alert_id_azp_crt_alert . " = '" . $empty_id . "' AND " . d_azp_crt_alert_m_deleted . " = '1'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (false == $sql_id) {
					# Verificar si el resultado devuleto no existe para asignar un valor especifico
					if (strtolower($sql_id) == '') { $sql_id[0][0] = 0; }
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_crt_alert_remove(array $data) : array {
			$var_error = $this->error_sql_azp_crt_alert_remove($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_crt_alert_m_deleted => '2',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_crt_alert, $var_array, d_azp_crt_alert_id_azp_crt_alert . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_crt_alert_restore(array $data) {
			try {
				#-------------------------------------------------------------------------#
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_crt_alert_restore(array $data) : array {
			$var_error = $this->error_sql_azp_crt_alert_restore($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				#-------------------------------------------------------------------------#
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(d_azp_crt_alert_m_deleted => '1',);
				# Query Sql Update: Actualizar valores de la tabla segun sus campos
				$this->db->update(t_azp_crt_alert, $var_array, d_azp_crt_alert_id_azp_crt_alert . " = '" . $empty_id . "'");
				#-------------------------------------------------------------------------#
				# Retornar el mensaje una vez ejecutada la rutina del proceso
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_azp_crt_alert_update(array $data) {
			try {
				#-------------------------------------------------------------------------#
				...
				if (!isset($data['field_up_crt_phase'])) { throw new Exception('<b>Error:</b> El campo de estado esta prohibido modificar.'); }
				#-------------------------------------------------------------------------#
				...
				$empty_crt_phase = $this->db->scape($data['field_up_crt_phase']);
				#-------------------------------------------------------------------------#
				if (isset($_SESSION['pe_time']) and end($_SESSION['pe_time']) >= time()) {
					# Informar un mensaje al usuario por medio de una excepcion
					throw new Exception('No puedes realizar tantas acciones seguidas.');
				...
				#-------------------------------------------------------------------------#
				# Verificar si el valor ingresado se encuentra repetido en los demas registros
				$sql_crt_phase = $this->db->select(d_azp_crt_alert_v_id_azp_crt_phase, t_azp_crt_alert, d_azp_crt_alert_id_azp_crt_alert . " != '" . $empty_id . "' AND " . d_azp_crt_alert_v_id_azp_crt_phase . " = '" . $empty_crt_phase . "'");
				# Verificar si el resultado de la sql es verdadero o falso
				if (true == $sql_crt_phase) {
					# Verificiar si el valor recibido de la sql es diferente del digitado
					if (strtolower($sql_crt_phase[0][0]) == strtolower($empty_crt_phase)) {
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_azp_crt_alert_update(array $data) : array {
			$var_error = $this->error_sql_azp_crt_alert_update($data);
			if (!is_bool($var_error)) { return $var_error; }
			if (!isset($_SESSION[SESS_APP_ID])) {
				# Redireccionar a una pagina segun el metodo cargado
				return array('error' => 1, 'message' => '<b>Error:</b> La sesión ha caducado, vuelve a iniciar sesión dando clic <a href="' . URL . 'login/?field_id=session">aqui</a>.');
				...
				$var_sql_select = $this->db->select('*', t_azp_crt_alert, d_azp_crt_alert_id_azp_crt_alert . " = '" . $empty_id . "'");
				# Validar si la sentencia query ejecutada es correcta y no falsa
				if (false != $var_sql_select) {
					# El constructor foreach proporciona un modo sencillo de iterar sobre arrays.
					foreach ($var_sql_select as $key_sql_select):
						$var_array = array(
							d_azs_crt_alert_m_by_created => $_SESSION[SESS_APP_ID],
							d_azs_crt_alert_m_by_modified => $_SESSION[SESS_APP_ID],
							d_azs_crt_alert_m_date_created => DATE_HOUR,
							d_azs_crt_alert_m_date_modified => DATE_HOUR,
							d_azs_crt_alert_m_deleted => $key_sql_select[d_azp_crt_alert_m_deleted],
							d_azs_crt_alert_m_description => $key_sql_select[d_azp_crt_alert_m_description],
							d_azs_crt_alert_m_level => $key_sql_select[d_azp_crt_alert_m_level],
							d_azs_crt_alert_m_status => $key_sql_select[d_azp_crt_alert_m_status],
							d_azs_crt_alert_m_temp => $key_sql_select[d_azp_crt_alert_m_temp],
							d_azs_crt_alert_t_next_time_d => $key_sql_select[d_azp_crt_alert_t_next_time_d],
							d_azs_crt_alert_t_next_time_h => $key_sql_select[d_azp_crt_alert_t_next_time_h],
							d_azs_crt_alert_t_next_time_m => $key_sql_select[d_azp_crt_alert_t_next_time_m],
							d_azs_crt_alert_t_next_time_s => $key_sql_select[d_azp_crt_alert_t_next_time_s],
							d_azs_crt_alert_t_time_expired_d => $key_sql_select[d_azp_crt_alert_t_time_expired_d],
							d_azs_crt_alert_t_time_expired_h => $key_sql_select[d_azp_crt_alert_t_time_expired_h],
							d_azs_crt_alert_t_time_expired_m => $key_sql_select[d_azp_crt_alert_t_time_expired_m],
							d_azs_crt_alert_t_time_expired_s => $key_sql_select[d_azp_crt_alert_t_time_expired_s],
							d_azs_crt_alert_u_crt_phase => $key_sql_select[d_azp_crt_alert_v_id_azp_crt_phase],
							d_azs_crt_alert_v_id_azp_crt_alert => $empty_id,
						);
						# Query Sql Insert: Insertar datos en la tabla con sus campos respectivos y asignados
						$this->db->insert(t_azs_crt_alert, $var_array);
					endforeach;
				}
				# Array para asignar argumentos o valores a los elementos
				$var_array = array(
					...
					d_azp_crt_alert_m_date_modified => DATE_HOUR,
					d_azp_crt_alert_m_description => $empty_description,
					d_azp_crt_alert_m_status => $empty_state,
					d_azp_crt_alert_t_next_time_d => $empty_next_time_d,
					d_azp_crt_alert_t_next_time_h => $empty_next_time_h,
					d_azp_crt_alert_t_next_time_m => $empty_next_time_m,
					d_azp_crt_alert_t_next_time_s => $empty_next_time_s,
		...
		/*=========================================================================================================================*/
		# Query Sql Select
		final public function sql_select_tc_azp_crt_phase() {
			# Seleccionar los registros de la tabla
			return $this->db->select('*', t_azp_crt_phase, d_azp_crt_phase_m_deleted . " = '1' AND " . d_azp_crt_phase_m_status . " = '1'");
		}
