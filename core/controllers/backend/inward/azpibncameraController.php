<?php
	...
	//------------------------------------------------
	class azpibncameraController extends Controllers {
		public function __construct() {
			...
			$var_m_azp_ibn_camera = new m_azp_ibn_cameraModel;
			# Instanciando clases del modelo
				...
				switch ($var_get_method) {
					...
					case 'delete':
						...
						if (false != $var_m_zz_design->sql_permits_value_delete($var_controller)) {
							...
							if ($this->isset_id) {
								...
								$var_m_azp_ibn_camera->sql_controller_delete();
								# Consultar registros de la tabla por medio del modelo instanciado
								$var_m_azp_ibn_camera->sql_azp_ibn_camera_delete();
							} else {
					...
					case 'info':
						...
						if (false != $var_m_zz_design->sql_permits_menu_value($var_controller)) {
							# Cargar en el metodo por url la plantilla con su contenido a visualizar
							echo $this->template->render('backend/inward/azp_ibn_camera', array(
								# Consultar registros de la tabla por medio del modelo instanciado
								...
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_ibn_control_panel' => $var_m_azp_ibn_camera->sql_select_tc_azp_ibn_control_panel(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_ibn_state' => $var_m_azp_ibn_camera->sql_select_tc_azp_ibn_state(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_ibn_type_certified' => $var_m_azp_ibn_camera->sql_select_tc_azp_ibn_type_certified(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_ibn_type_concept' => $var_m_azp_ibn_camera->sql_select_tc_azp_ibn_type_concept(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_ibn_observation' => $var_m_azp_ibn_camera->sql_select_tc_azp_ibn_observation(),

								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_acount' => $var_m_azp_ibn_camera->sql_field_t_acount($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_act_economic' => $var_m_azp_ibn_camera->sql_field_t_act_economic($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_address' => $var_m_azp_ibn_camera->sql_field_t_address($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_assessment' => $var_m_azp_ibn_camera->sql_field_t_assessment($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_business_name' => $var_m_azp_ibn_camera->sql_field_t_business_name($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_causal_feasibility' => $var_m_azp_ibn_camera->sql_field_t_causal_feasibility($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_city' => $var_m_azp_ibn_camera->sql_field_t_city($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_comment_legal' => $var_m_azp_ibn_camera->sql_field_t_comment_legal($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_concept' => $var_m_azp_ibn_camera->sql_field_t_concept($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_consecutive' => $var_m_azp_ibn_camera->sql_field_t_consecutive($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_department' => $var_m_azp_ibn_camera->sql_field_t_department($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_establishment' => $var_m_azp_ibn_camera->sql_field_t_establishment($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_full_name' => $var_m_azp_ibn_camera->sql_field_t_full_name($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_identification' => $var_m_azp_ibn_camera->sql_field_t_identification($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_legal_representative' => $var_m_azp_ibn_camera->sql_field_t_legal_representative($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_legal_rp_certificate' => $var_m_azp_ibn_camera->sql_field_t_legal_rp_certificate($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_limitation' => $var_m_azp_ibn_camera->sql_field_t_limitation($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_municipality' => $var_m_azp_ibn_camera->sql_field_t_municipality($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_nit' => $var_m_azp_ibn_camera->sql_field_t_nit($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_nro_registration' => $var_m_azp_ibn_camera->sql_field_t_nro_registration($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_observation' => $var_m_azp_ibn_camera->sql_field_t_observation($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_phone' => $var_m_azp_ibn_camera->sql_field_t_phone($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_policy_effective' => $var_m_azp_ibn_camera->sql_field_t_policy_effective($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_policy_final' => $var_m_azp_ibn_camera->sql_field_t_policy_final($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_policy_viability' => $var_m_azp_ibn_camera->sql_field_t_policy_viability($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_renewal_date' => $var_m_azp_ibn_camera->sql_field_t_renewal_date($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_rup' => $var_m_azp_ibn_camera->sql_field_t_rup($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_total_active' => $var_m_azp_ibn_camera->sql_field_t_total_active($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_type_company' => $var_m_azp_ibn_camera->sql_field_t_type_company($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_type_organization' => $var_m_azp_ibn_camera->sql_field_t_type_organization($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_viable' => $var_m_azp_ibn_camera->sql_field_t_viable($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_well_viable' => $var_m_azp_ibn_camera->sql_field_t_well_viable($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_year' => $var_m_azp_ibn_camera->sql_field_t_year($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_v_id_azp_ibn_control_panel' => $var_m_azp_ibn_camera->sql_field_v_id_azp_ibn_control_panel($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_v_id_azp_ibn_state' => $var_m_azp_ibn_camera->sql_field_v_id_azp_ibn_state($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_v_id_azp_ibn_type_certified' => $var_m_azp_ibn_camera->sql_field_v_id_azp_ibn_type_certified($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_v_id_azp_ibn_type_concept' => $var_m_azp_ibn_camera->sql_field_v_id_azp_ibn_type_concept($_GET['field_id']),
					...
					case 'remove':
						...
						if (false != $var_m_zz_design->sql_permits_value_remove($var_controller)) {
							...
							if ($this->isset_id) {
								# Consultar registros de la tabla por medio del modelo instanciado
								$var_m_azp_ibn_camera->sql_controller_remove();
								# Consultar registros de la tabla por medio del modelo instanciado
								$var_m_azp_ibn_camera->sql_azp_ibn_camera_remove();
							} else {
								# Redireccionar a una pagina segun el metodo cargado
								Func::redir(URL . $var_controller . 'info/query/');
								# Detener la ejecucion
					...
					case 'restore':
						...
						if (false != $var_m_zz_design->sql_permits_value_restore($var_controller)) {
							...
							if ($this->isset_id) {
								# Consultar registros de la tabla por medio del modelo instanciado
								$var_m_azp_ibn_camera->sql_controller_restore();
								# Consultar registros de la tabla por medio del modelo instanciado
								$var_m_azp_ibn_camera->sql_azp_ibn_camera_restore();
							} else {
								# Redireccionar a una pagina segun el metodo cargado
								Func::redir(URL . $var_controller . 'info/query/');
								# Detener la ejecucion
