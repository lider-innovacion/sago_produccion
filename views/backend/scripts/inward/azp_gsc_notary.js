...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_gsc_notary_id_azs_gsc_notary",
				data: "lbl_azs_gsc_notary_id_azs_gsc_notary",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_gsc_notary_m_date_created",
				data: "lbl_azs_gsc_notary_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_gsc_notary_m_date_modified",
				data: "lbl_azs_gsc_notary_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_gsc_notary_m_description",
				data: "lbl_azs_gsc_notary_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Direccion",
				id: "lbl_azs_gsc_notary_t_address",
				data: "lbl_azs_gsc_notary_t_address",
				type: "readonly",
				visible: true,
			},
			{
				title: "Razon Social",
				id: "lbl_azs_gsc_notary_t_business_name",
				data: "lbl_azs_gsc_notary_t_business_name",
				type: "readonly",
				visible: true,
			},
			{
				title: "Contacto",
				id: "lbl_azs_gsc_notary_t_contact",
				data: "lbl_azs_gsc_notary_t_contact",
				type: "readonly",
				visible: true,
			},
			{
				title: "Corrreo Electronico",
				id: "lbl_azs_gsc_notary_t_email",
				data: "lbl_azs_gsc_notary_t_email",
				type: "readonly",
				visible: true,
			},
			{
				title: "Telefono Fijo",
				id: "lbl_azs_gsc_notary_t_phone_fixed",
				data: "lbl_azs_gsc_notary_t_phone_fixed",
				type: "readonly",
				visible: true,
			},
			{
				title: "Telefono Movil",
				id: "lbl_azs_gsc_notary_t_phone_movil",
				data: "lbl_azs_gsc_notary_t_phone_movil",
				type: "readonly",
				visible: true,
			},
			{
				title: "Ciudad",
				id: "lbl_azs_gsc_notary_u_gsc_city",
				data: "lbl_azs_gsc_notary_u_gsc_city",
				type: "readonly",
				visible: true,
			},
		];
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_gsc_notary_id_azp_gsc_notary").innerHTML = objData.data.lbl_azp_gsc_notary_id_azp_gsc_notary;
					...
					document.querySelector("#lbl_azp_gsc_notary_m_date_created").innerHTML = objData.data.lbl_azp_gsc_notary_m_date_created;
					document.querySelector("#lbl_azp_gsc_notary_m_date_modified").innerHTML = objData.data.lbl_azp_gsc_notary_m_date_modified;
					document.querySelector("#lbl_azp_gsc_notary_m_description").innerHTML = objData.data.lbl_azp_gsc_notary_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_gsc_notary_t_address").innerHTML = objData.data.lbl_azp_gsc_notary_t_address;
					document.querySelector("#lbl_azp_gsc_notary_t_business_name").innerHTML = objData.data.lbl_azp_gsc_notary_t_business_name;
					document.querySelector("#lbl_azp_gsc_notary_t_contact").innerHTML = objData.data.lbl_azp_gsc_notary_t_contact;
					document.querySelector("#lbl_azp_gsc_notary_t_email").innerHTML = objData.data.lbl_azp_gsc_notary_t_email;
					document.querySelector("#lbl_azp_gsc_notary_t_phone_fixed").innerHTML = objData.data.lbl_azp_gsc_notary_t_phone_fixed;
					document.querySelector("#lbl_azp_gsc_notary_t_phone_movil").innerHTML = objData.data.lbl_azp_gsc_notary_t_phone_movil;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_gsc_notary/restore",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_gsc_notary_id_azp_gsc_notary;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_gsc_notary_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_gsc_notary_m_status;
					document.querySelector("#field_up_address").value = objData.data.lbl_azp_gsc_notary_t_address;
					document.querySelector("#field_up_business_name").value = objData.data.lbl_azp_gsc_notary_t_business_name;
					document.querySelector("#field_up_contact").value = objData.data.lbl_azp_gsc_notary_t_contact;
					document.querySelector("#field_up_email").value = objData.data.lbl_azp_gsc_notary_t_email;
					document.querySelector("#field_up_email_confirm").value = objData.data.lbl_azp_gsc_notary_t_email;
					document.querySelector("#field_up_phone_fixed").value = objData.data.lbl_azp_gsc_notary_t_phone_fixed;
					document.querySelector("#field_up_phone_movil").value = objData.data.lbl_azp_gsc_notary_t_phone_movil;
					document.querySelector("#field_up_gsc_city").value = objData.data.lbl_azp_gsc_notary_v_id_azp_gsc_city;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
