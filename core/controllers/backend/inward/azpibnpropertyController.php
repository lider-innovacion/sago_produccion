<?php
	...
	//------------------------------------------------
	class azpibnpropertyController extends Controllers {
		public function __construct() {
			...
			$var_m_azp_ibn_property = new m_azp_ibn_propertyModel;
			# Instanciando clases del modelo
				...
				switch ($var_get_method) {
					...
					case 'delete':
						...
						if (false != $var_m_zz_design->sql_permits_value_delete($var_controller)) {
							...
							if ($this->isset_id) {
								...
								$var_m_azp_ibn_property->sql_controller_delete();
								# Consultar registros de la tabla por medio del modelo instanciado
								$var_m_azp_ibn_property->sql_azp_ibn_property_delete();
							} else {
					...
					case 'info':
						...
						if (false != $var_m_zz_design->sql_permits_menu_value($var_controller)) {
							# Cargar en el metodo por url la plantilla con su contenido a visualizar
							echo $this->template->render('backend/inward/azp_ibn_property', array(
								# Consultar registros de la tabla por medio del modelo instanciado
								...
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_ibn_control_panel' => $var_m_azp_ibn_property->sql_select_tc_azp_ibn_control_panel(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_ibn_state' => $var_m_azp_ibn_property->sql_select_tc_azp_ibn_state(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_ibn_type_concept' => $var_m_azp_ibn_property->sql_select_tc_azp_ibn_type_concept(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_ibn_type_property' => $var_m_azp_ibn_property->sql_select_tc_azp_ibn_type_property(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_ibn_observation' => $var_m_azp_ibn_property->sql_select_tc_azp_ibn_observation(),

								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_acount' => $var_m_azp_ibn_property->sql_field_t_acount($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_address' => $var_m_azp_ibn_property->sql_field_t_address($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_area' => $var_m_azp_ibn_property->sql_field_t_area($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_assessment' => $var_m_azp_ibn_property->sql_field_t_assessment($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_causal_feasibility' => $var_m_azp_ibn_property->sql_field_t_causal_feasibility($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_comment_legal' => $var_m_azp_ibn_property->sql_field_t_comment_legal($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_concept' => $var_m_azp_ibn_property->sql_field_t_concept($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_consecutive' => $var_m_azp_ibn_property->sql_field_t_consecutive($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_department' => $var_m_azp_ibn_property->sql_field_t_department($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_full_name' => $var_m_azp_ibn_property->sql_field_t_full_name($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_identification' => $var_m_azp_ibn_property->sql_field_t_identification($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_limitation' => $var_m_azp_ibn_property->sql_field_t_limitation($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_market_value' => $var_m_azp_ibn_property->sql_field_t_market_value($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_municipality' => $var_m_azp_ibn_property->sql_field_t_municipality($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_nro_registration' => $var_m_azp_ibn_property->sql_field_t_nro_registration($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_observation' => $var_m_azp_ibn_property->sql_field_t_observation($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_ownership' => $var_m_azp_ibn_property->sql_field_t_ownership($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_policy_effective' => $var_m_azp_ibn_property->sql_field_t_policy_effective($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_policy_final' => $var_m_azp_ibn_property->sql_field_t_policy_final($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_policy_viability' => $var_m_azp_ibn_property->sql_field_t_policy_viability($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_purchase_annotation' => $var_m_azp_ibn_property->sql_field_t_purchase_annotation($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_viable' => $var_m_azp_ibn_property->sql_field_t_viable($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_t_well_viable' => $var_m_azp_ibn_property->sql_field_t_well_viable($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_v_id_azp_ibn_control_panel' => $var_m_azp_ibn_property->sql_field_v_id_azp_ibn_control_panel($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_v_id_azp_ibn_state' => $var_m_azp_ibn_property->sql_field_v_id_azp_ibn_state($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_v_id_azp_ibn_type_concept' => $var_m_azp_ibn_property->sql_field_v_id_azp_ibn_type_concept($_GET['field_id']),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_field_v_id_azp_ibn_type_property' => $var_m_azp_ibn_property->sql_field_v_id_azp_ibn_type_property($_GET['field_id']),
					...
					case 'remove':
						...
						if (false != $var_m_zz_design->sql_permits_value_remove($var_controller)) {
							...
							if ($this->isset_id) {
								# Consultar registros de la tabla por medio del modelo instanciado
								$var_m_azp_ibn_property->sql_controller_remove();
								# Consultar registros de la tabla por medio del modelo instanciado
								$var_m_azp_ibn_property->sql_azp_ibn_property_remove();
							} else {
								# Redireccionar a una pagina segun el metodo cargado
								Func::redir(URL . $var_controller . 'info/query/');
								# Detener la ejecucion
					...
					case 'restore':
						...
						if (false != $var_m_zz_design->sql_permits_value_restore($var_controller)) {
							...
							if ($this->isset_id) {
								# Consultar registros de la tabla por medio del modelo instanciado
								$var_m_azp_ibn_property->sql_controller_restore();
								# Consultar registros de la tabla por medio del modelo instanciado
								$var_m_azp_ibn_property->sql_azp_ibn_property_restore();
							} else {
								# Redireccionar a una pagina segun el metodo cargado
								Func::redir(URL . $var_controller . 'info/query/');
								# Detener la ejecucion
