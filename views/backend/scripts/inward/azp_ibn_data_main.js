...
function event_change_data() {
	...
	if (idtbl > 0) {
		...
		var columnSet = [
			{
				title: "Id",
				id: "lbl_azs_ibn_data_main_id_azs_ibn_data_main",
				data: "lbl_azs_ibn_data_main_id_azs_ibn_data_main",
				type: "readonly",
				className: "text-dark",
				visible: true,
			},
			...
			},
			{
				...
				id: "lbl_azs_ibn_data_main_m_date_created",
				data: "lbl_azs_ibn_data_main_m_date_created",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				...
				id: "lbl_azs_ibn_data_main_m_date_modified",
				data: "lbl_azs_ibn_data_main_m_date_modified",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			{
				title: "Descripcion",
				id: "lbl_azs_ibn_data_main_m_description",
				data: "lbl_azs_ibn_data_main_m_description",
				type: "readonly",
				className: "text-dark",
				visible: false,
			},
			...
			{
				title: "Consecutivo",
				id: "lbl_azs_ibn_data_main_t_consecutive",
				data: "lbl_azs_ibn_data_main_t_consecutive",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Nombre",
				id: "lbl_azs_ibn_data_main_t_full_name",
				data: "lbl_azs_ibn_data_main_t_full_name",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Cedula",
				id: "lbl_azs_ibn_data_main_t_identification",
				data: "lbl_azs_ibn_data_main_t_identification",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Codigo",
				id: "lbl_azs_ibn_data_main_t_code",
				data: "lbl_azs_ibn_data_main_t_code",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Departamento",
				id: "lbl_azs_ibn_data_main_t_department",
				data: "lbl_azs_ibn_data_main_t_department",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				title: "Ciudad",
				id: "lbl_azs_ibn_data_main_t_city",
				data: "lbl_azs_ibn_data_main_t_city",
				type: "text",
				className: "text-dark",
				visible: true,
			},
			{
				...
				id: "lbl_azs_ibn_data_main_u_ibn_control_panel",
				data: "lbl_azs_ibn_data_main_u_ibn_control_panel",
				type: "text",
				className: "text-dark",
				visible: true,
			},
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_data_main/create",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_data_main/delete",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-detail').modal('show');
					document.querySelector("#lbl_azp_ibn_data_main_id_azp_ibn_data_main").innerHTML = objData.data.lbl_azp_ibn_data_main_id_azp_ibn_data_main;
					...
					document.querySelector("#lbl_azp_ibn_data_main_m_date_created").innerHTML = objData.data.lbl_azp_ibn_data_main_m_date_created;
					document.querySelector("#lbl_azp_ibn_data_main_m_date_modified").innerHTML = objData.data.lbl_azp_ibn_data_main_m_date_modified;
					document.querySelector("#lbl_azp_ibn_data_main_m_description").innerHTML = objData.data.lbl_azp_ibn_data_main_m_description;
					document.querySelector("#lbl_azp_sys_state_t_name").innerHTML = objData.data.lbl_azp_sys_state_t_name;
					document.querySelector("#lbl_azp_ibn_data_main_t_city").innerHTML = objData.data.lbl_azp_ibn_data_main_t_city;
					document.querySelector("#lbl_azp_ibn_data_main_t_code").innerHTML = objData.data.lbl_azp_ibn_data_main_t_code;
					document.querySelector("#lbl_azp_ibn_data_main_t_consecutive").innerHTML = objData.data.lbl_azp_ibn_data_main_t_consecutive;
					document.querySelector("#lbl_azp_ibn_data_main_t_department").innerHTML = objData.data.lbl_azp_ibn_data_main_t_department;
					document.querySelector("#lbl_azp_ibn_data_main_t_full_name").innerHTML = objData.data.lbl_azp_ibn_data_main_t_full_name;
					document.querySelector("#lbl_azp_ibn_data_main_t_identification").innerHTML = objData.data.lbl_azp_ibn_data_main_t_identification;
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_data_main/remove",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_data_main/restore",
		...
		buttons: {
			...
			ok: {
				...
				callback: function() {
					$.ajax({
						type : "POST",
						url : "api/azp_ibn_data_main/update",
	...
	if (idtbl > 0) {
		...
		request.onreadystatechange = function(){
			if (request.readyState == 4 && request.status == 200) {
				...
				if (objData.status) {
					$('#modal-id-update').modal('show');
					document.querySelector("#field_up_id").value = objData.data.lbl_azp_ibn_data_main_id_azp_ibn_data_main;
					document.querySelector("#field_up_description").value = objData.data.lbl_azp_ibn_data_main_m_description;
					document.querySelector("#field_up_state").value = objData.data.lbl_azp_ibn_data_main_m_status;
					document.querySelector("#field_up_city").value = objData.data.lbl_azp_ibn_data_main_t_city;
					document.querySelector("#field_up_code").value = objData.data.lbl_azp_ibn_data_main_t_code;
					document.querySelector("#field_up_consecutive").value = objData.data.lbl_azp_ibn_data_main_t_consecutive;
					document.querySelector("#field_up_department").value = objData.data.lbl_azp_ibn_data_main_t_department;
					document.querySelector("#field_up_full_name").value = objData.data.lbl_azp_ibn_data_main_t_full_name;
					document.querySelector("#field_up_identification").value = objData.data.lbl_azp_ibn_data_main_t_identification;
					document.querySelector("#field_up_ibn_control_panel").value = objData.data.lbl_azp_ibn_data_main_v_id_azp_ibn_control_panel;
				} else {
					// Mensaje de audio para mostrar en la pagina web
					initApp.playSound('views/templates/smart/dist/media/sound', 'voice_on');
					bootbox.alert({
