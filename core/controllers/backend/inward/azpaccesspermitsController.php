<?php
	...
	//------------------------------------------------
	class azpaccesspermitsController extends Controllers {
				...
				switch ($var_get_method) {
					...
					case 'info':
						...
						if (true == $var_m_zz_design->sql_permits_menu_value($var_controller)) {
							# Cargar en el metodo por url la plantilla con su contenido a visualizar
							echo $this->template->render('backend/inward/azp_access_permits', array(
								...
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_access_type' => $var_m_azp_access_permits->sql_select_tc_azp_access_type(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_application' => $var_m_azp_access_permits->sql_select_tc_azp_application(),
								# Consultar registros de la tabla por medio del modelo instanciado
								'df_sql_select_tc_azp_role' => $var_m_azp_access_permits->sql_select_tc_azp_role(),
